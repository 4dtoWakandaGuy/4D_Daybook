...
If (False:C215)
	//Project Method Name:      Contracts List
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Contracts List")
...
Gen_ListSR("View Contracts"; "Contracts_File"; "Master"; ->[CONTRACTS:17]; ->vContr; "Contracts_Sel"; "Contracts"; "Contracts List"; ""; "ContrList"; $_bo_AutoSearch; $_t_SearchCode)
ERR_MethodTrackerReturn("Contracts List"; $_t_oldMethodName)