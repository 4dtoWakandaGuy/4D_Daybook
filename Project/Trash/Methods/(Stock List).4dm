...
If (False:C215)
	//Project Method Name:      Stock List
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Stock List")
//Stock List
Start_Process
If (Stock_File)
			...
			If (Records in selection:C76([STOCK_MOVEMENT_ITEMS:27])>0)
				...
				If (OK=1)
					If (Not:C34(SR_ReportOK("StockItList")))
						FORM SET OUTPUT:C54([STOCK_MOVEMENT_ITEMS:27]; "Stock List")
...
End if 
Process_End
ERR_MethodTrackerReturn("Stock List"; $_t_oldMethodName)