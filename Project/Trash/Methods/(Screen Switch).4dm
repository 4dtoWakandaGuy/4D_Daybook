...
If (False:C215)
	//Project Method Name:      Screen Switch
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Screen Switch")
$_t_FileMenuName:=Get localized string:C991("Menu_File")
If (<>MenuProc=0)
	<>MenuProc:=1
End if 
Menu_Record("Screen Switch"; "13'' Screens")
...
End if 
ERR_MethodTrackerReturn("Screen Switch"; $_t_oldMethodName)
