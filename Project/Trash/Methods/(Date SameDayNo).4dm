...
If (False:C215)
	//Project Method Name:      Date SameDayNo
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Date SameDayNo")
//Date SameDayNo - sets $0 to adjust $1 to be the same day number as
...
If ($_l_DayNumber#$_l_DayNumber2)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Date SameDayNo"; $_t_oldMethodName)