...
If (False:C215)
	//Project Method Name:      Tel SrvrRecPrmt
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Tel SrvrRecPrmt")
//tm_Record - Tel SrvrRecPrmt - with defaults
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Tel SrvrRecPrmt"; $_t_oldMethodName)
