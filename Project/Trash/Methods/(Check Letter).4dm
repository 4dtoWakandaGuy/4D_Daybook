...
If (False:C215)
	//Project Method Name:      Check Letter
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Check Letter")
	...
	If (Records in selection:C76([DOCUMENTS:7])>0)
		...
		Else 
			...
			If (OK=1)
				...
				DIALOG:C40([DOCUMENTS:7]; "dAsk Letter")
				CLOSE WINDOW:C154
...
Else 
	...
	//$p»:=""
End if 
ERR_MethodTrackerReturn("Check Letter"; $_t_oldMethodName)