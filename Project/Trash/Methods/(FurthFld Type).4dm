...
If (False:C215)
	//Project Method Name:      FurthFld Type
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FurthFld Type")
//FurthFld Type - Return just the Type of the Further Field
//As A N D or T
...
ERR_MethodTrackerReturn("FurthFld Type"; $_t_oldMethodName)