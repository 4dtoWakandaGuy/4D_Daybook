...
If (True:C214)
	C_BOOLEAN:C305(<>DB_bo_NewStockActive; <>InvTransferDelAddress; <>OrdersDisTr; <>PersAnOver; <>StockPostAu; <>StockPostIn; <>StockPostOr; $_bo_Locked; $_bo_OK)
	C_DATE:C307(<>DB_d_CurrentDate; $_d_SubscriptionDate; vDate)
	C_LONGINT:C283($_l_AddMode; $_l_Check; $_l_Month; $_l_OrderItemIndex; $_l_PeriodID; $_l_Year; INV_isUnique; INV_l_OrderID; vAdd; vIN)
	C_REAL:C285(INV_R_CCDeposit; INV_R_totalDeposit; vTotal)
	C_TEXT:C284(<>Per_t_CurrentDefaultAnalCode; <>SYS_t_ACCOpenBalancesStatus; <>SYS_t_BaseCurrency; $_t_Details; $_t_InvoiceNumber; $_t_Num; $_t_oldMethodName; $Layout3; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3)
	C_TEXT:C284(INV_t_OrderCode; Vdetails; vInvNo; vNumber; WIN_t_CurrentInputForm)
End if 
//Code Starts Here
