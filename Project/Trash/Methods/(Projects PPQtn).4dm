...
If (False:C215)
	//Project Method Name:      Projects PPQtn
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Projects PPQtn")
//Projects PPQtn
Menu_Record("Projects PPQtn"; "Quotation WP")
If ((DB_GetModuleSettingByNUM(Module_WPManager)=2) | (DB_GetModuleSettingByNUM(Module_WPManager)=4))
	...
	FORM SET INPUT:C55([DIARY:12]; "Diary_InL13"+Documents_4DWriteAccessType(True:C214))
	WIN_t_CurrentInputForm:="Diary_InL13"+Documents_4DWriteAccessType(True:C214)
...
End if 
ERR_MethodTrackerReturn("Projects PPQtn"; $_t_oldMethodName)
