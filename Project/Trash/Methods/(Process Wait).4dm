...
If (False:C215)
	//Project Method Name:      Process Wait
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_TEXT:C284(<>EXECUTE; $_t_menuCommand; $_t_oldMethodName; $_t_oldMethodName2; P_0; P_1)
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Process Wait")
...
End case 
P_1:=""
ERR_MethodTrackerReturn("Process Wait"; $_t_oldMethodName)
