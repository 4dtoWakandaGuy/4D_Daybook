...
If (False:C215)
	//Project Method Name:      Check Minor
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305(<>PER_bo_SystemSettingAccess; $_bo_BatchedEntry; $_bo_CreateRecord; AL_MINORFROMAL; DB_bo_ReadyForParameters; SD_bo_Contnue; vFromIn)
...
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Check Minor")
		...
		Else 
			...
			If (False:C215)
				...
				Else 
					...
					DB_DeletionControl($3; "Check Minor")
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Check Minor"; $_t_oldMethodName)