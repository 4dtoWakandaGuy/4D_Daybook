...
If (False:C215)
	//Project Method Name:      Menu DisFile
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>BAR; <>BarPos; <>BUTTPROC; <>MENU_l_BarModule; <>MenuProc; <>Mod_l_MenuBarPaletteProcess; <>newSetsProcess; <>ProcProc; <>SCPT_l_PaletteWIndow; $_l_DataManagerModuleName; $_l_DiaryModule)
...
$_t_oldMethodName:=ERR_MethodTracker("Menu DisFile")
...
If (<>Mod_l_MenuBarPaletteProcess>0)  //Modules Palette
...
If (DB_t_CurrentFormUsage#"ModBar")  //Update the Module Palette's button clicking
	If (<>Mod_l_MenuBarPaletteProcess#0)
		POST OUTSIDE CALL:C329(<>Mod_l_MenuBarPaletteProcess)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Menu DisFile"; $_t_oldMethodName)
