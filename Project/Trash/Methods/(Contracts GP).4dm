...
If (False:C215)
	//Project Method Name:      Contracts GP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Contracts GP")
//Contracts GP
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Menu_Record("Contracts GP"; "Add Product Items")
...
End if 
ERR_MethodTrackerReturn("Contracts GP"; $_t_oldMethodName)