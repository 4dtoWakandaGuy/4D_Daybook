...
If (False:C215)
	//Project Method Name:      Contacts DupGo
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Contacts DupGo")
Menu_Record("Contacts DupGo"; "Go to Duplicate")
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Contacts DupGo"; $_t_oldMethodName)