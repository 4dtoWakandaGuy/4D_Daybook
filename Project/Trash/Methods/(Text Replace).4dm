//%attributes = {}
If (False:C215)
	//Project Method Name:      Text Replace
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Text Replace")
Menu_Record("Text Replace"; "Replace...")
...
If (Type:C295($_ptr_FocusObject->)=2)
	...
	DIALOG:C40([COMPANIES:2]; "dText Replace")
	Close_ProWin
	If ((OK=1) & (<>TextFind#""))
...
End if 
ERR_MethodTrackerReturn("Text Replace"; $_t_oldMethodName)
