...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Editable; $_bo_NewLevel; $_bo_ShowP1Fields; INV_bo_FurtherFieldsLoaded)
	C_LONGINT:C283($_l_CurrentFormPage; $_l_FurtherFieldsExist; $_l_Index; $_l_TabRow; ballocate; INV_at_ViewTabsLabelsOLD; vALLevels)
	C_PICTURE:C286(INV_Pi_Mode)
	C_POINTER:C301($_ptr_ArrayReferences)
	C_REAL:C285(INV_l_FurtherFieldsMod)
	C_TEXT:C284($_t_FlagReference; $_t_HandlerCharacter1; $_t_oldMethodName; $_t_SubItemName; $1; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; INV_T_AssignedCode; SYS_t_AccessType; vButtDisInv)
End if 
			...
			Case of 
				: (INV_al_ViewTableToTable{INV_at_ViewTabsLabels}=Table:C252(->[CUSTOM_FIELDS:98]))
					...
					If (Size of array:C274(INV_aptr_ListboxSetup)=0) | (INV_at_ViewTabsLabelsOLD#INV_at_ViewTabsLabels)
						...
						LBi_ArrDefFill(->INV_aptr_ListboxSetup; ->INV_lb_InvoiceItems; ->[INVOICES_ITEMS:161]ID:17; ->[INVOICES:39]Invoice_Number:1; $_t_FlagReference; "Items in13"; 3; "Sales Ledger Items"; "Sales Ledger Item"; ""; $_bo_NewLevel)
				...
				: (INV_al_ViewTableToTable{INV_at_ViewTabsLabels}=Table:C252(->[INVOICES:39]))  //Invoice items
					...
					If (Size of array:C274(INV_aptr_ListboxSetup)=0) | (INV_at_ViewTabsLabelsOLD#INV_at_ViewTabsLabels)
						INV_at_ViewTabsLabelsOLD:=INV_at_ViewTabsLabels
						LBi_ArrDefFill(->INV_aptr_ListboxSetup; ->INV_lb_InvoiceItems; ->[INVOICES_ITEMS:161]ID:17; ->[INVOICES:39]Invoice_Number:1; $_t_FlagReference; "Items in13"; 3; "Sales Ledger Items"; "Sales Ledger Item"; ""; $_bo_NewLevel)
						//ALArrDefFill (->INV_aptr_ListboxSetup;->eALInvII;->[INVOICES];->[INVOICES]ITEMS;"Green";"ALModInvI";"411111000";"Items in13";"03903";◊User;"[INVOICES]ITEMS";"Sales Ledger Items";"Sales Ledger Item";->[INVOICES];->[INVOICES]Invoice No)
				...
				: (INV_al_ViewTableToTable{INV_at_ViewTabsLabels}=Table:C252(->[ORDER_ITEMS:25]))  //Orders
					...
					If (Size of array:C274(INV_aptr_ListboxSetup)=0) | (INV_at_ViewTabsLabelsOLD#INV_at_ViewTabsLabels)
						...
						LBi_ArrDefFill(->INV_aptr_ListboxSetup; ->INV_lb_InvoiceItems; ->[ORDER_ITEMS:25]Item_Number:27; ->[INVOICES:39]Invoice_Number:1; $_t_FlagReference; "Items In13"; (3+Num:C11(SYS_t_AccessType="Q")+(2*(Num:C11((DB_t_CurrentFormUsage="InE@") | (DB_t_CurrentFormUsage="InQ@") | (DB_t_CurrentFormUsage="InV@"))))); "Order Items"; "Order Item"; ""; $_bo_NewLevel)
						//LBi_ArrDefFill (->INV_aptr_ListboxSetup;->INV_lb_InvoiceItems;->[ORDERS]Order Code;->[INVOICES]Invoice No;"411111000";"Orders_In13";8;"Sales Orders";"Sales Orders";"";False)
