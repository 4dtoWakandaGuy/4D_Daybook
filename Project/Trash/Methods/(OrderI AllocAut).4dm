...
If (False:C215)
	//Project Method Name:      OrderI AllocAut
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OrderI AllocAut")
//OrderI AllocAut
//TRACE
...
If (Not:C34(ORD_bo_IsRevision))
	If (ORD_al_ViewTableToTable{ORD_at_ViewTabsLabels}=Table:C252(->[ORDER_ITEMS:25]))
		...
		Menu_Record("OrderI AllocAut"; "Allocate - Auto")
...
ERR_MethodTrackerReturn("OrderI AllocAut"; $_t_oldMethodName)