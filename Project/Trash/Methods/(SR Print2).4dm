...
If (False:C215)
	//Project Method Name:      SR Print2
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/12/2009 16:23`Method: SR Print2
...
$_t_oldMethodName:=ERR_MethodTracker("SR Print2")
//SR Print2 - see also SR_Print_Result
...
Else 
	...
	OK:=0
End if 
ERR_MethodTrackerReturn("SR Print2"; $_t_oldMethodName)
