...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_Event; $_l_ModuleRow; ch1; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; iCancel; iOK; ModuleNumber; PAL_BUTTON_10; PAL_BUTTON_7)
	C_LONGINT:C283(PAL_BUTTON_8; PAL_BUTTON_9; r1; r2; s1; s2; vSNo; vStockLevel)
	C_REAL:C285($1)
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		OpenHelp(Table:C252(->[STOCK_MOVEMENT_ITEMS:27]); "StockAss_In13")
		WS_AutoscreenSize(2; 384; 553)
		INT_SetInput(Table:C252(->[STOCK_MOVEMENT_ITEMS:27]); WIN_t_CurrentInputForm)
		DB_SetInputFormMenu(Table:C252(->[STOCK_MOVEMENT_ITEMS:27]); "StockAss_In13")
