...
$_t_oldMethodName:=ERR_MethodTracker("Jobs GP")
Menu_Record("Jobs GP"; "Add Product Items")
$_t_CurrentFormUsage:=DB_t_CurrentFormUsage
DB_t_CurrentFormUsage:="Job"
vOrdTitle:=vJobsTitle
Orders_GP
DB_t_CurrentFormUsage:=$_t_CurrentFormUsage
ERR_MethodTrackerReturn("Jobs GP"; $_t_oldMethodName)