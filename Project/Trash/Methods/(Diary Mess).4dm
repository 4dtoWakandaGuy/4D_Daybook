...
If (False:C215)
	//Project Method Name:      Diary Mess
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary Mess")
//Diary Message
...
If ([DIARY:12]Done:14=False:C215) & (SD_bo_AddingDiaryRecord)
	...
	Menu_Record("Diary Mess"; "Message to Personnel")
	...
	End if 
End if 
ERR_MethodTrackerReturn("Diary Mess"; $_t_oldMethodName)