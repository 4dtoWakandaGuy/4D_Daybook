...
If (False:C215)
	//Project Method Name:      Invoices ItInLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_CalledFromProcess; $_l_CharacterPosition; $_l_Event; $_l_ModuleRow; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; iCancel; iOK; ModuleNumber; PAL_BUTTON_10)
	C_LONGINT:C283(PAL_BUTTON_7; PAL_BUTTON_8; PAL_BUTTON_9; SD2_l_CallingProcess; SD2_l_TableNum)
...
$_t_oldMethodName:=ERR_MethodTracker("Invoices ItInLP")
...
Case of 
	...
	: ($_l_Event=On Activate:K2:9)
		DB_SetInputFormMenu(Table:C252(->[INVOICES_ITEMS:161]); "Items In13")
	...
	: ((($_l_Event=On Outside Call:K2:11) & (DB_l_ButtonClickedFunction#0)) | (iOK=1) | (iCancel=1))
		...
		Case of 
			...
			: (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Plus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Minus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Open"))
				...
				inButtSubHandle(FORM Get current page:C276; ->[INVOICES_ITEMS:161]; "items in13")
	...
	: ($_l_Event=On Clicked:K2:4) | ($_l_Event=On Data Change:K2:15)
		...
		Case of 
			: (BAR_t_Button#"")
				...
				If ($_l_ButtonNumber>1)
					...
					DB_SetInputFormMenu(Table:C252(->[INVOICES:39]); "Items In13")
		...
		End case 
End case 
ERR_MethodTrackerReturn("Invoices ItInLP"; $_t_oldMethodName)