...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Editable; $_bo_LoadSetup; $_bo_NewLevel; ORD_bo_IsRevision)
	...
	C_LONGINT:C283($_l_SortFieldNumber; $_l_TabIndex; DF_l_ContactCentric; ORD_l_AdHocAddressMode; ORD_l_BDragAll; ORD_l_BDragOrd; ORD_l_SelectedViewTabOLD; vALLevels)
	C_PICTURE:C286(OrdModePict)
	C_POINTER:C301($_ptr_ArrayFieldPointers; $_ptr_ArrayFieldPointers2; $_ptr_ArrayReferences; $_ptr_ArrayReferences2; $_ptr_ListBoxSetup; $_ptr_ListboxSetup2)
	C_REAL:C285(ORD_al_EditMode; ORD_r_SubSelection)
	C_TEXT:C284($_t_CurrentDefinitionsName; $_t_DataEditFormName; $_t_DragString; $_t_HandlerCharacter1; $_t_LBAreaOptions; $_t_oldMethodName; $_t_SubItemName; $1; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3)
	C_TEXT:C284(SYS_t_AccessType; vButtDisOrd)
End if 
//Code Starts Here
			...
			Case of 
				...
				: (ORD_al_ViewTableToTable{ORD_at_ViewTabsLabels}=Table:C252(->[ORDER_ITEMS:25]))  //Order items
					...
					If (Size of array:C274($_ptr_ListBoxSetup->)=0) | (ORD_l_SelectedViewTabOLD#ORD_at_ViewTabsLabels)
						...
						If ($_bo_NewLevel)
							LBi_ArrDefFill($_ptr_ListBoxSetup; ->ORD_r_SubSelection; ->[ORDER_ITEMS:25]Item_Number:27; ->[ORDERS:24]Order_Code:3; $_t_LBAreaOptions; "Items In13"; 3; "Order Line Items"; "Order Item"; ""; $_bo_NewLevel; $_l_ReuseLevel; "ORD_SelectedRelated")
						End if 
						//OK--so March 2007-I added a way last month to auto include a column if it is not in the definitions
						//here i am not only going to add the column SORT ORDER in I am also going to set this to ignore the users sort preference and sort by that column
						If (LB_GetColumnNumFromField(->[ORDER_ITEMS:25]Sort_Order:26; $_ptr_ListBoxSetup)<0)
				...
				: (ORD_al_ViewTableToTable{ORD_at_ViewTabsLabels}=Table:C252(->[INVOICES:39]))
					...
					If (Size of array:C274($_ptr_ListBoxSetup->)=0) | (ORD_l_SelectedViewTabOLD#ORD_at_ViewTabsLabels)
						...
						LBi_ArrDefFill($_ptr_ListBoxSetup; ->ORD_r_SubSelection; ->[INVOICES:39]Invoice_Number:1; ->[ORDERS:24]Order_Code:3; $_t_LBAreaOptions; "Invoices_In13"; 6; "Invoices"; "Invoice"; ""; $_bo_NewLevel; $_l_ReuseLevel; "ORD_SelectedRelated")
				...
				: (ORD_al_ViewTableToTable{ORD_at_ViewTabsLabels}=Table:C252(->[PURCHASE_ORDERS:57]))
					...
					If (Size of array:C274($_ptr_ListBoxSetup->)=0) | (ORD_l_SelectedViewTabOLD#ORD_at_ViewTabsLabels)
						ORD_l_SelectedViewTabOLD:=ORD_at_ViewTabsLabels
						LBi_ArrDefFill($_ptr_ListBoxSetup; ->ORD_r_SubSelection; ->[PURCHASE_ORDERS:57]Purchase_Order_Number:2; ->[ORDERS:24]Order_Code:3; $_t_LBAreaOptions; "Purch Ord In13"; 5; "Purchases Orders"; "Purchase order"; ""; $_bo_NewLevel; $_l_ReuseLevel; "ORD_SelectedRelated")
				...
				: (ORD_al_ViewTableToTable{ORD_at_ViewTabsLabels}=Table:C252(->[STOCK_MOVEMENT_ITEMS:27]))
					...
					If (Size of array:C274($_ptr_ListBoxSetup->)=0) | (ORD_l_SelectedViewTabOLD#ORD_at_ViewTabsLabels)
						ORD_l_SelectedViewTabOLD:=ORD_at_ViewTabsLabels
						LBi_ArrDefFill($_ptr_ListBoxSetup; ->ORD_r_SubSelection; ->[STOCK_MOVEMENT_ITEMS:27]x_ID:16; ->[ORDERS:24]Order_Code:3; $_t_LBAreaOptions; "Stock In13"; 1; "Items"; "Item"; ""; $_bo_NewLevel; $_l_ReuseLevel; "ORD_SelectedRelated")
