...
If (False:C215)
	//Project Method Name:      Post Balances
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Post Balances")
//Post Balances
OK:=1
...
Else 
	If (Application type:C494#4D Server:K5:6)
		...
		If ($_bo_NotLocked)
			...
			$_l_Process:=Execute on server:C373("ACC_RecordBalance"; 180000; "RecordAccountBalanceChange"; [ACCOUNT_BALANCES:34]Account_Code:2; $_t_ChangeType; $_r_ChangeTotal; $_r_AccBalance; $_r_AccBalance2; "Client "+<>PER_t_CurrentUserName+" Post Balances(1)")
	...
	Else 
		...
		$0:=[ACCOUNT_BALANCES:34]x_ID:7
		$_r_AccBalance2:=[ACCOUNT_BALANCES:34]Balance:3
		$_l_AccountBalanceProcess:=New process:C317("ACC_RecordBalance"; 180000; "RecordAccountBalanceChange"; [ACCOUNT_BALANCES:34]Account_Code:2; $_t_ChangeType; $_r_ChangeTotal; $_r_AccBalance; $_r_AccBalance2; "Server"+" Post Balances(1)")
...
If (([TRANSACTIONS:29]Tax_Amount:16#0) & (OK=1))
		...
		Else 
			...
			If (Application type:C494#4D Server:K5:6)
				...
				If ($_bo_NotLocked)
					...
					AA_CheckFileUnlocked(->[ACCOUNT_BALANCES:34]x_ID:7)
					$_r_AccBalance2:=[ACCOUNT_BALANCES:34]Balance:3
					$_l_Process:=Execute on server:C373("ACC_RecordBalance"; 180000; "RecordAccountBalanceChange"; [ACCOUNT_BALANCES:34]Account_Code:2; "Tax Amount"; $_r_ChangeTotal; $_r_AccBalance; $_r_AccBalance2; "Client "+<>PER_t_CurrentUserName+"Post Balances(2)")
			...
			Else 
				...
				AA_CheckFileUnlocked(->[ACCOUNT_BALANCES:34]x_ID:7)
				$_r_AccBalance2:=[ACCOUNT_BALANCES:34]Balance:3
				$_l_Process:=New process:C317("ACC_RecordBalance"; 180000; "RecordAccountBalanceChange"; [ACCOUNT_BALANCES:34]Account_Code:2; "Tax Amount"; $_r_ChangeTotal; $_r_AccBalance; $_r_AccBalance2; "Server Post Balances(2)")
				...
				Else 
					If (Application type:C494#4D Server:K5:6)
						...
						If ($_bo_NotLocked)
							...
							AA_CheckFileUnlocked(->[ACCOUNT_BALANCES:34]x_ID:7)
							$_r_AccBalance2:=[ACCOUNT_BALANCES:34]Balance:3
							$_l_Process:=Execute on server:C373("ACC_RecordBalance"; 180000; "RecordAccountBalanceChange"; [ACCOUNT_BALANCES:34]Account_Code:2; "Tax Amount"; $_r_ChangeTotal; $_r_AccBalance; $_r_AccBalance2; "Client  "+<>PER_t_CurrentUserName+"Post Balances(3)")
					...
					Else 
						...
						AA_CheckFileUnlocked(->[ACCOUNT_BALANCES:34]x_ID:7)
						$_r_AccBalance2:=[ACCOUNT_BALANCES:34]Balance:3
						$_l_Process:=New process:C317("ACC_RecordBalance"; 180000; "RecordAccountBalanceChange"; [ACCOUNT_BALANCES:34]Account_Code:2; "Tax Amount"; $_r_ChangeTotal; $_r_AccBalance; $_r_AccBalance2; "Server Post balances(3)")
	...
	End if 
End if 
ERR_MethodTrackerReturn("Post Balances"; $_t_oldMethodName)