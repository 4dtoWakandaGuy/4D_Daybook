...
If (False:C215)
	//Project Method Name:      In ButtLPIn
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("In ButtLPIn")  //NG April 2011-not called
...
ERR_MethodTrackerReturn("In ButtLPIn"; $_t_oldMethodName)
