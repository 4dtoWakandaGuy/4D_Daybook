...
If (False:C215)
	//Project Method Name:      Locations Mod
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>Mod_l_MaxModules; $_l_FormDefaultHeight; $_l_FormDefaultWidth; MOD_l_CurrentModuleAccess)
	C_REAL:C285(STK_l_LocationsReadWrite)
	C_TEXT:C284(<>SYS_t_FormSizeName; $_t_oldMethodName; WIN_t_CurrentOutputform)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Locations Mod")
TRACE:C157
...
End if 
ERR_MethodTrackerReturn("Locations Mod"; $_t_oldMethodName)
