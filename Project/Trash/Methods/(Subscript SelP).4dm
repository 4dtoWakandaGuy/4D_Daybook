...
If (False:C215)
	//Project Method Name:      Subscript SelP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Subscript SelP")
//Subscript SelP
...
While ((vCalls=1) & ((SRCH_l_And=1) | (SRCH_l_or=1) | (SRCH_l_Not=1)))
	...
	If ($_l_QueryID=0)
		...
		End if 
		DIALOG:C40([SUBSCRIPTIONS:93]; "dSubs Sel")
...
End if 
ERR_MethodTrackerReturn("Subscript SelP"; $_t_oldMethodName)
