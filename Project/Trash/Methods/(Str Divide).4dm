...
If (False:C215)
	//Project Method Name:      Str Divide
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Str Divide")
//Str Divide - does long division by hand on strings
...
Else 
	$0:=""
End if 
ERR_MethodTrackerReturn("Str Divide"; $_t_oldMethodName)
