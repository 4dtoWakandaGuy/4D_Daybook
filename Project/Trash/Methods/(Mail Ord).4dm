...
$_t_oldMethodName:=ERR_MethodTracker("Mail Ord")
//Mail Orders
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Start_Process
Start_ProcMail
Orders_File
FORM SET INPUT:C55([ORDERS:24]; "Orders_In13")  //NG April 2004 removed reference to ◊screen
...
While (vOrd=1)
	...
	If (vOrd=1)
		If (Records in selection:C76([ORDERS:24])>0)
			...
			//v`Layout:="Print"
			//Open_Pro_Window ("Mail Orders";0;1;->[ORDERS];WIN_t_CurrentOutputform)
...
ERR_MethodTrackerReturn("Mail Ord"; $_t_oldMethodName)
