...
If (False:C215)
	//Project Method Name:      Projects File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Projects File")

FORM SET INPUT:C55([PROJECTS:89]; "Projects_In13")  //NG April 2004 Removed ◊Screen
WIN_t_CurrentInputForm:="Projects_In13"
FORM SET OUTPUT:C54([PROJECTS:89]; "Projects Out")
WIN_t_CurrentOutputform:="Projects Out"
vA:=1
$0:=True:C214
...
End if 
ERR_MethodTrackerReturn("Projects File"; $_t_oldMethodName)