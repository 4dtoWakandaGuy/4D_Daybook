...
If (False:C215)
	//Project Method Name:      TransT ChPrefs
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("TransT ChPrefs")
//TransT ChPrefs - Check Prefs & return false if not allowed
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("TransT ChPrefs"; $_t_oldMethodName)