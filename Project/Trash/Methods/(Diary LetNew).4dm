...
If (False:C215)
	//Project Method Name:      Diary LetNew
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305(DB_bo_RecordModified; DOC_bo_AutoPrint; DOC_bo_TemplateSelected; FromDiary; DB_bo_4DwriteFullWindow; DB_bo_RecordModified; DOC_bo_AutoPrint; DOC_bo_TemplateSelected)
...
$_t_oldMethodName:=ERR_MethodTracker("Diary LetNew")
//Diary LetNew
FromDiary:=True:C214
$_t_WriteAccessType:=""
...
Else 
	Menu_Record("Diary LetNew"; "New Document")
...
End if 
ERR_MethodTrackerReturn("Diary LetNew"; $_t_oldMethodName)
