...
If (False:C215)
	//Project Method Name:      PurchOrd SubLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("PurchOrd SubLP")
//Purchases Items Sub
...
Case of 
	: ($_l_Event=On Data Change:K2:15)
		Case of 
			...
			: (Modified:C32([PURCHASE_ORDERS_ITEMS:169]Tax_Code:7))
				Check_MinorNC(->[PURCHASE_ORDERS_ITEMS:169]Tax_Code:7; ""; ->[TAX_CODES:35]; ->[TAX_CODES:35]Tax_Code:1; ->[TAX_CODES:35]Tax_Rate:3; Term VATWT("VAT Code"))
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		End if 
End case 
ERR_MethodTrackerReturn("PurchOrd SubLP"; $_t_oldMethodName)