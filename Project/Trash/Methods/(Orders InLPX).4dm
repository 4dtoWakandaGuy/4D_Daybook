...
If (True:C214)
	...
	C_BOOLEAN:C305(<>CCM_bo_Inited; <>ForceCred; <>SalesOrder; <>StatesLoaded; $_bo_CardIsFound; $_bo_NoMessage)
	C_DATE:C307(ORD_d_EntryDateFrom)
	C_LONGINT:C283($_l_CreditCardLength; $_l_CreditStateRow; CCM_l_CardToUse; CCM_l_isinternal; CCM_l_LastNoofDigits; ch1)
	C_POINTER:C301($1)
	C_TEXT:C284(<>Source; <>SYS_t_BaseCurrency; $_t_CompanyCode; $_t_ContactCode; $_t_Expires; $_t_NameOnCard; $_t_NewOrderState; $_t_oldMethodName; $_t_PreviousState; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2)
	C_TEXT:C284(DB_t_CurrentFormUsage3; vCallCode; vOrderCode; vStPrevOLD)
End if 
//Code Starts Here
