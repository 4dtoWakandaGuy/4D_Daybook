...
If (False:C215)
	//Project Method Name:      Sel UserSearch
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Sel UserSearch")
Menu_Record("Sel UserSearch"; "User Search ...")
...
ERR_MethodTrackerReturn("Sel UserSearch"; $_t_oldMethodName)