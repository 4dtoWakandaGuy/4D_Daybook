...
LBi_ArrDefFill(->ORD_aPtr_OrderItemsSetup; ->ORD_LB_TimeItems; ->[ORDER_ITEMS:25]Item_Number:27; ->[ORDERS:24]Order_Code:3; "411111126"; "Items In13"; 20; "Order Items"; "Order Item")  //changed from "eALOrdII" to "ORD_LB_TimeItems" (eALOrdII was undefined and presumably the pre listbox version) - 09/01/07 -kmw
