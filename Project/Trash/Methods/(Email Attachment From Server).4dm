//%attributes = {}
If (False:C215)
	//Project Method Name:      Email Attachment From Server
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Email Attachment From Server")
//$1 filename
//$2 Server file path
//$0 Local file path
//new comment
...
ERR_MethodTrackerReturn("Email Attachment From Server"; $_t_oldMethodName)