...
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("___Orphan___4300")

$oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oAccProfBalCB3"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oAccProfBalCB3"; $OldMethodName)