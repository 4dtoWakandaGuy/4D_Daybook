//%attributes = {}
If (False:C215)
	//Project Method Name:      PuOItems InLPX
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/11/2009`Method: PuOItems InLPX
...
$_t_oldMethodName:=ERR_MethodTracker("PuOItems InLPX")
//PuOItems InLPX
...
End case 
ERR_MethodTrackerReturn("PuOItems InLPX"; $_t_oldMethodName)
