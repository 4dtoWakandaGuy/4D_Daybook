...
If (False:C215)
	//Project Method Name:      Process Manager
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>AutoProc; <>MenuProc; <>Mod_l_MenuBarPaletteProcess; $_l_CurrentProcess; $_l_CurrentTime; $_l_FrontMostProcess; $_l_LastMonitor)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Process Manager")
...
End while 
ERR_MethodTrackerReturn("Process Manager"; $_t_oldMethodName)
