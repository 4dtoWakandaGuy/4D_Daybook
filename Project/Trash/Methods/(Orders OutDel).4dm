...
If (False:C215)
	//Project Method Name:      Orders OutDel
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders OutDel")
...
Else 
			...
			If (OK=1)
				...
				While (Not:C34(End selection:C36([ORDERS:24])))
					If ([ORDERS:24]Order_Code:3#"")
						...
						Else 
							//      ALERT("This is how it happens: Orders Out xDelete"+Char(13)+"TELL ROLLO")
						End if 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Orders OutDel"; $_t_oldMethodName)
