...
If (False:C215)
	//Project Method Name:      Orders PPQtn
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders PPQtn")
//Orders PPQtn
$_t_CurrentInputForm:=WIN_t_CurrentInputForm
Menu_Record("Orders PPQtn"; "Quotation WP")
...
Else 
	...
	If ((DB_GetModuleSettingByNUM(Module_WPManager)=2) | (DB_GetModuleSettingByNUM(Module_WPManager)=4))
		If (In_ButtChkMan(->[ORDERS:24]; "1 3"))
			...
			//WIN_t_CurrentInputForm:="Diary_InL13"+Letters Write (True)  `NG April 2004 Removed ◊Screen
...
ERR_MethodTrackerReturn("Orders PPQtn"; $_t_oldMethodName)
