...
FORM SET INPUT:C55([DOCUMENTS:7]; "Letters_In13W")  //NG April 2004 removed reference to ◊screen
WIN_t_CurrentInputForm:="Letters_In13W"
Case of 
	: (WS_l_SelDocTemplateClass=1)  //letter templates
		...
		End if 
		FORM SET INPUT:C55([DOCUMENTS:7]; "Letters_In13"+$_t_WriteAccessType)  //NG April 2004 removed reference to ◊screen
		WIN_t_CurrentInputForm:="Letters_In13"+$_t_WriteAccessType
	...
	: (WS_l_SelDocTemplateClass=5)  //others
		...
		WIN_t_CurrentInputForm:="Letters_In13"+$_t_WriteAccessType
End case 
//WIN_t_CurrentInputForm:="Letters_In13"+$_t_WriteAccessType  `NG April 2004 removed reference to ◊screen
