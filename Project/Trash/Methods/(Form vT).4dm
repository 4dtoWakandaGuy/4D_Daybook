...
$_t_oldMethodName:=ERR_MethodTracker("Form vT")
//Changed further=NG JUne 2003

If (($1) & ($2#""))
	vT:=RemoveTrailCR($2)
	$_l_CarriageReturns:=Str CountStr(vT; Char:C90(13))
...
Else 
	vT:=""
End if 
ERR_MethodTrackerReturn("Form vT"; $_t_oldMethodName)