...
If (False:C215)
	//Project Method Name:      Letters SWMenu
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letters SWMenu")
//Letters SWMenu - SuperWrite
...
If (Menu selected:C152#0)
				...
				: ($_l_menuItemNumber=18)
					...
					If ($_l_r=0)
						...
						If (vMod3)
							...
							//  SET_MENU ITEM MARK(2049;18;" ")
							vMod3:=False:C215
						Else 
							DB_MenuAction("File"; "Entry Defaults"; 4; "")
							//  SET_MENU ITEM MARK(2049;18;"18")
							vMod3:=True:C214
						End if 
					End if 
			End case 
	...
	End case 
End if 
ERR_MethodTrackerReturn("Letters SWMenu"; $_t_oldMethodName)