...
If (False:C215)
	//Project Method Name:      Orders DelBut
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders DelBut")
OK:=0
MESSAGES OFF:C175
If (MOD_l_CurrentModuleAccess<3)
	...
	If (OK=1)
											...
											: ($1="Contracts")
												If ([ORDER_ITEMS:25]Contract_Code:29#"")
													If ([ORDER_ITEMS:25]Order_Code:1#"")
														...
														End if 
													Else 
														$_l_OK:=DB_DeletionControl(->[ORDER_ITEMS:25]; "orders delbut")
														If ($_l_OK=1)
		...
		Else 
									...
									: ($1="Contracts")
										If ([ORDER_ITEMS:25]Contract_Code:29#"")
											If ([ORDER_ITEMS:25]Order_Code:1#"")
												...
												End if 
											Else 
												DB_DeletionControl(->[ORDER_ITEMS:25]; "orders delbut")
												DELETE RECORD:C58([ORDER_ITEMS:25])
											End if 
										End if 
			...
			End if 
			If ($_bo_noDeletion=False:C215)
				DB_DeletionControl(->[ORDERS:24]; "orders delbut")
...
MESSAGES ON:C181
ERR_MethodTrackerReturn("Orders DelBut"; $_t_oldMethodName)
