...
Menu_Record("Diary_PrintSht"; "Print Diary Sheet")
...
$_l_Printed:=Gen_PPSingle(->[DIARY:12]; "Diary Sheet"; "Diary Out"; [DIARY:12]Action_Code:9+"Printout"; [DIARY:12]Action_Code:9+"Printout"; ""; 0; ->[DIARY:12]Status:30; "Diary "+[DIARY:12]Action_Code:9; ""; False:C215; $_t_DocumentName)  // 05/04/040 pb"
...
If (True:C214)
	If (False:C215)
		COPY NAMED SELECTION:C331([DIARY:12]; "Diary Items")
		FORM SET OUTPUT:C54([DIARY:12]; "Diary Sheet")
