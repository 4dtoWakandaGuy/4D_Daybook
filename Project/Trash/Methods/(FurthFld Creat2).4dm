...
If (False:C215)
	//Project Method Name: FurthFld Creat2
	//------------------ Method Notes ------------------
	//------------------ Revision Control ----------------
...
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("FurthFld Creat2")
//FurthFld Creat2
Load_Fields
...
If ($_l_CountParameters>=2)
		...
		If ($_l_TableRow>0)
			...
			If (<>SYS_al_TableUniqueField{$_l_TableRow}#0)
				...
				If ($_l_FieldColumn<1)
					...
					$_t_AccessCode:=Str LeadZeros(String:C10($_l_TableRow); 3)+Str_TrailSpaces(<>PER_t_CurrentUserInitials; 5)
	...
	End if 
End if 
ERR_MethodTrackerReturn("FurthFld Creat2"; $_t_oldMethodName)