...
If (False:C215)
	//Project Method Name:      PurchOrd PPrint
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305(<>DB_bo_NewStockActive; <>STK_bo_UseNew; $_bo_EnableStockPosting; $_bo_NoPrint; $_bo_Updade; $3; PO_bo_AddItem; SR_bo_Validated)
	C_LONGINT:C283($_l_ModuleAccess; $_l_POIIndex; $_l_Printed; $1; vAdd; xCancel; xNext)
	C_POINTER:C301($2)
	C_TEXT:C284($_t_CurrentWindowTitle; $_t_DocumentName; $_t_oldMethodName; $_t_PONumber; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3)
End if 
//Code Starts Here



$_t_oldMethodName:=ERR_MethodTracker("PurchOrd PPrint")
SR_bo_Validated:=False:C215
Menu_Record("PurchOrd PPrint"; "Print Purchase Order")
OK:=1
xNext:=0
...
If ($_bo_NoPrint=False:C215)
	...
	//Gen_PPSingle (->[PURCHASE ORDERS];"Form";"Purch Ord Out";DB_t_CurrentFormUsage;"PURCHASE ORDER";"PurchOrd_FormLP";0;->[PURCHASE ORDERS]Purch Ord No;"Purch Order";[PURCHASE ORDERS]Analysis Code)
	...
	$_l_Printed:=Gen_PPSingle(->[PURCHASE_ORDERS:57]; "Form"; "Purch Ord Out"; DB_t_CurrentFormUsage; "PURCHASE ORDER"; "PurchOrd_FormLP"; 0; ->[PURCHASE_ORDERS:57]Purchase_Order_Number:2; "Purch Order"; [PURCHASE_ORDERS:57]Analysis_Code:15; False:C215; $_t_DocumentName)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("PurchOrd PPrint"; $_t_oldMethodName)
