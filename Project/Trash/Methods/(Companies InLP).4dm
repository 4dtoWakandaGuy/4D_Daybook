...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_CallledFromProcess; $_l_CharacterPosition; $_l_CurrentFormPage; $_l_Event; $_l_Index; $_l_ModuleRow; $_l_NewProcess; $m2; COM_l_Callback; DB_l_ButtonClickedFunction)
	C_LONGINT:C283(DB_l_WindowCurrentModule; iCancel; iOK; ModuleNumber; PAL_BUTTON_10; PAL_BUTTON_7; PAL_BUTTON_8; PAL_BUTTON_9; SD2_l_CallingProcess; SD2_l_TableNum; vAccessSwNo)
	C_PICTURE:C286(COM_Pi_EditMode)
	C_POINTER:C301($_ptr_ArrayReferences; $_ptr_ListboxSetup; $_ptr_Table)
	C_TEXT:C284($_t_CurrentTabTitle; $_t_DummyTab; $_t_oldMethodName; $_t_PalletButtonName; $_t_ReferencedTabTitle; $_t_SubItemName; BAR_t_Button; COM_t_COntext; COM_t_FalseTab; DB_t_Address1Label; DB_t_Address2Label)
	C_TEXT:C284(DB_t_CountryLabel; DB_t_CountyLabel; DB_t_CUrrentInputMenuRef; DB_T_CurrentInputWindowMenu; DB_t_DiaryCode; DB_t_PostcodeLabel; DB_t_TownLabel; IP_t_MessageReplySTR; IP_t_MessageReplyTXT; PAL_BUTTON; SD2_t_TabFunction)
	C_TEXT:C284(vButtDisCom; WIN_t_CurrentInputForm; WS_S1; WS_S2)
End if 
//Code Starts Here
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		OpenHelp(Table:C252(->[COMPANIES:2]); "Companies_In13")
		...
		Else 
			$_t_CurrentTabTitle:=""
		End if 
		DB_SetInputFormMenu(Table:C252(->[COMPANIES:2]); "Companies_In13"; $_t_CurrentTabTitle)
