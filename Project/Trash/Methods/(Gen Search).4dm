...
If (False:C215)
	//Project Method Name:      Gen Search
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305(<>StartProc; $Show; IME_isInternetManagerBool; WIN_bo_TrackerInited)
...
$_t_oldMethodName:=ERR_MethodTracker("Gen Search")
If (<>Keys="§M")
	OK:=1
	xNext:=1
	$0:=""
Else 
	...
	Else 
		...
		vRequest:=$2
		$Show:=True:C214
		$Show:=Not:C34(IME_isInternetManagerBool)  //$Show:=True `Wed, Feb 21, 2007 balinderwalia: changed
		If (<>Keys#"")
...
<>Keys:=""
ERR_MethodTrackerReturn("Gen Search"; $_t_oldMethodName)