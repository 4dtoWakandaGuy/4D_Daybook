//%attributes = {}
If (False:C215)
	//Project Method Name:      MoveType No_OLDSTYLE
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("MoveType No_OLDSTYLE")
...
Else 
	...
	Move_InType
	$0:=MoveType No_OLDSTYLE
End if 
ERR_MethodTrackerReturn("MoveType No_OLDSTYLE"; $_t_oldMethodName)
