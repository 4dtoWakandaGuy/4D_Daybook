...
Case of 
	...
	: ($1=(->[JOB_STAGES:47]B_Applicant_TAX:17))
		...
		Check_MinorNC(->[JOB_STAGES:47]B_Applicant_TAX:17; ""; ->[TAX_CODES:35]; ->[TAX_CODES:35]Tax_Code:1; ->[TAX_CODES:35]Tax_Rate:3; Term VATWT("VAT Code"))
		
		Check_MinorNC(->[JOB_STAGES:47]B_Applicant_TAX:17; ""; ->[TAX_CODES:35]; ->[TAX_CODES:35]Tax_Code:1; ->[TAX_CODES:35]Tax_Rate:3; Term VATWT("VAT Code"); $2)
