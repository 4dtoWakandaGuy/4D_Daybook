...
If (False:C215)
	//Project Method Name:      Menu PalButt
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Menu PalButt")
//Menu PalButt - see also scripts of Silver & Gold Buttons Palettes
...
If ($_t_MenuName=$_t_MenuFileName) | ($_l_MenuBarSelected=1)
	...
	End case 
End if 
ERR_MethodTrackerReturn("Menu PalButt"; $_t_oldMethodName)
