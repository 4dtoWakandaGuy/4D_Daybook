...
If (False:C215)
	//Project Method Name:      User inLP
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 23/11/2009`Method: User InLP
...
If (True:C214)
	...
	C_BOOLEAN:C305(<>PW_bo_PasswordExpires; <>PW_Bo_WindowsAutoLogin; <>SYS_bo_CapitaliseTown; <>TermST; $_bo_Continue; $_bo_OK; CAT_bo_ChangePrefs; DB_bo_NoLoad; DB_bo_RecordModified; DM_bo_CreditsSequence; DM_bo_nomAllowUnProc)
	C_BOOLEAN:C305(DM_bo_nomenforceAnalysis; DM_bo_nomLedgersBatched; DM_bo_nomLedgersRecJournal; DM_bo_nomPostatendofbatch; DM_bo_nomPostbyCompany; DM_bo_nomTransinCalc; DM_bo_nomVatcash; DM_bo_SALESAllowInvoicecancel; DM_bo_SALESAllowInvoicenoPrint; DM_bo_SALESAllowInvoiceUnproc; DM_bo_SALESAllowInvoiceZero)
	C_BOOLEAN:C305(DM_bo_SALESAllowPurchaseZero; DM_bo_SALESInvoiceAutoReceipt; EW_bo_ModifiedSettings; SD_bo_ChangePrefs; SD_bo_ResultsDialog; SD_bo_ResultsDialogSequence; SD_bo_SaturdayWork; SD_bo_SundayWork; Up_LogoMOD)
	C_DATE:C307(DM_D_SalesLEdgerStartDate)
	C_LONGINT:C283(<>BAR; <>PW_l_ExpiryDays; $_l_ButtonPressed; $_l_Event; $_l_FirstIdentityNumber; $_l_FunctionPosition; $_l_IdentityNumber; $_l_IDTableNumber; $_l_Index; $_l_Process; bd20)
	C_LONGINT:C283(bd21; bd22; CAT_l_DefaultCatalogue; ch0; ch1; ch2; ch5; ch6; ch7; DB_l_ButtonClickedFunction; DM_l_NomAgingStage1)
	C_LONGINT:C283(DM_l_NomAgingStage2; DM_l_NomAgingStage3; EW_l_SelectedTableNumber; iCancel; iOK; PROD_l_SimpleProdEntry; r0; r1; r2; r3; r4)
	C_LONGINT:C283(r5; r6; r7; s1; s2; s3; SD_CB_l_result; SD_CB_l_resultSequences; SD_CB_l_SaturdayWork; SD_l_SaturdayWork; SD_l_SundayWork)
	C_LONGINT:C283(SMTP_l_AUTH; SMTP_l_GeneralPassActive; SMTP_l_GeneralPassType; vCreate; xSearch; xSet; xSort)
	C_PICTURE:C286(UP_Logo)
	C_REAL:C285(<>PW_l_ExpiryDay; vTot)
	C_TEXT:C284(<>DefCopytoaddress; <>DefSignature; <>EMAIL_t_DefaultReplyToAddress; <>EMAIL_t_DefaultSMTPhost; <>OfficeCode; <>SYS_t_MainorRemote; <>UserAdd; $_t_IndentityString; $_t_Machine; $_t_oldMethodName; $_t_ProcessName)
	C_TEXT:C284($_t_user; CreateSem; DB_t_CallOnCloseorSave; DM_T_BankAccBalanceAdjustments; DM_T_BankAccBalanceProfitBFWD; DM_T_BankAccBalanceProfitYTD; DM_T_BankAccCashFrom; DM_T_BankAccCashTo; DM_T_BankAccCurrencyCharges; DM_T_BankAccCurrencyExchange; DM_T_BankAccFrom)
	C_TEXT:C284(DM_T_BankAccTo; DM_T_NomActualLayer; DM_T_NomDefaultCreditStage; DM_T_NomDefaultPurchaseTax; DM_T_NomDefaultSalesTax; DM_T_NomPurchaseTerms; DM_T_NomSalesTerms; DM_T_nomTRANDepositReceipt; DM_T_nomTRANSInvoicePost; DM_T_nomTRANSInvoicePrePay; DM_T_nomTRANSInvoiceReceipt)
	C_TEXT:C284(DM_T_nomTRANSPurchase; DM_T_nomTRANSPurchasePay; DM_T_nomTRANSPurchasePrePay; DM_T_nomVatCashACC; DM_T_nomVatECCreditor; DM_T_nomVatInput; DM_T_nomVatOutput; SMTP_t_GeneralPassAuth; SMTP_t_GeneralPassName; vButtDisUser; vOrdTitle)
	C_TEXT:C284(vTitle1; vTitle2; vTitle3)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("User InLP")
//User InLP
$_l_Event:=Form event code:C388

Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[USER:15]); "user in13")
		...
		If (<>Bar=47)  //Silver
			...
			//SET_MENU ITEM(2049;3;Term_StoWT ("Stock Control"))
		...
		Else 
			...
			DB_MenuAction("Section"; "Stock Control"; 1; Term_StoWT("Stock Control"))
			//  SET_MENU ITEM(2049;4;Term_StoWT ("Stock Control"))
		...
		[USER]Invoices_PayAft:=DM_bo_SALESInvoiceAutoReceipt
	...
	: ($_l_Event=On Data Change:K2:15)
		...
		End case 
End case 
ERR_MethodTrackerReturn("User InLP"; $_t_oldMethodName)
