...
If (False:C215)
	//Project Method Name:      EMAIL ON OUTSIDE CALL
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("EMAIL ON OUTSIDE CALL")
...
End if 
ERR_MethodTrackerReturn("EMAIL ON OUTSIDE CALL"; $_t_oldMethodName)