//%attributes = {}
If (False:C215)
	//Project Method Name:      Set FontFS_ByPointer
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Set FontFS_ByPointer")
If (Count parameters:C259>=3)
	...
	End for 
End if 
ERR_MethodTrackerReturn("Set FontFS_ByPointer"; $_t_oldMethodName)
