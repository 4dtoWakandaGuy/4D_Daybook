...
If (False:C215)
	//Project Method Name:      TransT InLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("TransT InLP")
//lp transt in
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		DB_SetnewToolBar
		TransT_InLPB
		OpenHelp(Table:C252(->[TRANSACTION_TYPES:31]); "TransT In13")
	...
	: ($_l_Event=On Data Change:K2:15)
		Case of 
			...
			: (Modified:C32([TRANSACTION_TYPES:31]Tax_Code:6))
				Check_MinorNC(->[TRANSACTION_TYPES:31]Tax_Code:6; ""; ->[TAX_CODES:35]; ->[TAX_CODES:35]Tax_Code:1; ->[TAX_CODES:35]Tax_Rate:3; Term VATWT("VAT Code"))
				DB_bo_RecordModified:=True:C214
	...
	: ($_l_Event=On Deactivate:K2:10)
		// PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("TransT InLP"; $_t_oldMethodName)
