...
If (False:C215)
	//Project Method Name:      Diary Summ
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary Summ")
//Diary Summ
	...
	While (vD=1)
		...
		If (vD=1)
			If (Records in selection:C76([DIARY:12])>0)
				...
				//Open_Pro_Window ("Call Summaries";0;1;->[DIARY];WIN_t_CurrentOutputform)  `NG may 2004 added form name
				...
				If (OK=1)
					...
					If (Not:C34(SR_ReportOK("DiarySumm")))
						...
						FORM SET OUTPUT:C54([DIARY:12]; "Call Summaries")
...
ERR_MethodTrackerReturn("Diary Summ"; $_t_oldMethodName)