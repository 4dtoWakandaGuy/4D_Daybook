...
If (False:C215)
	//Project Method Name:      Fax StartM2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Fax StartM2")
//Fax StartM2 - a non-SP specific version
Case of 
	: (<>FaxMode=1)
		FaxParam3:=$2
		FaxParam4:=$3
...
End case 
$0:=$_l_Error
ERR_MethodTrackerReturn("Fax StartM2"; $_t_oldMethodName)