...
If (False:C215)
	//Project Method Name:      Headings InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(HED_l_BUT9; ModuleNumber; PAL_BUTTON_10; PAL_BUTTON_7; PAL_BUTTON_8; PAL_BUTTON_9)
...
$_t_oldMethodName:=ERR_MethodTracker("Headings InLP")
...
Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetInputFormMenu(Table:C252(->[HEADINGS:84]); "Headings in13")
	...
	: ($_l_Event=On Menu Selected:K2:14)
		...
		End if 
End case 
ERR_MethodTrackerReturn("Headings InLP"; $_t_oldMethodName)