...
If (False:C215)
	//Project Method Name:      Master UseSS
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Master UseSS")
//Master UseSS
$_ptr_MasterTable:=$1
...
If (vAny=0)
	If ((cSIS=1) & (vSIS=False:C215))
		...
		Else 
			Gen_Alert("This method (Master UseSS has been modifiied and requires a parameter")
		End if 
...
End if 
vAny:=1
ERR_MethodTrackerReturn("Master UseSS"; $_t_oldMethodName)
