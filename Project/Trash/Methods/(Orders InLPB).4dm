...
If (True:C214)
	...
	C_BOOLEAN:C305(<>ForceCred; <>SalesOrder; <>StatesLoaded; <>SYS_bo_DefaultEntry; <>SYS_bo_DefaultSource; <>TermEst; CCM_bo_IsLicenced; LBI_bo_NoEdit; ORD_bo_FurtherFieldsLoaded; ORD_bo_IsRevision; ORD_bo_ItemsModified)
	C_BOOLEAN:C305(ORD_bo_OrderModified; STK_bo_ALLOCATIONASKED; STK_bo_SHOWSTOCKALLOCATION; vFromIn; vMod2)
	C_DATE:C307(<>DB_d_CurrentDate; ACC_d_EntryDateFrom; ORD_d_EntryDateFrom)
	C_LONGINT:C283(<>SYS_l_ORDDefaultRequiredDays; $_l_FurtherFieldsExist; $_l_Index; $_l_Silver; bPrintAuths; Bvoid; CCM_l_CardToUse; DF_l_ContactCentric; MOD_l_CurrentModuleAccess; ORD_l_DOwn; ORD_l_FurtherFieldsMod)
	C_LONGINT:C283(ORD_l_OrderRevision; ORD_l_RevisionNumbers; ORD_l_SelectedViewTabOLD; Ord_l_UP; Vadd; vDiaryCheck; vNo2; vOR; vProcaMod; xApply)
	C_POINTER:C301($_ptr_Field)
	C_REAL:C285(vTot; vTotal)
	C_TEXT:C284(<>CompCode; <>ContCode; <>DB_t_Address1Label; <>DB_t_Address2Label; <>DB_t_CountryLabel; <>DB_t_CountyLabel; <>DB_t_PostcodeLabel; <>DB_t_TownLabel; <>Source; <>SYS_t_BaseCurrency; <>SYS_t_DefaultTelFormat)
	C_TEXT:C284(<>UserAdd; $_t_oldMethodName; COM_t_TelephoneNumberFormat; DB_t_CallOnCloseorSave; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; ORD_t_AddressLine1; ORD_t_AddressLine2; ORD_t_Country; ORD_t_County)
	C_TEXT:C284(ORD_t_OrderCode; ORD_t_PostalCode; ORD_t_RevisionNote; ORD_t_Town; SD_t_CallingCompanyCode; SD_t_CallingContactCode; SYS_t_AccessType; vAttendType; vButtDisOrd; vCallCode; vCompName)
	C_TEXT:C284(vContName; vDetails; vOrderCode; VSELPREV; vSource; vTel; vVATTitle)
End if 
//Code Starts Here
...
If (DB_t_CurrentFormUsage#"None")
	...
	vVATTitle:=Term VATWT("VAT/Total")
