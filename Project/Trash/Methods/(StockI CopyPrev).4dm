...
If (False:C215)
	//Project Method Name:      StockI CopyPrev
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockI CopyPrev")
//StockI CopyPrev

Menu_Record("StockI CopyPrev"; "Copy Previous Movt")
...
End if 
ERR_MethodTrackerReturn("StockI CopyPrev"; $_t_oldMethodName)
