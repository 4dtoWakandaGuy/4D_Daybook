...
If (False:C215)
	//Project Method Name:      Macro Text
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305(<>DB_bo_ScriptsInited; MacrosInited)
	C_LONGINT:C283($_l_ScriptRow)
	C_TEXT:C284($_t_oldMethodName; $0; $1)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Macro Text")
//Macro Text - see also Int Text
While (Semaphore:C143("$InitingMacros"))
	DelayTicks
End while 
If (Not:C34(<>DB_bo_ScriptsInited)) | (Not:C34(MacrosInited))  //NG in the macro trigger (and aLPA method) set this to false and it will reload automaticallly
...
Else 
	$0:=""
End if 
ERR_MethodTrackerReturn("Macro Text"; $_t_oldMethodName)
