...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_Event; $_l_ModuleRow; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; iCancel; iOK; ModuleNumber; P_Message; PAL_BUTTON_10; PAL_BUTTON_7)
	C_LONGINT:C283(PAL_BUTTON_8; PAL_BUTTON_9; vAB)
...
Case of 
	: (($_l_Event=On Activate:K2:9) | (vFromIn))
		DB_SetInputFormMenu(Table:C252(->[JOBS:26]); "Jobs_In13")
	...
	: ($_l_Event=On Outside Call:K2:11)
		Case of 
			...
			: (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Plus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Minus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Open"))
				...
				inButtSubHandle(FORM Get current page:C276; ->[JOBS:26]; "Jobs_In13")
