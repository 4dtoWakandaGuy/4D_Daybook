...
If (False:C215)
	//Project Method Name:      Diary Next
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary Next")
//Diary Next
Menu_Record("Diary Next"; "Next Action")
...
ERR_MethodTrackerReturn("Diary Next"; $_t_oldMethodName)