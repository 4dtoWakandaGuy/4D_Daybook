...
If (False:C215)
	//Project Method Name:      RESET_DIARY EMAIL OBJS
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; EMAIL_t_AttachmentsLabel; EMAIL_t_EmailType; v_EMAIL_Body_Text; v_EMAIL_Subject_Text; WS_t_EmailAddress; WS_t_EmailName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("RESET_DIARY EMAIL OBJS")
//BSW 17/09/02
...
Else 
	...
	$_l_TopofnextItem:=($_l_TopofnextItem+$_l_ObjectHeight)+10
End if 
OBJECT SET VISIBLE:C603(v_EMAIL_Subject_Text; True:C214)
OBJECT GET COORDINATES:C663(v_EMAIL_Subject_Text; $_l_ObjectLeft; $_l_ObjectTop; $_l_ObjectRight; $_l_ObjectBottom)
$_l_ObjectHeight:=$_l_ObjectBottom-$_l_ObjectTop
OBJECT MOVE:C664(v_EMAIL_Subject_Text; $_l_ObjectLeft; $_l_TopofnextItem; $_l_ObjectRight; $_l_TopofnextItem+$_l_ObjectHeight; *)
...
//v_EMAIL_Body_Text
OBJECT SET VISIBLE:C603(v_EMAIL_Body_Text; True:C214)
OBJECT GET COORDINATES:C663(v_EMAIL_Body_Text; $_l_ObjectLeft; $_l_ObjectTop; $_l_ObjectRight; $_l_ObjectBottom)
$_l_ObjectHeight:=$_l_ObjectBottom-$_l_ObjectTop
OBJECT MOVE:C664(v_EMAIL_Body_Text; $_l_ObjectLeft; $_l_TopofnextItem; $_l_ObjectRight; $_l_ObjectBottom; *)
...
Case of 
	...
	: (Size of array:C274(SD2_at_EmailType)=1)
		...
		SD2_at_EmailName:=1
End case 
ERR_MethodTrackerReturn("RESET_DIARY EMAIL OBJS"; $_t_oldMethodName)
