...
If (False:C215)
	//Project Method Name:      Record Macro
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/12/2009 09:32`Method: Record Macro
...
$_t_oldMethodName:=ERR_MethodTracker("Record Macro")
...
End if 
ERR_MethodTrackerReturn("Record Macro"; $_t_oldMethodName)
