...
If (False:C215)
	//Project Method Name:      Contacts Mod
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>ButtProc; <>Mod_l_MenuBarPaletteProcess; $_l_ProcessState; $_l_TableNumber; $_l_Value; CON_l_IPcall; CON_l_SubInfoProcess; vO)
	C_TEXT:C284($_t_AutosearchCode; $_t_oldMethodName; $1; $2)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Contacts Mod")
...
While (vO=1)
	...
	Else 
		...
		If (<>Mod_l_MenuBarPaletteProcess>0)
			SHOW PROCESS:C325(<>Mod_l_MenuBarPaletteProcess)
...
Comp_Unload
Process_End
ERR_MethodTrackerReturn("Contacts Mod"; $_t_oldMethodName)