...
If (False:C215)
	//Project Method Name:      Jobs TC_GetSelectionsFromArrays
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Jobs TC_GetSelectionsFromArrays")
...
ERR_MethodTrackerReturn("Jobs TC_GetSelectionsFromArrays"; $_t_oldMethodName)