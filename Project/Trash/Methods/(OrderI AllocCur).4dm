...
If (False:C215)
	//Project Method Name:      OrderI AllocCur
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OrderI AllocCur")
//OrderI Alloc
...
If (Not:C34(ORD_bo_IsRevision))
	If (ORD_al_ViewTableToTable{ORD_at_ViewTabsLabels}=Table:C252(->[ORDER_ITEMS:25]))
		Menu_Record("OrderI AllocCur"; "Allocate Stock")
...
ERR_MethodTrackerReturn("OrderI AllocCur"; $_t_oldMethodName)
