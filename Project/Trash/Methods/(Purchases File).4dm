...
If (False:C215)
	//Project Method Name:      Purchases File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purchases File")

Purchases_FileI
FORM SET OUTPUT:C54([PURCHASE_INVOICES:37]; "Purchases Out")
WIN_t_CurrentOutputform:="Purchases Out"
vPu:=1
...
End if 
ERR_MethodTrackerReturn("Purchases File"; $_t_oldMethodName)
