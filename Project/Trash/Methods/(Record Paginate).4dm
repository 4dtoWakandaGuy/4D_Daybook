...
If (False:C215)
	//Project Method Name:      Record Paginate
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Record Paginate")
//Record Paginate
Menu_Record("Record Paginate"; "Calculate Indents")
...
End if 
ERR_MethodTrackerReturn("Record Paginate"; $_t_oldMethodName)
