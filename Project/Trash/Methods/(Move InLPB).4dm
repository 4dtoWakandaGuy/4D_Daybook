...
If (True:C214)
	...
	C_TEXT:C284($_t_SerialNumber; $_t_StockMovementType; $_t_SubItemName; DB_t_CallOnCloseorSave; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; STK_at_MovementParentLabel; STK_t_AddMovementType; STK_t_CopyNote; STK_t_CurrentStockType)
...
If ([STOCK_MOVEMENTS:40]MovementSourceTable:16#0)
	...
	Case of 
		: ([STOCK_MOVEMENTS:40]MovementSourceTable:16=Table:C252(->[PURCHASE_ORDERS:57]))
			STK_at_MovementParentLabel:="Purchase Order"
