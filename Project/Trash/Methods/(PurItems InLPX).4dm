...
If (False:C215)
	//Project Method Name:      PurItems InLPX
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("PurItems InLPX")
//Project Method PurItems InLPX 2/3/2(ID 10668-8544)
...
Case of 
	...
	: ($1=(->[PURCHASE_INVOICE_ITEMS:158]Tax_Code:5))
		...
		If (OK=1)
			Check_MinorNC(->[PURCHASE_INVOICE_ITEMS:158]Tax_Code:5; ""; ->[TAX_CODES:35]; ->[TAX_CODES:35]Tax_Code:1; ->[TAX_CODES:35]Tax_Rate:3; Term VATWT("VAT Code"))
	...
	: ($1=(->[PURCHASE_INVOICE_ITEMS:158]Item_Number:12))
		...
		End if 
End case 
ERR_MethodTrackerReturn("PurItems InLPX"; $_t_oldMethodName)