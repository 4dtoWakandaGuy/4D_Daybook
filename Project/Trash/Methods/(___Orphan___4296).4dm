...
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("___Orphan___4296")

$oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oAccProfBalCB2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oAccProfBalCB2"; $OldMethodName)