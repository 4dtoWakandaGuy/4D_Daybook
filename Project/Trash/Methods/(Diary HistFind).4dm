...
If (False:C215)
	//Project Method Name:      Diary HistFind
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary HistFind")
//Diary HistFind - converts menu items to reduced array
$0:=$1
...
Else 
	...
	End case 
End if 
ERR_MethodTrackerReturn("Diary HistFind"; $_t_oldMethodName)