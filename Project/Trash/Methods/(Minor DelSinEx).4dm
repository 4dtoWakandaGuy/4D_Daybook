...
If (False:C215)
	//Project Method Name:      Minor_DelSinEx
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Minor_DelSinEx")
...
If (OK=1)
	Case of 
		...
		Else 
			...
			DB_DeletionControl($1; "Minor_DelSinEX")
...
End if 
ERR_MethodTrackerReturn("Minor_DelSinEx"; $_t_oldMethodName)
