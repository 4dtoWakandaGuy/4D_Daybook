...
If (False:C215)
	//Project Method Name:      StatsView GrPrt
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StatsView GrPrt")
//StatsView PrtGr aph
...
If (OK=1)
	...
	If ($_l_OK>=0)  // NG Feb 2005 added this conditional-see inside Print_setSize about it
		//PAGE SETUP([COMPANIES];"SV GraphPrt")
		//PRINT SETTINGS
		//WS_PiC_Chart:= DB_CreateSVGgraph(Vgraph;-1)
		Print form:C5([COMPANIES:2]; "SV GraphPrt")
		PAGE BREAK:C6
		PRT_SetPrinterPaperOptions(Vtitle1)  //NG June 2005
	End if 
End if 
ERR_MethodTrackerReturn("StatsView GrPrt"; $_t_oldMethodName)