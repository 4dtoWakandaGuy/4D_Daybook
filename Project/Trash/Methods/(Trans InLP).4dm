...
If (False:C215)
	//Project Method Name:      Trans InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_LastFieldBottom; $_l_LastFieldLeft; $_l_LastFieldRight; $_l_LastFieldTop; $_l_LBBottom; $_l_LBLeft; $_l_LBRight; $_l_LBTop; $_l_ModuleRow; $_l_mouseButton; $_l_Mousex)
	C_LONGINT:C283($_l_Mousy; $_l_NewWindowBottom; $_l_PotentialWindowBottom; $_l_WindowBottom; $_l_WIndowHeight; $_l_WindowLeft; $_l_WindowRIght; $_l_WIndowTop; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; iCancel)
	C_LONGINT:C283(iOK; ModuleNumber; PAL_BUTTON_10; PAL_BUTTON_7; PAL_BUTTON_8; PAL_BUTTON_9)
	C_REAL:C285($1)
...
$_t_oldMethodName:=ERR_MethodTracker("Trans InLP"; Form event code:C388)
//lp trans in
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetnewToolBar
		OpenHelp(Table:C252(->[TRANSACTIONS:29]); "Trans In13")
		...
		DB_SetInputFormMenu(Table:C252(->[TRANSACTIONS:29]); "Trans In13")
	...
	: ($_l_Event=On Deactivate:K2:10)
		//PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("Trans InLP"; $_t_oldMethodName)