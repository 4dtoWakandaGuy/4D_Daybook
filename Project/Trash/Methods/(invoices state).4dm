...
If (False:C215)
	//Project Method Name:      invoices state
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("invoices state")
													...
													For ($_l_PrintIndex; 1; $_l_CountCompanyRecords)
														...
														For ($_l_Index; 1; $_l_CountRecordsInvoices)
															...
															If ($_l_CountLines+$_l_TestSubLines>=$_l_MaxLines) & ($_l_CountLines>0)
																...
																Repeat 
																	$_l_PrintHeight:=Print form:C5([INVOICES:39]; "Inv StateSubBLANK")
																	If ($_l_Index=1)
																...
																$_l_CountLines:=0
															End if 
															$_l_PrintHeight:=Print form:C5([INVOICES:39]; "Inv Statesubwdetail")
															...
															If ($_l_TestSubLines>0)
																...
																For ($_l_ReceiptIndex; 1; Size of array:C274(INV_at_ReceiptInvoices))
																	...
																	End if 
																	If (INV_T_DetailLine#"")
																		$_l_PrintHeight:=Print form:C5([INVOICES:39]; "Inv State SubDetail")
																		$_l_RemainingHeight:=$_l_RemainingHeight-$_l_PrintHeight
																		...
																		If ($_l_CountLines>$_l_MaxLines) | ($_l_RemainingHeight<=($_l_PrintHeight+PRT_FooterHeight))
																			...
																			Else 
																				...
																				$_l_PrintHeight:=Print form:C5([COMPANIES:2]; "Statement WDetailFooterFinal")
																				$_l_RemainingHeight:=PRT_l_MaxHeight-$_l_PrintHeight
																				$_l_CountLines:=0
																				PAGE BREAK:C6
																			End if 
...
ERR_MethodTrackerReturn("invoices state"; $_t_oldMethodName)