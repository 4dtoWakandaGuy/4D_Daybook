...
If (False:C215)
	//Project Method Name:      Invoices LPAge
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Invoices LPAge")
//See Also LP Invoices Out & Pay
...
If (vContr<0)
	vContr:=0
End if 
ERR_MethodTrackerReturn("Invoices LPAge"; $_t_oldMethodName)