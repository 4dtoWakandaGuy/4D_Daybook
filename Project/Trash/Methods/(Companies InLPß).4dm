						...
						Case of 
							: (CO_al_ViewTableToTable{CO_at_ViewTabsLabels}=Table:C252(->[CONTACTS:1]))  //Contacts
								...
								If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
									...
									LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[CONTACTS:1]Contact_Code:2; ->[COMPANIES:2]Company_Code:1; "411111000"; "Contacts_InM13"; (3+Num:C11(SYS_t_AccessType="Q")); "Contacts"; "Contact"; ""; $_bo_NewLevel; $_l_ReUseLevel)
								Else 
									OK:=1
									Case of 
								...
								Case of 
									: (CO_at_ViewTabsLabels{CO_at_ViewTabsLabels}="Enquiries")
										...
										If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
											...
											LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[ORDERS:24]Order_Code:3; ->[COMPANIES:2]Company_Code:1; $_t_FlagReference; "Orders_In13"; 8; "Enquiry Records"; "Enquiries"; ""; $_bo_NewLevel; $_l_ReUseLevel)
									...
									: (CO_at_ViewTabsLabels{CO_at_ViewTabsLabels}="Orders")
										...
										If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
											...
											$_l_OK:=1
											LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[ORDERS:24]Order_Code:3; ->[COMPANIES:2]Company_Code:1; "411111000"; "Orders_In13"; 9; "Order Records"; "Orders"; ""; $_bo_NewLevel; $_l_ReUseLevel)
							...
							: (CO_al_ViewTableToTable{CO_at_ViewTabsLabels}=Table:C252(->[PURCHASE_ORDERS:57]))  //Purchase orders
								...
								If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
									CO_at_ViewTabsLabelsOLD:=CO_at_ViewTabsLabels
									LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[PURCHASE_ORDERS:57]Purchase_Order_Number:2; ->[COMPANIES:2]Company_Code:1; $_t_FlagReference; "Purch Ord In13"; 5; "Purchases Orders"; "Purchase order"; ""; $_bo_NewLevel; $_l_ReUseLevel)
							...
							: (CO_al_ViewTableToTable{CO_at_ViewTabsLabels}=Table:C252(->[INVOICES:39]))  //Invoices
								...
								If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
									...
									LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[INVOICES:39]Invoice_Number:1; ->[COMPANIES:2]Company_Code:1; $_t_FlagReference; "Invoices_In13"; 6; "Invoices"; "Invoice"; ""; $_bo_NewLevel; $_l_ReUseLevel)
								Else 
									OK:=1
									Case of 
										: ($_t_CHaracter1="B") | ($_t_CHaracter1="N")  //this Else bit only on the first page
							...
							: (CO_al_ViewTableToTable{CO_at_ViewTabsLabels}=Table:C252(->[PURCHASE_INVOICES:37]))  //Purchase Invoices
								...
								If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
									CO_at_ViewTabsLabelsOLD:=CO_at_ViewTabsLabels
									LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[PURCHASE_INVOICES:37]Purchase_Invoice_Number:4; ->[COMPANIES:2]Company_Code:1; $_t_FlagReference; "Purchases_In13"; 4; "Purchases"; "Purchase invoice"; ""; $_bo_NewLevel; $_l_ReUseLevel)
							...
							: (CO_al_ViewTableToTable{CO_at_ViewTabsLabels}=Table:C252(->[CONTRACTS:17]))  //Contracts
								...
								If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
									CO_at_ViewTabsLabelsOLD:=CO_at_ViewTabsLabels
									LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[CONTRACTS:17]Contract_Code:3; ->[COMPANIES:2]Company_Code:1; $_t_FlagReference; "Contracts_In13"; 2; "Contracts"; "Contract"; ""; $_bo_NewLevel; $_l_ReUseLevel)
							...
							: (CO_al_ViewTableToTable{CO_at_ViewTabsLabels}=Table:C252(->[SERVICE_CALLS:20]))  //Service calls
								...
								If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
									CO_at_ViewTabsLabelsOLD:=CO_at_ViewTabsLabels
									LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[SERVICE_CALLS:20]Call_Code:4; ->[COMPANIES:2]Company_Code:1; $_t_FlagReference; "Calls_In13"; 2; "Service Calls"; "Service Call"; ""; $_bo_NewLevel; $_l_ReUseLevel)
							...
							: (CO_al_ViewTableToTable{CO_at_ViewTabsLabels}=Table:C252(->[JOBS:26]))  //JOBS
								...
								If (Size of array:C274($_ptr_ListboxSetup->)=0) | (CO_at_ViewTabsLabelsOLD#CO_at_ViewTabsLabels)
									CO_at_ViewTabsLabelsOLD:=CO_at_ViewTabsLabels
									LBi_ArrDefFill($_ptr_ListboxSetup; ->GEN_lb_ItemsArea; ->[JOBS:26]Job_Code:1; ->[COMPANIES:2]Company_Code:1; $_t_FlagReference; "Jobs_In13"; 2; "Jobs"; "Job"; ""; $_bo_NewLevel; $_l_ReUseLevel)
								Else 
									OK:=1
									Case of 
										: ($_t_CHaracter1="B") | ($_t_CHaracter1="N")  //this Else bit only on the first page
...
//Get_Picture FROM LIBRARY(22566;COM_pic_ClipBoardPICT)
If (DB_t_CurrentFormUsage#"None")
	If (False:C215)
...
If (($_l_OK=0) & (($_t_CHaracter1="F") | ($_t_CHaracter1="B") | ($_t_CHaracter1="N"))) & (DB_t_CurrentFormUsage#"None")
	...
	If (Records in selection:C76([CONTACTS:1])=1)
		...
		If (DB_t_CurrentFormUsage#"None")
			//OBJECT SET VISIBLE(*;"oAddressClipBoardButton@";True)
			//OBJECT SET VISIBLE(*;"oAddressClipBoardPicture@";True)
			//OBJECT SET Enabled(*;"oAddressClipBoardButton@";TRUE)
