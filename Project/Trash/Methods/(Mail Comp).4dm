...
If (True:C214)
	...
	C_LONGINT:C283($_l_OK; $_l_WindowReferenceRow; cList; rComp; vC; vNo; vP; WIN_l_CurrentWinRef)
	C_TEXT:C284($_t_oldMethodName; $_t_CurrentOutputform; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; vJobTitle; vRole; WIN_t_CurrentOutputform)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Mail Comp")
//Mail Comp
...
While (vC=1)
	...
	If (vC=1)
		If (Records in selection:C76([COMPANIES:2])>0)
			...
			Open_Pro_Window("Mail Companies"; 0; 1; ->[COMPANIES:2]; WIN_t_CurrentOutputform)
			...
			If (OK=1)
				...
				If (vP=1)
					...
					DIALOG:C40([DOCUMENTS:7]; "dAsk Cont")
					$_l_OK:=OK
					OK:=1
					CLOSE WINDOW:C154
...
ERR_MethodTrackerReturn("Mail Comp"; $_t_oldMethodName)