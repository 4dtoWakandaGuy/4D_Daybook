...
If (False:C215)
	//Project Method Name:      Companies Mod
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>ButtProc; <>Mod_l_MenuBarPaletteProcess; $_l_TableNumber; vC)
	C_TEXT:C284($_t_AutoSearchCode; $_t_oldMethodName; $1; $2; SYS_t_AccessType)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Companies Mod")
...
Comp_Unload
Process_End
ERR_MethodTrackerReturn("Companies Mod"; $_t_oldMethodName)