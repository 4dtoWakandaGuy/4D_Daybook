...
If (False:C215)
	//Project Method Name:      Invoices VAT101
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Invoices VAT101")
//Invoices VAT101
					...
					If (Not:C34(SR_ReportOK("SLEUList")))
						...
						If ($_l_OK>=0)
							...
							If ($_l_OK=1)
								...
								Print form:C5([INVOICES:39]; "VAT 101 Hdr")
								FIRST RECORD:C50([INVOICES:39])
								vNo1:=1
								vNo2:=1
								vTitle8:=""
								While (Not:C34(End selection:C36([INVOICES:39])))
									...
									vTitle6:=$Pref
									vTitle7:=$Reg
									Print form:C5([INVOICES:39]; "VAT 101 Det")
									vNo1:=vNo1+1
									vNo2:=vNo2+1
									If (vNo2>15)
										If (Not:C34(End selection:C36([INVOICES:39])))
											vNo2:=vNo2-1
											Print form:C5([INVOICES:39]; "VAT 101 Ftr")
											PAGE BREAK:C6
											Print form:C5([INVOICES:39]; "VAT 101 Hdr")
										End if 
										vNo1:=1
								...
								vNo2:=vNo2-1
								Print form:C5([INVOICES:39]; "VAT 101 Ftr")
								Print form:C5([INVOICES:39]; "VAT 101 Ftr2")
								PAGE BREAK:C6
...
ERR_MethodTrackerReturn("Invoices VAT101"; $_t_oldMethodName)