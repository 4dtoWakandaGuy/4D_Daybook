...
If (False:C215)
	//Project Method Name:      Out ButtCall
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Out ButtCall")
...
//Out_ButtCallSD
//OUT BUTTCallSD is used for the superdiary
...
If (<>StatsSwitch)
	...
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("Out ButtCall"; $_t_oldMethodName)
