...
$_t_oldMethodName:=ERR_MethodTracker("Jobs TS")
//Jobs TS
							...
							If (OK=1)
								...
								If ($_l_OK>=0)
									...
									If ($_l_OK=1)
										...
										FORM SET OUTPUT:C54([JOBS:26]; "Jobs TS")  //NG added Table May 2004
...
Process_End
WIN_t_CurrentOutputform:=$_t_CurrentOutputform
ERR_MethodTrackerReturn("Jobs TS"; $_t_oldMethodName)