...
If (False:C215)
	//Project Method Name:      Trans SubLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Trans SubLP")
//lp trans sub - at present repeated in Trans SubLPX -
...
Case of 
	...
	: (Modified:C32([TRANSACTION_BATCH_ITEMS:155]Tax_Code:7))
		...
		If (OK=1)
			Check_MinorNC(->[TRANSACTION_BATCH_ITEMS:155]Tax_Code:7; ""; ->[TAX_CODES:35]; ->[TAX_CODES:35]Tax_Code:1; ->[TAX_CODES:35]Tax_Rate:3; Term VATWT("VAT Code"))
...
End case 
ERR_MethodTrackerReturn("Trans SubLP"; $_t_oldMethodName)
