...
If (False:C215)
	//Project Method Name:      Stock File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Stock File")

FORM SET INPUT:C55([STOCK_MOVEMENT_ITEMS:27]; "Stock In13")  //NG April 2004 Removed ◊Screen
WIN_t_CurrentInputForm:="Stock In13"
...
End if 
ERR_MethodTrackerReturn("Stock File"; $_t_oldMethodName)
