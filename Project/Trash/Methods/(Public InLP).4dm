...
If (False:C215)
	//Project Method Name:      Public InLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Public InLP")
...
Case of 
	...
	: ($_l_Event=On Activate:K2:9)
		DB_SetInputFormMenu(Table:C252(->[PUBLICATIONS:52]); "Public In13")
		SD2_SetDiaryPopup
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		Public_InLPB
		OpenHelp(Table:C252(->[PUBLICATIONS:52]); "Public In13")
	...
	: ($_l_Event=On Outside Call:K2:11)
		...
		End case 
End case 
ERR_MethodTrackerReturn("Public InLP"; $_t_oldMethodName)