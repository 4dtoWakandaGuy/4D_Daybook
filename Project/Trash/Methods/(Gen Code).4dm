...
$_t_oldMethodName:=ERR_MethodTracker("Gen Code")
//Gen Code - See also Gen_CodePref
...
End if 
<>GCUSED:=<>GCUSED-1
ERR_MethodTrackerReturn("Gen Code"; $_t_oldMethodName)