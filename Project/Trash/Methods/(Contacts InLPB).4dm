...
If (True:C214)
	...
	C_REAL:C285(CON_bo_ApplicActive; CON_bo_ApplicActiveOLD; CON_R_MinRate; CON_R_MinRateOLD; CON_R_SALARYFROM; CON_R_SALARYFROMOLD; CON_R_SALARYTO; CON_R_SALARYTOOLD)
...
If (DB_t_CurrentFormUsage#"None")
	...
	OBJECT SET VISIBLE:C603(*; "oCompanyName"; (([COMPANIES:2]ADDRESS:60="") | (Vadd=1)))
	
	OBJECT SET VISIBLE:C603(*; "oCON_CompanyAddr@"; (([COMPANIES:2]ADDRESS:60="") | (Vadd=1)))
	//OBJECT SET VISIBLE([COMPANIES]Address_Line_two;True)
	OBJECT SET VISIBLE:C603(*; "oCON_CompanyAddr3"; (([COMPANIES:2]ADDRESS:60="") | (Vadd=1)))
	
	OBJECT SET VISIBLE:C603(*; "oCON_CompanyAddr4"; (([COMPANIES:2]ADDRESS:60="") | (Vadd=1)))
	
	OBJECT SET VISIBLE:C603(*; "oCON_CompanyAddr5"; (([COMPANIES:2]ADDRESS:60="") | (Vadd=1)))
	OBJECT SET VISIBLE:C603(*; "oCON_CompanyAddr6"; (([COMPANIES:2]ADDRESS:60="") | (Vadd=1)))
	
	OBJECT SET VISIBLE:C603(vATAdd11; False:C215)
	OBJECT SET VISIBLE:C603(*; "oCompanyAddress1"; ([COMPANIES:2]ADDRESS:60#"") | (Vadd#1))
