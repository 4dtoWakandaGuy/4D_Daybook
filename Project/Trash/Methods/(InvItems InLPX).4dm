...
If (False:C215)
	//Project Method Name:      InvItems InLPX
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("InvItems InLPX")
//Project Method InvItems InLPX 2/3/2(ID 12281-9048)
...
Case of 
	...
	: ($1=(->[INVOICES_ITEMS:161]Tax_Code:6))
		...
		If (OK=1)
			Check_MinorNC(->[INVOICES_ITEMS:161]Tax_Code:6; ""; ->[TAX_CODES:35]; ->[TAX_CODES:35]Tax_Code:1; ->[TAX_CODES:35]Tax_Rate:3; Term VATWT("VAT Code"))
	...
	: ($1=(->[INVOICES_ITEMS:161]Analysis_Code:10))
		...
		End if 
End case 
ERR_MethodTrackerReturn("InvItems InLPX"; $_t_oldMethodName)