...
If (False:C215)
	//Project Method Name:      Companies Print
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Companies Print")
//Companies Print
If (vCM=0)
	...
	If ((DB_GetModuleSettingByNUM(14)<2) | ($1="Diary"))
		...
		FORM SET OUTPUT:C54([COMPANIES:2]; "Companies Print")
	Else 
		...
		FORM SET OUTPUT:C54([COMPANIES:2]; "Companies PrQ")
	End if 
...
End if 
ERR_MethodTrackerReturn("Companies Print"; $_t_oldMethodName)