...
If (True:C214)
	...
	//C_UNKNOWN(CON2_iRB_ChargeProRata)
	//C_UNKNOWN(CONT_4DWriteText)
	//C_UNKNOWN(iCancel)
	//C_UNKNOWN(iOK)
	//C_UNKNOWN(ModuleNumber)
	//C_UNKNOWN(PAL_BUTTON)
	//C_UNKNOWN(PAL_BUTTON_10)
	//C_UNKNOWN(PAL_BUTTON_7)
	//C_UNKNOWN(PAL_BUTTON_8)
	//C_UNKNOWN(PAL_BUTTON_9)
	...
	C_BOOLEAN:C305(SVS_bo_LoansBilling; SVS_bo_PartsBilling; SVS_bo_Sheduled; SVS_bo_TimeOption; $_bo_DocOK; CON_bo_Chargable; CON_bo_LoansBilling; CON_bo_PartsBilling; DB_bo_NoLoad; DB_bo_RecordModified; ORD_bo_ProductIsFound)
	C_BOOLEAN:C305(PAL_bo_ButtonSubFunction; SVS_bo_Chargable; SVS_bo_LoansBilling; SVS_bo_PartsBilling; SVS_bo_Sheduled; SVS_bo_TimeOption)
	...
	C_LONGINT:C283(CON2_iRB_ChargePartPeriodnil; CON2_iRB_ChargeProRata; CONT_4DWriteText; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; iCancel; iOK; ModuleNumber; PAL_BUTTON_10; PAL_BUTTON_7; PAL_BUTTON_8)
	C_LONGINT:C283(PAL_BUTTON_9; SD2_l_CallingProcess; SD2_l_TableNum; SVS_l_ChargeLoanOption; SVS_l_ChargePeriodType; SVS_l_LoansPricePeriod; SVS_l_TimeBilling; SVS_l_TimeMinimum; SVS_l_TimePerUnit; $_l_ButtonNumber; $_l_CalledFromProcess)
	C_LONGINT:C283($_l_CharacterPosition; $_l_Event; $_l_Index; $_l_ModuleRow; $_l_Offscreen; $_l_TypeOpenEndedStatus; $1; CON_l_ChargeLoanOption; CON_l_ChargePeriodType; CON_l_LoansPricePeriod; CON_l_LoansPricePeriodOLD)
	C_LONGINT:C283(CON_l_OpenEndedStatus; CON_l_RestrictCharging; CON_l_TimeBilling; CON_l_TimeMinimum; CON_l_TimeMinimumOLD; CON_l_TimePerUnit; CON_l_TimePerUnitOLD; CON2_iRB_ChargePartPeriod; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; SD2_l_CallingProcess)
	C_LONGINT:C283(SD2_l_TableNum; SVS_l_ChargeLoanOption; SVS_l_ChargePeriodType; SVS_l_LoansPricePeriod; SVS_l_TimeBilling; SVS_l_TimeMinimum; SVS_l_TimePerUnit)
	C_OBJECT:C1216($_obj_WpProObject; CONT_Obj_4DContractText; $_obj_ContractRules; $_obj_WpProObject; CONT_Obj_4DContractText)
	C_PICTURE:C286(CON_pic_ModePict)
	C_POINTER:C301($_ptr_ArrayReferences; $_ptr_ListboxSetup; $_ptr_ArrayReferences; $_ptr_ListboxSetup)
	C_REAL:C285(vTot; S_iRB_TimeBilling)
	...
	C_TEXT:C284(PAL_BUTTON; SD2_t_TabFunction; SVS_t_CurrencyCode; SVS_t_LoansPriceGroup; SVS_t_PartsPriceGroup; vButtDisCNTR; vCompName; vTel; WIN_t_CurrentInputForm; <>SYS_t_DefaultTelFormat; $_t_DocumentWriteType)
	C_TEXT:C284($_t_DummyTab; $_t_oldMethodName; $_t_PalletButtonName; $_t_SubItemName; BAR_t_Button; COM_t_TelephoneNumberFormat; CON_t_CurrencyCode; CON_t_CurrencyCodeOLD; CON_t_CurrencyName; CON_t_LoansPriceGroup; CON_t_PartsPriceGroup)
	C_TEXT:C284(CONT_t_FalseTab; CONT_t_LoansPriceGroup; CONT_t_LoansPriceGroupOLD; CONT_t_PartsPriceGroup; CONT_t_PartsPriceGroupOLD; CONT_t_TabFunction; DB_t_CUrrentInputMenuRef; DB_T_CurrentInputWindowMenu; IP_t_MessageReplySTR; SD2_t_TabFunction; SVS_t_CurrencyCode)
	C_TEXT:C284(SVS_t_LoansPriceGroup; SVS_t_PartsPriceGroup; WIN_t_CurrentInputForm)
End if 
//Code Starts Here
...
Case of 
	...
	: ($_l_Event=On Activate:K2:9)
		DB_SetInputFormMenu(Table:C252(->[CONTRACTS:17]); "Contracts_In13")
		OpenHelp(Table:C252(->[CONTRACTS:17]); "Contracts  in13")
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		DB_SetnewToolBar
		OpenHelp(Table:C252(->[CONTRACTS:17]); "Contracts_In13")
		WS_AutoscreenSize(1; 384; 700; Table name:C256(->[CONTRACTS:17])+"_"+"Contracts_In13")
