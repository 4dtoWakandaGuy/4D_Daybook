...
If (False:C215)
	//Project Method Name:      Gen ShowTel
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Gen ShowTel")
...
Else 
	If (Count parameters:C259=0)
		...
		DIALOG:C40([CONTACTS:1]; "dShow Tel")
		CLOSE WINDOW:C154
	...
	End if 
End if 
ERR_MethodTrackerReturn("Gen ShowTel"; $_t_oldMethodName)