			...
			Case of 
				: (PO_al_ViewTableToTable{PO_at_ViewTabsLabels}=Table:C252(->[CUSTOM_FIELDS:98]))  //Purchase Order items
					...
					If (Size of array:C274(POI_aptr_LBSetup)=0) | (PO_l_SelectedTabsLabelsOLD#PO_at_ViewTabsLabels)
						...
						End if 
						LBi_ArrDefFill(->POI_aptr_LBSetup; ->PO_LB_PurchaseOrderItems; ->[PURCHASE_ORDERS_ITEMS:169]ID:17; ->[PURCHASE_ORDERS:57]Purchase_Order_Number:2; $_t_FlagReference; "Items in13"; 3; "Purchase Items"; "Purchase Item"; ""; $_bo_NewLevel; $_l_ReuseLevel)
				...
				: (PO_al_ViewTableToTable{PO_at_ViewTabsLabels}=Table:C252(->[ORDER_ITEMS:25]))  //Sales order items
					...
					If (Size of array:C274(POI_aptr_LBSetup)=0) | (PO_l_SelectedTabsLabelsOLD#PO_at_ViewTabsLabels)
						PO_l_SelectedTabsLabelsOLD:=PO_at_ViewTabsLabels
						LBi_ArrDefFill(->POI_aptr_LBSetup; ->PO_LB_PurchaseOrderItems; ->[ORDER_ITEMS:25]Item_Number:27; ->[PURCHASE_ORDERS:57]Purchase_Order_Number:2; $_t_FlagReference; "Items In13"; 24; "Order Items"; "Order Item"; ""; $_bo_NewLevel; $_l_ReuseLevel)
				...
				: (PO_al_ViewTableToTable{PO_at_ViewTabsLabels}=Table:C252(->[PURCHASE_INVOICES:37]))  //Purchase invoices
					...
					If (Size of array:C274(POI_aptr_LBSetup)=0) | (PO_l_SelectedTabsLabelsOLD#PO_at_ViewTabsLabels)
						...
						If (Size of array:C274(POI_aptr_LBSetup)=0)
							...
							//ALArrDefFill (->POI_aptr_LBSetup;->eALPuOII;->[PURCHASE ORDERS];->[PURCHASE ORDERS]ITEMS;"Red";"ALModPuOI";"211111000";"Items in13";"05703";◊User;"[PURCHASE ORDERS]ITEMS";"Purchase Order Items";"Purchase Order Item";->[PURCHASE ORDERS];->[PURCHASE ORDERS]Purch Ord No)  `NG April 2004 Removed ◊Screen
							LBi_ArrDefFill(->POI_aptr_LBSetup; ->PO_LB_PurchaseOrderItems; ->[PURCHASE_INVOICES:37]Purchase_Code:1; ->[PURCHASE_ORDERS:57]Purchase_Order_Number:2; $_t_FlagReference; "Purchases_In13"; 4; "Purchases"; "Purchase invoice"; ""; $_bo_NewLevel; $_l_ReuseLevel)
							//;"";False)
					...
					If (Size of array:C274(POI_aptr_LBSetup)=0) | (PO_l_SelectedTabsLabelsOLD#PO_at_ViewTabsLabels)
						...
						If (Size of array:C274(POI_aptr_LBSetup)=0)
							...
							If (<>DB_bo_NewStockActive)
								LBi_ArrDefFill(->POI_aptr_LBSetup; ->PO_LB_PurchaseOrderItems; ->[STOCK_MOVEMENT_ITEMS:27]x_ID:16; ->[PURCHASE_ORDERS:57]Purchase_Order_Number:2; $_t_FlagReference; "Stock In13"; 1; "Items"; "Item"; ""; $_bo_NewLevel; $_l_ReuseLevel)
