...
$_t_oldMethodName:=ERR_MethodTracker("Jobs List")
//Jobs List
	...
	While (vJ=1)
		...
		If (vJ=1)
			If (Records in selection:C76([JOBS:26])>0)
				...
				Open_Pro_Window("Jobs List"; 0; 1; ->[JOBS:26]; WIN_t_CurrentOutputform)
...
ERR_MethodTrackerReturn("Jobs List"; $_t_oldMethodName)