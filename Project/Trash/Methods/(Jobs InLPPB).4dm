...
Else 
	If (Size of array:C274(JOB_aPtr_OrderItemsSetup)=0)
		...
		LBi_ArrDefFill(->JOB_aPtr_OrderItemsSetup; ->JOB_LB_OrderItems; ->[ORDER_ITEMS:25]Item_Number:27; ->[JOBS:26]Job_Code:1; "411111126"; "Items In13"; 11; "Cost Items"; "Order Item")
