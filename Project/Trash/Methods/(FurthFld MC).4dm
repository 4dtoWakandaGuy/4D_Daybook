...
If (False:C215)
	//Project Method Name:      FurthFld MC
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FurthFld MC")
//FurthFld MC - More Choices
Load_Fields
...
If ((DB_GetModuleSettingByNUM(1))#5)
	...
	If (<>SYS_al_TableUniqueField{$_l_TableRow}#0)
		...
		$_t_TableNumberasString:=Str LeadZeros(String:C10($_l_TableNumber); 3)
		...
		If ($_l_SizeofArray#0)
			...
			DIALOG:C40([CUSTOM_FIELDS:98]; "dFurthFld MC")
			CLOSE WINDOW:C154
			$_l_OK:=OK
			OK:=1
...
Else 
	...
	OK:=0
End if 
ERR_MethodTrackerReturn("FurthFld MC"; $_t_oldMethodName)