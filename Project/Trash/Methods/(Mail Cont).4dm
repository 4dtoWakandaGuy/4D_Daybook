...
$_t_oldMethodName:=ERR_MethodTracker("Mail Cont")
//Mail Cont
Start_Process
Start_ProcMail
Contacts_File
...
While (vO=1)
	...
	If (vO=1)
		If (Records in selection:C76([CONTACTS:1])>0)
			...
			Open_Pro_Window("Mail Contacts"; 0; 1; ->[CONTACTS:1]; WIN_t_CurrentOutputform)
			...
			If (OK=1)
				...
				If (vP=1)
					If (<>MultiCo)
						...
						DIALOG:C40([DOCUMENTS:7]; "dAsk Comp")
						$_l_OK:=OK
						OK:=1
						CLOSE WINDOW:C154
...
End while 
Process_End
ERR_MethodTrackerReturn("Mail Cont"; $_t_oldMethodName)