...
If (False:C215)
	//Project Method Name:      FurthFld Print
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FurthFld Print")
//FurthFld Print
$_l_OK:=PRINT_SetSIZE("A4"; "P"; "FurtherFields")
//PAGE SETUP([FURTHER FIELDS];"FurthFld Hdr")
//PRINT SETTINGS
If ($_l_OK>=0)
	Print form:C5([CUSTOM_FIELDS:98]; "FurthFld Hdr")
	...
	For ($_l_Index; 1; $_l_SizeofArray)
		...
		Print form:C5([CUSTOM_FIELDS:98]; "FurthFld Det")
	End for 
	PAGE BREAK:C6
	PRT_SetPrinterPaperOptions("FurtherFields")  //NG June 2005
	
End if 
ERR_MethodTrackerReturn("FurthFld Print"; $_t_oldMethodName)