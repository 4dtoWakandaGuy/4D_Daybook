...
If (True:C214)
	...
	C_TEXT:C284(<>SYS_t_DefaultTelFormat; $_t_CompanyCode; $_t_oldMethodName; $_t_ParentCompanyCode; $_t_Terms; COM_t_TelephoneNumberFormat; vCallCode; vCompName; vName; vTel)
End if 
//Code Starts Here
