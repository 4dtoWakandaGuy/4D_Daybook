...
If (False:C215)
	//Project Method Name:      TransB Print
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("TransB Print")
...
Menu_Record("TransB Print"; "Print Transaction Batch")
FORM SET OUTPUT:C54([TRANSACTION_BATCHES:30]; "TransB Print")
PRINT RECORD:C71([TRANSACTION_BATCHES:30])

FORM SET OUTPUT:C54([TRANSACTION_BATCHES:30]; "TransB Out")
ERR_MethodTrackerReturn("TransB Print"; $_t_oldMethodName)
