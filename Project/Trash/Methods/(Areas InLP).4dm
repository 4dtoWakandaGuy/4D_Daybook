...
If (False:C215)
	//Project Method Name:      Areas InLP
	Areas_InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_Event; $_l_ModulePosition; DB_l_WindowCurrentModule; ModuleNumber; PAL_BUTTON_10; PAL_BUTTON_7; PAL_BUTTON_8; PAL_BUTTON_9)
	C_REAL:C285($1)
	C_TEXT:C284($_t_oldMethodName; $_t_PalleteButton; BAR_t_Button; DB_t_CUrrentInputMenuRef; PAL_BUTTON; WIN_t_CurrentInputForm)
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Areas InLP")
...
End if 
$_t_oldMethodName:=ERR_MethodTracker("Areas InLP"; $_l_Event)
...
Case of 
		...
		Case of 
			: (BAR_t_Button#"")
				...
				If ($_l_ButtonNumber>1)
					...
					DB_SetInputFormMenu(Table:C252(->[AREAS:3]); "Areas In13")
				End if 
				BAR_t_Button:=""
			: (PAL_BUTTON#"")
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[AREAS:3]); "Areas In13")
		WS_AutoscreenSize(2; 360; 585)
		WIN_t_CurrentInputForm:="Areas In13"
...
End case 
ERR_MethodTrackerReturn("Areas InLP"; $_t_oldMethodName)
