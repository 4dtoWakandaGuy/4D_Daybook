...
If (False:C215)
	//Project Method Name:      Diary ApptsLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary ApptsLP")
$_l_Event:=Form event code:C388

Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[DIARY:12]); "Diary Appts13")
		vButtDis:="A                "
...
End case 
ERR_MethodTrackerReturn("Diary ApptsLP"; $_t_oldMethodName)