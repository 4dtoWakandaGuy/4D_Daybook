...
If (True:C214)
	...
	C_LONGINT:C283(<>AutoProc; $_l_DiaryID; $_l_Index; $_l_Process; $_l_RecordNumber; $_l_CurrentWinRefOLD; vDY; WIN_l_CurrentWinRef; WIN_l_CurrentWinRefOLD; XCANCEL; XNEXT)
	C_LONGINT:C283(XOK)
