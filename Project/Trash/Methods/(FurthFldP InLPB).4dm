...
If (False:C215)
	//Project Method Name:      FurthFldP InLPB
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FurthFldP InLPB")
//FurthFldP InLPB
...
If ($_l_RecordsCount>0)
	...
	$_t_CustomFieldCode:=Str LeadZeros(String:C10($1); 3)+Str_TrailSpaces([PERSONNEL:11]Initials:1; 5)+"@"
...
End if 
vJB:=$1
ERR_MethodTrackerReturn("FurthFldP InLPB"; $_t_oldMethodName)