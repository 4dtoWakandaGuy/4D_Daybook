...
If (False:C215)
	//Project Method Name:      StockAss BoM
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockAss BoM")
//StockAss BoM
					...
					If (OK=1)
						...
						If ($_l_OK>=0)
							...
							While (Not:C34(End selection:C36([PRODUCTS:9])))
								Print form:C5([STOCK_MOVEMENT_ITEMS:27]; "StockAss BoMHdr")
...
ERR_MethodTrackerReturn("StockAss BoM"; $_t_oldMethodName)