...
If (False:C215)
	//Project Method Name:      Trans File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Trans File")
//DEFAULT TABLE([TRANSACTIONS])
FORM SET INPUT:C55([TRANSACTIONS:29]; "trans in13")  //NG April 2004 Removed ◊Screen
WIN_t_CurrentInputForm:="trans in13"
FORM SET OUTPUT:C54([TRANSACTIONS:29]; "trans Out")
WIN_t_CurrentOutputform:="trans Out"
vTr:=1
...
If ((vAdd=0) & (<>SYS_bo_StatsView))
	Trans_SV
End if 
ERR_MethodTrackerReturn("Trans File"; $_t_oldMethodName)
