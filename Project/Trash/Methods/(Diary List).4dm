...
If (False:C215)
	//Project Method Name:      Diary List
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary List")
...
Gen_ListSR("List Diary"; "Diary_File2"; "DMaster"; ->[DIARY:12]; ->vD; "Diary_Sel"; "Diary Items"; "Diary List"; ""; "DiaryList"; $_bo_AutoSearch; $_t_SearchCode)
ERR_MethodTrackerReturn("Diary List"; $_t_oldMethodName)