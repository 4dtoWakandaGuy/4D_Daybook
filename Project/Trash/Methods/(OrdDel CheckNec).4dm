...
If (False:C215)
	//Project Method Name:      OrdDel CheckNec
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OrdDel CheckNec")
//OrdDel CheckNec - check is necessary
...
If (Size of array:C274($_at_ProductCodes)>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OrdDel CheckNec"; $_t_oldMethodName)