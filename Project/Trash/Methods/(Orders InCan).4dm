...
If (True:C214)
	C_BOOLEAN:C305($_bo_Delete; ORD_bo_IsRevision; ORD_bo_ItemsModified; ORD_bo_OrderModified)
	C_LONGINT:C283($_l_OK; vAdd)
	C_TEXT:C284(<>OrderCode; $_t_CalledFrom; $_t_oldMethodName; $1)
End if 
//Code Starts Here
