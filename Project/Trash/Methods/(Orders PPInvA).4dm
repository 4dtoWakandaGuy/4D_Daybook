...
If (False:C215)
	//Project Method Name:      Orders PPInvA
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 23/05/2011 13:17
...
$_t_oldMethodName:=ERR_MethodTracker("Orders PPInvA")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders PPInvA"; "Invoice All")
...
End if 
ERR_MethodTrackerReturn("Orders PPInvA"; $_t_oldMethodName)