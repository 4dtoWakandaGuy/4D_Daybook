...
If (False:C215)
	//Project Method Name:      IME DBEdit
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("IME DBEdit")
//IME DBEdit
//Rollo 11/6/2004
...
Case of 
	...
	: ($_t_Submit="New")  //clicked the New button
		IME DBEdit("DBEdit"+$_t_FunctionName)
		$_bo_Draw:=False:C215
...
End if 
ERR_MethodTrackerReturn("IME DBEdit"; $_t_oldMethodName)