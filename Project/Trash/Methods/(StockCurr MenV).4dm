...
If (False:C215)
	//Project Method Name:      StockCurr MenV
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockCurr MenV")
$_bo_OK:=True:C214

If (Count parameters:C259>=1)
	
	$_l_Menu:=Sel_LPmi("StockCurr MenV")
Else 
	$_l_Menu:=Num:C11($1)
End if 
...
End if 
ERR_MethodTrackerReturn("StockCurr MenV"; $_t_oldMethodName)
