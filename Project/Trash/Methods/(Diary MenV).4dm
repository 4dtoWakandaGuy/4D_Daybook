...
If (False:C215)
	//Project Method Name:      Diary MenV
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary MenV")
...
Else 
	$_l_MenuItem:=Sel_LPmi("Diary MenV")
End if 
...
End case 
ERR_MethodTrackerReturn("Diary MenV"; $_t_oldMethodName)