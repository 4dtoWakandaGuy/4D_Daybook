...
If (False:C215)
	//Project Method Name:      Postcodes InLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Postcodes InLP")
//Postcodes InLP
...
Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetInputFormMenu(Table:C252(->[POSTAL_CODES:50]); "Postcodes In13")
	...
	: ($_l_Event=On Deactivate:K2:10)
		// PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("Postcodes InLP"; $_t_oldMethodName)