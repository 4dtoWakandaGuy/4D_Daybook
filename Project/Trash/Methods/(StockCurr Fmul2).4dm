...
If (False:C215)
	//Project Method Name:      StockCurr Fmul2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockCurr Fmul2")
//StockCurr Fmul2- for use in Included Formulae
...
ERR_MethodTrackerReturn("StockCurr Fmul2"; $_t_oldMethodName)