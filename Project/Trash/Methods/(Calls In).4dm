...
$_t_oldMethodName:=ERR_MethodTracker("Calls In")
Start_Process
...
End if 
If (Calls_File)  //NG Modified June 2004
	If (SD_t_InputFormName#"")
		FORM SET INPUT:C55([SERVICE_CALLS:20]; SD_t_InputFormName)
		WIN_t_CurrentInputForm:=SD_t_InputFormName
	End if 
	Gen_InMid("Enter Service Calls"; "Master"; ->[SERVICE_CALLS:20])
End if 

Process_End
ERR_MethodTrackerReturn("Calls In"; $_t_oldMethodName)