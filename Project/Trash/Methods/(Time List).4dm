...
$_t_oldMethodName:=ERR_MethodTracker("Time List")
//Time List
		...
		If (vD=1)
			If (Records in selection:C76([DIARY:12])>0)
				If (Not:C34(SR_ReportOK("DiaryTime")))
					...
					Open_Pro_Window("Time List"; 0; 1; ->[DIARY:12]; WIN_t_CurrentOutputform)
...
ERR_MethodTrackerReturn("Time List"; $_t_oldMethodName)