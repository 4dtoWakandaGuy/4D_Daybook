...
If (False:C215)
	//Project Method Name:      Purch InvPost
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purch InvPost")
//Project Method Purch InvPost 26/3/2(ID 13515-3800)
...
If ((DB_GetModuleSettingByNUM(Module_NominalLedger)>0) & (OK=1))
	...
	End if 
End if 
ERR_MethodTrackerReturn("Purch InvPost"; $_t_oldMethodName)
