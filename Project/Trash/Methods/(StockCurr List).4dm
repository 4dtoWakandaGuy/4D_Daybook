...
If (False:C215)
	//Project Method Name:      StockCurr List
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockCurr List")
//Current Stock_List
			...
			If (Records in selection:C76([CURRENT_STOCK:62])>0)
				...
				If (OK=1)
					...
					If (Not:C34(SR_ReportOK("StockCuList")))
						FORM SET OUTPUT:C54([CURRENT_STOCK:62]; "StockCurr List")
						BREAK LEVEL:C302(6)
...
ERR_MethodTrackerReturn("StockCurr List"; $_t_oldMethodName)