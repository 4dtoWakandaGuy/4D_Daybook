...
If (False:C215)
	//Project Method Name:      Diary RecCheck
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/12/2009 09:32`Method: Diary RecCheck
...
$_t_oldMethodName:=ERR_MethodTracker("Diary RecCheck")
...
End while 
ERR_MethodTrackerReturn("Diary RecCheck"; $_t_oldMethodName)