...
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("___Orphan___4710")

$oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oCoTypesCB6"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oCoTypesCB6"; $OldMethodName)