...
If (False:C215)
	//Project Method Name:      Check Product
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 08/12/2009 14:41`Method: Check Product
...
$_t_oldMethodName:=ERR_MethodTracker("Check Product")
//Check Product
...
ERR_MethodTrackerReturn("Check Product"; $_t_oldMethodName)