...
$_t_oldMethodName:=ERR_MethodTracker("Jobs CP")
//Jobs CP
Menu_Record("Jobs CP"; "Copy Previous")
...
If (In_ButtChkMan(->[JOBS:26]; "1"))
	...
	End if 
End if 
ERR_MethodTrackerReturn("Jobs CP"; $_t_oldMethodName)