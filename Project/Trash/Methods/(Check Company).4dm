...
If (False:C215)
	//Project Method Name:      Check Company
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 10/12/2009 14:47`Method: Check Company
...
$_t_oldMethodName:=ERR_MethodTracker("Check Company")
//Check Company
...
End if 
ERR_MethodTrackerReturn("Check Company"; $_t_oldMethodName)
