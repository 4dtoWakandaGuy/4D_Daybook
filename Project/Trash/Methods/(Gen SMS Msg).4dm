...
If (False:C215)
	//Project Method Name:      Gen SMS Msg
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Gen SMS Msg")
// Gen SMS Msg
...
$_l_WindowReference:=Open form window:C675([COMPANIES:2]; "dRequest SMSText"; 1)
...
DIALOG:C40([COMPANIES:2]; "dRequest SMSText")
CLOSE WINDOW:C154
$0:=vT
<>SYS_bo_CurrentWindowModal:=False:C215
ERR_MethodTrackerReturn("Gen SMS Msg"; $_t_oldMethodName)