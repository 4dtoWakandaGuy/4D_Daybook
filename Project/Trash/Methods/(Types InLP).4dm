...
If (False:C215)
	//Project Method Name:      Types InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_UpdateisDone; DB_bo_NoLoad; DB_bo_RecordModified; PAL_bo_ButtonSubFunction)
	C_LONGINT:C283($_l_ButtonNumber; $_l_Event; $_l_ModuleRow; $_l_Type; $_l_UpdateTypes; DB_l_WindowCurrentModule; ModuleNumber; PAL_BUTTON_10; PAL_BUTTON_7; PAL_BUTTON_8; PAL_BUTTON_9)
...
$_t_oldMethodName:=ERR_MethodTracker("Types InLP")
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		OpenHelp(Table:C252(->[TYPES:5]); "Types In13")
		Types_InLPCU
		WS_AutoscreenSize(2; 380; 590)
		INT_SetInput(Table:C252(->[TYPES:5]); WIN_t_CurrentInputForm)
		
		DB_SetInputFormMenu(Table:C252(->[TYPES:5]); "Types In13")
	...
	: ($_l_Event=On Activate:K2:9)
		...
		End if 
End case 
ERR_MethodTrackerReturn("Types InLP"; $_t_oldMethodName)
