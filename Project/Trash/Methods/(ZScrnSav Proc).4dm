...
If (True:C214)
	C_LONGINT:C283(<>PER_l_CurrentPersFunctions; $_l_ProcessNumber; $_l_ProcessState; $_l_ProcessTime; $0)
...
If (($_t_ProcessName="Design Process") | (<>PER_l_CurrentPersFunctions ?? 6))
	$0:=0
Else 
