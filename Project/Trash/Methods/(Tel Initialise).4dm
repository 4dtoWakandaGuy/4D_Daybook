...
If (False:C215)
	//Project Method Name:      Tel Initialise
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Tel Initialise")
//aaInitialise - Tel initialise
vTelMaxTask:=2
...
Else 
	<>TelServer:=False:C215
End if 
ERR_MethodTrackerReturn("Tel Initialise"; $_t_oldMethodName)
