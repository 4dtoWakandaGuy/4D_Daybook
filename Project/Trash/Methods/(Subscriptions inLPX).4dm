...
If (False:C215)
	//Project Method Name:      Subscriptions inLPX
	//------------------ Method Notes ------------------
...
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Subscriptions inLPX")

//NG April 2004
//new method created to handle data modication of subscription
//derived from the subform area scripts of[SUBSCRIPTIONS];"Items Sub" and [SUBSCRIPTIONS];"Subscript Sub"
$_t_oldMethodName:=ERR_MethodTracker("Subscriptions inLPX"; Form event code:C388)
...
ERR_MethodTrackerReturn("Subscriptions inLPX"; $_t_oldMethodName)