//%attributes = {}
If (False:C215)
	//Project Method Name:      DB_Process Started
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("DB_Process Started")
$0:=False:C215
$_t_MethodName:=$1
$_l_ProcessMemory:=$2
$_t_ProcessName:=$3
...
ERR_MethodTrackerReturn("DB_Process Started"; $_t_oldMethodName)