...
If (False:C215)
	//Project Method Name:      Subscript LetDe
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Subscript LetDe")
//Subscript LetDe tails - called from Letter_AllDets
If (rOrd=2)
...
If (rOrd=3)
	...
	End while 
End if 
ERR_MethodTrackerReturn("Subscript LetDe"; $_t_oldMethodName)