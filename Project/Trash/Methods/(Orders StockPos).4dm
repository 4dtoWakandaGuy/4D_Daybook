...
If (False:C215)
	//Project Method Name:      Orders StockPos
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders StockPos")
If (Not:C34(ORD_bo_IsRevision))
	If (ORD_al_ViewTableToTable{ORD_at_ViewTabsLabels}=Table:C252(->[ORDER_ITEMS:25]))
		...
		Else 
			$_t_InvoiceNumber:=""
		End if 
		Menu_Record("Orders StockPos"; "Delivery-Type Stock Movt")
...
End if 
ERR_MethodTrackerReturn("Orders StockPos"; $_t_oldMethodName)
