...
$_t_oldMethodName:=ERR_MethodTracker("Jobs File")

Jobs_FileI
FORM SET OUTPUT:C54([JOBS:26]; "Jobs Out")
WIN_t_CurrentOutputform:="Jobs Out"
vJ:=1
...
End if 
ERR_MethodTrackerReturn("Jobs File"; $_t_oldMethodName)