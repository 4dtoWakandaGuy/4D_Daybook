If (False:C215)
	//Table Form Method Name: [ORDER_ITEMS]Items In13S
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [ORDER_ITEMS].Items In13S"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ORDER_ITEMS:25]); "Items In13S")
		WS_AutoscreenSize(2; 384; 553)
...
End case 
OrderI_InLP
ERR_MethodTrackerReturn("FM [ORDER_ITEMS].Items In13S"; $_t_oldMethodName)
