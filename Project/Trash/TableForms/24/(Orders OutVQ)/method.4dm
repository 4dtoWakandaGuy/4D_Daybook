If (False:C215)
	//Table Form Method Name: [ORDERS]Orders OutVQ
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisO; vTitleR; vVATTitleF; WIN_t_CurrentInputForm; WIN_t_CurrentOutputform)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("FM [ORDERS].Orders OutVQ"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ORDERS:24]); "Orders OutVQ")
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[ORDERS:24]; ->[ORDERS:24]Order_Code:3; ->[ORDERS:24]Company_Code:1; "Orders"; "Orders_InE"; "Orders_Sel"; "Orders_OutDel"; "OrMaster"; "Types"; "Orders_OutCntV"; 1; 2)
	...
	: ($_l_event=On Close Detail:K2:24)
		...
		vVATTitleF:=Term_VATWT("VAT")
End case 
ERR_MethodTrackerReturn("FM [ORDERS].Orders OutVQ"; $_t_oldMethodName)
