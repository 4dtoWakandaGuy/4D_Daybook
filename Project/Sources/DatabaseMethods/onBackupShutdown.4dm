If (False:C215)
	//Database Method Name:      On Backup Shutdown
	//------------------ Method Notes ------------------
...
If (True:C214)
	//C_UNKNOWN($1)
	C_LONGINT:C283($1; $_l_EndShutDownProcess)
	C_TEXT:C284($_t_oldMethodName; $_t_Document; $_t_oldMethodName)
End if 
//Code Starts Here
...
$_l_EndShutDownProcess:=New process:C317("BP_OnBackupShutdown"; 128*1024; "OnBackupShutdown Process"; $1)  //moved most code from this method to run in new process - kmw 09/10/08 v631b120
