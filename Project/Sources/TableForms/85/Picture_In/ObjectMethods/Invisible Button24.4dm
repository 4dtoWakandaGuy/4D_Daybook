If (False:C215)
	//object Name: [PICTURES]Picture_In.Invisible Button24
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 04/10/2010 16:39
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PICTURES].Picture_In.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PICTURES].Picture_In.Invisible Button24"; $_t_oldMethodName)
