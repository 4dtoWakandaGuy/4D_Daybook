If (False:C215)
	//object Name: [PICTURES]Picture_In.Invisible Button28
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PICTURES].Picture_In.Invisible Button28"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PICTURES].Picture_In.Invisible Button28"; $_t_oldMethodName)
