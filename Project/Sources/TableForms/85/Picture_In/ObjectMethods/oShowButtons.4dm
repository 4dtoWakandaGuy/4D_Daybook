If (False:C215)
	//object Name: [PICTURES]Picture_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:48
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisPICTURES)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [PICTURES].Picture_In.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisPICTURES; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
...
End case 
ERR_MethodTrackerReturn("OBJ [PICTURES].Picture_In.oShowButtons"; $_t_oldMethodName)
