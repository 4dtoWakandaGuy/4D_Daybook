If (False:C215)
	//Table Form Method Name: [PICTURES]Pictures_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [PICTURES].Pictures_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[PICTURES:85]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[PICTURES:85]); "Pictures_Out")
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[PICTURES:85]; ->[PICTURES:85]Picture_Code:1; ->[PICTURES:85]Picture_Name:2; "Pictures"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Pictures"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[PICTURES:85])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM:Pictures Out"; $_t_oldMethodName)
