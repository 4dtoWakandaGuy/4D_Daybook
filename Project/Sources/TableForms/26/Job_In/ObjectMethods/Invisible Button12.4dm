If (False:C215)
	//object Name: [JOBS]Job_In.Invisible Button12
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 02/10/2010 07:32
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOBS].Job_In.Invisible Button12"; Form event code:C388)
...
Else 
	...
	RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
End if 
ERR_MethodTrackerReturn("OBJ [JOBS].Job_In.Invisible Button12"; $_t_oldMethodName)
