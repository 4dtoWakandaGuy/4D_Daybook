If (False:C215)
	//object Name: [JOBS]Job_In.Variable18
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOBS].Job_In.Variable18"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [JOBS].Job_In.Variable18"; $_t_oldMethodName)
