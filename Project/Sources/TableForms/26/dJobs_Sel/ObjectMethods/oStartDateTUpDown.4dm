If (False:C215)
	//object Name: [JOBS]dJobs_Sel.oStartDateTUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOBS].dJobs_Sel.oStartDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [JOBS].dJobs_Sel.oStartDateTUpDown"; $_t_oldMethodName)
