If (False:C215)
	//object Name: [JOBS]dJobs_Sel.oEndDateTUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOBS].dJobs_Sel.oEndDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [JOBS].dJobs_Sel.oEndDateTUpDown"; $_t_oldMethodName)
