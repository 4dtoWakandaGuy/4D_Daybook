If (False:C215)
	//object Name: [PURCHASE_ORDERS]dASK_purchaseOrder.Variable10
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_ORDERS].dASK_purchaseOrder.Variable10"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [PURCHASE_ORDERS].dASK_purchaseOrder.Variable10"; $_t_oldMethodName)
