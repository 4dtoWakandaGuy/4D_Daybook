If (False:C215)
	//object Name: [PURCHASE_ORDERS]Purch_Ord_In13OLD.Variable26
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284(PO_t_Country; PO_t_CountryOLD; PO_t_County; PO_t_CountyOLD; PO_t_DeliveryAddress; PO_t_PostalCode; PO_t_PostalCodeOLD; PO_t_Town; PO_t_TownOLD)
End if 
//Code Starts Here
