If (False:C215)
	//object Name: [PURCHASE_ORDERS]Purch_Ord_In13OLD.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_ORDERS].PurchaseOrder_In.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_ORDERS].PurchaseOrder_In.Variable71"; $_t_oldMethodName)
