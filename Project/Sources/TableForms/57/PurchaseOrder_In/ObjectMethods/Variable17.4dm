If (False:C215)
	//object Name: [PURCHASE_ORDERS]PurchaseOrder_In.Variable17
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Switch; $_bo_Reload; $_bo_Switch)
...
ERR_MethodTrackerReturn("OBJ:PurchaseOrder_In,PO_at_ModePO"; $_t_oldMethodName)
