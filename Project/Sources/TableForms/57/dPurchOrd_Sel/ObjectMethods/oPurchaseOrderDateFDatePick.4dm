If (False:C215)
	//object Name: [PURCHASE_ORDERS]dPurchOrd_Sel.oPurchaseOrderDateFDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/08/2012 13:16
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_ORDERS].dPurchOrd_Sel.oPurchaseOrderDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_ORDERS].dPurchOrd_Sel.oPurchaseOrderDateFDatePick"; $_t_oldMethodName)
