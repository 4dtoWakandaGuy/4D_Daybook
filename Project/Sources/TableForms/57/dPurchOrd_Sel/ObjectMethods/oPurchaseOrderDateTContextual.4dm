If (False:C215)
	//object Name: [PURCHASE_ORDERS]dPurchOrd_Sel.oPurchaseOrderDateTContextual
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 28/07/2012 12:18
...
If (True:C214)
	C_LONGINT:C283($_l_CallBackProcess; $_l_CharacterPosition; $_l_DatesProcess; $_l_FieldNumber; $_l_MouseButton; $_l_MouseX; $_l_MouseY; $_l_TableNumber; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_ORDERS].dPurchOrd_Sel.oPurchaseOrderDateTContextual"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_ORDERS].dPurchOrd_Sel.oPurchaseOrderDateTContextual"; $_t_oldMethodName)
