If (False:C215)
	//object Name: [PURCHASE_ORDERS]dPurchOrd_Sel.oPurchaseOrderDateFUpDown
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_event; $_l_offset; $_l_PurchaseOrdersCount; vIDateFupDown)
	C_POINTER:C301($_ptr_Field)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_ORDERS].dPurchOrd_Sel.oPurchaseOrderDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (vIDateF=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([PURCHASE_ORDERS:57]; [PURCHASE_ORDERS:57]Purchase_Order_Date:3<vIDateF; *)
				QUERY:C277([PURCHASE_ORDERS:57];  & ; [PURCHASE_ORDERS:57]Purchase_Order_Date:3#!00-00-00!)
