If (False:C215)
	//object Name: [PURCHASE_ORDERS]dPurchOrd_Sel.oQueryDropDown
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>PER_l_CurrentUserID; $_l_event; $_l_PurchaseOrdersTable; CH0; CH1; cNAA; cNAL; cSIS; R0; R1; SM_l_QueryMode)
	C_LONGINT:C283(SM_l_ReturnQueryID; ViDateFOffset; ViDateTOffset; vpDateFOffset; vpDateTOffset; VRDateFOffset; VRDateTOffset)
	C_REAL:C285(vInvF; vinvT)
	C_TEXT:C284($_t_ContextName; $_t_oldMethodName; $_t_SearchName; ACC_t_CurrencyCode; VAnalysis; VCompCode; VCompName; VCOmpNameC; vContactName; vContCode; vEvent)
	C_TEXT:C284(VforeName; VLayer; VorderNo; VProdCode; VPurchCode; VPurchInvNo; Vsurname)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_ORDERS].dPurchOrd_Sel.oQueryDropDown"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_ORDERS].dPurchOrd_Sel.oQueryDropDown"; $_t_oldMethodName)
