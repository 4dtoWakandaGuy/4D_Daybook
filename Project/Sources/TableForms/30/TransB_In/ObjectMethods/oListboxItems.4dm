If (False:C215)
	//object Name: [TRANSACTION_BATCHES]TransB_in.oListboxItems
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 07/09/2012 08:55
...
If (True:C214)
	...
	C_LONGINT:C283($_l_BatchItemID; $_l_ColumnIndex; $_l_event; $_l_FirstRealLine; $_l_InsertAt; $_l_ItemViewContext; $_l_ObjectBottom; $_l_ObjectLeft; $_l_ObjectRight; $_l_ObjectTop; $_l_Process)
	C_LONGINT:C283($_l_ProcessOrigin; $_l_ProcessState; $_l_ProcessTime; $_l_Retries; $_l_SelectedRow; $_l_SizeofArray; $_l_TransBatchItemID; $_l_TransCreditID; $_l_TransDebitID; $_l_UniqueProcessID; $_l_WindowBottom)
	C_LONGINT:C283($_l_WindowLeft; $_l_WindowRight; $_l_WindowTop; $CurrentRealLine; ACC_l_BatchItemID; ACC_l_DisplayedItemNumber; ACC_l_ItemEntryProcess; ACC_l_ItemViewContext; ACC_l_MaxItemNumber; ACC_l_TransBatchItemID; ACC_l_TransCreditID)
	C_LONGINT:C283(ACC_l_TransDebitID; DB_l_ButtonClickedFunction; DS_l_BATCHITEMRef; MOD_l_CurrentModuleAccess)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].TransB_in.oListboxItems"; Form event code:C388)
	...
	: ($_l_event=On Double Clicked:K2:5)
		...
		If (Size of array:C274(ACC_al_BatchitemCompanion{$_l_SelectedRow})>=1)
			...
			Else 
				...
				If ([TRANSACTION_BATCHES:30]Posted_Date:16=!00-00-00!)
					$_l_ItemViewContext:=3
				Else 
					$_l_ItemViewContext:=2
				End if 
				ACC_l_ItemEntryProcess:=New process:C317("ACC_BatchItemEntry"; 64000; "ItemEntry"+String:C10([TRANSACTION_BATCHES:30]Batch_Number:10); Current process:C322; [TRANSACTION_BATCHES:30]Batch_Number:10; $_l_ItemViewContext; [TRANSACTION_BATCHES:30]State:15; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; MOD_l_CurrentModuleAccess; [TRANSACTION_BATCHES:30]Batch_Date:1; SYS_t_AccessType; $_l_WindowLeft+$_l_ObjectLeft; $_l_WindowTop+$_l_ObjectTop; True:C214)
				$_l_Retries:=0
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].TransB_in.oListboxItems"; $_t_oldMethodName)
