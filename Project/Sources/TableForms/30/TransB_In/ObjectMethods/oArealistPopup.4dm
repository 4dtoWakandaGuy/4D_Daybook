If (False:C215)
	//object Name: [TRANSACTION_BATCHES]TransB_in.oArealistPopup
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 05/09/2009 14:53
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].TransB_in.oArealistPopup"; Form event code:C388)
Case of 
	...
	Else 
		//transactions area
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].TransB_in.oArealistPopup"; $_t_oldMethodName)
