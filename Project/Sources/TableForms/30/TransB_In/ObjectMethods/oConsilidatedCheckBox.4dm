If (False:C215)
	//object Name: [TRANSACTION_BATCHES]TransB_in.oConsilidatedCheckBox
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].TransB_in.oConsilidatedCheckBox"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].TransB_in.oConsilidatedCheckBox"; $_t_oldMethodName)
