If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVTDateFDatePick
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVTDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVTDateFDatePick"; $_t_oldMethodName)
