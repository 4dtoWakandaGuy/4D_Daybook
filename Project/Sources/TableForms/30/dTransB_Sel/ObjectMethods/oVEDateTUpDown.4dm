If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVEDateTUpDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/07/2012 16:48
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVEDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVEDateTUpDown"; $_t_oldMethodName)
