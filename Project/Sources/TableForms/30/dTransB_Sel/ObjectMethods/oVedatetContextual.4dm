If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVedatetContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVedatetContextual"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVedatetContextual"; $_t_oldMethodName)
