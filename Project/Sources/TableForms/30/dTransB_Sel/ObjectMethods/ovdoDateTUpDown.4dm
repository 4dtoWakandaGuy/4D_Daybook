If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.ovdoDateTUpDown
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES]dTransB_Sel.ovdoDateTUpDown"; Form event code:C388)
