If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVTDateFUpDown
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES]dTransB_Sel.oVTDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (VTdateF=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([TRANSACTION_BATCHES:30]; [TRANSACTION_BATCHES:30]Batch_Date:1<VTdateF; *)
				QUERY:C277([TRANSACTION_BATCHES:30];  & ; [TRANSACTION_BATCHES:30]Batch_Date:1#!00-00-00!)
