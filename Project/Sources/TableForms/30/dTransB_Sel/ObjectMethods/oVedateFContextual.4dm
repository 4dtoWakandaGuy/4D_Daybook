If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVedateFContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVedateFContextual"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVedateFContextual"; $_t_oldMethodName)
