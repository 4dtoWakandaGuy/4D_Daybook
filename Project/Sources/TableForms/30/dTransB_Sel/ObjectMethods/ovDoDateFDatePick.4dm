If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.ovDoDateFDatePick
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.ovDoDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.ovDoDateFDatePick"; $_t_oldMethodName)
