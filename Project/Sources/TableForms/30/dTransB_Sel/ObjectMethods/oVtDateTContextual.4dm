If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVtDateTContextual
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 29/07/2012 08:34
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVtDateTContextual"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVtDateTContextual"; $_t_oldMethodName)
