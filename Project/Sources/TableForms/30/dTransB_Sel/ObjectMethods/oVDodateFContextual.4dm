If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVDodateFContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVDodateFContextual"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVDodateFContextual"; $_t_oldMethodName)
