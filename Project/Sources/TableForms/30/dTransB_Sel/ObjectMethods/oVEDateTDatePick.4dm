If (False:C215)
	//object Name: [TRANSACTION_BATCHES]dTransB_Sel.oVEDateTDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/08/2012 13:32
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVEDateTDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].dTransB_Sel.oVEDateTDatePick"; $_t_oldMethodName)
