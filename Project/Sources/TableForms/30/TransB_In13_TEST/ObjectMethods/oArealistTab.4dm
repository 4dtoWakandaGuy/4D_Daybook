If (False:C215)
	//object Name: [TRANSACTION_BATCHES]TransB_In13_TEST.oArealistTab
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTION_BATCHES].TransB_In13_TEST.oArealistTab"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTION_BATCHES].TransB_In13_TEST.oArealistTab"; $_t_oldMethodName)
