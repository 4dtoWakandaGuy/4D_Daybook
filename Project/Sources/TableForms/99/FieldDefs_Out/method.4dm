If (False:C215)
	//Table Form Method Name: [CUSTOM_FIELD_DEFINITiONS]FieldDefs_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [CUSTOM_FIELD_DEFINITiONS].FieldDefs_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[CUSTOM_FIELD_DEFINITiONS:99]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[CUSTOM_FIELD_DEFINITiONS:99]); "FieldDefs_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[CUSTOM_FIELD_DEFINITiONS:99]; ->[CUSTOM_FIELD_DEFINITiONS:99]FD_Code:1; ->[CUSTOM_FIELD_DEFINITiONS:99]Field_Name:2; "FieldDefs"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Field Definitions"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[CUSTOM_FIELD_DEFINITiONS:99])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:FieldDefs_Out"; $_t_oldMethodName)
