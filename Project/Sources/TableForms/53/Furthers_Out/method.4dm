If (False:C215)
	//Table Form Method Name: [ADDITIONAL_RECORD_ANALYSIS]Furthers_out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [ADDITIONAL_RECORD_ANALYSIS].Furthers_out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[ADDITIONAL_RECORD_ANALYSIS:53]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ADDITIONAL_RECORD_ANALYSIS:53]); "Furthers_out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[ADDITIONAL_RECORD_ANALYSIS:53]; ->[ADDITIONAL_RECORD_ANALYSIS:53]Additional_Analysis_Code:1; ->[ADDITIONAL_RECORD_ANALYSIS:53]Additional_Analysis_Name:2; "Furthers"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_DelEx"; ""; "Furthers"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[ADDITIONAL_RECORD_ANALYSIS:53])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM:Furthers Out"; $_t_oldMethodName)
