If (False:C215)
	//object Name: [PROJECTS]Projects_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 14:00
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PROJECTS].Projects_In.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PROJECTS].Projects_In.oShowButtons"; $_t_oldMethodName)
