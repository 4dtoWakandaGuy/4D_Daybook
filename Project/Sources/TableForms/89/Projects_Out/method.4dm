If (False:C215)
	//Table Form Method Name: [PROJECTS]Projects_Out
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 13/09/2010 16:48
...
$_t_oldMethodName:=ERR_MethodTracker("FM [PROJECTS].Projects_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[PROJECTS:89]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Display Detail:K2:22)
		If ([PROJECTS:89]Project_Code:1#"")
			If ([COMPANIES:2]Company_Code:1#[PROJECTS:89]Company_Code:3)  //only here cos StatsView kills auto rels
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[PROJECTS:89]); "Projects_Out")
		Cache_Initialise("AMaster")
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[PROJECTS:89]; ->[PROJECTS:89]Project_Code:1; ->[PROJECTS:89]Project_Name:2; "Projects"; "DB_MenuNewRecord"; "Projects_Sel"; "Projects_OutDelete"; "AMaster"; "Projects"; "Projects_OutCou"; 3; 4)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[PROJECTS:89])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:Projects Out"; $_t_oldMethodName)
