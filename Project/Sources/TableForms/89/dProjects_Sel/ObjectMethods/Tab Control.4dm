If (False:C215)
	//object Name: [PROJECTS]dProjects_Sel.Tab Control
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_DATE:C307($_d_doDateT; $_d_fDateF; $_d_SDateT; $SRCH_d_EntryDateFrom; SRCH_d_EntryDateFrom; vDateF1; vDateF2; vDateF3; vDateF4; vDateF5; vDateT1)
	...
	C_LONGINT:C283($_l_NAL; $_l_No1; $_l_No2; $_l_No3; $_l_No4; $_l_No5; $_l_OK; $_l_QueryMode; $_l_rState; $_l_SIS; $_l_TabsWidth)
	...
	C_TEXT:C284($_t_Title4; $_t_Title5; $_t_town; $_t_Type; dbtabText2; Varea; VComments; VcompCode; vCompName; vContrCode; VCountry)
	C_TEXT:C284(VCounty; vDesc1; vDesc2; vDesc3; vDesc4; vDesc5; VLocation; VOmit; VpostCode; vProbCode; VProdCode)
	C_TEXT:C284(vrstate; Vsales; Vsource; Vstatus; vSubGroup1; vSubGroup2; vSubGroup3; vSubGroup4; vSubGroup5; VSuperior; Vtel)
	C_TEXT:C284(Vtele; vTitle1; vTitle2; vTitle3; vTitle4; vTitle5; Vtown; Vtype)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [PROJECTS].dProjects_Sel.Tab Control"; Form event code:C388)
...
$_r_Valuef:=VValueF
$_r_ValueT:=VvalueT
$SRCH_d_EntryDateFrom:=SRCH_d_EntryDateFrom
$_d_SDateT:=VSDateT
$_d_fDateF:=VFDateT
...
ERR_MethodTrackerReturn("OBJ [PROJECTS].dProjects_Sel.Tab Control"; $_t_oldMethodName)
