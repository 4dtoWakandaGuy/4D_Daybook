If (False:C215)
	//object Name: [PROJECTS]dProjects_Sel.oVsDateFUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PROJECTS].dProjects_Sel.oVsDateFUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PROJECTS].dProjects_Sel.oVsDateFUpDown"; $_t_oldMethodName)
