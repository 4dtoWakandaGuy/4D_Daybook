If (False:C215)
	//object Name: [PROJECTS]dProjects_Sel.oVsDateTUpDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 18/07/2012 16:32
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PROJECTS].dProjects_Sel.oVsDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PROJECTS].dProjects_Sel.oVsDateTUpDown"; $_t_oldMethodName)
