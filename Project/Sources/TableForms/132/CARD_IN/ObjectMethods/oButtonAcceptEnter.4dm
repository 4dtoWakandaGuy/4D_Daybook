If (False:C215)
	//object Name: [xCreditCardDetails]CARD IN.oButtonAcceptEnter
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [xCreditCardDetails].CARD_IN.oButtonAcceptEnter"; Form event code:C388)
If (CCM_T_CardNumber#"")
	If (CCM_t_EndDate#"")
		If (CCM_T_NameOnCard#"")
			If (CCM_t_CardType#"")
...
End if 
ERR_MethodTrackerReturn("OBJ [xCreditCardDetails].CARD_IN.oButtonAcceptEnter"; $_t_oldMethodName)
