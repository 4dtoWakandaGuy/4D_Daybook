If (False:C215)
	//object Method Name: Object Name:      [xCreditCardDetails].CARD_IN.oCardOwnerShip1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [xCreditCardDetails].CARD_IN.oCardOwnerShip1"; Form event code:C388)
$_l_Event:=Form event code:C388
Case of 
	: ($_l_Event=On Clicked:K2:4)
		If (CCM_Rb_CompanyCard=0)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [xCreditCardDetails].CARD_IN.oCardOwnerShip1"; $_t_oldMethodName)
