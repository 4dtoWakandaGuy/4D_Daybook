If (False:C215)
	//Table Form Method Name: [TERMINOLOGY]Term_in
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [TERMINOLOGY].Term_in"; Form event code:C388)
$_l_event:=Form event code:C388
Minor_LP(->[TERMINOLOGY:75]Terminology_Code:1; ->[TERMINOLOGY:75]Terminology_Name:2; ->[TERMINOLOGY:75]; "Terminology"; "1"; ""; "")

Case of 
	: ($_l_event=On Header:K2:17) | ($_l_event=On Resize:K2:27)
		//WS_AutoscreenSize (2;260;570)
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[TERMINOLOGY:75]); "Term_in")
		WS_AutoscreenSize(2; 315; 570)
		INT_SetInput(Table:C252(->[TERMINOLOGY:75]); WIN_t_CurrentInputForm)
		
		DB_SetInputFormMenu(Table:C252(->[TERMINOLOGY:75]); "Term_in")
...
End case 
ERR_MethodTrackerReturn("FM:Term_In"; $_t_oldMethodName)
