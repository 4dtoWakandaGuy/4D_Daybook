If (False:C215)
	//Table Form Method Name: [TERMINOLOGY]Term_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [TERMINOLOGY].Term_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[TERMINOLOGY:75]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[TERMINOLOGY:75]); "Term_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[TERMINOLOGY:75]; ->[TERMINOLOGY:75]Terminology_Code:1; ->[TERMINOLOGY:75]Terminology_Name:2; "Term"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Terminology"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[TERMINOLOGY:75])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:Term_Out"; $_t_oldMethodName)
