If (False:C215)
	//Table Form Method Name: [LIST_ITEMS]Lists_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [LIST_ITEMS].Lists_Out"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[LIST_ITEMS:95]); "Lists_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[LIST_ITEMS:95]; ->[LIST_ITEMS:95]List_Name:1; ->[LIST_ITEMS:95]List_Entry:2; "Lists"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Lists"; ""; 0; 0)
	: ($_l_event=On Open Detail:K2:23)
		GET WINDOW RECT:C443(SIZ_l_OLDLEFT; SIZ_l_OLDTOP; SIZ_l_OLDRIGHT; SIZ_l_OLDBOTTOM)
		INT_bo_DetailOpen:=True:C214
		
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[LIST_ITEMS:95])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM:Lists_Out"; $_t_oldMethodName)
