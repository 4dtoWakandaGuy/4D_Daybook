If (False:C215)
	//Table Form Method Name: [CUSTOM_FIELDS]CustomFIelds_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [CUSTOM_FIELDS].CustomFIelds_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[CUSTOM_FIELDS:98]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[CUSTOM_FIELDS:98]); "CustomFIelds_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[CUSTOM_FIELDS:98]; ->[CUSTOM_FIELDS:98]Unique_Code:2; ->[CUSTOM_FIELDS:98]Field_Name:3; "FurthFld"; "DB_MenuNewRecord"; "FurthFld_Sel"; "Minor_Del"; ""; "Further Fields"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[CUSTOM_FIELDS:98])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM:CustomFIelds_Out"; $_t_oldMethodName)
