If (False:C215)
	//object Name: [EW_ExportProjects]Calculation.Variable3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [EW_ExportProjects].Calculation.Variable3"; Form event code:C388)
//[Calculations]entry
// bOK button
...
Case of 
	...
	Else 
		ACCEPT:C269
End case 
ERR_MethodTrackerReturn("OBJ [EW_ExportProjects].Calculation.Variable3"; $_t_oldMethodName)
