If (False:C215)
	//object Name: [INVOICES]dInv_Sel.oInvoiceDateFUpDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 23/07/2012 10:53
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].dInv_Sel.oInvoiceDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (vIDateF=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([INVOICES:39]; [INVOICES:39]Invoice_Date:4<vIDateF; *)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].dInv_Sel.oInvoiceDateFUpDown"; $_t_oldMethodName)
