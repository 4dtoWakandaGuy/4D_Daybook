If (False:C215)
	//object Name: [INVOICES]dInv_Sel.oPostedDateFContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].dInv_Sel.oPostedDateFContextual"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].dInv_Sel.oPostedDateFContextual"; $_t_oldMethodName)
