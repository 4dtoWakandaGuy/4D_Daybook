If (False:C215)
	//object Name: [INVOICES]dInv_Sel.oStatementDateTContextual
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 28/07/2012 10:52
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].dInv_Sel.oStatementDateTContextual"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].dInv_Sel.oStatementDateTContextual"; $_t_oldMethodName)
