If (False:C215)
	//object Name: [INVOICES]dInv_Sel.oInvoiceDateTDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/08/2012 12:42
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].dInv_Sel.oInvoiceDateTDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].dInv_Sel.oInvoiceDateTDatePick"; $_t_oldMethodName)
