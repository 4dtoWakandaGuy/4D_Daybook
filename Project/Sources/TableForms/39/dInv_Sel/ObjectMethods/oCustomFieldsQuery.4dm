If (False:C215)
	//object Name: [INVOICES]dInv_Sel.oCustomFieldsQuery
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/07/2012 15:31
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].dInv_Sel.oCustomFieldsQuery"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Data Change:K2:15)
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].dInv_Sel.oCustomFieldsQuery"; $_t_oldMethodName)
