If (False:C215)
	//object Name: [INVOICES]dInv_Sel.oDropDownContextualPeriods
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/08/2012 11:00
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].dInv_Sel.oDropDownContextualPeriods"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].dInv_Sel.oDropDownContextualPeriods"; $_t_oldMethodName)
