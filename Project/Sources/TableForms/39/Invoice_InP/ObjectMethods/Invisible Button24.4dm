If (False:C215)
	//object Name: [INVOICES]Invoice_inP.Invisible Button24
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].Invoice_inP.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].Invoice_inP.Invisible Button24"; $_t_oldMethodName)
