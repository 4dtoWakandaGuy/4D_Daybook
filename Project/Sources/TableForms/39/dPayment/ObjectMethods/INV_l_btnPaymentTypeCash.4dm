If (False:C215)
	//object Name: [INVOICES]dPayment.INV_l_btnPaymentTypeCash
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES]dPayment.INV_l_btnPaymentTypeCash"; Form event code:C388)
...
//*************************************************************************************
ERR_MethodTrackerReturn("OBJ [INVOICES]dPayment.INV_l_btnPaymentTypeCash"; $_t_oldMethodName)
