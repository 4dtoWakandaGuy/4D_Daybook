If (False:C215)
	//object Name: [INVOICES]dPayment.INV_l_btnPaymentTypeCheque
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES]dPayment.INV_l_btnPaymentTypeCheque"; Form event code:C388)
...
//*************************************************************************************
ERR_MethodTrackerReturn("OBJ [INVOICES]dPayment.INV_l_btnPaymentTypeCheque"; $_t_oldMethodName)
