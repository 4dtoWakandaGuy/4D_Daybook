If (False:C215)
	//Table Form Method Name: [INVOICES]Form_DT2_Header
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [INVOICES].Form_DT2_Header"; Form event code:C388)
$_l_event:=Form event code:C388

Case of 
	: ($_l_event=On Printing Detail:K2:18)
		
		PRT_l_HeaderSize:=320
		PRT_l_MaxSize:=776
...
End case 
Invoices_FormLP
ERR_MethodTrackerReturn("FM [INVOICES].Form_DT2_Header"; $_t_oldMethodName)
