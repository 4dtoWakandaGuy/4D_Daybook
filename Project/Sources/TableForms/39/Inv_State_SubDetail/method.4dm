If (False:C215)
	//Table Form Method Name: [INVOICES]Inv_State_SubDetail
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [INVOICES].Inv_State_SubDetail"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("FM [INVOICES].Inv_State_SubDetail"; $_t_oldMethodName)
