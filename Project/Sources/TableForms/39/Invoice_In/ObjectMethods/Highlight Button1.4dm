If (False:C215)
	//object Name: [INVOICES]Invoices_In.Highlight Button1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].Invoices_In.Highlight Button1"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].Invoices_In.Highlight Button1"; $_t_oldMethodName)
