If (False:C215)
	//object Name: [INVOICES]Invoices_In.Invisible Button7
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].Invoices_In.Invisible Button7"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].Invoices_In.Invisible Button7"; $_t_oldMethodName)
