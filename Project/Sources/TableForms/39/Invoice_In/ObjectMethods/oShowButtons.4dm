If (False:C215)
	//object Name: [INVOICES]Invoices_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:24
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES].Invoices_In.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES].Invoices_In.oShowButtons"; $_t_oldMethodName)
