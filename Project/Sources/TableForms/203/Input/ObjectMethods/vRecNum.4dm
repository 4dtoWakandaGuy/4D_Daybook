If (False:C215)
	//object Name: [ACTIONS_RESULTSLINK]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ACTIONS_RESULTSLINK].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [ACTIONS_RESULTSLINK].Input.vRecNum"; $_t_oldMethodName)
