If (False:C215)
	//object Name: [JOB_STAGES]dJobStages_Sel.Tab Control
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_NAL; $_l_Number1; $_l_Number2; $_l_Number3; $_l_Number4; $_l_Number5; $_l_OK; $_l_QueryMode; $_l_RecordState; $_l_SIS; $_l_TabsWidth)
	...
	C_REAL:C285($_r_DiscountF; $_r_DiscountT; $_r_vValueF; $_r_vValueT; VDiscountF; vDiscountT; VValueF; VvalueT)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB_STAGES].dJobStages_Sel.Tab Control"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [JOB_STAGES].dJobStages_Sel.Tab Control"; $_t_oldMethodName)
