If (False:C215)
	//object Name: [JOB_STAGES]JobStage_in.Highlight Button1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB_STAGES].JobStage_in.Highlight Button1"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [JOB_STAGES].JobStage_in.Highlight Button1"; $_t_oldMethodName)
