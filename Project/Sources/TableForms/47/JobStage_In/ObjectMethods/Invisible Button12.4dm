If (False:C215)
	//object Name: [JOB_STAGES]JobStage_in.Invisible Button12
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB_STAGES].JobStage_in.Invisible Button12"; Form event code:C388)
...
Else 
	...
	RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
End if 
ERR_MethodTrackerReturn("OBJ [JOB_STAGES].JobStage_in.Invisible Button12"; $_t_oldMethodName)
