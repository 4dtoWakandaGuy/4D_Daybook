If (False:C215)
	//object Name: [JOB_STAGES]JobStage_in.Invisible Button11
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB_STAGES].JobStage_in.Invisible Button11"; Form event code:C388)
$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ [JOB_STAGES].JobStage_in.Invisible Button11"; $_t_oldMethodName)