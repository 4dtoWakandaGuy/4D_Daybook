If (False:C215)
	//object Name: [SOLUTIONS]Solutions_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 14:09
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SOLUTIONS].Solutions_in.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [SOLUTIONS].Solutions_in.oShowButtons"; $_t_oldMethodName)
