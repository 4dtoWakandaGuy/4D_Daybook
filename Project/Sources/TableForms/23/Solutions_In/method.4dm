If (False:C215)
	//Table Form Method Name: [SOLUTIONS]Solutions_in
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [SOLUTIONS].Solutions_in"; Form event code:C388)
$_l_event:=Form event code:C388

Minor_LP(->[SOLUTIONS:23]Solution_Code:1; ->[SOLUTIONS:23]Solution_Name:2; ->[SOLUTIONS:23]; "Solutions"; "1"; ""; "")

Case of 
	: ($_l_event=On Header:K2:17) | ($_l_event=On Resize:K2:27)
		//WS_AutoscreenSize (2;140;570)
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[SOLUTIONS:23]); "Solutions_in")
		WS_AutoscreenSize(2; 185; 570)
		INT_SetInput(Table:C252(->[SOLUTIONS:23]); WIN_t_CurrentInputForm)
		DB_SetInputFormMenu(Table:C252(->[SOLUTIONS:23]); "Solutions_in")
		If (Records in selection:C76([SOLUTIONS:23])<=1)
...
End case 
ERR_MethodTrackerReturn("FM:Solutions_In"; $_t_oldMethodName)
