If (False:C215)
	//Table Form Method Name: [SOLUTIONS]Solutions_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [SOLUTIONS].Solutions_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[SOLUTIONS:23]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[SOLUTIONS:23]); "Solutions_Out")
		Cache_Initialise
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[SOLUTIONS:23]; ->[SOLUTIONS:23]Solution_Code:1; ->[SOLUTIONS:23]Solution_Name:2; "Solutions"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Solutions"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[SOLUTIONS:23])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:Solutions Out"; $_t_oldMethodName)
