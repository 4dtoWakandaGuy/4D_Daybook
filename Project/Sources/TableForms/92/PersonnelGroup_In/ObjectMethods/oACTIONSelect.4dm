If (False:C215)
	//object Method Name: Object Name:      [PERSONNEL_GROUPS].Groups_In.oACTIONSelect
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 30/10/2012 09:57
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL_GROUPS].Groups_In.oACTIONSelect"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4) | ($_l_event=On Double Clicked:K2:5)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL_GROUPS].Groups_In.oACTIONSelect"; $_t_oldMethodName)
