If (False:C215)
	//object Name: [PERSONNEL_GROUPS]Groups_In.Invisible Button5
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL_GROUPS].Groups_In.Invisible Button5"; Form event code:C388)
$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ [PERSONNEL_GROUPS].Groups_In.Invisible Button5"; $_t_oldMethodName)