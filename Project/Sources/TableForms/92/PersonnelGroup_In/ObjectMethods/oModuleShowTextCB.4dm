If (False:C215)
	//object Name: [PERSONNEL_GROUPS]Groups_In.Variable9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL_GROUPS].Groups_In.Variable9"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End for 
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL_GROUPS].Groups_In.Variable9"; $_t_oldMethodName)
