If (False:C215)
	//object Name: [TRANSACTIONS]dTrans_Sel.oVEDateFUpDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/07/2012 04:49
...
If (True:C214)
	...
	C_LONGINT:C283($_l_event; $_l_offset; $_l_TransactionsInCount; VeDateFupDown)
	C_POINTER:C301($_ptr_Field)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].dTrans_Sel.oVEDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (SRCH_d_EntryDateFrom=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([TRANSACTIONS:29]; [TRANSACTIONS:29]Entry_Date:11<SRCH_d_EntryDateFrom; *)
				QUERY:C277([TRANSACTIONS:29];  & ; [TRANSACTIONS:29]Entry_Date:11#!00-00-00!)
