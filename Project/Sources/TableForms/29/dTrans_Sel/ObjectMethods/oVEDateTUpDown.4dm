If (False:C215)
	//object Name: [TRANSACTIONS]dTrans_Sel.oVEDateTUpDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/07/2012 19:27
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].dTrans_Sel.oVEDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].dTrans_Sel.oVEDateTUpDown"; $_t_oldMethodName)
