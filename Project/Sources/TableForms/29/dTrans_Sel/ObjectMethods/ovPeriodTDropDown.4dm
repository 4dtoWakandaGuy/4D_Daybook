If (False:C215)
	//object Name: [TRANSACTIONS]dTrans_Sel.ovPeriodTDropDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/08/2012 11:08
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].dTrans_Sel.ovPeriodTDropDown"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].dTrans_Sel.ovPeriodTDropDown"; $_t_oldMethodName)
