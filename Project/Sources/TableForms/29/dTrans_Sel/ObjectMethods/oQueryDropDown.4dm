If (False:C215)
	//object Name: [TRANSACTIONS]dTrans_Sel.oQueryDropDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 29/07/2012 08:19
...
If (True:C214)
	...
	C_LONGINT:C283(<>PER_l_CurrentUserID; $_l_event; $_l_offset; $_l_TransBatchTable; ACC_l_EntryDateFromOffset; ACC_l_EntryDateToOffset; ACC_l_PeriodFromOffset; ACC_l_PeriodToOffset; ACC_l_TransDateFromOffset; ACC_l_TransDateToOffset; CH0)
	C_LONGINT:C283(CH1; Ch2; cNAA; cNAL; cSIS; R1; R2; SM_l_QueryMode; SM_l_ReturnQueryID; VNo1; VNo2)
	C_REAL:C285(VamountF; VamountT)
	C_TEXT:C284($_t_ContextName; $_t_oldMethodName; $_t_SearchName; ACC_t_PeriodFrom; ACC_t_PeriodTo; TR_t_ReconcilliationReference; Vlayer; VText)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].dTrans_Sel.oQueryDropDown"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		If (SM_at_SearchNames>0)
			Case of 
				...
				: (SM_al_SearchIDs{SM_at_SearchNames}<0)  //Resave
					...
					SM_SearchVarsToBlob(->SM_blb_SearchBlob; ->VNo1; ->VNo2; ->Vlayer; ->VamountF; ->VamountT; ->VText; ->VDoDateF; ->VDoDateT; ->SRCH_d_EntryDateFrom; ->SRCH_d_EntryDateTo; ->VTDateF; ->R1; ->R2; ->CH0; ->CH1; ->Ch2; ->SRCH_d_TransToDate; ->cSIS; ->cNAA; ->cNAL; ->TR_t_ReconcilliationReference; ->ACC_l_PeriodFromOffset; ->ACC_l_PeriodToOffset; ->ACC_l_EntryDateFromOffset; ->ACC_l_TransDateFromOffset; ->ACC_l_EntryDateToOffset; ->ACC_l_TransDateToOffset)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].dTrans_Sel.oQueryDropDown"; $_t_oldMethodName)
