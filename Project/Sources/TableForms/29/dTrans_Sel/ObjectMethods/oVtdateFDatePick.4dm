If (False:C215)
	//object Name: [TRANSACTIONS]dTrans_Sel.oVtdateFDatePick
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].dTrans_Sel.oVtdateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].dTrans_Sel.oVtdateFDatePick"; $_t_oldMethodName)
