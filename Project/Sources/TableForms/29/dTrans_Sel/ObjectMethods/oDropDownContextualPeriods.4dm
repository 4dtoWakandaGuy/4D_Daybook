If (False:C215)
	//object Name: [TRANSACTIONS]dTrans_Sel.oDropDownContextualPeriods
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].dTrans_Sel.oDropDownContextualPeriods"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].dTrans_Sel.oDropDownContextualPeriods"; $_t_oldMethodName)
