If (False:C215)
	//object Name: [SF_LOGIN_USERS]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SF_LOGIN_USERS].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [SF_LOGIN_USERS].Input.vRecNum"; $_t_oldMethodName)
