...
If (False:C215)
	//Object Name:      [TYPES].types_in.oDefaultHomeAddress
	//------------------ Script Notes ------------------
...
Case of 
	: (Form event code:C388=On Clicked:K2:4)
		...
		If ($_obj_types.length>0)
			...
			CONFIRM:C162($_obj_types[0].Type_Name+" is already designated as the default home address type. Do you wish to change it to "+[TYPES:5]Type_Name:2+"?"; "No"; "Yes")
			If (OK=0)
				...
				End case 
				OB SET:C1220([TYPES:5]TypeAttributes:9; "addresstypedefault"; 2)
