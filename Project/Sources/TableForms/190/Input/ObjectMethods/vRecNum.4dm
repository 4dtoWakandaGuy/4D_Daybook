If (False:C215)
	//object Name: [CALCULATED DATA]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [WASBUILT_CODE_FORMAT_SECTION].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [WASBUILT_CODE_FORMAT_SECTION].Input.vRecNum"; $_t_oldMethodName)
