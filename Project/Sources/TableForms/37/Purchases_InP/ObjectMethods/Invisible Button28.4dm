If (False:C215)
	//object Name: [PURCHASE_INVOICES]Purchases_inP.Invisible Button28
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].Purchases_inP.Invisible Button28"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].Purchases_inP.Invisible Button28"; $_t_oldMethodName)
