If (False:C215)
	//object Name: [PURCHASE_INVOICES]Purchases_inP.Invisible Button22
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].Purchases_inP.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].Purchases_inP.Invisible Button22"; $_t_oldMethodName)
