If (False:C215)
	//object Name: [PURCHASE_INVOICES]dask_Purchases.Variable10
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dask_Purchases.Variable10"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dask_Purchases.Variable10"; $_t_oldMethodName)
