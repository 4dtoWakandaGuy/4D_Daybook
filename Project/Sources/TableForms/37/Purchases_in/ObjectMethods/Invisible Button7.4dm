If (False:C215)
	//object Name: [PURCHASE_INVOICES]Purchases_in.Invisible Button7
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].Purchases_in.Invisible Button7"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].Purchases_in.Invisible Button7"; $_t_oldMethodName)
