If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oInvoiceDateTContextual
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 28/07/2012 13:16
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateTContextual"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateTContextual"; $_t_oldMethodName)
