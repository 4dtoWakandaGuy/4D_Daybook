If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oDueDateFDatePick
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oDueDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oDueDateFDatePick"; $_t_oldMethodName)
