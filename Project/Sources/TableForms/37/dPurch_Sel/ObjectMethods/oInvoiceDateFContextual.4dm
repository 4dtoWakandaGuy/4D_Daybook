If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oInvoiceDateFContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateFContextual"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateFContextual"; $_t_oldMethodName)
