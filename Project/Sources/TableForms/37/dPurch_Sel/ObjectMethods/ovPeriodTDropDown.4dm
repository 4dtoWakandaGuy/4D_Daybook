If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.ovPeriodTDropDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/08/2012 11:07
...
If (True:C214)
	...
	C_BOOLEAN:C305(ACC_bo_PopUpInitedFrom; ACC_bo_PopupInitedTo)
	C_LONGINT:C283($_l_event; $_l_NumberofPeriods; $_l_offset; ACC_l_PeriodToOffset)
	C_TEXT:C284($_t_oldMethodName; ACC_t_PeriodTo)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.ovPeriodTDropDown"; Form event code:C388)

$_l_event:=Form event code:C388
Case of 
	: ($_l_event=On Clicked:K2:4)
		If (Not:C34(ACC_bo_PopupInitedTo))
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.ovPeriodTDropDown"; $_t_oldMethodName)
