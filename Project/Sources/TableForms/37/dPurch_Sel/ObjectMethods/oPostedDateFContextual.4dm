If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oPostedDateFContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oPostedDateFContextual"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oPostedDateFContextual"; $_t_oldMethodName)
