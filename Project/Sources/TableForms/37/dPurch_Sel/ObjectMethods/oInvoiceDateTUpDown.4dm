If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oInvoiceDateTUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateTUpDown"; $_t_oldMethodName)
