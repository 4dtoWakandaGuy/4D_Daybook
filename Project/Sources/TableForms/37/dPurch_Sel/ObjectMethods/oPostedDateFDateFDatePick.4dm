If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oPostedDateFDateFDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/08/2012 13:20
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oPostedDateFDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oPostedDateFDateFDatePick"; $_t_oldMethodName)
