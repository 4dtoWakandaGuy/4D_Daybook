If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oDueDateFContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oDueDateFContextual"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oDueDateFContextual"; $_t_oldMethodName)
