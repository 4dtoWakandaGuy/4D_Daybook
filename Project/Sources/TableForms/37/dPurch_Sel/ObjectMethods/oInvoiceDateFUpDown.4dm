If (False:C215)
	//object Name: [PURCHASE_INVOICES]dPurch Sel.oInvoiceDateFUpDown
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_event; $_l_offset; $_l_PurchaseInvoiceCount; vIDateFupDown)
	C_POINTER:C301($_ptr_Field)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (vIDateF=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([PURCHASE_INVOICES:37]; [PURCHASE_INVOICES:37]Invoice_Date:5<vIDateF; *)
				QUERY:C277([PURCHASE_INVOICES:37];  & ; [PURCHASE_INVOICES:37]Invoice_Date:5#!00-00-00!)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PURCHASE_INVOICES].dPurch Sel.oInvoiceDateFUpDown"; $_t_oldMethodName)
