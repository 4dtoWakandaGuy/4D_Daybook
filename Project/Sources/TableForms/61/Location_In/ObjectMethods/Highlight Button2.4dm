If (False:C215)
	//object Name: [LOCATIONS]Location_In.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [LOCATIONS].Location_In.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [LOCATIONS].Location_In.Highlight Button2"; $_t_oldMethodName)
