If (False:C215)
	//object Name: [LOCATIONS]Location_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:35
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [LOCATIONS].Location_In.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [LOCATIONS].Location_In.oShowButtons"; $_t_oldMethodName)
