If (False:C215)
	//object Name: [LOCATIONS]Location_In.Invisible Button22
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 02/10/2010 11:52
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [LOCATIONS].Location_In.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [LOCATIONS].Location_In.Invisible Button22"; $_t_oldMethodName)
