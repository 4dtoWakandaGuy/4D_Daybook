If (False:C215)
	//Table Form Method Name: [SUBSCRIPTIONS]Subscript_sub
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [SUBSCRIPTIONS].Subscript_sub"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[SUBSCRIPTIONS:93]); "Subscript_sub")
		...
		vProblem:="Issue"
End case 
ERR_MethodTrackerReturn("FM [SUBSCRIPTIONS].Subscript_sub"; $_t_oldMethodName)
