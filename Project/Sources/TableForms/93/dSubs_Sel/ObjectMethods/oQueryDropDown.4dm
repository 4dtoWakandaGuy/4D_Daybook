If (False:C215)
	//object Name: [SUBSCRIPTIONS]dSubs Sel.oQueryDropDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/07/2012 16:38
...
If (True:C214)
	...
	C_LONGINT:C283(<>PER_l_CurrentUserID; $_l_event; $_l_OrdersTable; cNAA; cNAL; cSetAdd; cSetMod; cSIS; SM_l_QueryMode; SM_l_ReturnQueryID)
	...
	C_TEXT:C284(VCompName; VcontCode; vEnclosures; vEvent; VForename; vLayer; VorderCode; vOrderNo; vProdCode; VSales; Vsource)
	C_TEXT:C284(VSurname; vTele)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [SUBSCRIPTIONS].dSubs Sel.oQueryDropDown"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [SUBSCRIPTIONS].dSubs Sel.oQueryDropDown"; $_t_oldMethodName)
