If (False:C215)
	//object Name: [JOB_TYPES]types_in.Invisible Button8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB_TYPES].types_in.Invisible Button8"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [JOB_TYPES].types_in.Invisible Button8"; $_t_oldMethodName)
