If (False:C215)
	//object Name: [JOB_TYPES]types_in.oShowButtons
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisJtypes)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB_TYPES].types_in.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisJtypes; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
...
End case 
ERR_MethodTrackerReturn("OBJ [JOB_TYPES].types_in.oShowButtons"; $_t_oldMethodName)
