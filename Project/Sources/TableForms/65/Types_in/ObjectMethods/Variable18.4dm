If (False:C215)
	//object Name: [JOB_TYPES]types_in.Variable18
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB_TYPES].types_in.Variable18"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [JOB_TYPES].types_in.Variable18"; $_t_oldMethodName)
