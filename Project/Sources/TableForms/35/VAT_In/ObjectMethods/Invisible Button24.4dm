If (False:C215)
	//object Name: [TAX_CODES]Vat_in.Invisible Button24
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 05/10/2010 13:51
...
If (True:C214)
	...
	C_POINTER:C301($_Ptr_PopUpNumber; $_t_PalletButtonName)
	C_TEXT:C284($_t_oldMethodName; $_t_PopupMenu; $_t_ProcessName; PAL_BUTTON)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [TAX_CODES].Vat_in.Invisible Button24"; Form event code:C388)
$_t_PalletButtonName:=Self:C308
RESOLVE POINTER:C394($_t_PalletButtonName; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
...
End case 
ERR_MethodTrackerReturn("OBJ [TAX_CODES].Vat_in.Invisible Button24"; $_t_oldMethodName)
