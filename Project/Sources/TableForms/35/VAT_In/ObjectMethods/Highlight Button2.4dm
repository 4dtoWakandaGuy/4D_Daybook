If (False:C215)
	//object Name: [TAX_CODES]Vat_in.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TAX_CODES].Vat_in.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TAX_CODES].Vat_in.Highlight Button2"; $_t_oldMethodName)
