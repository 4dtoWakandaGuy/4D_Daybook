If (False:C215)
	//object Name: [TAX_CODES]Vat_in.Invisible Button6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TAX_CODES].Vat_in.Invisible Button6"; Form event code:C388)
...
Else 
	...
	RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
End if 
ERR_MethodTrackerReturn("OBJ [TAX_CODES].Vat_in.Invisible Button6"; $_t_oldMethodName)
