If (False:C215)
	//object Name: [TAX_CODES]Vat_in.Invisible Button28
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TAX_CODES].Vat_in.Invisible Button28"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TAX_CODES].Vat_in.Invisible Button28"; $_t_oldMethodName)
