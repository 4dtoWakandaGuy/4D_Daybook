If (False:C215)
	//object Name: [LIST_LAYOUTS]ALL_FIELDS.bDelete
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [LIST_LAYOUTS].ALL_FIELDS.bDelete"; Form event code:C388)
$_l_RecordsinSelection:=Records in set:C195("UserSet")
...
Else 
	...
	Else 
		CONFIRM:C162("Do you really want to delete these "+String:C10($_l_RecordsinSelection)+" record?")
	End if 
	If (OK=1)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [LIST_LAYOUTS].ALL_FIELDS.bDelete"; $_t_oldMethodName)
