If (False:C215)
	//Table Form Method Name: [ACTIONS]Actions_Out
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 30/08/2013 14:00
...
$_t_oldMethodName:=ERR_MethodTracker("FM [ACTIONS].Actions_Out"; Form event code:C388)
$_l_event:=Form event code:C388

Case of 
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ACTIONS:13]); "Actions_Out")
		Cache_Initialise
	...
	: ($_l_event=On Header:K2:17)
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[ACTIONS:13]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[ACTIONS:13]; ->[ACTIONS:13]Action_Code:1; ->[ACTIONS:13]Action_Name:2; "Actions"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_DelEx"; ""; "Actions"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[ACTIONS:13])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:Actions_Out"; $_t_oldMethodName)
