If (False:C215)
	//object Name: [SYS_ManualSequences]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SYS_ManualSequences].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [SYS_ManualSequences].Input.vRecNum"; $_t_oldMethodName)
