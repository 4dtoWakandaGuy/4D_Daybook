If (False:C215)
	//object Name: [SF_COMMS]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SF_COMMS].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [SF_COMMS].Input.vRecNum"; $_t_oldMethodName)
