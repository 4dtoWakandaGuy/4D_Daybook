If (False:C215)
	//Table Form Method Name: [RESULTS]Results_in
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [RESULTS].Results_in"; Form event code:C388)
$_l_event:=Form event code:C388
Minor_LP_Ex(->[RESULTS:14]Result_Code:1; ->[RESULTS:14]Result_Name:2; ->[RESULTS:14]Export:4; ->[RESULTS:14]; "Results"; "1"; "")

Case of 
	: ($_l_event=On Header:K2:17) | ($_l_event=On Resize:K2:27)
		WS_AutoscreenSize(2; 210; 585)
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[RESULTS:14]); "Results_in")
		WS_AutoscreenSize(2; 210; 585)
		INT_SetInput(Table:C252(->[RESULTS:14]); WIN_t_CurrentInputForm)
		DB_SetInputFormMenu(Table:C252(->[RESULTS:14]); "Results_in")
...
End case 
ERR_MethodTrackerReturn("FM:Results_In"; $_t_oldMethodName)
