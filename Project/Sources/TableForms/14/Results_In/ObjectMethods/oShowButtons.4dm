If (False:C215)
	//object Name: [RESULTS]Results_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 14:06
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [RESULTS].Results_in.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [RESULTS].Results_in.oShowButtons"; $_t_oldMethodName)
