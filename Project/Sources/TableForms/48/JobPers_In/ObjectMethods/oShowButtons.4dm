If (False:C215)
	//object Name: [JOB PERSONNEL]JobPers_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:28
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisJPers)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [JOB PERSONNEL].JobPers_in.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisJPers; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
...
End case 
ERR_MethodTrackerReturn("OBJ [JOB PERSONNEL].JobPers_in.oShowButtons"; $_t_oldMethodName)
