If (False:C215)
	//Table Form Method Name: [JOB PERSONNEL]JobPers_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [JOB PERSONNEL].JobPers_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[JOB PERSONNEL:48]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[JOB PERSONNEL:48]); "JobPers_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[JOB PERSONNEL:48]; ->[USER:15]Name:38; ->[USER:15]Name:38; "JobPers"; ""; "JobPers_Sel"; "Minor_Del"; ""; "Job Personnel"; "JobPers_OutCoun"; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[JOB PERSONNEL:48])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM [JOB PERSONNEL].JobPers_Out"; $_t_oldMethodName)
