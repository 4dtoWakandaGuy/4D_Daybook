If (False:C215)
	//object Name: [COMPANIES]WS_TOOLBAR.oBarButton9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].WS_TOOLBAR.oBarButton9"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].WS_TOOLBAR.oBarButton9"; $_t_oldMethodName)
