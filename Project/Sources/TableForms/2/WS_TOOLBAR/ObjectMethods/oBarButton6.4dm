If (False:C215)
	//object Name: [COMPANIES]WS_TOOLBAR.oBarButton6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].WS_TOOLBAR.oBarButton6"; Form event code:C388)
$_l_event:=Form event code:C388
Case of 
	: ($_l_event=On Clicked:K2:4)
		$_ptr_Button:=Self:C308
		RESOLVE POINTER:C394($_ptr_Button; BAR_t_Button; $_l_TableNumber; $_l_FieldNumber)
...
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].WS_TOOLBAR.oBarButton6"; $_t_oldMethodName)
