If (False:C215)
	//object Name: [COMPANIES]dAsk_StartImp.Invisible Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dAsk_StartImp.Invisible Button2"; Form event code:C388)
...
Else 
	...
	RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dAsk_StartImp.Invisible Button2"; $_t_oldMethodName)
