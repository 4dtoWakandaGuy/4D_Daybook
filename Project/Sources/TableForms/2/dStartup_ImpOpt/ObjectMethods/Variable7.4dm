If (False:C215)
	//object Name: [COMPANIES]dStartup_ImpOpt.Variable7
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dStartup_ImpOpt.Variable7"; Form event code:C388)
SET CHANNEL:C77(10; "")
If (OK=1)
	...
	SET CHANNEL:C77(11)
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dStartup_ImpOpt.Variable7"; $_t_oldMethodName)
