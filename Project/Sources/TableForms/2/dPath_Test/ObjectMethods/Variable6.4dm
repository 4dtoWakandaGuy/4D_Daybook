If (False:C215)
	//object Name: [COMPANIES]dPath_Test.Variable6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dPath_Test.Variable6"; Form event code:C388)
...
Else 
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dPath_Test.Variable6"; $_t_oldMethodName)
