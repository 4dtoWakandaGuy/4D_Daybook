If (False:C215)
	//object Name: [COMPANIES]WS_Buttons.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].WS_Buttons.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].WS_Buttons.Highlight Button2"; $_t_oldMethodName)
