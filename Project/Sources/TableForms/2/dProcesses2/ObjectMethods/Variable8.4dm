If (False:C215)
	//object Name: [COMPANIES]dProcesses2.Variable8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dProcesses2.Variable8"; Form event code:C388)
If (Size of array:C274(PRC_al_ProcessNum)>0)
	...
	Else 
		Process_GenAll("Awaken"; 0)
	End if 
	
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dProcesses2.Variable8"; $_t_oldMethodName)
