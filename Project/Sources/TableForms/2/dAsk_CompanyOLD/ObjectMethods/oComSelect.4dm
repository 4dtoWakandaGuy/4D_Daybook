If (False:C215)
	//object Name: [COMPANIES]dAsk_CompanyOLD.oComSelect
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dAsk_CompanyOLD.oComSelect"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4) | ($_l_event=On Double Clicked:K2:5)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dAsk_CompanyOLD.oComSelect"; $_t_oldMethodName)
