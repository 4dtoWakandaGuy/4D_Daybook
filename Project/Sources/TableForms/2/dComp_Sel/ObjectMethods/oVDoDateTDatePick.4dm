If (False:C215)
	//object Name: [COMPANIES]dComp_Sel.oVDoDateTDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 15/07/2012 20:33
...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Customise; DB_bo_NoLoad; SRCH_bo_vDoDateToSet)
	C_DATE:C307(vDate; vDoDateF; vDoDateT)
	C_TEXT:C284($_t_FormName; $_t_ObjectName; $_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dComp_Sel.oVDoDateTDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dComp_Sel.oVDoDateTDatePick"; $_t_oldMethodName)
