If (False:C215)
	//object Name: [COMPANIES]dComp_Sel.oVsDateFUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dComp_Sel.oVsDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (VsdateF=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([COMPANIES:2]; [COMPANIES:2]Modified_Date:32<VsdateF; *)
				QUERY:C277([COMPANIES:2];  & ; [COMPANIES:2]Modified_Date:32#!00-00-00!)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dComp_Sel.oVsDateFUpDown"; $_t_oldMethodName)
