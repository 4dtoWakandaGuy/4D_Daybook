If (False:C215)
	//object Name: [COMPANIES]dComp_Sel.oVEDateFUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dComp_Sel.oVEDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (ACC_d_EntryDateFrom=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([COMPANIES:2]; [COMPANIES:2]Entry_Date:16<ACC_d_EntryDateFrom; *)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dComp_Sel.oVEDateFUpDown"; $_t_oldMethodName)
