If (False:C215)
	//object Name: [COMPANIES]dComp_Sel.oCustomFieldsQuery
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/07/2012 05:02
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dComp_Sel.oCustomFieldsQuery"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Data Change:K2:15)
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dComp_Sel.oCustomFieldsQuery"; $_t_oldMethodName)
