If (False:C215)
	//object Name: [COMPANIES]dComp_Sel.oVEDateFDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/08/2012 11:38
...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Customize; DB_bo_NoLoad)
	C_DATE:C307(vDate)
	C_TEXT:C284($_t_ObjectName; $_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dComp_Sel.oVEDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dComp_Sel.oVEDateFDatePick"; $_t_oldMethodName)
