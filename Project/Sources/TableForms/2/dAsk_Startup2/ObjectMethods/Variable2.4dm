If (False:C215)
	//object Name: [COMPANIES]dAsk_Startup2.Variable2
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_DATE:C307(SRCH_d_EntryDateFrom; vDate)
	C_LONGINT:C283($_l_PeriodID; ch1; ch2; ch3; s1; s2)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dAsk_Startup2.Variable2"; Form event code:C388)
vDate:=SRCH_d_EntryDateFrom
...
Else 
	[USER:15]Year PeriodF:22:=[PERIODS:33]Period_Code:1
	...
	Startup_Page2ch
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dAsk_Startup2.Variable2"; $_t_oldMethodName)
