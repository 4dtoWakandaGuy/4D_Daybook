If (False:C215)
	//object Name: [COMPANIES]dAsk_NewComp.Variable9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dAsk_NewComp.Variable9"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dAsk_NewComp.Variable9"; $_t_oldMethodName)
