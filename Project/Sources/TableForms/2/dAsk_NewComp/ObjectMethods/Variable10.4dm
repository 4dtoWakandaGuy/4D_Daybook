If (False:C215)
	//object Name: [COMPANIES]dAsk_NewComp.Variable10
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vCompName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dAsk_NewComp.Variable10"; Form event code:C388)
...
Case of 
	: ($_l_event=On Data Change:K2:15)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dAsk_NewComp.Variable10"; $_t_oldMethodName)
