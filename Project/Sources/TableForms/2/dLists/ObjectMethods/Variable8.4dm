If (False:C215)
	//object Name: [COMPANIES]dLists.Variable8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dLists.Variable8"; Form event code:C388)
If (GEN_at_Name>1)
...
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dLists.Variable8"; $_t_oldMethodName)
