If (False:C215)
	//object Name: [COMPANIES]dLists.Variable9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dLists.Variable9"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dLists.Variable9"; $_t_oldMethodName)
