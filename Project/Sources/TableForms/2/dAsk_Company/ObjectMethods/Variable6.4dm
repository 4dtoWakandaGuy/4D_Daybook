If (False:C215)
	//object Name: [COMPANIES]dAsk_Company.Variable6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dAsk_Company.Variable6"; Form event code:C388)
If ((ch2=0) & (ch1=0))
	ch1:=1
End if 
...
ERR_MethodTrackerReturn("OBJ [COMPANIES].dAsk_Company.Variable6"; $_t_oldMethodName)