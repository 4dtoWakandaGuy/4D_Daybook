If (False:C215)
	//object Name: [COMPANIES]dAsk_Company.Variable12
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].dAsk_Company.Variable12"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].dAsk_Company.Variable12"; $_t_oldMethodName)
