If (False:C215)
	//object Name: [COMPANIES]Company_In.Invisible Button3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.Invisible Button3"; Form event code:C388)
If (User in group:C338(Current user:C182; "Administrator"))
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].Company_In.Invisible Button3"; $_t_oldMethodName)
