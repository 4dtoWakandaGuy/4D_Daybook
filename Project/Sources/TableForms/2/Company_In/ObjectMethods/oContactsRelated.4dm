If (False:C215)
	//object Name: [COMPANIES]Company_In.oContactsRelated
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_FormUsage3; $_t_oldMethodName; $_t_VariableName; CON_t_ContactCode; CON_t_CurrentFocus; DB_t_CurrentFormUsage3; vT)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.oContactsRelated"; Form event code:C388)
...
Case of 
	...
	Else 
		...
		//***********ends**********************************
End case 
ERR_MethodTrackerReturn("OBJ [COMPANIES].Company_In.oContactsRelated"; $_t_oldMethodName)
