If (False:C215)
	//object Name: [COMPANIES]Company_In.Variable29
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; COM_t_County; COM_t_PostalCode)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.Variable29"; Form event code:C388)
//SCRIPT : COM_t_County
//FORM Company_In
				...
				If ($_l_AddressTypesRow>0)
					...
					Case of 
						...
						: (CO_at_AddressTypes{$_l_AddressTypesRow}="Invoice Address")
							...
							Companies_InLPD
							COM_t_County:=[COMPANIES:2]Invoice_County:21
						Else 
			...
			: (CUR_l_SelectedAddressTypeRow<0)
				...
				Else 
					...
					If ($_l_AddressRow<0)
						...
						CO_at_County{Size of array:C274(CO_at_County)}:=COM_t_County
...
End case 
ERR_MethodTrackerReturn("OBJ:Company_In,COM_t_County"; $_t_oldMethodName)
