If (False:C215)
	//object Name: [COMPANIES]Company_In.oChangeCompany
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.oChangeCompany"; Form event code:C388)
If (<>PER_l_AccessLevel<2)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].Company_In.oChangeCompany"; $_t_oldMethodName)
