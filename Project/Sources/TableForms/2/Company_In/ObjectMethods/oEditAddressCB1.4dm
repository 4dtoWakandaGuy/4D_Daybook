If (False:C215)
	//object Name: [COMPANIES]Company_In.Check Box1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.Check Box1"; Form event code:C388)
//WT: 10/12/00
...
ERR_MethodTrackerReturn("OBJ [COMPANIES].Company_In.Check Box1"; $_t_oldMethodName)
