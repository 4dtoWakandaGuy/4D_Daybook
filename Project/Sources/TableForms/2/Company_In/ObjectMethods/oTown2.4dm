If (False:C215)
	//object Name: [COMPANIES]Company_In.Variable36
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; COM_t_County; COM_t_Town)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.Variable36"; Form event code:C388)
//SCRIPT : COM_t_Town
...
Case of 
	: ($_l_event=On Data Change:K2:15)
				...
				If ($_l_AddressTypesRow>0)
					...
					Case of 
						...
						: (CO_at_AddressTypes{$_l_AddressTypesRow}="Invoice Address")
							...
							Companies_InLPD
							COM_t_Town:=[COMPANIES:2]Invoice_Town:20
						Else 
			...
			: (CUR_l_SelectedAddressTypeRow<0)
				...
				Else 
					...
					If ($_l_AddressRow<0)
						...
						CO_at_Town{Size of array:C274(CO_at_Town)}:=COM_t_Town
		...
		GOTO OBJECT:C206(COM_t_County)
End case 
ERR_MethodTrackerReturn("OBJ:Company_In,COM_t_Town"; $_t_oldMethodName)
