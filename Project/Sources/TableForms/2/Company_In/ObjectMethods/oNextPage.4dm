If (False:C215)
	//object Name: [COMPANIES]Company_In.Variable1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.Variable1"; Form event code:C388)
If (COM_at_CompanyTab<Size of array:C274(COM_at_CompanyTab))
