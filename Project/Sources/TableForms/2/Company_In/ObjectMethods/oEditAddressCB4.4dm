If (False:C215)
	//object Name: [COMPANIES]Company_In.Check Box5
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [COMPANIES].Company_In.Check Box5"; Form event code:C388)
//WT: 10/12/00
If (False:C215)
...
End if 
ERR_MethodTrackerReturn("OBJ [COMPANIES].Company_In.Check Box5"; $_t_oldMethodName)
