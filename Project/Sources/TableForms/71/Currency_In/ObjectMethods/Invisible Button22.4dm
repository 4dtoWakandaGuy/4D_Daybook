If (False:C215)
	//object Name: [CURRENCIES]Currency_In.Invisible Button22
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 15/10/2010 09:08
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CURRENCIES].Currency_In.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [CURRENCIES].Currency_In.Invisible Button22"; $_t_oldMethodName)
