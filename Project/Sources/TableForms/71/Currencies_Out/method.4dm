If (False:C215)
	//Table Form Method Name: [CURRENCIES]Currencies_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [CURRENCIES].Currencies_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[CURRENCIES:71]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[CURRENCIES:71]); "Currencies_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
		SD2_SetDiaryPopup
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[CURRENCIES:71]; ->[CURRENCIES:71]Currency_Code:1; ->[CURRENCIES:71]Currency_Name:2; "Currencies"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Currencies"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[CURRENCIES:71])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		SD2_SetDiaryPopup
End case 
ERR_MethodTrackerReturn("FM:Currencies_Out"; $_t_oldMethodName)
