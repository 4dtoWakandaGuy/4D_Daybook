If (False:C215)
	//Table Form Method Name: [ANALYSES]Analyses_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [ANALYSES].Analyses_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[ANALYSES:36]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ANALYSES:36]); "Analyses_Out")
		Cache_Initialise
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[ANALYSES:36]; ->[ANALYSES:36]Analysis_Code:1; ->[ANALYSES:36]Analysis_Name:2; "Analyses"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Analyses"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[ANALYSES:36])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:Analyses_Out"; $_t_oldMethodName)
