If (False:C215)
	//object Name: [POSTAL_CODES]PostalCode_In.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [POSTAL_CODES].PostalCode_In.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [POSTAL_CODES].PostalCode_In.Variable71"; $_t_oldMethodName)
