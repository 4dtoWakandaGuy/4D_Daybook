If (False:C215)
	//object Name: [POSTAL_CODES]PostalCode_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:49
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisPC)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [POSTAL_CODES].PostalCode_In.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisPC; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
...
End case 
ERR_MethodTrackerReturn("OBJ [POSTAL_CODES].PostalCode_In.oShowButtons"; $_t_oldMethodName)
