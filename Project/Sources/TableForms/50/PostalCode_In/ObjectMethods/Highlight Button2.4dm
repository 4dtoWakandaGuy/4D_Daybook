If (False:C215)
	//object Name: [POSTAL_CODES]PostalCode_In.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [POSTAL_CODES].PostalCode_In.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [POSTAL_CODES].PostalCode_In.Highlight Button2"; $_t_oldMethodName)
