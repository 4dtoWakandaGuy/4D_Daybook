If (False:C215)
	//Table Form Method Name: [SOURCES]Sources_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [SOURCES].Sources_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[SOURCES:6]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[SOURCES:6]); "Sources_Out")
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[SOURCES:6]; ->[SOURCES:6]Source_Code:1; ->[SOURCES:6]Source_Name:2; "Sources"; "Sources_In"; "Minor_Sel"; "Minor_DelExCU"; "Master"; "Sources"; "Sources_OutCoun"; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[SOURCES:6])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM [SOURCES].Sources_Out"; $_t_oldMethodName)
