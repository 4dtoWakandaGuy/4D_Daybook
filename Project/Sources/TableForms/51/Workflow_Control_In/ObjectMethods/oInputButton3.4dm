If (False:C215)
	//object Name: [WORKFLOW_CONTROL]Workflow_Control_In.Invisible Button6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [WORKFLOW_CONTROL].Workflow_Control_In.Invisible Button6"; Form event code:C388)
...
Else 
	...
	RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
End if 
ERR_MethodTrackerReturn("OBJ [WORKFLOW_CONTROL].Workflow_Control_In.Invisible Button6"; $_t_oldMethodName)
