If (False:C215)
	//object Name: [STOCK_MOVEMENT_ITEMS]Stock_in.oCoButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STOCK_MOVEMENT_ITEMS].Stock_in.oCoButton"; Form event code:C388)
...
If ([STOCK_MOVEMENTS:40]Company_From:2#"")
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [STOCK_MOVEMENT_ITEMS].Stock_in.oCoButton"; $_t_oldMethodName)
