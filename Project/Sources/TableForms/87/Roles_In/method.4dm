If (False:C215)
	//Table Form Method Name: [ROLES]Roles_In
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("FM [ROLES]Roles_In"; Form event code:C388)

$_l_event:=Form event code:C388

Minor_LP(->[ROLES:87]Role_Code:1; ->[ROLES:87]Role_Name:2; ->[ROLES:87]; "Roles"; "1"; ""; "")

Case of 
	: ($_l_event=On Header:K2:17) | ($_l_event=On Resize:K2:27)
		WS_AutoscreenSize(2; 182; 570)
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ROLES:87]); "Roles_In")
		WS_AutoscreenSize(2; 182; 570)
		INT_SetInput(Table:C252(->[ROLES:87]); WIN_t_CurrentInputForm)
		DB_SetInputFormMenu(Table:C252(->[ROLES:87]); "Roles_In")
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End case 
End case 
ERR_MethodTrackerReturn("FM:Roles_In"; $_t_oldMethodName)
