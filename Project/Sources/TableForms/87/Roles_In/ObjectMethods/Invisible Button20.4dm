If (False:C215)
	//object Name: [ROLES]Roles_In.Invisible Button20
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 05/10/2010 10:31
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ROLES].Roles_In.Invisible Button20"; Form event code:C388)
$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ [ROLES].Roles_In.Invisible Button20"; $_t_oldMethodName)
