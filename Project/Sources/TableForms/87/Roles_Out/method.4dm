If (False:C215)
	//Table Form Method Name: [ROLES]Roles_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [ROLES].Roles_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[ROLES:87]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ROLES:87]); "Roles_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[ROLES:87]; ->[ROLES:87]Role_Code:1; ->[ROLES:87]Role_Name:2; "Roles"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Roles"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[ROLES:87])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:Roles Out"; $_t_oldMethodName)
