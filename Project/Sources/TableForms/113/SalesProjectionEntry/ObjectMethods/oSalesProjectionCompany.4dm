If (False:C215)
	//object Name: [SALES_PROJECTION]SalesProjectionEntry.Variable5
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 10/09/2009 13:49
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SALES_PROJECTION].SalesProjectionEntry.Variable5"; Form event code:C388)
...
Case of 
	: ($_l_event=On Data Change:K2:15)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [SALES_PROJECTION].SalesProjectionEntry.Variable5"; $_t_oldMethodName)
