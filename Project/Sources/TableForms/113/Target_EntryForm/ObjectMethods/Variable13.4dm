If (False:C215)
	//object Name: [SALES_PROJECTION]Target_EntryForm.Variable13
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SALES_PROJECTION].Target_EntryForm.Variable13"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [SALES_PROJECTION].Target_EntryForm.Variable13"; $_t_oldMethodName)
