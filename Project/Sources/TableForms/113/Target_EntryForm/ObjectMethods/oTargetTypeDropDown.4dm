If (False:C215)
	//object Name: [SALES_PROJECTION]Target_EntryForm.Pop-up%2FDrop-down List2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SALES_PROJECTION].Target_EntryForm.Pop-up/Drop-down List2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [SALES_PROJECTION].Target_EntryForm.Pop-up/Drop-down List2"; $_t_oldMethodName)
