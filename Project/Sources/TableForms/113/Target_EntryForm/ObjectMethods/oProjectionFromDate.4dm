If (False:C215)
	//object Name: [SALES_PROJECTION]Target_EntryForm.Field1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SALES_PROJECTION].Target_EntryForm.Field1"; Form event code:C388)
...
Case of 
	: ($_l_event=On Data Change:K2:15)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [SALES_PROJECTION].Target_EntryForm.Field1"; $_t_oldMethodName)
