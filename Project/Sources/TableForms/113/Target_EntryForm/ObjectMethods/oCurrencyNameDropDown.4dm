If (False:C215)
	//object Name: [SALES_PROJECTION]Target_EntryForm.Variable9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SALES_PROJECTION].Target_EntryForm.Variable9"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [SALES_PROJECTION].Target_EntryForm.Variable9"; $_t_oldMethodName)