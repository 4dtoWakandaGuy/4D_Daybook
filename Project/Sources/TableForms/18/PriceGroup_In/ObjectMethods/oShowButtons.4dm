If (False:C215)
	//object Name: [PRICE_GROUPS]PriceGroup_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:50
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRICE_GROUPS].PriceGroup_In.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRICE_GROUPS].PriceGroup_In.oShowButtons"; $_t_oldMethodName)
