If (False:C215)
	//object Name: [PRICE_GROUPS]PriceGroup_In.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRICE_GROUPS].PriceGroup_In.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRICE_GROUPS].PriceGroup_In.Variable71"; $_t_oldMethodName)
