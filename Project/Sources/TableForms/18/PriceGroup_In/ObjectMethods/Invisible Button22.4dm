If (False:C215)
	//object Name: [PRICE_GROUPS]PriceGroup_In.Invisible Button22
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 04/10/2010 19:27
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRICE_GROUPS].PriceGroup_In.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRICE_GROUPS].PriceGroup_In.Invisible Button22"; $_t_oldMethodName)
