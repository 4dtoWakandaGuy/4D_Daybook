If (False:C215)
	//object Name: [PERSONNEL]Diary_View.oLetterButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.oLetterButton"; Form event code:C388)
...
Case of 
	...
	Else 
		...
		// End if
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.oLetterButton"; $_t_oldMethodName)
