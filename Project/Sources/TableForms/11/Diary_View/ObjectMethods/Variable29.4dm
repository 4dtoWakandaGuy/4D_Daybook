If (False:C215)
	//object Name: [PERSONNEL]Diary_View.Variable29
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.Variable29"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		SD_HL_Sort(1)
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.Variable29"; $_t_oldMethodName)
