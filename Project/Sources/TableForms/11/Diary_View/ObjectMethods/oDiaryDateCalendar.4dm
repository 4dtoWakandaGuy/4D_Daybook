If (False:C215)
	//object Method Name: Object Name:      [PERSONNEL].Diary_View.oDiaryDateCalendar
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.oDiaryDateCalendar"; Form event code:C388)
//◊SuperDiary
...
If (Not:C34(Is nil pointer:C315(SD_ptr_Date2)))
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.oDiaryDateCalendar"; $_t_oldMethodName)
