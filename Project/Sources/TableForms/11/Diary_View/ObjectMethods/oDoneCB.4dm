If (False:C215)
	//object Name: [PERSONNEL]Diary_View.oDoneCB
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.oDoneCB"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.oDoneCB"; $_t_oldMethodName)
