If (False:C215)
	//object Name: [PERSONNEL]Diary_View.Check Box1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.Check Box1"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.Check Box1"; $_t_oldMethodName)
