If (False:C215)
	//object Name: [PERSONNEL]Diary_View.Invisible Button4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.Invisible Button4"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.Invisible Button4"; $_t_oldMethodName)
