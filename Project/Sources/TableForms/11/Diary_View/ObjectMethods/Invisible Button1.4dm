If (False:C215)
	//object Name: [PERSONNEL]Diary_View.Invisible Button1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.Invisible Button1"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		SD_HL_Sort(3)
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.Invisible Button1"; $_t_oldMethodName)
