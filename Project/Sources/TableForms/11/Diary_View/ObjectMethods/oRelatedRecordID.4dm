If (False:C215)
	//object Name: [PERSONNEL]Diary_View.oRelatedRecordID
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.oRelatedRecordID"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.oRelatedRecordID"; $_t_oldMethodName)
