...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.Pop-up/Drop-down List1"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.Pop-up/Drop-down List1"; $_t_oldMethodName)
