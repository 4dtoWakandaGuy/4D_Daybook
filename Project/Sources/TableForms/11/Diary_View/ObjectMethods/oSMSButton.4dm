If (False:C215)
	//object Name: [PERSONNEL]Diary_View.oSMSButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.oSMSButton"; Form event code:C388)
...
If ($_bo_Proceed)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.oSMSButton"; $_t_oldMethodName)
