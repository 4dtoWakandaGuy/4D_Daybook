If (False:C215)
	//object Name: [PERSONNEL]Diary_View.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.Highlight Button2"; Form event code:C388)
//◊SuperDiary
...
SD_DiaryViewCalc
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.Highlight Button2"; $_t_oldMethodName)
