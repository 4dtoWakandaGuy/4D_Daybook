If (False:C215)
	//object Name: [PERSONNEL]Diary_View.oDiaryTimeSettingDropDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.oDiaryTimeSettingDropDown"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.oDiaryTimeSettingDropDown"; $_t_oldMethodName)
