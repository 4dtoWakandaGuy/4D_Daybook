If (False:C215)
	//object Name: [PERSONNEL]Diary_View.vSD_SelDateRIGHT
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.vSD_SelDateRIGHT"; Form event code:C388)
...
SD_DiaryViewCalc
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.vSD_SelDateRIGHT"; $_t_oldMethodName)
