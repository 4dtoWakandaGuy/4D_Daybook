If (False:C215)
	//object Name: [PERSONNEL]Diary_View.oActionNamesDropDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/10/2012 13:17
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_View.oActionNamesDropDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_View.oActionNamesDropDown"; $_t_oldMethodName)
