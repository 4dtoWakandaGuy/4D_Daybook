If (False:C215)
	//object Method Name:      SD2_lb_Actions
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Personnel_In.oACTIONSelect"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4) | ($_l_event=On Double Clicked:K2:5)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Personnel_In.oACTIONSelect"; $_t_oldMethodName)
