If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.oStartSliderP1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.oStartSliderP1"; Form event code:C388)
$_l_event:=Form event code:C388
Case of 
	: ($_l_event=On Data Change:K2:15) | ($_l_event=On Clicked:K2:4)
		SD_l_AgendaStartTime:=SD_l_StartSlider
End case 
...
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.oStartSliderP1"; $_t_oldMethodName)
