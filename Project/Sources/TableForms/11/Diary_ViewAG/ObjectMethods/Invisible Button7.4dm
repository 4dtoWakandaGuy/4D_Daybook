If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.Invisible Button7
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.Invisible Button7"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		SD_HL_Sort(2)
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.Invisible Button7"; $_t_oldMethodName)
