If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.ovSD_SelDateLEFT
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.ovSD_SelDateLEFT"; Form event code:C388)
...
SD_DiaryViewCalc
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.ovSD_SelDateLEFT"; $_t_oldMethodName)
