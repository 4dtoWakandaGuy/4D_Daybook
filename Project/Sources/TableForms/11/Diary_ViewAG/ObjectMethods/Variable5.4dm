If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.Variable5
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.Variable5"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.Variable5"; $_t_oldMethodName)
