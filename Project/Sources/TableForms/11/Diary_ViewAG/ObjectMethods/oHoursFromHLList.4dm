If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.oHoursFromHLList
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.oHoursFromHLList"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.oHoursFromHLList"; $_t_oldMethodName)