If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.oDiaryTimeSettingDropDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.oDiaryTimeSettingDropDown"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.oDiaryTimeSettingDropDown"; $_t_oldMethodName)
