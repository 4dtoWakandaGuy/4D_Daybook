If (False:C215)
	//object Method Name: Object Name:      [PERSONNEL].Diary_ViewAG.Check Box3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.Check Box3"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.Check Box3"; $_t_oldMethodName)
