If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.Invisible Button4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.Invisible Button4"; Form event code:C388)
$_l_event:=Form event code:C388
Case of 
	: ($_l_event=On Clicked:K2:4)
		Case of 
			: (SD_CurrentFormObject=1)
				If (SD_at_Events<Size of array:C274(SD_at_Events))
			...
			: (SD_CurrentFormObject=2)
				...
				If ($_l_SelectedListItem<Count list items:C380(SD_l_HLDayTime))
			...
			: (SD_CurrentFormObject=3)
				If (SD_at_ToDoList<Size of array:C274(SD_at_ToDoList))
...
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.Invisible Button4"; $_t_oldMethodName)
