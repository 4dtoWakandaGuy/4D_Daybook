If (False:C215)
	//object Method Name: Object Name:      [PERSONNEL].Diary_ViewAG.oDiaryDateFromCalendar
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>FloatingCalender; $_l_CalendarProcess; $_l_DetailsBottom; $_l_DetailsLeft; $_l_DetailsRight; $_l_DetailsTop; $_l_Margin; $_l_ObJWidth; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.oDiaryDateFromCalendar"; Form event code:C388)
//◊SuperDiary
...
If (Not:C34(Is nil pointer:C315(SD_ptr_Date1)))
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.oDiaryDateFromCalendar"; $_t_oldMethodName)
