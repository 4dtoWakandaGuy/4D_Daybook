If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.oEmailButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.oEmailButton"; Form event code:C388)
...
Case of 
	...
	Else 
		...
		Diary_EmailNew
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.oEmailButton"; $_t_oldMethodName)
