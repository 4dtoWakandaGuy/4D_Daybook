If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.Variable16
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.Variable16"; Form event code:C388)
//◊SuperDiary
...
End if 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.Variable16"; $_t_oldMethodName)
