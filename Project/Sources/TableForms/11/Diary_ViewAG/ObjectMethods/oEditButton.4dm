If (False:C215)
	//object Name: [PERSONNEL]Diary_ViewAG.oEditButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PERSONNEL].Diary_ViewAG.oEditButton"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PERSONNEL].Diary_ViewAG.oEditButton"; $_t_oldMethodName)
