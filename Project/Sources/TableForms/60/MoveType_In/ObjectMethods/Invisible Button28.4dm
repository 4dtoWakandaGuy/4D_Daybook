If (False:C215)
	//object Name: [MOVEMENT_TYPES]MoveType_in.Invisible Button28
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [MOVEMENT_TYPES].MoveType_in.Invisible Button28"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [MOVEMENT_TYPES].MoveType_in.Invisible Button28"; $_t_oldMethodName)
