If (False:C215)
	//object Name: [MOVEMENT_TYPES]MoveType_in.Invisible Button22
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 03/10/2010 15:40
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [MOVEMENT_TYPES].MoveType_in.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [MOVEMENT_TYPES].MoveType_in.Invisible Button22"; $_t_oldMethodName)
