If (False:C215)
	//object Name: [MOVEMENT_TYPES]MoveType_in.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [MOVEMENT_TYPES].MoveType_in.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [MOVEMENT_TYPES].MoveType_in.Highlight Button2"; $_t_oldMethodName)
