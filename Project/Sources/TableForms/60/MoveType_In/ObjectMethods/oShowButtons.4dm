If (False:C215)
	//object Name: [MOVEMENT_TYPES]MoveType_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:38
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [MOVEMENT_TYPES].MoveType_in.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [MOVEMENT_TYPES].MoveType_in.oShowButtons"; $_t_oldMethodName)
