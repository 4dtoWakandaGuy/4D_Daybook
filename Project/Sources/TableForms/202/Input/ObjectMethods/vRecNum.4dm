If (False:C215)
	//object Name: [ACTIONS_MACROS]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ACTIONS_MACROS].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [ACTIONS_MACROS].Input.vRecNum"; $_t_oldMethodName)
