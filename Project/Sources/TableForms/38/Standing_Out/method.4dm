If (False:C215)
	//Table Form Method Name: [RECURRING_JOURNALS]Standing_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [RECURRING_JOURNALS].Standing_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[RECURRING_JOURNALS:38]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Display Detail:K2:22)
		...
		vDateF:=TRANS_GetNextJournalDate
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[RECURRING_JOURNALS:38]); "Standing_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[RECURRING_JOURNALS:38]; ->[RECURRING_JOURNALS:38]Transaction_Type_Code:2; ->[RECURRING_JOURNALS:38]Company_Code:1; "Standing"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; "Master"; "Recurring Journals"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[RECURRING_JOURNALS:38])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM:Standing Out"; $_t_oldMethodName)
