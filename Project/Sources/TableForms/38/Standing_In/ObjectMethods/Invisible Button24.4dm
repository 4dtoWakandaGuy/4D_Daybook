If (False:C215)
	//object Name: [RECURRING_JOURNALS]Standing_In.Invisible Button24
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [RECURRING_JOURNALS].Standing_In.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [RECURRING_JOURNALS].Standing_In.Invisible Button24"; $_t_oldMethodName)
