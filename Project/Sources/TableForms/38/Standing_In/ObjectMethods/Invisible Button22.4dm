If (False:C215)
	//object Name: [RECURRING_JOURNALS]Standing_In.Invisible Button22
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [RECURRING_JOURNALS].Standing_In.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [RECURRING_JOURNALS].Standing_In.Invisible Button22"; $_t_oldMethodName)
