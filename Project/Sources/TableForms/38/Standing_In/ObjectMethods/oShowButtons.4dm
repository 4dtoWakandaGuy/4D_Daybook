If (False:C215)
	//object Name: [RECURRING_JOURNALS]Standing_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 14:05
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [RECURRING_JOURNALS].Standing_In.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisSJ; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
	: ($_l_event=On Mouse Leave:K2:34)
		//DB_HideFloatingButtons
End case 
ERR_MethodTrackerReturn("OBJ [RECURRING_JOURNALS].Standing_In.oShowButtons"; $_t_oldMethodName)
