If (False:C215)
	//object Name: [PUBLICATIONS]Public_in.Invisible Button24
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 04/10/2010 19:55
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PUBLICATIONS].Public_in.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PUBLICATIONS].Public_in.Invisible Button24"; $_t_oldMethodName)
