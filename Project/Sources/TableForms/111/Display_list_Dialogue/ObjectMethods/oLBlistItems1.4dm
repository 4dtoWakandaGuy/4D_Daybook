If (False:C215)
	//object Method Name: Object Name:      [X_LISTS].Display_list_Dialogue.oLBlistItems1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 29/10/2012 18:58
...
If (True:C214)
	...
	C_LONGINT:C283($_l_Event; $_l_Index; $_l_ItemID; $_l_PropertiesCount; $_l_PropertyIDRow; $_l_PropertyTypeRow; $_l_Row; $_l_SubListID; $_l_SubListRow; AA_l_CurrentItemID; AA_l_CurrentSelectedItemID)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [X_LISTS].Display_list_Dialogue.oLBlistItems1"; Form event code:C388)
				...
				For ($_l_Index; 1; Size of array:C274(AA_at_ListItemPropertyTypes))
					If (AA_al_ListPropTypesID{$_l_Index}>0)
						...
						If ($_l_PropertyIDRow>0)
							...
							$_l_SubListRow:=Find in array:C230(AA_al_2DItemAttributesLIstID{$_l_Row}; $_l_SubListID)
							If ($_l_SubListRow<0)
								//no value set=thats ok
								AA_at_ListItemvalue{$_l_Index}:="Not Set"
							Else 
								AA_al_ListItemvalue{$_l_Index}:=AA_al_2DItemAttributes{$_l_Row}{$_l_SubListRow}
								AA_at_ListItemvalue{$_l_Index}:=AA_at_2DItemAttributes{$_l_Row}{$_l_SubListRow}
							End if 
						Else 
							//there is a problem
...
End case 
ERR_MethodTrackerReturn("OBJ [X_LISTS].Display_list_Dialogue.oLBlistItems1"; $_t_oldMethodName)
