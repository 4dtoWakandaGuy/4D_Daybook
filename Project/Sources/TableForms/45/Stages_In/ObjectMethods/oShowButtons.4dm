If (False:C215)
	//object Name: [STAGES]Stages_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 14:10
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STAGES].Stages_in.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [STAGES].Stages_in.oShowButtons"; $_t_oldMethodName)
