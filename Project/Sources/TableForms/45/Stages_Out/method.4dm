If (False:C215)
	//Table Form Method Name: [STAGES]Stages_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [STAGES].Stages_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[STAGES:45]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[STAGES:45]); "Stages_Out")
		Cache_Initialise
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[STAGES:45]; ->[STAGES:45]Stage_Code:1; ->[STAGES:45]Stage_Name:2; "Stages"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Stages"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[STAGES:45])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM:Stages Out"; $_t_oldMethodName)
