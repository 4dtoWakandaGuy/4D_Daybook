If (False:C215)
	//Table Form Method Name: Object Name:      [PRODUCTS].Products_SimplifiedEntry
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [PRODUCTS].Products_SimplifiedEntry"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		WS_AutoscreenSize(2; 224; 584; Table name:C256(->[PRODUCTS:9])+"_"+"Products_SimplifiedEntry")
		...
		ARRAY LONGINT:C221(PRD_al_ProductsTabPage; 3)
		PRD_at_ProductsTab{1}:="Products"
		PRD_al_ProductsTabPage{1}:=4
		PRD_at_ProductsTab{2}:="Enclosures"
		PRD_al_ProductsTabPage{2}:=4
...
Products_simpleentryLP
ERR_MethodTrackerReturn("FM [PRODUCTS].Products_SimplifiedEntry"; $_t_oldMethodName)
