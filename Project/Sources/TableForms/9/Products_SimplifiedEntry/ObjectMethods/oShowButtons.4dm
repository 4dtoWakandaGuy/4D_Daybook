If (False:C215)
	//object Name: [PRODUCTS]Products_SimplifiedEntry.oShowButtons
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_SimplifiedEntry.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_SimplifiedEntry.oShowButtons"; $_t_oldMethodName)
