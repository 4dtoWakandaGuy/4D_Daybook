If (False:C215)
	//object Name: [PRODUCTS]Products_inCAT.Variable19
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_inCAT.Variable19"; Form event code:C388)

$_bo_Switch:=True:C214

$_bo_Update:=(PROD_al_EditMode{PROD_r_ModeSupplier}=3)
...
End if 
ERR_MethodTrackerReturn("OBJ:Products_inCAT,PROD_S11_ModeSupplier"; $_t_oldMethodName)
