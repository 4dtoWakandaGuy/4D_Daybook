If (False:C215)
	//object Name: [PRODUCTS]Products_inCAT.Variable34
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_inCAT.Variable34"; Form event code:C388)
$_l_event:=Form event code:C388
Case of 
	: ($_l_event=On Data Change:K2:15)
		QUERY:C277([CURRENCIES:71]; [CURRENCIES:71]Currency_Code:1=PROD_t_Currency)
		Case of 
			: (Records in selection:C76([CURRENCIES:71])>0)
			...
			Else 
				//no currency found!!
				Gen_Alert("This currency cannot be found")
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_inCAT.Variable34"; $_t_oldMethodName)
