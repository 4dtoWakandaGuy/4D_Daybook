If (False:C215)
	//object Name: [PRODUCTS]Products_inCAT.oFurl
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_inCAT.oFurl"; Form event code:C388)
...
Case of 
	...
	Else 
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_inCAT.oFurl"; $_t_oldMethodName)
