If (False:C215)
	//object Name: [PRODUCTS]Products_inCAT.Variable23
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CatalogueCount; $_l_CatalogueRow; $_l_Clash; $_l_ConventionRow; $_l_DestinationROw; $_l_ImageIndex; $_l_ImageNameRow; $_l_NamingRow; $_l_SourceIndex; CAT_l_PageNumber; CAT_l_PictureSource)
	C_LONGINT:C283(CAT_l_SaveSettings; WIN_l_CurrentWinRef; WIN_l_CurrentWinRefOLD)
	C_PICTURE:C286(PRD_Pic_Graphic)
	C_TEXT:C284($_t_CatalogueName; $_t_CurrentImageName; $_t_ExpectedImageName; $_t_NameWithoutExtension; $_t_oldMethodName; $_t_PictureCode; $_t_SaveImageName; CAT_t_PictureNaming; CAT_T_PicturePath; DB_t_CurrentFormUsage)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_inCAT.Variable23"; Form event code:C388)
...
//End if
//End if
ERR_MethodTrackerReturn("OBJ:Products_inCAT,BaddGraphic"; $_t_oldMethodName)