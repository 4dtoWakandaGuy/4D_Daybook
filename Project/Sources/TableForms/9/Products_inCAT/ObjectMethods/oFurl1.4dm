If (False:C215)
	//object Name: [PRODUCTS]Products_inCAT.oFurl1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_inCAT.oFurl1"; Form event code:C388)
...
Case of 
	...
	Else 
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_inCAT.oFurl1"; $_t_oldMethodName)
