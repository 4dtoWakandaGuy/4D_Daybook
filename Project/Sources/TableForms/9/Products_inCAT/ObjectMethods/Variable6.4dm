If (False:C215)
	//object Name: [PRODUCTS]Products_inCAT.Variable6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_inCAT.Variable6"; Form event code:C388)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_inCAT.Variable6"; $_t_oldMethodName)
