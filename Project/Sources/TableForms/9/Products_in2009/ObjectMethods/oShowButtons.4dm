If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:58
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisPro; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
	: ($_l_event=On Mouse Leave:K2:34)
		//DB_HideFloatingButtons
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.oShowButtons"; $_t_oldMethodName)
