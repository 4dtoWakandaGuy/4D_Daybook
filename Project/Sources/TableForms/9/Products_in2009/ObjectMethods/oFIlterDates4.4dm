If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.oFIlterDates4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.oFIlterDates4"; Form event code:C388)
...
If (PRD_at_FilterDates2>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.oFIlterDates4"; $_t_oldMethodName)
