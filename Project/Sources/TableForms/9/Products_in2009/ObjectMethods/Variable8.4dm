If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.Variable8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.Variable8"; Form event code:C388)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.Variable8"; $_t_oldMethodName)
