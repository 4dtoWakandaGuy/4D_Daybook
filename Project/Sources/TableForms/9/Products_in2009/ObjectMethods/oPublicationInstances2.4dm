If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.oPublicationInstances2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.oPublicationInstances2"; Form event code:C388)
...
Case of 
	: ($_l_event=On Double Clicked:K2:5)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.oPublicationInstances2"; $_t_oldMethodName)
