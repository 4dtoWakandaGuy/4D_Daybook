If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.oIterationsEveryType
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.oIterationsEveryType"; Form event code:C388)
Case of 
...
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.oIterationsEveryType"; $_t_oldMethodName)