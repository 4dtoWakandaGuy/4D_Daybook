If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.oPublicationInstances1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.oPublicationInstances1"; Form event code:C388)
$_l_event:=Form event code:C388

Case of 
	: ($_l_event=On Double Clicked:K2:5)
		
		LISTBOX GET CELL POSITION:C971(PRD_lb_PublicationDates2; $_l_Column; $_l_Row)
		If ($_l_Row>0)
			COPY NAMED SELECTION:C331([DIARY:12]; "CURRENTSELECTION")
			LISTBOX SELECT ROW:C912(PRD_lb_PublicationDates2; $_l_Row)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.oPublicationInstances1"; $_t_oldMethodName)
