If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.oSubComponents
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ColumnNumber; $_l_DateIndex; $_l_event; $_l_FieldNumber; $_l_Retries; $_l_Row; $_l_TableNumber; $_l_UniqueRow; $_l_Year; $_l_Year2; PRD_al_CodeFormatID)
	C_LONGINT:C283(PROD_l_ComponentCheck; PROD_l_ComponentResult; PROD_l_curComponentsQTY)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.oSubComponents"; Form event code:C388)
$_l_event:=Form event code:C388
LISTBOX GET CELL POSITION:C971(PROD_lb_SubsComponents; $_l_ColumnNumber; $_l_Row)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		If ($_l_ColumnNumber=1) | ($_l_ColumnNumber=3)
			LB_GoToCell(->PROD_lb_SubsComponents; $_l_ColumnNumber; $_l_Row)
		Else 
			LISTBOX SELECT ROW:C912(PROD_lb_SubsComponents; $_l_Row; 0)
		End if 
	...
	: ($_l_event=On Data Change:K2:15)
		...
		$_l_Row:=Self:C308->
		$_l_ColumnNumber:=LB_GetColumn(->PROD_lb_SubsComponents; $_t_VariableName)
		Case of 
					...
					: ([PRODUCTS:9]x_Product_Entry_Class:55=2)
						...
						Case of 
							...
							: (PROD_l_ComponentResult=-2)
								...
								LB_GoToCell(->PROD_lb_SubsComponents; 1; $_l_Row)
						End case 
						
						
						Products_InMod
					: ([PRODUCTS:9]x_Product_Entry_Class:55=4)  //Subscription Products-allow selection from Time based iteration Products
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.oSubComponents"; $_t_oldMethodName)
