If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.Variable36
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.Variable36"; Form event code:C388)
...
Else 
	...
	[PRODUCTS:9]x_Supplier_Update_Option:47:=$_l_Setting ?+ PROD_at_SupplierOption
End if 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.Variable36"; $_t_oldMethodName)
