If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.Invisible Button7
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 13/04/2011 19:04
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STOCK_MOVEMENTS].Movements_in.Invisible Button7"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [STOCK_MOVEMENTS].Movements_in.Invisible Button7"; $_t_oldMethodName)
