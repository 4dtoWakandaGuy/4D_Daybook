If (False:C215)
	//object Name: [PRODUCTS]Products_in2009.Variable34
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_in2009.Variable34"; Form event code:C388)
...
Case of 
	: ($_l_event=On Data Change:K2:15)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_in2009.Variable34"; $_t_oldMethodName)
