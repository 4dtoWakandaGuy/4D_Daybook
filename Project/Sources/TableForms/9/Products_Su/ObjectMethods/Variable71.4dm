If (False:C215)
	//object Name: [PRODUCTS]Products_SU.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_SU.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_SU.Variable71"; $_t_oldMethodName)
