If (False:C215)
	//object Name: [PRODUCTS]Products_SU.oShowButtons
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_SU.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_SU.oShowButtons"; $_t_oldMethodName)
