If (False:C215)
	//object Name: [PRODUCTS]dProd_Sel.oLastModifiedTUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].dProd_Sel.oLastModifiedTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].dProd_Sel.oLastModifiedTUpDown"; $_t_oldMethodName)
