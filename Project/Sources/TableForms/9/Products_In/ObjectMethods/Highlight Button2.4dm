If (False:C215)
	//object Name: [PRODUCTS]Products_In.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_In.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_In.Highlight Button2"; $_t_oldMethodName)
