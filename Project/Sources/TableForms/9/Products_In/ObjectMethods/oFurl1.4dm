If (False:C215)
	//object Name: [PRODUCTS]Products_In.oFurl1
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ColumnNumber; $_l_ComponentRow; $_l_event; $_l_FieldNumber; $_l_Retries; $_l_Row; $_l_TableNumber; PROD_l_ComponentCheck; PROD_l_ComponentResult; PROD_l_curComponentsQTY)
	C_REAL:C285($_r_Quantity)
	C_TEXT:C284($_t_ComponentsUnique; $_t_oldMethodName; $_t_ProductCode; $_t_VariableName; PROD_t_CurComponentsCode; PROD_t_curComponentsNM; PROD_t_ParentProductCode; PROD_t_ProductCode; PROD_t_RetProductCode; PROD_t_RetProductName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_In.oFurl1"; Form event code:C388)
...
Case of 
	...
	Else 
					...
					: ($_l_ColumnNumber=1)  // Component code
						...
						Case of 
							: (PROD_l_ComponentResult=1)
								...
								$_t_ComponentsUnique:=BLD_FIXEDLENGTH(25; [PRODUCTS:9]Product_Code:1; PROD_t_RetProductCode)
								
								$_l_ComponentRow:=Find in array:C230(PROD_at_ComponentUnique; $_t_ComponentsUnique)
								//this is to stop you adding the same component twice!
								If ($_l_ComponentRow>0)
									If ($_l_ComponentRow#$_l_Row)
								...
								PROD_at_ComponentUnique{$_l_Row}:=$_t_ComponentsUnique
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_In.oFurl1"; $_t_oldMethodName)
