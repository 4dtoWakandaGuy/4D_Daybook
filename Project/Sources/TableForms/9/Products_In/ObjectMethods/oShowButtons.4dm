If (False:C215)
	//object Name: [PRODUCTS]Products_In.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:53
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_In.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_In.oShowButtons"; $_t_oldMethodName)
