If (False:C215)
	//object Name: [PRODUCTS]Products_In.Variable35
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCTS].Products_In.Variable35"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCTS].Products_In.Variable35"; $_t_oldMethodName)
