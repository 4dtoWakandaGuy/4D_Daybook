If (False:C215)
	//Table Form Method Name: [PRODUCTS]Products_OutCAT
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>PER_l_CurrentUserID; $_l_event; FS_l_SortDirection; FS_l_SortFieldNUM; FS_l_SortTableNUM; PROD_l_SettingsCalled; PROD_l_SortFieldWas; PROD_l_SortOrderWas; PROD_l_SortTableWas; SIZ_l_Minimized; SIZ_l_OLDBottom)
...
$_t_oldMethodName:=ERR_MethodTracker("FM [PRODUCTS].Products_OutCAT"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[PRODUCTS:9]); "Products_OutCAT")
...
End case 
ERR_MethodTrackerReturn("FM:Products_OutCAT"; $_t_oldMethodName)
