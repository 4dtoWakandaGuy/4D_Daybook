If (False:C215)
	//object Name: [SYS_LISTS]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SYS_LISTS].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [SYS_LISTS].Input.vRecNum"; $_t_oldMethodName)
