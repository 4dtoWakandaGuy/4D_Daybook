If (False:C215)
	//Table Form Method Name: [SCRIPTS]Scripts_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [SCRIPTS].Scripts_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[SCRIPTS:80]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[SCRIPTS:80]); "Scripts_Out")
		Cache_Initialise
		//FSetting_SetLabel (WIN_t_CurrentOutputform)
	: ($_l_event=On Activate:K2:9)  // | (vFromIn))
		...
		vButtDisO:="O              DT"
		Out_Buttons
		DB_MenuAction("Find"; "Paste Current Macro"; 3; "")
		
		
		
		//  DISABLE MENU ITEM(2049;1)
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[SCRIPTS:80]; ->[SCRIPTS:80]Script_Code:1; ->[SCRIPTS:80]Script_Name:2; "Macros"; "DB_MenuNewRecord"; "Macros_Sel"; "Minor_Del"; ""; "Macros"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[SCRIPTS:80])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		vButtDisO:="O              DT"
		Out_Buttons
		DISABLE MENU ITEM:C150(2050; 1)
End case 
ERR_MethodTrackerReturn("FM:Macros Out"; $_t_oldMethodName)
