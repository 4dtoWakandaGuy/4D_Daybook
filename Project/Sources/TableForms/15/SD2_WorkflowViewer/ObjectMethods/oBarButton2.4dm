If (False:C215)
	//object Name: [USER]SD2_WorkflowViewer.oBarButton2
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 26/10/2010 10:51
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER]SD2_WorkflowViewer.oBarButton2"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Long Click:K2:37)
		...
		BAR_ButtonMethod($_l_ButtonNumber; ->MOD_al_ModuleBarNum)
		
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_WorkflowViewer.oBarButton2"; $_t_oldMethodName)
