If (False:C215)
	//object Name: [USER]SD2_ScheduleWindow.oSearchvalue
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_ScheduleWindow.oSearchvalue"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_ScheduleWindow.oSearchvalue"; $_t_oldMethodName)
