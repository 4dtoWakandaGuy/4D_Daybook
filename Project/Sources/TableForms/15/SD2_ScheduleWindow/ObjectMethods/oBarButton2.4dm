If (False:C215)
	//object Name: [USER]SD2_ScheduleWindow.oBarButton2
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER]SD2_ScheduleWindow.oBarButton2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_ScheduleWindow.oBarButton2"; $_t_oldMethodName)
