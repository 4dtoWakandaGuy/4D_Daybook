If (False:C215)
	//object Name: [USER]SD2_ScheduleWindow.oSelectCurrentButton
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 26/01/2013 10:00
...
If (True:C214)
	...
	C_DATE:C307(SD2_d_CurrentDate; vDate)
	C_TEXT:C284($_t_FormName; $_t_ObjectName; $_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_ScheduleWindow.oSelectCurrentButton"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_ScheduleWindow.oSelectCurrentButton"; $_t_oldMethodName)
