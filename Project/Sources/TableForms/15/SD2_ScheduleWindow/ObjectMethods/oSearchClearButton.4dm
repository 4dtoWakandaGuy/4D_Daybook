If (False:C215)
	//object Name: [USER]SD2_ScheduleWindow.oSearchClearButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_ScheduleWindow.oSearchClearButton"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [USER].SD2_ScheduleWindow.oSearchClearButton"; $_t_oldMethodName)