If (False:C215)
	//object Method Name: Object Name:      [USER].SD2_ScheduleWindow.oSearchCriteriaButton1
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_CarriageReturn; $_t_FocusRingName; $_t_oldMethodName; $_t_PopupMenu; $_t_SearchButtonName; $_t_SearchCloseName; $_t_SearchCriteriaName; SD2_t_SearchCriteria; SD2_T_SearchValue; SRCH_t_SearchValue)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_ScheduleWindow.oSearchCriteriaButton1"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Alternative Click:K2:36)
		...
		If (SD2_t_SearchCriteria="More Choices")
			...
			//And now open a new window with the search result As per the existing schedule window
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_ScheduleWindow.oSearchCriteriaButton1"; $_t_oldMethodName)
