If (False:C215)
	//object Name: [USER]SD2_ScheduleWindow.oBarButton5
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_ScheduleWindow.oBarButton5"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_ScheduleWindow.oBarButton5"; $_t_oldMethodName)
