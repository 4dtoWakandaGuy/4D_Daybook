If (False:C215)
	//object Name: [USER]PER_EmailAddresses.Variable3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].PER_EmailAddresses.Variable3"; Form event code:C388)
If (USR_bo_Modified)
...
CANCEL:C270
ERR_MethodTrackerReturn("OBJ [USER].PER_EmailAddresses.Variable3"; $_t_oldMethodName)