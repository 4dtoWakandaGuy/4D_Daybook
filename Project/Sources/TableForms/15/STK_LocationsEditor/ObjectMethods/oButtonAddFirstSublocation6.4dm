If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAddFirstSublocation6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFirstSublocation6"; Form event code:C388)
