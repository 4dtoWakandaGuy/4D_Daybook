If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oStockLocationsLevel6
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:19
...
If (True:C214)
	...
	C_POINTER:C301($_ptr_ProductNames; $_ptr_SubLevelAdd; $_ptr_SubLevelAddFurther; $_ptr_SubLevelArrayPointer; $_Ptr_SubLevelCount; $_ptr_SubLevelDelete; $_ptr_SubLevelEdit; $_Ptr_SubLevelLBArea; $_ptr_SubLevelSelect)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel6"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		$_ptr_SubLevelArrayPointer:=$_aptr_ColumnVariables{6}
		...
		//`
		Case of 
			: ($_ptr_SubLevelArrayPointer->{$_l_SelectedRow}#"")  //This location has a sublevel named
				//``
		...
		$_ptr_CurrentLocationSubLevName->:=$_ptr_SubLevelArrayPointer->{$_l_SelectedRow}
		OBJECT SET ENTERABLE:C238(STK_t_CurrentLocation0; True:C214)
		
		//``
		
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel6"; $_t_oldMethodName)
