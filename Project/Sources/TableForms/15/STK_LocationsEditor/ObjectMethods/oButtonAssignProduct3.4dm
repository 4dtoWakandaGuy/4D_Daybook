If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAssignProduct3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAssignProduct3"; Form event code:C388)
