If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oSubLevelInformation1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 20:22
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_event; $_l_FieldNumber; $_l_FillArray; $_l_HeaderLevel; $_l_Index; $_l_NextLevel; $_l_NextLevelHeader; $_l_oBottom; $_l_oLeft; $_l_oRight)
	C_LONGINT:C283($_l_oTop; $_l_ProductID; $_l_ProductPosition; $_l_ProductsCount; $_l_SelectedRow; $_l_SizeofArray; $_l_TableNumber; $_l_ThisLocationID; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight)
	...
	C_POINTER:C301($_ptr_Array9; $_ptr_CurrentLocation; $_ptr_CurrentLocationCode; $_ptr_CurrentLocationCount; $_ptr_CurrentLocationID; $_ptr_CurrentLocationSubLevName; $_ptr_ListBoxArea; $_Ptr_NextAddPrdl; $_Ptr_NextAddSubLevel; $_Ptr_NEXTCurrentLocation; $_Ptr_NEXTCurrentLocationCode)
	...
	C_TEXT:C284($_t_ButtonsName; $_t_CountNextSubLevelsSTR; $_t_Label; $_t_LevelName; $_t_LocationSubdivisionName; $_t_NEXTProdCodeLabelName; $_t_NEXTProdCountLabelName; $_t_NEXTProdNameLabelName; $_t_NextSublevelLabel; $_t_NEXTSubLevelLabelName; $_t_NextSubLevelNamed)
	C_TEXT:C284($_t_NextSubLocationCode; $_t_oldMethodName; $_t_ProdCodeLabelName; $_t_ProdCountLabelName; $_t_ProdNameLabelName; $_t_ProductCode; $_t_SelectedOption; $_t_Singular; $_t_SublevelLabel; $_t_SubLevelLabelName; $_t_SubLocationDefault)
	C_TEXT:C284($_t_VariableName; STK_t_ProductCode)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oSubLevelInformation1"; Form event code:C388)
	...
	: ($_l_event=On Double Clicked:K2:5)
		...
		Case of 
			: ($_t_NextSubLevelNamed#"")  //The location has a sublevel
				...
				ARRAY POINTER:C280($_aptr_ColumnStyles; 0)
				LISTBOX GET ARRAYS:C832($_Ptr_SubLevelLBArea->; $_at_ColumnNames; $_at_HeaderNames; $_aptr_ColumnVariables; $_aptr_HeaderVariables; $_abo_ColumnsVisible; $_aptr_ColumnStyles)
				$_ptr_Array1:=$_aptr_ColumnVariables{1}  // Location Name
				...
				$_ptr_ThisLocationName->:=$_ptr_Array1->{$_l_SelectedRow}
				//````
			...
			Else 
				...
				Case of 
					...
					: (OK=0)  //Sublocation
						...
						//STK_T_CurrentLocation1:=$_ptr_Array1->{$_l_SelectedRow}
						//``
						ARRAY TEXT:C222($_at_ColumnNames; 0)
						ARRAY TEXT:C222($_at_HeaderNames; 0)
						ARRAY POINTER:C280($_aptr_ColumnVariables; 0)
							...
							If ($_t_NextSubLocationCode#"") & (OK=1)
								...
								If (Num:C11($_t_CountNextSubLevelsSTR)>0)
									...
									For ($_l_FillArray; 1; Size of array:C274($_ptr_SubLocationHolds->))
										...
										$_ptr_SubLocationNames->{$_l_FillArray}:=$_ptr_Array1->{$_l_SelectedRow}+","+$_t_singular+" "+String:C10($_l_FillArray)
										STK_l_Subid:=0
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oSubLevelInformation1"; $_t_oldMethodName)
