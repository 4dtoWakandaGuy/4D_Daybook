If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonEditSub9
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 09:14
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_FillArray; $_l_HeaderLevel; $_l_Index; $_l_NextLevel; $_l_NextLevelHeader; $_l_ObjectBottom; $_l_ObjectLeft; $_l_ObjectRight; $_l_ObjectTop; $_l_ProductID)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonEditSub9"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	Case of 
		...
		: ($_t_ProductCode#"Unknown") & ($_t_ProductCode#"")  //Has a product code show the product attachment screen
			...
			OBJECT GET COORDINATES:C663($_ptr_Self->; $_l_ObjectLeft; $_l_ObjectTop; $_l_ObjectRight; $_l_ObjectBottom)
			
			$_t_SelectedOption:=Gen_RequestWithList("Select an option"; ""; "Continue"; "Cancel"; ($_l_WindowLeft+$_l_ObjectRight); ($_l_windowTop+$_l_ObjectTop); "Edit Option"; 0; ""; ""; "Add Additional Product to Location"; "Remove Product from Location")
				...
				Case of 
					...
					: ($_t_SelectedOption="Remove Product from Location")
						...
						Else 
							...
							GET WINDOW RECT:C443($_l_WindowLeft; $_l_windowTop; $_l_WindowRight; $_l_WindowBottom)
							OBJECT GET COORDINATES:C663($_ptr_Self->; $_l_ObjectLeft; $_l_ObjectTop; $_l_ObjectRight; $_l_ObjectBottom)
							$_t_SelectedOption:=Gen_RequestWithList("Select a Product"; ""; "Continue"; "Cancel"; ($_l_WindowLeft+$_l_ObjectRight); ($_l_windowTop+$_l_ObjectTop); "Remove Product"; 0; ""; "STK_at_RelProdCodes")
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonEditSub9"; $_t_oldMethodName)
