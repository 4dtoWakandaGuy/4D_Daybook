If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAssignProduct8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAssignProduct8"; Form event code:C388)
