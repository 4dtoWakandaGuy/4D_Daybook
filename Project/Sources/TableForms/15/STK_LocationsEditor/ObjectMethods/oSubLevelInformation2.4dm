If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oSubLevelInformation2
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_oRight; $_l_oTop; $_l_ProductID; $_l_ProductsCount; $_l_RelatedCodePosition; $_l_SelectedRow; $_l_TableNumber; $_l_ThisLocationID; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight)
	...
	C_TEXT:C284($_t_oldMethodName; $_t_ProdCodeLabelName; $_t_ProdCountLabelName; $_t_ProdNameLabelName; $_t_ProductCode; $_t_SelectedOption; $_t_Singular; $_t_SubLevelLabel; $_t_SubLevelLabelName; $_t_SubLocationDefault; $_t_VariableName)
	C_TEXT:C284($_t_NextSubLevelNamed; $_t_ProductCode; STK_t_ProductCode)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oSubLevelInformation2"; Form event code:C388)
						...
						: ($_t_SelectedOption="Remove Product from Location")
							...
							Else 
								...
								If ($_t_SelectedOption#"") & (OK=1)
									$_l_RelatedCodePosition:=Find in array:C230(STK_at_RelProdCodes; $_t_SelectedOption)
									$_l_ProductID:=$_al_ProductsXID{$_l_RelatedCodePosition}
									READ WRITE:C146([x_ProductLocations:185])
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oSubLevelInformation2"; $_t_oldMethodName)
