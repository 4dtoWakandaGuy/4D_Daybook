If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oSubLevelInformation10
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 09:22
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oSubLevelInformation10"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		$_Ptr_LocationCodesArray:=$_aptr_ColumnVariables{2}
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oSubLevelInformation10"; $_t_oldMethodName)
