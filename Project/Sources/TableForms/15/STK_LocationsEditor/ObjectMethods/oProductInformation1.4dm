If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oProductInformation1
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_POINTER:C301($_Ptr_ProdIDSArray; $_Ptr_ProdNameArray; $_ptr_ProdSelected; $_ptr_ProductAdd; $_ptr_ProductCode; $_ptr_ProductCodes; $_ptr_ProductCount; $_ptr_ProductCounts; $_ptr_ProductDelete; $_ptr_ProductID; $_ptr_ProductList)
	C_POINTER:C301($_ptr_ProductName; $_ptr_ProductNames; $_ptr_SubLevelAdd; $_ptr_SubLevelAddFurther; $_Ptr_SubLevelCount; $_ptr_SubLevelDelete; $_ptr_SubLevelEdit; $_Ptr_SubLevelLBArea; $_ptr_SubLevelSelect; $P3)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oProductInformation1"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		$_Ptr_ProdCodeArray:=Get pointer:C304("STK_al_aProductListID"+String:C10($_l_HeaderLevel))  //Array of Products(IDS) to display in list of products
		...
		$_Ptr_ProdCodeArray:=$_aptr_ColumnVariables{4}  //Pointer to array containing the ids
		
		$_l_SelectedRow:=Self:C308->
		//Column FIVE contains the ID
		$_ptr_ProdSelected->:=$_Ptr_ProdCodeArray->{$_l_SelectedRow}
	...
	: ($_l_event=On Data Change:K2:15)
		...
		$_ptr_ProductList:=Get pointer:C304("STK_lB_Products"+String:C10($_l_HeaderLevel))  //Area showing list of products at this location..only displayed if multiple products at this one location
		$_ptr_ProductCodes:=Get pointer:C304("STK_at_ProductCode"+String:C10($_l_HeaderLevel))  //Array of Products(Codes) to display in list of products
		$_Ptr_ProdIDSArray:=Get pointer:C304("STK_al_aProductListID"+String:C10($_l_HeaderLevel))  //Array of Products(IDS) to display in list of products `
		$_ptr_ProductNames:=Get pointer:C304("STK_at_ProductName"+String:C10($_l_HeaderLevel))  //Array of Products(Names) to display in list of products
		$_ptr_ProductCounts:=Get pointer:C304("STK_ar_ProductCount"+String:C10($_l_HeaderLevel))  //Array of Products( stock count at location) to display in list of products
		...
		$_Ptr_ProdCodeArray:=$_aptr_ColumnVariables_1{4}
			...
			: ($_l_ColumnNumber=1)  //The product code(no other column should be editable
				...
				If (STK_bo_ProductFound)
					...
					If ($_bo_Continue)
						...
						$_Ptr_ProdIDSArray->{$_l_SelectedRow}:=[PRODUCTS:9]X_ID:43
				...
				Else 
					...
					Else 
						...
						$_Ptr_ProdIDSArray->{$_l_SelectedRow}:=0
						$_ptr_ProductCounts->{$_l_SelectedRow}:=0
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oProductInformation1"; $_t_oldMethodName)
