If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oButtonEditSub4
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:06
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonEditSub4"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonEditSub4"; $_t_oldMethodName)
