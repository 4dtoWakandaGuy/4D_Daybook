If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonDeleteSub10
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_POINTER:C301($_ptr_CurrentLocationCode; $_ptr_CurrentLocationCount; $_ptr_CurrentLocationID; $_ptr_CurrentLocationSubLevName; $_Ptr_HeaderLBArea; $_Ptr_LocationCodesArray; $_Ptr_LocationHoldsArray; $_ptr_LocationIDSArray; $_Ptr_LocationNamesArray; $_Ptr_ProdCodeArray; $_Ptr_ProdNameArray)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub10"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	$_t_LocationName:=$_ptr_Array4->{$_l_LocationCodePosition}
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub10"; $_t_oldMethodName)
