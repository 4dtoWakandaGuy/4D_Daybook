If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oAddAnotherroduct2
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 20:38
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct2"; Form event code:C388)
...
If ($_ptr_CurrentLocationID->>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct2"; $_t_oldMethodName)
