If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oSubLevelInformation4
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:03
...
If (True:C214)
	...
	C_TEXT:C284($_t_NextSubLocationCode; $_t_oldMethodName; $_t_ProdCodeLabelName; $_t_ProdCountLabelName; $_t_ProdNameLabelName; $_t_ProductCode; $_t_SelectedOption; $_t_Singular; $_t_SubLevelLabelName; $_t_SubLocationDefault; $_t_NextSubLevelNamed)
	C_TEXT:C284($_t_ProductCode; STK_t_ProductCode)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oSubLevelInformation4"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oSubLevelInformation4"; $_t_oldMethodName)
