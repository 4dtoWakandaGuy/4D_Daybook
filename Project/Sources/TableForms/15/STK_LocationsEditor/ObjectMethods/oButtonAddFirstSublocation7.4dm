If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAddFirstSublocation7
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 08:21
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrenttLevel; $_l_HeaderLevel; $_l_Index; $_l_LocationPosition; SLOC1_l_BUT2; Sloc10_l_BUT2; Sloc2_l_BUT2; Sloc3_l_BUT2; Sloc4_l_BUT2; Sloc5_l_BUT2; Sloc6_l_BUT2)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFirstSublocation7"; Form event code:C388)
//This button is only visible if the location does not have sublocations already.

$_l_CurrenttLevel:=FORM Get current page:C276
$_l_HeaderLevel:=$_l_CurrenttLevel-1
...
$_ptr_SubLevelSelect:=Get pointer:C304("STK_l_SubLevelSelected"+String:C10($_l_CurrenttLevel))
$_ptr_ProdSelected:=Get pointer:C304("STK_l_ProdatlocSelected"+String:C10($_l_CurrenttLevel))
			...
			If ($_t_SubLevelLabel#"") & (OK=1)
				...
				If ($_t_SubLocationCode#"") & (OK=1)
					...
					If (Num:C11($_t_CounSubLevelsSTR)>0)
						...
						$_ptr_Array1:=Get pointer:C304("STK_at_SubLocationNames"+String:C10($_l_CurrenttLevel))
						$_ptr_Array2:=Get pointer:C304("STK_al_SubLocationsIDs"+String:C10($_l_CurrenttLevel))
						$_ptr_Array3:=Get pointer:C304("STK_at_SubLocationCodes"+String:C10($_l_CurrenttLevel))
						$_ptr_Array4:=Get pointer:C304("STK_at_SubLevelLabel"+String:C10($_l_CurrenttLevel))
						$_ptr_Array5:=Get pointer:C304("STK_al_SubCodingPref"+String:C10($_l_CurrenttLevel))
						$_ptr_Array6:=Get pointer:C304("STK_al_SubParentLocation"+String:C10($_l_CurrenttLevel))
						$_ptr_Array7:=Get pointer:C304("STK_abo_SUBRECORDMODIFIED"+String:C10($_l_CurrenttLevel))
						$_ptr_Array8:=Get pointer:C304("STK_at_SubLocProdCode"+String:C10($_l_CurrenttLevel))
						$_ptr_Array9:=Get pointer:C304("STK_at_SubLocProdName"+String:C10($_l_CurrenttLevel))
						$_ptr_Array10:=Get pointer:C304("STK_at_SubLocHolds"+String:C10($_l_CurrenttLevel))
						...
						$_t_ObjectName:="osubloc"+String:C10($_l_CurrenttLevel)
