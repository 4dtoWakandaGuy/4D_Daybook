If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oProductInformation9
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 08:36
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; $_t_ProdCodeLabelName; $_t_ProdCountLabelName; $_t_ProdNameLabelName; $_t_ProductCodeEntered; $_t_SubLevelLabelName; $_t_VariableName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oProductInformation9"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Data Change:K2:15)
		...
		RESOLVE POINTER:C394(Self:C308; $_t_VariableName; $_l_TableNumber; $_l_FieldNumber)
		$_l_SelectedRow:=Self:C308->
		$_l_ColumnNumber:=LB_GetColumn($_ptr_ProductList; $_t_VariableName)
		Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oProductInformation9"; $_t_oldMethodName)
