If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oAddAnotherroduct4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct4"; Form event code:C388)
...
If ($_ptr_CurrentLocationID->>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct4"; $_t_oldMethodName)
