If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oStockLocationsLevel10
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 09:21
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_event; $_l_FieldNumber; $_l_FillCounts; $_l_HeaderLevel; $_l_Index; $_l_SelectedRow; $_l_SIzeofArray; $_l_TableNumber; PLOC0_l_BUT1; PLOC0_l_BUT10)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel10"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel10"; $_t_oldMethodName)
