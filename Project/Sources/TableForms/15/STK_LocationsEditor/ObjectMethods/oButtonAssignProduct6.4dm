If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAssignProduct6
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:20
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAssignProduct6"; Form event code:C388)
