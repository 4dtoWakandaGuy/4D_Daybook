If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonDeleteSub4
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:07
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub4"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	$_l_LocationPosition:=Find in array:C230($_ptr_Array2->; $_ptr_SubLevelSelect->)
	$_t_LocationName:=$_ptr_Array3->{$_l_LocationPosition}
	...
	If (OK=0)
		...
		Else 
			...
			LISTBOX DELETE ROWS:C914($_Ptr_SubLevelLBArea->; $_l_LocationPosition)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub4"; $_t_oldMethodName)
