If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oButtonAddFurtherSub2
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 20:40
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_ElementsPerParent; $_l_HeaderLevel; $_l_Index; $_l_Index2; $_l_LocationElements; $_l_LocationID; $_l_ParentsIndex; $_l_SelectedRow; $_l_SubLocationPosition; STK_l_Subid)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub2"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub2"; $_t_oldMethodName)
