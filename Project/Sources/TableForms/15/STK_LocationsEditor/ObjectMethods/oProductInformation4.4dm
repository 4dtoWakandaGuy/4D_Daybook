If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oProductInformation4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oProductInformation4"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oProductInformation4"; $_t_oldMethodName)
