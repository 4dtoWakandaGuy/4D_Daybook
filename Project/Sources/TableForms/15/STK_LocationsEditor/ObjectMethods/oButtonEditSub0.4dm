If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oButtonEditSub0
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonEditSub0"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonEditSub0"; $_t_oldMethodName)
