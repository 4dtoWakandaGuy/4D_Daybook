If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonEditSub5
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:17
...
If (True:C214)
	...
	C_TEXT:C284($_t_ButtonsName; $_t_CountNextSubLevelsSTR; $_t_Label; $_t_LevelName; $_t_LocationSubdivisionName; $_t_Name; $_t_NEXTProdCodeLabelName; $_t_NEXTProdCountLabelName; $_t_NEXTProdNameLabelName; $_t_NextSublevelLabel; $_t_NEXTSubLevelLabelName)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonEditSub5"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	$_t_Name:=$_ptr_Array3->{$_l_SelectedRow}
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonEditSub5"; $_t_oldMethodName)
