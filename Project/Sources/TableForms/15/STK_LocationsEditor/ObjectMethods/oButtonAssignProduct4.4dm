If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAssignProduct4
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 20:59
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAssignProduct4"; Form event code:C388)
