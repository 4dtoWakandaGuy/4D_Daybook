If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oAddAnotherroduct0
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_LONGINT:C283($_l_CurrentLevel; $_l_HeaderLevel; $_l_SizeofArray; PLOC0_l_BUT1; PLOC0_l_BUT10; PLOC0_l_BUT2; PLOC0_l_BUT3; PLOC0_l_BUT4; PLOC0_l_BUT5; PLOC0_l_BUT6; PLOC0_l_BUT7)
	C_LONGINT:C283(PLOC0_l_BUT8; PLOC0_l_BUT9; PLOC1_l_BUT1; PLOC1_l_BUT10; PLOC1_l_BUT2; PLOC1_l_BUT3; PLOC1_l_BUT4; PLOC1_l_BUT5; PLOC1_l_BUT7; PLOC1_l_BUT8; PLOC1_l_BUT9)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct0"; Form event code:C388)
...
If ($_ptr_CurrentLocationID->>0)
	If ($_ptr_CurrentLocationSubLevName->="")
		...
		Else 
			...
			If ($_ptr_ProductCode->#"")
				...
				$_t_ButtonName:="PLOC"+String:C10($_l_HeaderLevel)+"_L"
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct0"; $_t_oldMethodName)
