If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oStockLocationsLevel7
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 08:20
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel7"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel7"; $_t_oldMethodName)
