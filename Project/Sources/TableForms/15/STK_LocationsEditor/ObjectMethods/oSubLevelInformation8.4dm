If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oSubLevelInformation8
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 08:30
...
If (True:C214)
	...
	C_TEXT:C284($_t_NextSublevelNamed; STK_t_ProductCode)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oSubLevelInformation8"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oSubLevelInformation8"; $_t_oldMethodName)
