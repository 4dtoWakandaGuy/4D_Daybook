If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonDeleteSub1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 20:28
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_HeaderLevel; $_l_LocationPosition; $_l_SelectedRow)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub1"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub1"; $_t_oldMethodName)
