If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonDeleteSub5
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub5"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonDeleteSub5"; $_t_oldMethodName)
