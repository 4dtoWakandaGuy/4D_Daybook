If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oSubLevelInformation5
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:14
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oSubLevelInformation5"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oSubLevelInformation5"; $_t_oldMethodName)
