If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oProductInformation3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oProductInformation3"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oProductInformation3"; $_t_oldMethodName)
