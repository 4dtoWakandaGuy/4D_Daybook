If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAddSub8
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 08:33
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddSub8"; Form event code:C388)
...
If ($_ptr_CurrentLocationCode->#"")
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonAddSub8"; $_t_oldMethodName)
