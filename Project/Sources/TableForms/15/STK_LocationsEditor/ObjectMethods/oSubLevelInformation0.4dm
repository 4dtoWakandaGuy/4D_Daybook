If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oSubLevelInformation0
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_arraySize; $_l_CurrentLevel; $_l_event; $_l_FieldNumber; $_l_FillArray; $_l_HeaderLevel; $_l_Index; $_l_NextLevel; $_l_NextLevelHeader; $_l_oBottom; $_l_oLeft)
	C_LONGINT:C283($_l_oRight; $_l_oTop; $_l_ProductID; $_l_ProductPosition; $_l_ProductsCount; $_l_SelectedRow; $_l_TableNumber; $_l_ThisLocationID; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight)
	C_LONGINT:C283($_l_windowTop; STK_l_Subid; xNext)
	...
	C_POINTER:C301($_ptr_CurrentLocation; $_ptr_CurrentLocationCode; $_ptr_CurrentLocationCount; $_ptr_CurrentLocationID; $_ptr_CurrentLocationSubLevelNam; $_ptr_ListBoxArea; $_Ptr_LocationNamesArray; $_Ptr_NextAddPrdl; $_Ptr_NextAddSubLevel; $_Ptr_NEXTCurrentLocation; $_Ptr_NEXTCurrentLocationCode)
	...
	C_TEXT:C284($_t_ButtonsName; $_t_ColumnName; $_t_CountNextSubLevelsSTR; $_t_Label; $_t_LevelName; $_t_LocationSubdivisionName; $_t_NEXTProdCodeLabelName; $_t_NEXTProdCountLabelName; $_t_NEXTProdNameLabelName; $_t_NextSubLevelLabel; $_t_NEXTSubLevelLabelName)
	C_TEXT:C284($_t_NextSubLocationCode; $_t_oldMethodName; $_t_ProdCodeLabelName; $_t_ProdCountLabelName; $_t_ProdNameLabelName; $_t_ProductCode; $_t_SelectedOption; $_t_Singular; $_t_SublevelName; $_t_SubLocationDefault; $_t_NextSubLevelNamed)
	C_TEXT:C284($_t_ProductCode; STK_t_ProductCode)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oSubLevelInformation0"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		$_ptr_CurrentLocationSubLevelNam:=Get pointer:C304("STK_t_SubLevelLabel"+String:C10($_l_HeaderLevel))  //Name of the sublevels attached to this location
	...
	: ($_l_event=On Double Clicked:K2:5)
		...
		Case of 
			: ($_t_NextSubLevelNamed#"")  //The location has a sublevel
				...
				$_t_LocationSubdivisionName:=$_ptr_CurrentLocationSubLevelNam->
