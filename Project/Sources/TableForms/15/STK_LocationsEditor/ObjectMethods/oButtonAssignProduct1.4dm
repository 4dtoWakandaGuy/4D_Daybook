If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAssignProduct1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 20:24
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAssignProduct1"; Form event code:C388)
