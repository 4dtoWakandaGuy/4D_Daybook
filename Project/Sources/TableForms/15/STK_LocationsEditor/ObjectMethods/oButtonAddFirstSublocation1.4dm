If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oButtonAddFirstSublocation1
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_ButtonName; $_t_CountSubLevelsSTR; $_t_ObjectName; $_t_oldMethodName; $_t_ProdCodeLabelName; $_t_ProdCountLabelName; $_t_ProdNameLabelName; $_t_Singular; $_t_SubLevelLabel; $_t_SubLevelLabelName; $_t_SubLocationCode)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFirstSublocation1"; Form event code:C388)
			...
			If ($_t_SubLevelLabel#"") & (OK=1)
				...
				If ($_t_SubLocationCode#"") & (OK=1)
					...
					If (Num:C11($_t_CountSubLevelsSTR)>0)
						...
						$_Ptr_SubLocationNamesArray->{$_l_LocationPosition}:=$_t_SubLevelLabel
						//```
						$_ptr_CurrentLocationCount->:=Num:C11($_t_CountSubLevelsSTR)
