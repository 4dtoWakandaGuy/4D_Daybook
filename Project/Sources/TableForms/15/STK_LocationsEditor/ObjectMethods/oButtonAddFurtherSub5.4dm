If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oButtonAddFurtherSub5
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:16
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_ElementsCount; $_l_ElementsPerParent; $_l_HeaderLevel; $_l_Index; $_l_Index2; $_l_IndexD; $_l_ParentsIndex; $_l_SelectedRow; $_l_SubLocationPosition; STK_l_Subid)
	...
	C_TEXT:C284($_t_CountSubLevelsSTR; $_t_LocationName; $_t_oldMethodName; $_t_ParentLocationCode; $_t_ProdCodeLabelName; $_t_ProdCountLabelName; $_t_ProdNameLabelName; $_t_Singular; $_t_SublevelLabel; $_t_SubLevelLabelName; $_t_SubLocationCode)
	C_TEXT:C284($_t_SubLocationDefault)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub5"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub5"; $_t_oldMethodName)
