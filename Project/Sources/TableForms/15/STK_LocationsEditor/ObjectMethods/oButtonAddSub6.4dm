If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAddSub6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddSub6"; Form event code:C388)
...
If ($_ptr_CurrentLocationCode->#"")
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonAddSub6"; $_t_oldMethodName)
