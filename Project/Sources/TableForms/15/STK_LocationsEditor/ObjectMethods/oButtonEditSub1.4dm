If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oButtonEditSub1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 20:27
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonEditSub1"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	$_t_LocationName:=$_ptr_Array3->{$_l_SelectedRow}
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonEditSub1"; $_t_oldMethodName)
