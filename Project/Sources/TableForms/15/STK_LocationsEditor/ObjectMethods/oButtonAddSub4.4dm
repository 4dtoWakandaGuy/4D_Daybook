If (False:C215)
	//object Method Name: Object Name:      [USER].STK_LocationsEditor.oButtonAddSub4
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_AddRowsIndex; $_l_ArraySize; $_l_CurrentLevel; $_l_HeaderLevel; $_l_Index; $_l_LastLocationNameNum; $_l_LastLocationNumber; $_l_Length; $_l_NumberToAdd; $_l_RecordClashtest; STK_l_currentLocation)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddSub4"; Form event code:C388)
...
If ($_ptr_CurrentLocationCode->#"")
	If ($_ptr_CurrentLocationSubLevName->#"")
		...
		If (OK=1) & ($_l_NumberToAdd>0)
			...
			For ($_l_AddRowsIndex; 1; $_l_NumberToAdd)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonAddSub4"; $_t_oldMethodName)
