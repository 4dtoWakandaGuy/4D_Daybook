If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAddFurtherSub8
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_ElementsCount; $_l_ElementsPerParent; $_l_HeaderLevel; $_l_Index; $_l_LocationID; $_l_ParentsIndex; $_l_SublevelRow; $_l_SubLocationPosition; STK_l_Subid)
	...
	C_POINTER:C301($_Ptr_SubLevelLBArea; $_ptr_SubLevelSelect; $_Ptr_SublocationCode; SublocationsnamesPtr)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub8"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
	...
	$_l_SublevelRow:=Find in array:C230($_ptr_Array2->; $_ptr_SubLevelSelect->)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub8"; $_t_oldMethodName)
