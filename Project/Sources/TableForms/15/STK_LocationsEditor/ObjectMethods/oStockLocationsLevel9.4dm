If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oStockLocationsLevel9
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 08:35
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ArraySize; $_l_CurrentLevel; $_l_event; $_l_FieldNumber; $_l_FillCounts; $_l_HeaderLevel; $_l_Index; $_l_SelectedRow; $_l_TableNumber; PLOC0_l_BUT1; PLOC0_l_BUT10)
	...
	C_POINTER:C301($_ptr_Array9; $_ptr_CurrentLocation; $_ptr_CurrentLocationCode; $_ptr_CurrentLocationCount; $_ptr_CurrentLocationID; $_ptr_CurrentLocationSubLevName; $_Ptr_HeaderLBArea; $_Ptr_LocationCode; $_Ptr_LocationIDSArray; $_ptr_LocationNameArray; $_ptr_ProdSelected)
	C_POINTER:C301($_ptr_ProductAdd; $_ptr_ProductCode; $_ptr_ProductCodeArray; $_ptr_ProductCodes; $_ptr_ProductCount; $_ptr_ProductCounts; $_ptr_ProductDelete; $_ptr_ProductID; $_ptr_ProductIDS; $_ptr_ProductList; $_ptr_ProductName)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel9"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		$_ptr_ProductCodeArray:=$_aptr_ColumnVariables{4}
		...
		Case of 
			...
			: ($_ptr_ProductCodeArray->{$_l_SelectedRow}#"")
				...
				If ($_ptr_ProductCodeArray->{$_l_SelectedRow}="Multiple Products")
					ARRAY LONGINT:C221($_ptr_ProductIDS->; 0)
					ARRAY TEXT:C222($_ptr_ProductCodes->; 0)
					ARRAY TEXT:C222($_ptr_ProductNames->; 0)
					ARRAY REAL:C219($_ptr_ProductCounts->; 0)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oStockLocationsLevel9"; $_t_oldMethodName)
