If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oAddAnotherroduct5
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:15
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct5"; Form event code:C388)
...
If ($_ptr_CurrentLocationID->>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct5"; $_t_oldMethodName)
