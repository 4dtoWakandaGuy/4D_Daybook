If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oAddAnotherroduct10
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/11/2009 09:23
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct10"; Form event code:C388)
...
If ($_ptr_CurrentLocationID->>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oAddAnotherroduct10"; $_t_oldMethodName)
