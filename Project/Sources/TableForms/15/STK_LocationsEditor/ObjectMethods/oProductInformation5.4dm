If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oProductInformation5
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ColumNumber; $_l_CurrentLevel; $_l_event; $_l_FieldNumber; $_l_HeaderLevel; $_l_LocationPosition; $_l_OldProductID; $_l_SelectedRow; $_l_TableNumber)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oProductInformation5"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Data Change:K2:15)
		...
		RESOLVE POINTER:C394(Self:C308; $_t_ColumnName; $_l_TableNumber; $_l_FieldNumber)
		$_l_SelectedRow:=Self:C308->
		$_l_ColumNumber:=LB_GetColumn($_ptr_ProductList; $_t_ColumnName)
		Case of 
			: ($_l_ColumNumber=1)  //The product code(no other column should be editable
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oProductInformation5"; $_t_oldMethodName)
