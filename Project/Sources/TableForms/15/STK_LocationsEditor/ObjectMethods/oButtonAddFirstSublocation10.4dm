If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAddFirstSublocation10
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_POINTER:C301($_ptr_ProductNames; $_ptr_SubLevelAdd; $_ptr_SubLevelAddFurther; $_Ptr_SubLevelArrayLabel; $_Ptr_SubLevelCount; $_ptr_SubLevelDelete; $_ptr_SubLevelEdit; $_Ptr_SubLevelLBArea; $_ptr_SubLevelSelect; $_Ptr_SubLocationNamesArray)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFirstSublocation10"; Form event code:C388)
...
$_Ptr_SubLevelArrayLabel:=$_aptr_ColumnVariables{6}  //Pointer to array containing the product code
		...
		If ($_ptr_ProductName->="") & (Size of array:C274($_ptr_ProductCodes->)=0)
			...
			If ($_t_SublevelLabel#"") & (OK=1)
				If ($_l_LocationPosition>0)
					$_Ptr_SubLevelArrayLabel->{$_l_LocationPosition}:=$_t_SublevelLabel
				End if 
