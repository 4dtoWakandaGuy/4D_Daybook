If (False:C215)
	//object Name: [USER]STK_LocationsEditor.oButtonAddFurtherSub4
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 21:05
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentLevel; $_l_ElementsCount; $_l_ElementsPerParent; $_l_HeaderLevel; $_l_Index; $_l_Index2; $_l_LocationID; $_l_ParentIndex; $_l_SelectedRow; $_l_SubLocationPosition; STK_l_Subid)
	...
	C_POINTER:C301($_ptr_SubLevelEdit; $_Ptr_SubLevelLBArea; $_ptr_SubLevelSelect; $_Ptr_SublocationCode; $_Ptr_SubLocationNamesArray; SublocationsnamesPtr)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub4"; Form event code:C388)
...
If ($_ptr_SubLevelSelect->>0)
					...
					If ($_t_SublevelLabel#"") & (OK=1)
						...
						If ($_t_SubLocationCode#"") & (OK=1)
							...
							If (Num:C11($_t_CountSubLevelsSTR)>0)
								...
								$_ptr_NextLevel9:=Get pointer:C304("STK_at_SubLocProdName"+String:C10($_l_CurrentLevel+1))
								$_ptr_NextLevel10:=Get pointer:C304("STK_at_SubLocHolds"+String:C10($_l_CurrentLevel+1))
								ARRAY TEXT:C222($_ptr_NextLevel1->; $_l_ElementsCount)
								ARRAY LONGINT:C221($_ptr_NextLevel2->; $_l_ElementsCount)
								ARRAY TEXT:C222($_ptr_NextLevel3->; $_l_ElementsCount)
								ARRAY TEXT:C222($_ptr_NextLevel4->; $_l_ElementsCount)
								ARRAY LONGINT:C221($_ptr_NextLevel5->; $_l_ElementsCount)
								ARRAY LONGINT:C221($_ptr_NextLevel6->; $_l_ElementsCount)
								ARRAY BOOLEAN:C223($_ptr_NextLevel7->; $_l_ElementsCount)
								ARRAY TEXT:C222($_ptr_NextLevel8->; $_l_ElementsCount)
								ARRAY TEXT:C222($_ptr_NextLevel9->; $_l_ElementsCount)
								ARRAY TEXT:C222($_ptr_NextLevel10->; $_l_ElementsCount)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].STK_LocationsEditor.oButtonAddFurtherSub4"; $_t_oldMethodName)
