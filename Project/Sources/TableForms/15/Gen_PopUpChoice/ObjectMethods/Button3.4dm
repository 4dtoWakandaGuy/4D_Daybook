If (False:C215)
	//object Name: [USER]Gen_PopUpChoice.Button3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Gen_PopUpChoice.Button3"; Form event code:C388)
...
CANCEL:C270
ERR_MethodTrackerReturn("OBJ [USER].Gen_PopUpChoice.Button3"; $_t_oldMethodName)