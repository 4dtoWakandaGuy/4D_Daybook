If (False:C215)
	//object Name: [USER]Gen_PopUpChoice.Variable2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Gen_PopUpChoice.Variable2"; Form event code:C388)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].Gen_PopUpChoice.Variable2"; $_t_oldMethodName)
