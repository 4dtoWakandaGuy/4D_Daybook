If (False:C215)
	//object Name: [USER]SD2_SelectCalenderDialog.Variable2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_SelectCalenderDialog.Variable2"; Form event code:C388)
...
Else 
End if 
ERR_MethodTrackerReturn("OBJ:Diary_OwnerDialog,BUPDATE"; $_t_oldMethodName)
