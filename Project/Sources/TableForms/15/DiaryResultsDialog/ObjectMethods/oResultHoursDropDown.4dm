If (False:C215)
	//object Name: [USER]DiaryResultsDialog.Variable6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].DiaryResultsDialog.Variable6"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [USER].DiaryResultsDialog.Variable6"; $_t_oldMethodName)