If (False:C215)
	//object Name: [USER]DiaryResultsDialog.Hierarchical Pop-up Menu2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].DiaryResultsDialog.Hierarchical Pop-up Menu2"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [USER].DiaryResultsDialog.Hierarchical Pop-up Menu2"; $_t_oldMethodName)