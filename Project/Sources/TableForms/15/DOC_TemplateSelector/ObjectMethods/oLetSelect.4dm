If (False:C215)
	//object Name: [USER]DOC_TemplateSelector.oLetSelect
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 02/12/2009 08:50
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].DOC_TemplateSelector.oLetSelect"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].DOC_TemplateSelector.oLetSelect"; $_t_oldMethodName)
