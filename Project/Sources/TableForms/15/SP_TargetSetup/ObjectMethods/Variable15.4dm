If (False:C215)
	//object Name: [USER]SP_TargetSetup.Variable15
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SP_TargetSetup.Variable15"; Form event code:C388)
$_l_OK:=0
...
If ($_l_OK>0)
	...
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ [USER].SP_TargetSetup.Variable15"; $_t_oldMethodName)
