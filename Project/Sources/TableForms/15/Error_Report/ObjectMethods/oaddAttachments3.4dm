If (False:C215)
	//object Name: [USER]Error_Report.oaddAttachments3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Error_Report.oaddAttachments3"; Form event code:C388)
...
If ($_l_OK=1) & (Size of array:C274($_at_ErrorAttachments)>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].Error_Report.oaddAttachments3"; $_t_oldMethodName)
