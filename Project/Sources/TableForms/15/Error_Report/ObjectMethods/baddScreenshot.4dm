If (False:C215)
	//object Name: [USER]Error_Report.baddScreenshot
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Error_Report.baddScreenshot"; Form event code:C388)
...
SHOW WINDOW:C435
ERR_MethodTrackerReturn("OBJ [USER].Error_Report.baddScreenshot"; $_t_oldMethodName)