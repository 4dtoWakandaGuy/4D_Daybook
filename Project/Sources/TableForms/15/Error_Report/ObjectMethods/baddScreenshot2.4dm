If (False:C215)
	//object Name: [USER]Error_Report.baddScreenshot2
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 15/12/2009 10:10
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Error_Report.baddScreenshot2"; Form event code:C388)
...
SHOW WINDOW:C435
ERR_MethodTrackerReturn("OBJ [USER].Error_Report.baddScreenshot2"; $_t_oldMethodName)