If (False:C215)
	//object Name: [USER]BK_FileOptions.Variable50
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].BK_FileOptions.Variable50"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [USER].BK_FileOptions.Variable50"; $_t_oldMethodName)
