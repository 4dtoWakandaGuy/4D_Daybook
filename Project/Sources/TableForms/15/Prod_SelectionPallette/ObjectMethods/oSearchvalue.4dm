If (False:C215)
	//object Name: [USER]Prod_SelectionPallette.oSearchvalue
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Prod_SelectionPallette.oSearchvalue"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].Prod_SelectionPallette.oSearchvalue"; $_t_oldMethodName)
