If (False:C215)
	//object Name: [USER]Prod_SelectionPallette.oSearchClearButton
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_TEXT:C284($_t_FocusRingName; $_t_oldMethodName; $_t_SearchButtonName; $_t_SearchCloseName; $_t_SearchCriteriaName; SD2_T_SearchValue; SRCH_t_SearchValue)
End if 

//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Prod_SelectionPallette.oSearchClearButton"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [USER].Prod_SelectionPallette.oSearchClearButton"; $_t_oldMethodName)