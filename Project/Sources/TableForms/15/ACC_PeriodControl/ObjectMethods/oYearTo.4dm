If (False:C215)
	//object Name: [USER]ACC_PeriodControl.Variable9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].ACC_PeriodControl.Variable9"; Form event code:C388)
	...
	: ($_l_event=On Data Change:K2:15)
		...
		If (Acc_D_SelectedYearEndDate>!00-00-00!)
			For ($_l_Index; 1; Size of array:C274(ACC_ad_FinancialYearFrom))
				If (Acc_D_SelectedYearEndDate>=ACC_ad_FinancialYearFrom{$_l_Index}) & (Acc_D_SelectedYearStartDate<ACC_ad_FinancialYearto{$_l_Index})
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [USER].ACC_PeriodControl.Variable9"; $_t_oldMethodName)
