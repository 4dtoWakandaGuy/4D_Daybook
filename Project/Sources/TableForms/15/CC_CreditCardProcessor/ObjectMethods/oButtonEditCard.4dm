If (False:C215)
	//object Name: [USER]CC_CreditCardProcessor.Variable15
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_SelectedRow; CCM_l_CurrentOwnerID; CCM_l_CurrentOwnerTable)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].CC_CreditCardProcessor.Variable15"; Form event code:C388)
$_l_SelectedRow:=CCM_at_CardNumbers
If ($_l_SelectedRow>0)
	CCM_EditRecord(CCM_al_CardRecordIDs{$_l_SelectedRow})
...
Else 
	Gen_Alert("select a card first to edit it!")
End if 
ERR_MethodTrackerReturn("OBJ [USER].CC_CreditCardProcessor.Variable15"; $_t_oldMethodName)
