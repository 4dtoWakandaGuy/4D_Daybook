If (False:C215)
	//object Name: [USER]Diary_OwnerDialog.OLBDiary
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Diary_OwnerDialog.OLBDiary"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].Diary_OwnerDialog.OLBDiary"; $_t_oldMethodName)
