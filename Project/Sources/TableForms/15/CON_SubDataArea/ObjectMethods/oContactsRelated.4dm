If (False:C215)
	//object Name: [USER]CON_SubDataArea.oContactsRelated
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_Column; $_l_CurrentSortColumn; $_l_event; $_l_FieldNumber; $_l_Row; $_l_SelectedRow; $_l_TableNumber; $_l_TabSettings; CON_l_CurrentSubArea; CON_l_FurtherFieldsMod; CON_l_ParentProcess)
	C_LONGINT:C283(LB_l_ColumnNumber; LB_l_LastRow; LB_l_RowNumber)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].CON_SubDataArea.oContactsRelated"; Form event code:C388)
...
Case of 
	...
	Else 
		...
		RESOLVE POINTER:C394(Self:C308; $_t_VariableName; $_l_TableNumber; $_l_FieldNumber)
		$_l_Row:=Self:C308->
		$_l_TabSettings:=CON_al_ViewTabsSettings{CON_at_ViewTabsLabels}
		...
		//***********ends**********************************
End case 
ERR_MethodTrackerReturn("OBJ [USER].CON_SubDataArea.oContactsRelated"; $_t_oldMethodName)
