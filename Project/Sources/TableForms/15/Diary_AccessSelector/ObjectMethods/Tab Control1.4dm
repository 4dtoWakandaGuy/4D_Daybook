If (False:C215)
	//object Name: [USER]Diary_AccessSelector.Tab Control1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Diary_AccessSelector.Tab Control1"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].Diary_AccessSelector.Tab Control1"; $_t_oldMethodName)
