If (False:C215)
	//object Name: [USER]Diary_AccessSelector.OLBDiary
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Diary_AccessSelector.OLBDiary"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].Diary_AccessSelector.OLBDiary"; $_t_oldMethodName)
