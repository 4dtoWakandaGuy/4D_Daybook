If (False:C215)
	//object Method Name: Object Name:      [USER].SD2_DiaryRelationsDialog.oLBDiaryrelations
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 08/09/2009 08:08
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_DiaryRelationsDialog.oLBDiaryrelations"; Form event code:C388)
...
Case of 
	...
	Else 
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_DiaryRelationsDialog.oLBDiaryrelations"; $_t_oldMethodName)
