If (False:C215)
	//object Name: [USER]SD2_DiaryRelationsDialog.oAddRelation
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_DiaryRelationsDialog.oAddRelation"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].SD2_DiaryRelationsDialog.oAddRelation"; $_t_oldMethodName)
