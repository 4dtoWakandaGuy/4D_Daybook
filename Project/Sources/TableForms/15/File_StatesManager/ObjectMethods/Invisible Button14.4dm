If (False:C215)
	//object Name: [USER]File_StatesManager.Invisible Button14
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].File_StatesManager.Invisible Button14"; Form event code:C388)
$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ [USER].File_StatesManager.Invisible Button14"; $_t_oldMethodName)