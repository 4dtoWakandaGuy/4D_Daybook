If (False:C215)
	//object Name: [USER]File_StatesManager.Pop-up%2FDrop-down List2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].File_StatesManager.Pop-up/Drop-down List2"; Form event code:C388)
If (ST_at_PipelineState>0)
	...
	ST_l_Modified:=1
End if 
ERR_MethodTrackerReturn("OBJ [USER].File_StatesManager.Pop-up/Drop-down List2"; $_t_oldMethodName)
