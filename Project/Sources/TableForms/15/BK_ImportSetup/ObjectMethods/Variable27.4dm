If (False:C215)
	//object Name: [USER]BK_ImportSetup.Variable27
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].BK_ImportSetup.Variable27"; Form event code:C388)
DM_l_CSave:=0
If (DM_bo_CModified)
...
Else 
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ [USER].BK_ImportSetup.Variable27"; $_t_oldMethodName)
