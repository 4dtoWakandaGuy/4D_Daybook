If (False:C215)
	//object Name: [USER]BK_ImportSetup.Pop-up%2FDrop-down List3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].BK_ImportSetup.Pop-up/Drop-down List3"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [USER].BK_ImportSetup.Pop-up/Drop-down List3"; $_t_oldMethodName)
