If (False:C215)
	//object Name: [USER]List_PropertiesItemManager.Variable5
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_PropertyIndex; $_l_PropertyRow; AA_l_CurrentSelectItemID; AA_l_LoadPropertyItemsListID; AA_l_PropertyCurItemActionCode)
	C_TEXT:C284($_t_oldMethodName; AA_t_PropertyCurrentItem; AA_t_PropertyCurrentItemAction)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].List_PropertiesItemManager.Variable5"; Form event code:C388)
...
For ($_l_PropertyIndex; 1; Size of array:C274(AA_al_PropertyItemsID))
	If (AA_al_PropertyItemsID{$_l_PropertyIndex}<0)
		//this item does not exist
		AA_al_PropertyItemsID{$_l_PropertyIndex}:=AA_ListAddItembyID(AA_l_LoadPropertyItemsListID; AA_at_PropertyItems{$_l_PropertyIndex})
		//now save the "CODE"
		If (AA_at_PropertyItemAction{$_l_PropertyIndex}#"")
			
			READ WRITE:C146([LIST_ITEMS:95])
			QUERY:C277([LIST_ITEMS:95]; [LIST_ITEMS:95]X_ID:3=AA_al_PropertyItemsID{$_l_PropertyIndex})
			AA_SetListItemProperty("CODE"; AA_at_PropertyItemActionCodes{$_l_PropertyIndex})
...
CANCEL:C270
ERR_MethodTrackerReturn("OBJ [USER].List_PropertiesItemManager.Variable5"; $_t_oldMethodName)
