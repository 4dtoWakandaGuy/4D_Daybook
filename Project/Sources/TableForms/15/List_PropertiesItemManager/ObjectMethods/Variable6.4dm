If (False:C215)
	//object Name: [USER]List_PropertiesItemManager.Variable6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].List_PropertiesItemManager.Variable6"; Form event code:C388)
...
Else 
	...
	OBJECT SET VISIBLE:C603(AA_at_ActionNames; False:C215)
End if 
ERR_MethodTrackerReturn("OBJ [USER].List_PropertiesItemManager.Variable6"; $_t_oldMethodName)
