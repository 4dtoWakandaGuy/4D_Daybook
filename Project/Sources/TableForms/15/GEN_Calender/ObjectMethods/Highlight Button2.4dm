If (False:C215)
	//object Name: [USER]GEN_Calender.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].GEN_Calender.Highlight Button2"; Form event code:C388)
If (Not:C34(CAL_bo_isFloating))
	CANCEL:C270
Else 
	$_d_ReturnDate:=!00-00-00!
	For ($_l_Index; 1; 7)
...
If (CAL_bo_AutoCancel)
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ [USER].GEN_Calender.Highlight Button2"; $_t_oldMethodName)
