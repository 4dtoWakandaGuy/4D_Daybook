If (False:C215)
	//object Name: [USER]GEN_Calender.Highlight Button3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].GEN_Calender.Highlight Button3"; Form event code:C388)
...
If (CAL_bo_AutoCancel)
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ [USER].GEN_Calender.Highlight Button3"; $_t_oldMethodName)
