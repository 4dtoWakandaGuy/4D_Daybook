If (False:C215)
	//object Name: [USER]GEN_Calender.Highlight Button6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].GEN_Calender.Highlight Button6"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].GEN_Calender.Highlight Button6"; $_t_oldMethodName)
