If (False:C215)
	//object Name: [USER]SVS_ConfigureProblemTypes.Button1
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentRow; $_l_Index; $_l_ProblemTypeRow; SVS_l_ProblemTypeID; SVS_l_ProbTypeID)
	C_TEXT:C284($_t_oldMethodName; SVS_t_problemTypeName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SVS_ConfigureProblemTypes.Button1"; Form event code:C388)
If (SVS_l_ProblemTypeID#0)
	If (SVS_l_ProblemTypeID=-1)
		If (SVS_t_problemTypeName#"")
			...
			$_l_ProblemTypeRow:=Size of array:C274(SD2_al_ProblemTypeIDs)
	...
	End if 
End if 
SVS_l_ProblemTypeID:=-1
SVS_t_problemTypeName:=""
OBJECT SET ENTERABLE:C238(SVS_t_problemTypeName; True:C214)
GOTO OBJECT:C206(SVS_t_problemTypeName)
ERR_MethodTrackerReturn("OBJ [USER].SVS_ConfigureProblemTypes.Button1"; $_t_oldMethodName)
