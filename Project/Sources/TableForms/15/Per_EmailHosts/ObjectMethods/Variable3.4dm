If (False:C215)
	//object Name: [USER]Per_EmailHosts.Variable3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Per_EmailHosts.Variable3"; Form event code:C388)
If (USR_bo_Modified)
...
CANCEL:C270
ERR_MethodTrackerReturn("OBJ [USER].Per_EmailHosts.Variable3"; $_t_oldMethodName)