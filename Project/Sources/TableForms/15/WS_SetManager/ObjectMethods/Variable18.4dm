If (False:C215)
	//object Name: [USER]WS_SetManager.Variable18
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_LONGINT:C283($_l_FieldNumber; $_l_ItemReference; $_l_SelectedListItem; $_l_SourceProcess; $_l_SubListID; $_l_TableNumber; $srcElement; SM_HL_l_SETMANAGER; SM_SaveSelection)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].WS_SetManager.Variable18"; Form event code:C388)
...
If ($_l_SelectedListItem>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].WS_SetManager.Variable18"; $_t_oldMethodName)
