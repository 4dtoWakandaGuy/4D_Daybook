If (False:C215)
	//object Name: [USER]WS_SetManager.Button11
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].WS_SetManager.Button11"; Form event code:C388)
If (SM_at_ScriptNames>0)
	//we will copy this to the 'new' macro
	...
	SM_T_MacroText:=SM_T_MacroText2
	SM_T_MacroText2:=""
	ARRAY TEXT:C222(SM_at_ScriptCodes; 0)
	ARRAY TEXT:C222(SM_at_ScriptNames; 0)
	FORM GOTO PAGE:C247(3)
End if 
ERR_MethodTrackerReturn("OBJ [USER].WS_SetManager.Button11"; $_t_oldMethodName)
