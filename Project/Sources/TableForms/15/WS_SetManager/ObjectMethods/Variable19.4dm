If (False:C215)
	//object Name: [USER]WS_SetManager.Variable19
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].WS_SetManager.Variable19"; Form event code:C388)
...
If ($_l_SelectedListItem>0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].WS_SetManager.Variable19"; $_t_oldMethodName)
