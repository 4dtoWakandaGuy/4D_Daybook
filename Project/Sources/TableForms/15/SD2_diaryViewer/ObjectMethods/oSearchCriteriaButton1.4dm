If (False:C215)
	//object Name: [USER]SD2_diaryViewer.oSearchCriteriaButton1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_diaryViewer.oSearchCriteriaButton1"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Alternative Click:K2:36)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_diaryViewer.oSearchCriteriaButton1"; $_t_oldMethodName)
