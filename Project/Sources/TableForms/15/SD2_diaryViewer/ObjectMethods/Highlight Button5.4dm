If (False:C215)
	//object Name: [USER]SD2_diaryViewer.Highlight Button5
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_diaryViewer.Highlight Button5"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_diaryViewer.Highlight Button5"; $_t_oldMethodName)
