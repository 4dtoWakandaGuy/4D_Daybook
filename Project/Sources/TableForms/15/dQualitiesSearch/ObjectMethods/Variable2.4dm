If (False:C215)
	//object Method Name: Object Name:      [USER].dQualitiesSearch.Variable2
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_event; $_l_FieldNumber; $_l_ItemReference; $_l_Length; $_l_parentitemRef; $_l_SelectedItemParent; $_l_SelectedListItem; $_l_SublistID; $_l_TableNumber; QV_HL_QualitiesList; QV_l_SourceElement)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].dQualitiesSearch.Variable2"; Form event code:C388)
	...
	: ($_l_event=On Drop:K2:12)
		If (QV_bo_Drop)
			...
			If ($_l_SelectedItemParent>0)
				...
				GET LIST ITEM:C378(QV_HL_QualitiesList; $_l_SelectedListItem; $_l_parentitemRef; $_t_ParentItemText; $_l_SublistID; $_bo_Expanded)
				If ($_l_Length=0)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].dQualitiesSearch.Variable2"; $_t_oldMethodName)
