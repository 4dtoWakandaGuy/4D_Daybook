If (False:C215)
	//object Name: [USER]dQualitiesSearch.Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].dQualitiesSearch.Button2"; Form event code:C388)
QV_ParseText(QV_T_QualitiesAsText)
QV_DoSearch(QV_l_CurrentTable)
QV_l_OK:=1
CANCEL:C270
CLEAR LIST:C377(QV_HL_QualitiesList; *)
ERR_MethodTrackerReturn("OBJ [USER].dQualitiesSearch.Button2"; $_t_oldMethodName)