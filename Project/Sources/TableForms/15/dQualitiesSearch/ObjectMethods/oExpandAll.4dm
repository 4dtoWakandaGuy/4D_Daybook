If (False:C215)
	//object Name: [USER]dQualitiesSearch.Variable1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].dQualitiesSearch.Variable1"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].dQualitiesSearch.Variable1"; $_t_oldMethodName)
