If (False:C215)
	//object Name: [USER]SD2_SimpleEntry.oTimeToPopUp
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_SimpleEntry.oTimeToPopUp"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [USER].SD2_SimpleEntry.oTimeToPopUp"; $_t_oldMethodName)