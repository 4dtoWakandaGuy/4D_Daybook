If (False:C215)
	//object Name: [USER]SD2_SimpleEntry.oDiaryResultNamePopUp_P2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_SimpleEntry.oDiaryResultNamePopUpP2"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].SD2_SimpleEntry.oDiaryResultNamePopUpP2"; $_t_oldMethodName)
