If (False:C215)
	//object Name: [USER]SD2_SimpleEntry.oDateToButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_SimpleEntry.oDateToButton"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_SimpleEntry.oDateToButton"; $_t_oldMethodName)
