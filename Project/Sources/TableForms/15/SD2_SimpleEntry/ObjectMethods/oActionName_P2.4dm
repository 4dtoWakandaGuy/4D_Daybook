If (False:C215)
	//object Name: [USER]SD2_SimpleEntry.oActionName_P2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_SimpleEntry.oActionName"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_SimpleEntry.oActionName"; $_t_oldMethodName)
