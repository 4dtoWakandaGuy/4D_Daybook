If (False:C215)
	//object Name: [USER]BK_DataModel.Variable12
	//------------------ Method Notes ------------------
...
If (True:C214)
	ARRAY LONGINT:C221($_al_DisableFieldNumbers; 0)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].BK_DataModel.Variable12"; Form event code:C388)
...
If (BK_at_DayBookContext>0)
	...
	Case of 
		: (BK_l_DayBookContext=25)  //orders
			ARRAY LONGINT:C221($_al_DisableFieldNumbers; 15)
			$_al_DisableFieldNumbers{1}:=Field:C253(->[ORDERS:24]Export:24)
			$_al_DisableFieldNumbers{2}:=Field:C253(->[ORDERS:24]Print_Comments:44)
			$_al_DisableFieldNumbers{3}:=Field:C253(->[ORDERS:24]SORT_Date:57)
			$_al_DisableFieldNumbers{4}:=Field:C253(->[ORDERS:24]x_ID:58)
			$_al_DisableFieldNumbers{5}:=Field:C253(->[ORDERS:24]Total_Amount:6)
			$_al_DisableFieldNumbers{6}:=Field:C253(->[ORDERS:24]Total_TAX:7)
			$_al_DisableFieldNumbers{7}:=Field:C253(->[ORDERS:24]Total_Total:8)
			$_al_DisableFieldNumbers{8}:=Field:C253(->[ORDERS:24]Total_Cost:11)
			$_al_DisableFieldNumbers{9}:=Field:C253(->[ORDERS:24]Total_Margin:12)
			$_al_DisableFieldNumbers{10}:=Field:C253(->[ORDERS:24]Total_Margin_PC:13)
			$_al_DisableFieldNumbers{11}:=Field:C253(->[ORDERS:24]Forecast_PC:22)
			$_al_DisableFieldNumbers{12}:=Field:C253(->[ORDERS:24]Total_StandM:36)
			$_al_DisableFieldNumbers{13}:=Field:C253(->[ORDERS:24]Total_StandMPC:37)
			$_al_DisableFieldNumbers{14}:=Field:C253(->[ORDERS:24]Total_StandA:38)
			$_al_DisableFieldNumbers{15}:=Field:C253(->[ORDERS:24]Total_StandC:39)
			...
			For ($_l_FieldNumberIndex; 1; Get last field number:C255(Table:C252(->[ORDERS:24])))
				...
				If (Not:C34($_bo_FieldInvisible))
					$_l_FieldPosition:=Find in array:C230($_al_DisableFieldNumbers; $_l_FieldNumberIndex)
				...
				End if 
			End for 
			ARRAY LONGINT:C221($_al_DisableFieldNumbers; 6)
			$_al_DisableFieldNumbers{1}:=Field:C253(->[ORDER_ITEMS:25]Order_Code:1)
			$_al_DisableFieldNumbers{2}:=Field:C253(->[ORDER_ITEMS:25]WT_Tag1:54)
			$_al_DisableFieldNumbers{3}:=Field:C253(->[ORDER_ITEMS:25]WT_Tag2:55)
			$_al_DisableFieldNumbers{4}:=Field:C253(->[ORDER_ITEMS:25]WT_Tag3:56)
			$_al_DisableFieldNumbers{5}:=Field:C253(->[ORDER_ITEMS:25]WT_Tag4:57)
			$_al_DisableFieldNumbers{6}:=Field:C253(->[ORDER_ITEMS:25]x_ID:58)
		...
		: (BK_l_DayBookContext=2)  //Contacts/Companies
			ARRAY LONGINT:C221($_al_DisableFieldNumbers; 4)
			$_al_DisableFieldNumbers{1}:=Field:C253(->[COMPANIES:2]CUS_LabelPrint:67)
			$_al_DisableFieldNumbers{2}:=Field:C253(->[COMPANIES:2]x_ID:63)
			$_al_DisableFieldNumbers{3}:=Field:C253(->[COMPANIES:2]Deleted:61)
			$_al_DisableFieldNumbers{4}:=Field:C253(->[COMPANIES:2]ADDRESS:60)
			...
			End for 
			ARRAY LONGINT:C221($_al_DisableFieldNumbers; 4)
			$_al_DisableFieldNumbers{1}:=Field:C253(->[CONTACTS:1]Company_Code:1)
			$_al_DisableFieldNumbers{2}:=Field:C253(->[CONTACTS:1]Exported:23)
			$_al_DisableFieldNumbers{3}:=Field:C253(->[CONTACTS:1]x_ID:33)
			$_al_DisableFieldNumbers{4}:=Field:C253(->[CONTACTS:1]CUS_LabelPrint:34)
		...
		: (BK_l_DayBookContext=Table:C252(->[PRODUCTS:9]))  //products
			ARRAY LONGINT:C221($_al_DisableFieldNumbers; 4)
			$_al_DisableFieldNumbers{1}:=Field:C253(->[PRODUCTS:9]Exported:24)
			$_al_DisableFieldNumbers{2}:=Field:C253(->[PRODUCTS:9]X_ID:43)
			$_al_DisableFieldNumbers{3}:=Field:C253(->[PRODUCTS:9]Default_Price_Currency_ID:45)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].BK_DataModel.Variable12"; $_t_oldMethodName)
