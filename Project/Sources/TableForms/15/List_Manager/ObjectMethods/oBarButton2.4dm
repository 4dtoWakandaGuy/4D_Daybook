If (False:C215)
	//object Name: [USER]List_Manager.oBarButton2
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 29/10/2010 05:56
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER]List_Manager.oBarButton2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].List_Manager.oBarButton2"; $_t_oldMethodName)
