If (False:C215)
	//object Name: [USER]List_Manager.Variable12
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_event; $_l_ItemReference; $_l_SelectedListItem; $_l_SubListID; AA_HL_ListItems)
	C_TEXT:C284($_t_ItemText; $_t_oldMethodName; AA_t_CurrentListItem)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].List_Manager.Variable12"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].List_Manager.Variable12"; $_t_oldMethodName)
