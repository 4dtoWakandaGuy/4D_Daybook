If (False:C215)
	//object Name: [USER]Template_manager.Button1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Template_manager.Button1"; Form event code:C388)
...
If ($_l_SelectedTemplate>0)
	...
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ [USER].Template_manager.Button1"; $_t_oldMethodName)
