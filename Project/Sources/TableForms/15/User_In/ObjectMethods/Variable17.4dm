If (False:C215)
	//object Name: [USER]User_In.Variable17
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_NextPriority)
	C_TEXT:C284($_t_NewName; $_t_oldMethodName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].User_In.Variable17"; Form event code:C388)
$_t_NewName:=Request:C163("Enter New Priority:"; "")
If (OK=1)
	If ($_t_NewName#"")
		APPEND TO ARRAY:C911(SD_at_PriorityNM; $_t_NewName)
		$_l_NextPriority:=Size of array:C274(SD_al_PriorityNUM)+1
		APPEND TO ARRAY:C911(SD_al_PriorityNUM; $_l_NextPriority)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].User_In.Variable17"; $_t_oldMethodName)
