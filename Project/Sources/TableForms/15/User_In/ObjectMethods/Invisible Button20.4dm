If (False:C215)
	//object Name: [USER]User_In.Invisible Button20
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 05/10/2010 14:12
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].User_In.Invisible Button20"; Form event code:C388)
$_t_PalletButtonName:=Self:C308
RESOLVE POINTER:C394($_t_PalletButtonName; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ [USER].User_In.Invisible Button20"; $_t_oldMethodName)
