If (False:C215)
	//object Name: [USER]User_In.Check Box11
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].User_In.Check Box11"; Form event code:C388)
// data interchange
// 31/10/02 pb
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].User_In.Check Box11"; $_t_oldMethodName)
