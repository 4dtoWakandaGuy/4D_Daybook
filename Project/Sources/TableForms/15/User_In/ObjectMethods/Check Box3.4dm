If (False:C215)
	//object Name: [USER]User_In.Check Box3
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_DataInterchangeTab)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].User_In.Check Box3"; Form event code:C388)
// data interchange
// 31/10/02 pb

If (Self:C308->=1)
	$_l_DataInterchangeTab:=Find in array:C230(DB_at_USERTAB; "data interchange")
	If ($_l_DataInterchangeTab<0)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].User_In.Check Box3"; $_t_oldMethodName)
