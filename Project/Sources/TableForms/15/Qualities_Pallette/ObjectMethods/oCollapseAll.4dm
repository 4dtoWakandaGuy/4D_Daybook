If (False:C215)
	//object Name: [USER]Qualities_Pallette.ocollapseall
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Qualities_Pallette.ocollapseall"; Form event code:C388)
If (Is a list:C621(QV_HL_QUalitiesList))
	...
	For ($_l_ListItemIndex; 1; $_l_CountListItems)
		...
		If ($_l_SublistID>0)
			SET LIST ITEM:C385($_l_ListIDReference; $_l_ItemReference; $_t_ItemText; $_l_ItemReference; $_l_SublistID; False:C215)
		End if 
	End for 
	//////_o_REDRAW LIST(QV_HL_QUalitiesList)
End if 
ERR_MethodTrackerReturn("OBJ [USER].Qualities_Pallette.ocollapseall"; $_t_oldMethodName)
