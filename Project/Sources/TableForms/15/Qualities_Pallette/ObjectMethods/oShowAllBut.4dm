If (False:C215)
	//object Name: [USER]Qualities_Pallette.oShowAllBut
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].Qualities_Pallette.oShowAllBut"; Form event code:C388)
Case of 
	: (QV_l_CurrentMode=1)
	: (QV_l_CurrentMode=2)
...
ERR_MethodTrackerReturn("OBJ [USER].Qualities_Pallette.oShowAllBut"; $_t_oldMethodName)
