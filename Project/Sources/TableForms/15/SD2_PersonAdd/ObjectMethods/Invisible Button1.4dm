If (False:C215)
	//object Name: [USER]SD2_PersonAdd.Invisible Button1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_PersonAdd.Invisible Button1"; Form event code:C388)
...
End if 
CANCEL:C270
ERR_MethodTrackerReturn("OBJ [USER].SD2_PersonAdd.Invisible Button1"; $_t_oldMethodName)
