If (False:C215)
	//object Name: [USER]SD2_PersonAdd.Invisible Button4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_PersonAdd.Invisible Button4"; Form event code:C388)
...
If (SD2_l_EmailChoiceProc>0)
	...
	SET PROCESS VARIABLE:C370(SD2_l_EmailChoiceProc; DOC_l_CallEvent; 3)
	BRING TO FRONT:C326(SD2_l_EmailChoiceProc)
	POST OUTSIDE CALL:C329(SD2_l_EmailChoiceProc)
	CLEAR SEMAPHORE:C144("$SD2NamesCall")
End if 
ERR_MethodTrackerReturn("OBJ [USER].SD2_PersonAdd.Invisible Button4"; $_t_oldMethodName)
