If (False:C215)
	//object Name: [USER]SalesProjectionEntry.Variable9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SalesProjectionEntry.Variable9"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [USER].SalesProjectionEntry.Variable9"; $_t_oldMethodName)