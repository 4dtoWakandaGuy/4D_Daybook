If (False:C215)
	//object Name: [USER]SalesProjectionEntry.Variable3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SalesProjectionEntry.Variable3"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].SalesProjectionEntry.Variable3"; $_t_oldMethodName)
