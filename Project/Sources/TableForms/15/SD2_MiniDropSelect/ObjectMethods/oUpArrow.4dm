If (False:C215)
	//object Name: [USER]SD2_MiniDropSelect.oUpArrow
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_MiniDropSelect.oUpArrow"; Form event code:C388)
...
If (SD2_at_ContactEmailSelect>1)
	...
	DOC_l_CallEvent:=0
End if 
ERR_MethodTrackerReturn("OBJ [USER].SD2_MiniDropSelect.oUpArrow"; $_t_oldMethodName)
