If (False:C215)
	//object Name: [TRANSACTIONS]Trans_in.oProductsButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].Trans_in.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].Trans_in.Invisible Button24"; $_t_oldMethodName)
