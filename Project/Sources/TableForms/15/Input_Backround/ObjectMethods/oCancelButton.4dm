If (False:C215)
	//object Name: [TRANSACTIONS]Trans_in.oCancelButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].Trans_in.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].Trans_in.Variable71"; $_t_oldMethodName)
