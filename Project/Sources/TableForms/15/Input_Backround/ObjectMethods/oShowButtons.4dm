If (False:C215)
	//object Name: [TRANSACTIONS]Trans_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 14:56
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisTRANS)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [TRANSACTIONS].Trans_in.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisTRANS; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
	: ($_l_event=On Mouse Leave:K2:34)
		//DB_HideFloatingButtons
End case 
ERR_MethodTrackerReturn("OBJ [TRANSACTIONS].Trans_in.oShowButtons"; $_t_oldMethodName)
