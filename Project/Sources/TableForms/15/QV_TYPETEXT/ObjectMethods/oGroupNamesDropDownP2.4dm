If (False:C215)
	//object Name: [USER]QV_TYPETEXT.Variable1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].QV_TYPETEXT.Variable1"; Form event code:C388)
...
QV_GroupPopUpScript
ERR_MethodTrackerReturn("OBJ [USER].QV_TYPETEXT.Variable1"; $_t_oldMethodName)
