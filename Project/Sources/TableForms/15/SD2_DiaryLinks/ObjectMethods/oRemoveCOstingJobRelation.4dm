If (False:C215)
	//object Name: [USER]SD2_DiaryLinks.oRemoveCOstingJobRelation
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_DiaryLinks.oRemoveCOstingJobRelation"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].SD2_DiaryLinks.oRemoveCOstingJobRelation"; $_t_oldMethodName)
