If (False:C215)
	//object Name: [USER]SD2_DiaryLinks.oAddEvents
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_DiaryLinks.oAddEvents"; Form event code:C388)
...
If (Not:C34([DIARY:12]Done:14))
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [USER].SD2_DiaryLinks.oAddEvents"; $_t_oldMethodName)
