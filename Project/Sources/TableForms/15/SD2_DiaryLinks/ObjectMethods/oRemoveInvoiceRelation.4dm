If (False:C215)
	//object Name: [USER]SD2_DiaryLinks.oRemoveInvoiceRelation
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_DiaryLinks.oRemoveInvoiceRelation"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].SD2_DiaryLinks.oRemoveInvoiceRelation"; $_t_oldMethodName)
