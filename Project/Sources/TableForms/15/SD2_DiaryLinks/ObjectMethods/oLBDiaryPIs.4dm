If (False:C215)
	//object Method Name: Object Name:      [USER].SD2_DiaryLinks.oLBDiaryPIs
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_DiaryLinks.oLBDiaryPIs"; Form event code:C388)
...
Case of 
	...
	Else 
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_DiaryLinks.oLBDiaryPIs"; $_t_oldMethodName)
