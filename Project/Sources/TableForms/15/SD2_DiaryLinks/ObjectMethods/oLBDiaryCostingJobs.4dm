If (False:C215)
	//object Method Name: Object Name:      [USER].SD2_DiaryLinks.oLBDiaryCostingJobs
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_Column; $_l_event; $_l_RelationRow2; $_l_Row; SD2_l_ListID)
	C_TEXT:C284($_t_CompanyCode; $_t_ContactCode; $_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD2_DiaryLinks.oLBDiaryCostingJobs"; Form event code:C388)
...
Case of 
				...
				: ($_l_Column=1)
					If (SD2_at_RelationShipnames{$_l_Row}#SD2_at_RelationShipnamesOLD{$_l_Row})
						If (SD2_at_RelationShipnamesOLD{$_l_Row}="")  //that is ok
							$_l_RelationRow2:=Find in array:C230(SD2_at_RelationShipSelector; SD2_at_RelationShipnames{$_l_Row})
							SD2_at_RelationShipnamesOLD{$_l_Row}:=SD2_at_RelationShipnames{$_l_Row}
							SD2_al_RelationshipTables{$_l_Row}:=SD2_al_RelatedtableNumber{$_l_RelationRow2}
							SD2_al_RelationshipFields{$_l_Row}:=SD2_al_RelatedCodeFieldNumber{$_l_RelationRow2}
					...
					If (SD2_at_RelationShipnames{$_l_Row}#"")
						...
						Case of 
							: (SD2_al_RelationshipTables{$_l_Row}=Table:C252(->[COMPANIES:2]))
								...
								$_l_RelationRow2:=Find in array:C230(SD2_al_RelationshipTables; 1)  //Relation to contact
								If ($_l_RelationRow2>0)
									Check_Company(->SD2_at_RelationshipCodes{$_l_Row}; ->SD2_at_RelationshipCodes{$_l_RelationRow2}; ->[DIARY:12])
								Else 
								...
								If (SD2_at_RelationshipCodes{$_l_Row}#"")
									...
									If ($_l_RelationRow2>0)
										...
										If ($_t_ContactCode#"")
											...
											SD2_al_RelationshipIDS{$_l_RelationRow2}:=[CONTACTS:1]x_ID:33
											SD2_at_RelationshipCodes{$_l_RelationRow2}:=[CONTACTS:1]Contact_Code:2
											SD2_at_RelatedRecordNames{$_l_RelationRow2}:=SD2_GetRecordName(->[CONTACTS:1])
										End if 
									Else 
							...
							: (SD2_al_RelationshipTables{$_l_Row}=Table:C252(->[CONTACTS:1]))
								$_l_RelationRow2:=Find in array:C230(SD2_al_RelationshipTables; 2)  //Relation to company
								If ($_l_RelationRow2>0)
									Check_Contact(->SD2_at_RelationshipCodes{$_l_Row}; ->SD2_at_RelationshipCodes{$_l_RelationRow2}; ->[DIARY:12])
								Else 
							...
							: (SD2_al_RelationshipTables{$_l_Row}=Table:C252(->[CONTRACTS:17]))
								...
								If (SD2_at_RelationshipCodes{$_l_Row}#"")
									...
									$_l_RelationRow2:=Find in array:C230(SD2_al_RelationshipTables; 2)  //Relation to company
									If ($_l_RelationRow2>0)
										If (SD2_at_RelationshipCodes{$_l_RelationRow2}#$_t_CompanyCode)
	...
	Else 
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD2_DiaryLinks.oLBDiaryCostingJobs"; $_t_oldMethodName)
