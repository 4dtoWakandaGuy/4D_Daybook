If (False:C215)
	//object Name: [USER]CAT_Selector.oCatSelector
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 30/08/2013 17:19
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].CAT_Selector.oCatSelector"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].CAT_Selector.oCatSelector"; $_t_oldMethodName)
