If (False:C215)
	//object Name: [USER]CCM_Prefs.oShowPassword2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].CCM_Prefs.oShowPassword2"; Form event code:C388)

$_t_ConfirmCode:=Gen_Request("Enter Transaction Key"; "")
...
End if 
ERR_MethodTrackerReturn("OBJ [USER].CCM_Prefs.oShowPassword2"; $_t_oldMethodName)
