If (False:C215)
	//object Name: [USER]INT_InputButtons.Variable6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].INT_InputButtons.Variable6"; Form event code:C388)
//Save Record
...
End if 
ERR_MethodTrackerReturn("OBJ:INT_InputButtons,isaveEnter"; $_t_oldMethodName)
