If (False:C215)
	//object Name: [USER]INT_InputButtons.Variable4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].INT_InputButtons.Variable4"; Form event code:C388)
//ADD SUBRECORD
...
End if 
ERR_MethodTrackerReturn("OBJ:INT_InputButtons,iCancelstop"; $_t_oldMethodName)
