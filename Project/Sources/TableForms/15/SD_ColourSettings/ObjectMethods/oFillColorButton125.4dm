If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable395
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable395"; Form event code:C388)
...
//
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable395"; $_t_oldMethodName)
