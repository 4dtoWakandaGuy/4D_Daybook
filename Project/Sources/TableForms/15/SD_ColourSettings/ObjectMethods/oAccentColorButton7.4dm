If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable769
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 18/08/2009 12:10
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable769"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable769"; $_t_oldMethodName)
