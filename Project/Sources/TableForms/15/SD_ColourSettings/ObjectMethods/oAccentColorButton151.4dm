If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable625
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable625"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable625"; $_t_oldMethodName)
