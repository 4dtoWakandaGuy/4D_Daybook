If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable365
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable365"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable365"; $_t_oldMethodName)
