If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable414
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 18/08/2009 12:48
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable414"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable414"; $_t_oldMethodName)
