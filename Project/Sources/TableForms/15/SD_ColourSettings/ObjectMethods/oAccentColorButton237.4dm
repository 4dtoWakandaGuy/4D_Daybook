If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable539
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 18/08/2009 13:20
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable539"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (SD_t_CurrentSelectedActionCode#"")
			...
			If ($_l_Number>0)
				...
				// SET RGB COLOR (SD_l_AgendaColourWell2;$_l_Red;$_l_Green;$_l_Blue)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable539"; $_t_oldMethodName)
