If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable674
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable674"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable674"; $_t_oldMethodName)
