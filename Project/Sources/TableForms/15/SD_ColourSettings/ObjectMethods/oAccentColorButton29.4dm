If (False:C215)
	//object Name: [USER]SD_ColourSettings.Variable747
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 18/08/2009 14:44
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].SD_ColourSettings.Variable747"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].SD_ColourSettings.Variable747"; $_t_oldMethodName)
