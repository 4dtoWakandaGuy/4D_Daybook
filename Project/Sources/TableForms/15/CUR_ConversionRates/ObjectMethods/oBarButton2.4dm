If (False:C215)
	//object Name: [USER]CUR_ConversionRates.oBarButton2
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER]CUR_ConversionRates.oBarButton2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].CUR_ConversionRates.oBarButton2"; $_t_oldMethodName)
