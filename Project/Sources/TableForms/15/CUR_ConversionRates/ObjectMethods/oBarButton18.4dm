If (False:C215)
	//object Name: [USER]CUR_ConversionRates.oBarButton18
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [USER].CUR_ConversionRates.oBarButton18"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [USER].CUR_ConversionRates.oBarButton18"; $_t_oldMethodName)
