If (False:C215)
	//object Name: [Attribute_Classes]Data_Entry.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [LAYERS].Layer_In.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [LAYERS].Layer_In.Highlight Button2"; $_t_oldMethodName)
