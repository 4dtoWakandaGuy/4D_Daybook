If (False:C215)
	//object Name: [Attribute_Classes]Data_Entry.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [LAYERS].Layer_In.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [LAYERS].Layer_In.Variable71"; $_t_oldMethodName)
