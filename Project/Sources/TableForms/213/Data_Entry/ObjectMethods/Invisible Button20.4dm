If (False:C215)
	//object Name: [Attribute_Classes]Data_Entry.Invisible Button20
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 02/10/2010 09:43
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [LAYERS].Layer_In.Invisible Button20"; Form event code:C388)
...
Case of 
	: ($_l_event=On Long Click:K2:37)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [Attribute_Classes]Data_Entry.Invisible Button20"; $_t_oldMethodName)
