If (False:C215)
	//object Name: [PRICE_TABLE]PriceTable_In.Invisible Button22
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRICE_TABLE].PriceTable_In.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRICE_TABLE].PriceTable_In.Invisible Button22"; $_t_oldMethodName)
