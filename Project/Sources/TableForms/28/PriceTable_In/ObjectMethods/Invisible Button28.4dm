If (False:C215)
	//object Name: [PRICE_TABLE]PriceTable_In.Invisible Button28
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 04/10/2010 19:38
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRICE_TABLE].PriceTable_In.Invisible Button28"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRICE_TABLE].PriceTable_In.Invisible Button28"; $_t_oldMethodName)
