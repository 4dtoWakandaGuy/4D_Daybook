If (False:C215)
	//Table Form Method Name: [PRICE_TABLE]PriceTable_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [PRICE_TABLE].PriceTable_Out"; Form event code:C388)
$_l_event:=Form event code:C388

Case of 
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[PRICE_TABLE:28]); "PriceTable_Out")
		Cache_Initialise
	: ($_l_event=On Header:K2:17)
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[PRICE_TABLE:28]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[PRICE_TABLE:28]; ->[PRICE_TABLE:28]Table_Code:12; ->[PRICE_TABLE:28]Product_Code:1; "PriceT"; "DB_MenuNewRecord"; "PriceT_Sel"; "Minor_DelEx"; "Master"; "Price Table"; "PriceT_OutCount"; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[PRICE_TABLE:28])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		Out_Buttons
End case 
ERR_MethodTrackerReturn("FM:PriceT Out"; $_t_oldMethodName)
