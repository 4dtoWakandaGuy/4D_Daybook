If (False:C215)
	//object Name: [SF_PURCHASE_ORDER]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SF_PURCHASE_ORDER].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [SF_PURCHASE_ORDER].Input.vRecNum"; $_t_oldMethodName)
