If (False:C215)
	//Table Form Method Name: [CREDIT_STAGES]invStages_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [CREDIT_STAGES].invStages_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[CREDIT_STAGES:54]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[CREDIT_STAGES:54]); "invStages_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
		SD2_SetDiaryPopup
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[CREDIT_STAGES:54]; ->[CREDIT_STAGES:54]Stage_Code:1; ->[CREDIT_STAGES:54]Stage_Name:2; "InvStages"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Credit stages"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[CREDIT_STAGES:54])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		SD2_SetDiaryPopup
End case 
ERR_MethodTrackerReturn("FM:invStages_Out"; $_t_oldMethodName)
