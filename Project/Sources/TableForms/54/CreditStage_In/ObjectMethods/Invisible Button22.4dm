If (False:C215)
	//object Name: [CREDIT_STAGES]CreditStage_In.Invisible Button22
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 15/10/2010 07:43
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CREDIT_STAGES].CreditStage_In.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [CREDIT_STAGES].CreditStage_In.Invisible Button22"; $_t_oldMethodName)
