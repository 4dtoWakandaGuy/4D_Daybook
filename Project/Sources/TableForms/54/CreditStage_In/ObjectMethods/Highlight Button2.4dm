If (False:C215)
	//object Name: [CREDIT_STAGES]CreditStage_In.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CREDIT_STAGES].CreditStage_In.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [CREDIT_STAGES].CreditStage_In.Highlight Button2"; $_t_oldMethodName)
