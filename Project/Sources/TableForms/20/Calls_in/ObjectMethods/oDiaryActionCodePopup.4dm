If (False:C215)
	//object Name: [SERVICE_CALLS]Calls_in.oDiaryActionCodePopup
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SERVICE_CALLS].Calls_in.oDiaryActionCodePopup"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [SERVICE_CALLS].Calls_in.oDiaryActionCodePopup"; $_t_oldMethodName)
