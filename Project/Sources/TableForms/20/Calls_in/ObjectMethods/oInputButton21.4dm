If (False:C215)
	//object Name: [SERVICE_CALLS]Calls_in.Invisible Button8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SERVICE_CALLS].Calls_in.Invisible Button8"; Form event code:C388)
$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ [SERVICE_CALLS].Calls_in.Invisible Button8"; $_t_oldMethodName)
