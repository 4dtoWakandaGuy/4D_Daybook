If (False:C215)
	//object Name: [SERVICE_CALLS]Calls_in.Invisible Button32
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SERVICE_CALLS].Calls_in.Invisible Button32"; Form event code:C388)
...
Else 
	...
	RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
End if 
ERR_MethodTrackerReturn("OBJ [SERVICE_CALLS].Calls_in.Invisible Button32"; $_t_oldMethodName)
