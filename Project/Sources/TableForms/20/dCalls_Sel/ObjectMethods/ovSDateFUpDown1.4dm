If (False:C215)
	//object Name: [SERVICE_CALLS]dCalls_Sel.ovSDateFUpDown1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 19/07/2012 07:00
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SERVICE_CALLS].dCalls_Sel.ovSDateFUpDown1"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [SERVICE_CALLS].dCalls_Sel.ovSDateFUpDown1"; $_t_oldMethodName)
