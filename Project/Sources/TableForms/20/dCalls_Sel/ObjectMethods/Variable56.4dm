If (False:C215)
	//object Name: [SERVICE_CALLS]dCalls_Sel.Variable56
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>PER_l_CurrentUserID; $_l_event; $_l_ServiceCallTable; CH0; CH1; CH2; cNAA; cNAL; cSIS; SM_l_QueryMode; SM_l_ReturnQueryID)
	C_TEXT:C284($_t_ContextName; $_t_oldMethodName; $_t_SearchName; VCallCode; vCharge; VCompCode; VCompName; VContCode; VContrCode; VForename; VPerson)
	C_TEXT:C284(Vpriority; VProbCode; VProbDesc; VProdCode; VprodName; VserialNo; VSolCode; VSolDesc; VSurname; Vtele)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [SERVICE_CALLS].dCalls_Sel.Variable56"; Form event code:C388)
$_l_event:=Form event code:C388
$_l_ServiceCallTable:=Table:C252(->[SERVICE_CALLS:20])
$_t_ContextName:="Service calls"
...
Case of 
	: ($_l_event=On Clicked:K2:4)
			...
			Case of 
				: (SM_al_SearchIDs{SM_at_SearchNames}>0)
					...
					If (SM_l_QueryMode#0)
						...
						End if 
						Gen_Set_enterable($_bo_Enterable; ->VCompCode; ->VCompName; ->Vpriority; ->VContCode; ->VForename; ->VSurname; ->VCallCode; ->VContrCode; ->VPerson; ->Vtele; ->vCharge; ->VProbCode; ->VProbDesc; ->VSolCode; ->VSolDesc; ->VProdCode; ->VprodName; ->VserialNo; ->VCDateF; ->VcDateT; ->VsDateF; ->VsDateT; ->CH0; ->CH1; ->CH2; ->cSIS; ->cNAA; ->cNAL)
				...
				: (SM_al_SearchIDs{SM_at_SearchNames}=-99998)  //Set user default
					If (SM_al_SearchIDs{Size of array:C274(SM_al_SearchIDs)-1}<0)
						...
						If (ok=1)
							Sm_SetUserSearchPrefs(True:C214; $_l_ServiceCallTable; <>PER_l_CurrentUserID; Abs:C99(SM_al_SearchIDs{Size of array:C274(SM_al_SearchIDs)-1}))
					...
					Else 
						...
						If (ok=0)
							Sm_SetUserSearchPrefs(True:C214; $_l_ServiceCallTable; <>PER_l_CurrentUserID; 0)
					...
					If (SM_al_SearchIDs{Size of array:C274(SM_al_SearchIDs)-1}<0)
						...
						If (ok=1)
							...
							Else 
								...
								SM_LoadSearchParameterNames($_l_ServiceCallTable)
				...
				: (SM_al_SearchIDs{SM_at_SearchNames}<0)  //Resave
					...
					SM_SaveSearchParameters(Abs:C99(SM_al_SearchIDs{SM_at_SearchNames}); ""; $_l_ServiceCallTable; <>PER_l_CurrentUserID; ->SM_blb_SearchBlob)
				...
				Else 
					...
					If ($_t_SearchName#"")
						...
						SET BLOB SIZE:C606(SM_blb_SearchBlob; 0)
						SM_SearchVarsToBlob(->SM_blb_SearchBlob; ->VCompCode; ->VCompName; ->Vpriority; ->VContCode; ->VForename; ->VSurname; ->VCallCode; ->VContrCode; ->VPerson; ->Vtele; ->vCharge; ->VProbCode; ->VProbDesc; ->VSolCode; ->VSolDesc; ->VProdCode; ->VprodName; ->VserialNo; ->VCDateF; ->VcDateT; ->VsDateF; ->VsDateT; ->CH0; ->CH1; ->CH2; ->cSIS; ->cNAA; ->cNAL)
						SM_SaveSearchParameters(0; $_t_SearchName; $_l_ServiceCallTable; <>PER_l_CurrentUserID; ->SM_blb_SearchBlob)
						SM_LoadSearchParameterNames($_l_ServiceCallTable)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [SERVICE_CALLS].dCalls_Sel.Variable56"; $_t_oldMethodName)
