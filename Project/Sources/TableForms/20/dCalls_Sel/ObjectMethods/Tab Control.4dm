If (False:C215)
	//object Name: [SERVICE_CALLS]dCalls_Sel.Tab Control
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_DATE:C307($_d_DoDateT; $_d_EntryDateFrom; $_d_FDateFrom; $_d_SDateTo; ACC_d_EntryDateFrom; vDateF1; vDateF2; vDateF3; vDateF4; vDateF5; vDateT1)
	C_DATE:C307(vDateT2; vDateT3; vDateT4; vDateT5; vDoDateF; VDoDateT; VfDateF; VFDateT; VSDateT)
	C_LONGINT:C283($_l_Act1; $_l_Act2; $_l_Act3; $_l_Act4; $_l_Act5; $_l_ch1; $_l_NAA; $_l_NAL; $_l_No1; $_l_No2; $_l_No3)
	C_LONGINT:C283($_l_no4; $_l_No5; $_l_OK; $_l_SetAdd; $_l_SetMod; $_l_SIS; $_l_State; $_l_TabsWidth; $_l_TotalWidth; $_l_bestHeight; $_l_bestWidth)
	C_LONGINT:C283($_l_QueryMode; ch1; cNAA; cNAL; cSetAdd; cSetMod; cSIS; rHold; SM_l_QueryMode; vAct1; vAct2)
	...
	C_TEXT:C284($_t_Area; $_t_Comments; $_t_CompCode; $_t_CompName; $_t_ContractCode; $_t_Country; $_t_County; $_t_Desc1; $_t_Desc2; $_t_Desc3; $_t_Desc4)
	C_TEXT:C284($_t_Desc5; $_t_Location; $_t_oldMethodName; $_t_Omit; $_t_PostCode; $_t_ProblemCode; $_t_ProductCode; $_t_Sales; $_t_Source; $_t_State; $_t_Status)
	C_TEXT:C284($_t_SubGroup1; $_t_SubGroup2; $_t_SubGroup3; $_t_SubGroup4; $_t_SubGroup5; $_t_Superior; $_t_Tele; $_t_Telephone; $_t_Title1; $_t_Title2; $_t_Title3)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [SERVICE_CALLS].dCalls_Sel.Tab Control"; Form event code:C388)


$_t_State:=vrstate
$_l_State:=VrStateL
$_t_CompCode:=VcompCode
...
ERR_MethodTrackerReturn("OBJ [SERVICE_CALLS].dCalls_Sel.Tab Control"; $_t_oldMethodName)
