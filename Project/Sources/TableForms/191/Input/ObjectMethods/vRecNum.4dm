If (False:C215)
	//object Name: [Contract_Type_Products]Input.vRecNum
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [Contract_Type_Products].Input.vRecNum"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [Contract_Type_Products].Input.vRecNum"; $_t_oldMethodName)
