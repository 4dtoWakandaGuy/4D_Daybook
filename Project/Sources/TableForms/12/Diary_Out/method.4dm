If (False:C215)
	//Table Form Method Name: [DIARY]Diary_Out
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305(DB_bo_NoLoad; INT_bo_DetailOpen; vFromIn; WIN_bo_Resize)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisO; vName; WIN_t_CurrentInputForm; WIN_t_CurrentOutputform)
End if 
//Code Starts Here



$_t_oldMethodName:=ERR_MethodTracker("FM [DIARY].Diary_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[DIARY:12]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		OpenHelp(Table:C252(->[DIARY:12]); "Diary_Out")
	...
	: ($_l_event=On Outside Call:K2:11)
		...
		Out_ButtCall(->[DIARY:12]; ->[DIARY:12]Diary_Code:3; ->[DIARY:12]Company_Code:1; "Diary"; "Diary_New"; "Diary_Sel"; "Minor_DelSetEx"; "DMaster"; "Diary"; "Diary_OutCount"; 1; 2)
...
End case 
ERR_MethodTrackerReturn("FM [DIARY].Diary_Out"; $_t_oldMethodName)
