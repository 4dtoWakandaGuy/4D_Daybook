If (False:C215)
	//Table Form Method Name: [DIARY]Diary_inLW
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [DIARY].Diary_inLW"; Form event code:C388)
...
Case of 
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		If ([DOCUMENTS:7]Document_Class:14=Text Email)
			...
			CANCEL:C270
		Else 
			OpenHelp(Table:C252(->[DIARY:12]); "Diary_inLW")
			//Write:=WR New offscreen area
			INT_SetInput(Table:C252(->[DOCUMENTS:7]); WIN_t_CurrentInputForm)
			DB_SetInputFormMenu(Table:C252(->[DIARY:12]); "Diary_inLW")
...
Diary_InLLP
ERR_MethodTrackerReturn("FM:Diary_inLW"; $_t_oldMethodName)
