If (False:C215)
	//object Name: [DIARY]Diary_inLW.Variable27
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_inLW.Variable27"; Form event code:C388)
...
End if 
PER_at_EmailNames:=0
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_inLW.Variable27"; $_t_oldMethodName)
