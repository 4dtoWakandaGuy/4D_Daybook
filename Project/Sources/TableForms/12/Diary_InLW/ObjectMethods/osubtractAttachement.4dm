If (False:C215)
	//object Name: [DIARY]Diary_inLW.osubtractAttachement
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_inLW.osubtractAttachement"; Form event code:C388)
If (WS_at_Attachments>0)
	...
	SETEMAILFORMOBJECTS
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_inLW.osubtractAttachement"; $_t_oldMethodName)
