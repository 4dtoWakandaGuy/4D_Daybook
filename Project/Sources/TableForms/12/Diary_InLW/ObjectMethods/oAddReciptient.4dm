If (False:C215)
	//object Name: [DIARY]Diary_inLW.oAddReciptient
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_Move; $_l_Move2; $_l_ObjectBottom; $_l_ObjectBottom2; $_l_ObjectBottom3; $_l_ObjectBottom4; $_l_ObjectLeft; $_l_ObjectLeft2; $_l_ObjectLeft3; $_l_ObjectLeft4; $_l_ObjectRight)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_inLW.oAddReciptient"; Form event code:C388)
...
If (False:C215)
	...
	Case of 
		: (Size of array:C274(WS_at_Attachments)=0)
			...
			$_l_Move:=$_l_ObjectTop4-($_l_ObjectBottom3+3+6)
			OBJECT MOVE:C664(*; "oLBAttachments"; 0; -$_l_Move)
			OBJECT MOVE:C664(Baddattachements; 0; -$_l_Move)
			OBJECT GET COORDINATES:C663(*; "oLBAttachments"; $_l_ObjectLeft4; $_l_ObjectTop4; $_l_ObjectRight4; $_l_ObjectBottom4)
			$_l_Move:=$_l_ObjectTop-($_l_ObjectBottom4+3+6)
			
			OBJECT MOVE:C664([DIARY:12]Email_Subject:40; 0; -$_l_Move)
			OBJECT MOVE:C664(*; "Text_Subject"; 0; -$_l_Move)
			$_l_ObjectBottom:=$_l_ObjectBottom-$_l_Move
			//GET OBJECT RECT([DIARY]Email_Subject;$_l_ObjectLeft;$_l_ObjectTop;$_l_ObjectRight;$_l_ObjectBottom)
			OBJECT GET COORDINATES:C663([DIARY:12]Email_Text:42; $_l_ObjectLeft2; $_l_ObjectTop2; $_l_ObjectRight2; $_l_ObjectBottom2)
			$_l_Move:=$_l_ObjectTop2-($_l_ObjectBottom+(6+12))
			$_l_Move2:=$_l_ObjectTop2-($_l_ObjectBottom+6)
			OBJECT MOVE:C664(*; "Text_EmailText"; 0; -$_l_Move)
			OBJECT MOVE:C664([DIARY:12]Email_Text:42; 0; -$_l_Move; 0; $_l_Move)
		...
		: (Size of array:C274(WS_at_Attachments)>0)
			...
			$_l_Move:=$_l_ObjectTop4-($_l_ObjectBottom3+3+6)
			OBJECT MOVE:C664(WS_at_Attachments; 0; -$_l_Move)
			OBJECT MOVE:C664(BDeleteattachements; 0; -$_l_Move)
			OBJECT GET COORDINATES:C663(WS_at_Attachments; $_l_ObjectLeft4; $_l_ObjectTop4; $_l_ObjectRight4; $_l_ObjectBottom4)
			$_l_Move:=$_l_ObjectTop-($_l_ObjectBottom4+3+6)
			OBJECT MOVE:C664([DIARY:12]Email_Subject:40; 0; -$_l_Move)
			OBJECT MOVE:C664(*; "Text_Subject"; 0; -$_l_Move)
...
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_inLW.oAddReciptient"; $_t_oldMethodName)
