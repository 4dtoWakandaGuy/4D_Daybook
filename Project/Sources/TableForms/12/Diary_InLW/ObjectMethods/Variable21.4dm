If (False:C215)
	//object Name: [DIARY]Diary_inLW.Variable21
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_inLW.Variable21"; Form event code:C388)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_inLW.Variable21"; $_t_oldMethodName)
