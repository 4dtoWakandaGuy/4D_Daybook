If (False:C215)
	//object Name: [DIARY]Diary_inLW.Field11
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_inLW.Field11"; Form event code:C388)
...
Case of 
	: ($_l_event=On Getting Focus:K2:7)
		...
		SETEMAILFORMOBJECTS
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_inLW.Field11"; $_t_oldMethodName)
