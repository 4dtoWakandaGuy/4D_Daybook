If (False:C215)
	//object Name: [DIARY]Diary_SubsEditor.Invisible Button24
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_SUBSEditor.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_SUBSEditor.Invisible Button24"; $_t_oldMethodName)
