If (False:C215)
	//object Name: [DIARY]Diary_SubsEditor.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_SUBSEditor.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_SUBSEditor.Highlight Button2"; $_t_oldMethodName)
