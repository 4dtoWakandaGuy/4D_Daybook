If (False:C215)
	//object Method Name: Object Name:      [DIARY].Diary_InDocument.omLBEmails1
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ObjectTop; $_l_RecordNumber; $_l_Row; $_l_SalutationRow; $_l_StartHighlight; $_l_TableNumber; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight; $_l_WindowTop; EmailChoiceProc)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InDocument.omLBEmails1"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InDocument.omLBEmails1"; $_t_oldMethodName)
