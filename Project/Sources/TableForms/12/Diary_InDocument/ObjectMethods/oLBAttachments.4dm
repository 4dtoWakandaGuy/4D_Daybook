If (False:C215)
	//object Name: [DIARY]Diary_InDocument.oLBAttachments
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InDocument.oLBAttachments"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InDocument.oLBAttachments"; $_t_oldMethodName)
