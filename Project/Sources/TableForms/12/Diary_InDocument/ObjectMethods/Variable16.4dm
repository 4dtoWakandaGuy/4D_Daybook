If (False:C215)
	//object Name: [DIARY]Diary_InDocument.Variable16
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InDocument.Variable16"; Form event code:C388)
...
End if 
PER_at_EmailNames:=0
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InDocument.Variable16"; $_t_oldMethodName)