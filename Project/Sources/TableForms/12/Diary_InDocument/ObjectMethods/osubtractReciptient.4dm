If (False:C215)
	//object Name: [DIARY]Diary_InDocument.osubtractReciptient
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InDocument.osubtractReciptient"; Form event code:C388)
...
End if 
SETEMAILFORMOBJECTS
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InDocument.osubtractReciptient"; $_t_oldMethodName)
