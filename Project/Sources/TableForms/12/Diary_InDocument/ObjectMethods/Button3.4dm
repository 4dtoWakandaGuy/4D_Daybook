If (False:C215)
	//object Name: [DIARY]Diary_InDocument.Button3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InDocument.Button3"; Form event code:C388)
...
End if 
SETEMAILFORMOBJECTS
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InDocument.Button3"; $_t_oldMethodName)
