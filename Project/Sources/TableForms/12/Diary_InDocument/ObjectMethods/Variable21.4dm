If (False:C215)
	//object Name: [DIARY]Diary_InDocument.Variable21
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentWinRefOLD; $_l_DocClass; $_l_Index; $_l_TemplatesRow; $_l_WindowBottom; $_l_WindowCentreVertical; $_l_WindowLeft; $_l_WindowRight; $_l_WindowTop; $_l_WindowWidth; WIN_l_CurrentWinRef)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InDocument.Variable21"; Form event code:C388)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InDocument.Variable21"; $_t_oldMethodName)
