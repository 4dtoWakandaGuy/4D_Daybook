If (False:C215)
	//object Name: [DIARY]Diary_InDocument.Button4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InDocument.Button4"; Form event code:C388)
If (WS_at_Attachments>0)
	...
	SETEMAILFORMOBJECTS
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InDocument.Button4"; $_t_oldMethodName)
