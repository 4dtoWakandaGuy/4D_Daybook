If (False:C215)
	//object Name: [DIARY]Diary_PDTEditor.oInvoicedOn
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_PDTEditor.oInvoicedOn"; Form event code:C388)
...
End if 
CREATE SET:C116([ORDER_ITEMS:25]; "SelectedBookings")
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_PDTEditor.oInvoicedOn"; $_t_oldMethodName)
