If (False:C215)
	//object Name: [DIARY]SD2_Input.oDiaryDetailsTab
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.oDiaryDetailsTab"; Form event code:C388)
...
If (SD_l_CurrentTab#SD2_at_PlanResultTab)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.oDiaryDetailsTab"; $_t_oldMethodName)
