If (False:C215)
	//object Name: [DIARY]SD2_Input.oDiaryResultNamePopUpP4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.oDiaryResultNamePopUpP4"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.oDiaryResultNamePopUpP4"; $_t_oldMethodName)
