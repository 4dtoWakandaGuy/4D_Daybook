If (False:C215)
	//object Name: [DIARY]SD2_Input.Invisible Button15
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.Invisible Button15"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.Invisible Button15"; $_t_oldMethodName)
