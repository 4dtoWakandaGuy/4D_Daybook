If (False:C215)
	//object Name: [DIARY]SD2_Input.Invisible Button17
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.Invisible Button17"; Form event code:C388)
...
Case of 
	: ($_l_event=On Long Click:K2:37)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.Invisible Button17"; $_t_oldMethodName)
