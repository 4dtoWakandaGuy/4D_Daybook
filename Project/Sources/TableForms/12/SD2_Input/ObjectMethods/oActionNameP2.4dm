If (False:C215)
	//object Name: [DIARY]SD2_Input.oActionNameP2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.oActionNameP2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.oActionNameP2"; $_t_oldMethodName)
