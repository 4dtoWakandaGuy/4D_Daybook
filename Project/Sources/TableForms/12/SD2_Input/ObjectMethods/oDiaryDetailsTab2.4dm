If (False:C215)
	//object Name: [DIARY]SD2_Input.oDiaryDetailsTab2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.oDiaryDetailsTab2"; Form event code:C388)
...
If (SD_l_CurrentTab#SD2_at_PlanResultTab)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.oDiaryDetailsTab2"; $_t_oldMethodName)
