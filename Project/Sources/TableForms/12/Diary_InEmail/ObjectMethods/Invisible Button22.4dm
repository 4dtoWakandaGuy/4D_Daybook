If (False:C215)
	//object Name: [DIARY]Diary_InEmail.Invisible Button22
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InEmail.Invisible Button22"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InEmail.Invisible Button22"; $_t_oldMethodName)
