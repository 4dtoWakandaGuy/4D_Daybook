If (False:C215)
	//object Name: [DIARY]Diary_InEmail.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 12:44
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; vButtDisDry)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InEmail.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisDry; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InEmail.oShowButtons"; $_t_oldMethodName)
