If (False:C215)
	//object Method Name: Object Name:      [DIARY].Diary_InEmail.olbMailsReciptients
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_AtPosition; $_l_ColumnNumber; $_l_ContactsIndex; $_l_EditedTetPosition; $_l_EmailPosition; $_l_EndHighlight; $_l_event; $_l_FieldNumber; $_l_ObjectBottom; $_l_ObjectLeft; $_l_ObjectRight)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InEmail.olbMailsReciptients"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On After Keystroke:K2:26)
						...
						Case of 
							: (Records in selection:C76([CONTACTS:1])=1)
								...
								If ($_t_EmailAddress#"")
									...
									$_l_EditedTetPosition:=Position:C15($_t_EditedText; $_t_EmailName)
									//I want only to append the name
									SD2_at_EmailName{$_l_Row}:=Substring:C12($_t_EmailName; $_l_EditedTetPosition; Length:C16($_t_EmailName))
									If ([DIARY:12]Contact_Code:2="")
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InEmail.olbMailsReciptients"; $_t_oldMethodName)
