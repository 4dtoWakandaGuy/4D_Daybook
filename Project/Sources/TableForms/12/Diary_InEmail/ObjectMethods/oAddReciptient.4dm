If (False:C215)
	//object Name: [DIARY]Diary_InEmail.oAddReciptient
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ObjectRight2; $_l_ObjectRight3; $_l_ObjectRight4; $_l_ObjectTop; $_l_ObjectTop2; $_l_ObjectTop3; $_l_ObjectTop4; $_l_SIzeOfArray; Baddattachements; BDELETEattachements; BMinus)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InEmail.oAddReciptient"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InEmail.oAddReciptient"; $_t_oldMethodName)
