If (False:C215)
	//object Name: [DIARY]Diary_InEmail.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InEmail.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InEmail.Variable71"; $_t_oldMethodName)
