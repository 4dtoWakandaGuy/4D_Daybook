If (False:C215)
	//object Name: [DIARY]Diary_InEmail.oLBAttachments
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InEmail.oLBAttachments"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InEmail.oLBAttachments"; $_t_oldMethodName)
