If (False:C215)
	//object Name: [DIARY]Diary_InEmail.Invisible Button20
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InEmail.Invisible Button20"; Form event code:C388)
...
Case of 
	: ($_l_event=On Long Click:K2:37)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InEmail.Invisible Button20"; $_t_oldMethodName)
