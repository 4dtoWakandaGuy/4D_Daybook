If (False:C215)
	//object Method Name: Object Name:      [DIARY].Diary_InNEW.oDiaryDateFromCalendar
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_WindowTop; CAL_l_CallBackEventNo; SD3_l_DiaryActionNum)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.oDiaryDateFromCalendar"; Form event code:C388)
//◊SuperDiary
...
If (Not:C34(Is nil pointer:C315(SD_ptr_Date1)))
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.oDiaryDateFromCalendar"; $_t_oldMethodName)
