If (False:C215)
	//object Name: [DIARY]Diary_InNEW.oRelatedRecordID
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_FirstChar; $_t_oldMethodName; $_t_RelationAdd; SD_t_RelationAdd; SD_t_RelationCode)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.oRelatedRecordID"; Form event code:C388)
...
If (SD_ptr_RelationAdd->#"")
	...
	Else 
		...
		$_t_FirstChar:=Uppercase:C13(Substring:C12($_t_RelationAdd; 1; 1))
		$_t_RelationAdd:=$_t_FirstChar+Substring:C12($_t_RelationAdd; 2; Length:C16($_t_RelationAdd))
...
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.oRelatedRecordID"; $_t_oldMethodName)
