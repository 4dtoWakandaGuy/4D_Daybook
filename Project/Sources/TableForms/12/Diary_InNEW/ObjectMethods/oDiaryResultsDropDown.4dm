If (False:C215)
	//object Name: [DIARY]Diary_InNEW.oResultsDropDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/10/2012 10:15
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.oResultsDropDown"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.oResultsDropDown"; $_t_oldMethodName)
