If (False:C215)
	//object Name: [DIARY]Diary_InNEW.oHoursFromHLList
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.oHoursFromHLList"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.oHoursFromHLList"; $_t_oldMethodName)