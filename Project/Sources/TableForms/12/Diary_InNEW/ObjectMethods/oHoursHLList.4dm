If (False:C215)
	//object Name: [DIARY]Diary_InNEW.oHoursHLList
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.oHoursHLList"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.oHoursHLList"; $_t_oldMethodName)