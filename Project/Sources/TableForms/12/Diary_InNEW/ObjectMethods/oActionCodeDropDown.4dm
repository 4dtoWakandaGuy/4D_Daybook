If (False:C215)
	//object Name: [DIARY]Diary_InNEW.oActionCodeDropDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.oActionCodeDropDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.oActionCodeDropDown"; $_t_oldMethodName)
