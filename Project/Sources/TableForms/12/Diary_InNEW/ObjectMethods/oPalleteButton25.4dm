If (False:C215)
	//object Name: [DIARY]Diary_InNEW.oPalleteButton25
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.Invisible Button24"; $_t_oldMethodName)
