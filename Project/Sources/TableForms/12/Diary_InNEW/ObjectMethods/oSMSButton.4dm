If (False:C215)
	//object Name: [DIARY]Diary_InNEW.oSMSButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].Diary_InNEW.oSMSButton"; Form event code:C388)
...
If ($_bo_Proceed)
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].Diary_InNEW.oSMSButton"; $_t_oldMethodName)
