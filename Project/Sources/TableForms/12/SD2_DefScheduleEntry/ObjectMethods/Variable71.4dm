If (False:C215)
	//object Name: [DIARY]SD2_DefScheduleEntry.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefScheduleEntry.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefScheduleEntry.Variable71"; $_t_oldMethodName)
