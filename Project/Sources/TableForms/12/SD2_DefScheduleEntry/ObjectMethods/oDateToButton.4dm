If (False:C215)
	//object Name: [DIARY]SD2_DefScheduleEntry.oDateToButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefScheduleEntry.oDateToButton"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefScheduleEntry.oDateToButton"; $_t_oldMethodName)
