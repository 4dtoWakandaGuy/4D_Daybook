If (False:C215)
	//object Name: [DIARY]SD2_DefScheduleEntry.Highlight Button2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefScheduleEntry.Highlight Button2"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefScheduleEntry.Highlight Button2"; $_t_oldMethodName)
