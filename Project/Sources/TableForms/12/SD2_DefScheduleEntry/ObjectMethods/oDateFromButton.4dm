If (False:C215)
	//object Name: [DIARY]SD2_DefScheduleEntry.oDateFromButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefScheduleEntry.oDateFromButton"; Form event code:C388)
