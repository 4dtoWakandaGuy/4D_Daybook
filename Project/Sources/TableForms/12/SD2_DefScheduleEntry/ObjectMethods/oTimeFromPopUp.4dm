If (False:C215)
	//object Name: [DIARY]SD2_DefScheduleEntry.oTimeFromPopUp
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefScheduleEntry.oTimeFromPopUp"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefScheduleEntry.oTimeFromPopUp"; $_t_oldMethodName)