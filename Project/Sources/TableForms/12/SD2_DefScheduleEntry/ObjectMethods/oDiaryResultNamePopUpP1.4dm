If (False:C215)
	//object Name: [DIARY]SD2_DefScheduleEntry.oDiaryResultNamePopUpP1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefScheduleEntry.oDiaryResultNamePopUpP1"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefScheduleEntry.oDiaryResultNamePopUpP1"; $_t_oldMethodName)
