If (False:C215)
	//object Name: [DIARY]dDiary_Sel.oVDoDateTContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].dDiary_Sel.oVDoDateTContextual"; Form event code:C388)
Case of 
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].dDiary_Sel.oVDoDateTContextual"; $_t_oldMethodName)
