If (False:C215)
	//object Name: [DIARY]dDiary_Sel.oCustomFieldsQuery
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].dDiary_Sel.oCustomFieldsQuery"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Data Change:K2:15)
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].dDiary_Sel.oCustomFieldsQuery"; $_t_oldMethodName)
