If (False:C215)
	//object Name: [DIARY]dDiary_Sel.oVDnDateFDatePick
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].dDiary_Sel.oVDnDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].dDiary_Sel.oVDnDateFDatePick"; $_t_oldMethodName)
