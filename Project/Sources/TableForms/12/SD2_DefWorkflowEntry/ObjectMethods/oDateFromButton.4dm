If (False:C215)
	//object Name: [DIARY]SD2_DefWorkflowEntry.oDateFromButton
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefWorkflowEntry.oDateFromButton"; Form event code:C388)
...
Case of 
	: ($_l_event=On Long Click:K2:37)
		...
		$_l_PopUpProcess:=New process:C317("SD2_PopUpDiary"; 64000; $_t_ProcessName; $_l_CallBackProcess; [DIARY:12]Display_Date_From:51; "SD2_D_DisplayDateFrom"; "SD2_l_EventCall"; 11; $_l_WindowLeft+$_l_MouseX; $_l_WindowTop+$_l_MouseY; *)
		BRING TO FRONT:C326($_l_PopUpProcess)
		POST OUTSIDE CALL:C329($_l_PopUpProcess)
		
	Else 
		[DIARY:12]Display_Date_From:51:=Current date:C33(*)
End case 
ERR_MethodTrackerReturn("OBJ:SD2_diaryViewer,SD2_l_DateFromCall"; $_t_oldMethodName)
