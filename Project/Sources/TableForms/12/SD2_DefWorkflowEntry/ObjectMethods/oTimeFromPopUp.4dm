If (False:C215)
	//object Name: [DIARY]SD2_DefWorkflowEntry.oTimeFromPopUp
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_event; $_l_ItemReference; $_l_SelectedListItem; $_l_SublistID; SD_HL_l_Hours)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefWorkflowEntry.oTimeFromPopUp"; Form event code:C388)
		...
		If ([DIARY:12]Diary_Code:3#"")
			...
			If ($_l_SelectedListItem>0)
				...
				If ([DIARY:12]Done:14=False:C215)
					[DIARY:12]Display_Time_From:53:=$_ti_Time
				Else 
					[DIARY:12]Display_Time_From:53:=$_ti_Time
				End if 
				SD2_DiaryinLPX(->[DIARY:12]Display_Time_From:53)
...
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefWorkflowEntry.oTimeFromPopUp"; $_t_oldMethodName)