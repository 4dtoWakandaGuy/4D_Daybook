If (False:C215)
	//object Name: [DIARY]SD2_DefWorkflowEntry.oActionName
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefWorkflowEntry.oActionName"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefWorkflowEntry.oActionName"; $_t_oldMethodName)
