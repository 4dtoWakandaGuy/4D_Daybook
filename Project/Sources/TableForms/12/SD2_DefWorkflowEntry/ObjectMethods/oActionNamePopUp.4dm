If (False:C215)
	//object Name: [DIARY]SD2_DefWorkflowEntry.oActionNamePopUp
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefWorkflowEntry.oActionNamePopUp"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefWorkflowEntry.oActionNamePopUp"; $_t_oldMethodName)
