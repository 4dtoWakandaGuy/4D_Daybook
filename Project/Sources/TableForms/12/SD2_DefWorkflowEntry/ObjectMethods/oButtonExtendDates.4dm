If (False:C215)
	//object Name: [DIARY]SD2_DefWorkflowEntry.oButtonExtendDates
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_DefWorkflowEntry.oButtonExtendDates"; Form event code:C388)
...
SD2_l_ShowDate2:=1
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_DefWorkflowEntry.oButtonExtendDates"; $_t_oldMethodName)