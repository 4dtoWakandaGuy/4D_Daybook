If (False:C215)
	//object Name: [STOCK_MOVEMENTS]dMove Sel.ovIDateFContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateFContextual"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateFContextual"; $_t_oldMethodName)
