If (False:C215)
	//object Name: [STOCK_MOVEMENTS]dMove Sel.ovIDateTDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/08/2012 13:25
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateTDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateTDatePick"; $_t_oldMethodName)
