If (False:C215)
	//object Name: [STOCK_MOVEMENTS]dMove Sel.ovIDateTContextual
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateTContextual"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateTContextual"; $_t_oldMethodName)
