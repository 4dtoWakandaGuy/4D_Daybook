If (False:C215)
	//object Name: [STOCK_MOVEMENTS]dMove Sel.ovIDateFDatePick
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/08/2012 13:26
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateFDatePick"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [STOCK_MOVEMENTS].dMove Sel.ovIDateFDatePick"; $_t_oldMethodName)
