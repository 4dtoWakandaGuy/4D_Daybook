If (False:C215)
	//object Name: [STOCK_MOVEMENTS]dask_StockMovements.Variable10
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [STOCK_MOVEMENTS].dask_StockMovements.Variable10"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [STOCK_MOVEMENTS].dask_StockMovements.Variable10"; $_t_oldMethodName)
