If (False:C215)
	//object Name: [CLIENT_SERVERMESSAGES]ALL_FIELDS.bDelete
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CLIENT_SERVERMESSAGES].ALL_FIELDS.bDelete"; Form event code:C388)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [CLIENT_SERVERMESSAGES].ALL_FIELDS.bDelete"; $_t_oldMethodName)
