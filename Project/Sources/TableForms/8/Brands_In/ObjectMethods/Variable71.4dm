If (False:C215)
	//object Name: [PRODUCT_BRANDS]Brands_In.Variable71
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [PRODUCT_BRANDS].Brands_In.Variable71"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [PRODUCT_BRANDS].Brands_In.Variable71"; $_t_oldMethodName)
