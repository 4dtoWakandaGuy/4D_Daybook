If (False:C215)
	//Table Form Method Name: [HEADINGS]PL_Totals12
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	//C_UNKNOWN(vT9)
	//C_UNKNOWN(vTot)
	C_BOOLEAN:C305(vMod3; DB_bo_NoLoad)
	C_LONGINT:C283($_l_Index; $_l_MaxStringLength; $_l_NumberLength; $_l_event; $_l_Index; $_l_MaxStringLength; $_l_NumberLength)
...
$_t_oldMethodName:=ERR_MethodTracker("FM [HEADINGS].PL_Totals12"; Form event code:C388)
...
Case of 
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		End if 
End case 
ERR_MethodTrackerReturn("FM [HEADINGS].PL_Totals12"; $_t_oldMethodName)
