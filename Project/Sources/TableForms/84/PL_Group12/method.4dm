If (False:C215)
	//Table Form Method Name: [HEADINGS]P&L Group12
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [HEADINGS].P&L Group12"; Form event code:C388)
...
Case of 
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		If (vMod3) & (False:C215)
			OBJECT SET FONT SIZE:C165(vGroup; 6)
		...
		End if 
End case 
ERR_MethodTrackerReturn("FM [HEADINGS].P&L Group12"; $_t_oldMethodName)
