If (False:C215)
	//object Name: [CONTACTS]dask_Contact2.Variable11
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CONTACTS].dask_Contact2.Variable11"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [CONTACTS].dask_Contact2.Variable11"; $_t_oldMethodName)
