If (False:C215)
	//object Name: [CONTACTS]dCont_Sel.oVEDateTUpDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 21/07/2012 15:05
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CONTACTS].dCont_Sel.oVEDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [CONTACTS].dCont_Sel.oVEDateTUpDown"; $_t_oldMethodName)
