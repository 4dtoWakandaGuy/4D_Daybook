If (False:C215)
	//object Name: [CONTACTS]dCont_Sel.oCustomFieldsQuery
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_DATE:C307($_d_Date)
	C_LONGINT:C283($_l_Column; $_l_event; $_l_PageNumber; $_l_Row)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ [CONTACTS].dCont_Sel.oCustomFieldsQuery"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Data Change:K2:15)
			...
			: ($_l_Column=2)
				...
				Case of 
					...
					: (FUR_at_CustomFieldTypes{$_l_Row}="N")
						$_l_PageNumber:=Num:C11(CUS_at_DisplayedData{$_l_Row})
						CUS_at_DisplayedData{$_l_Row}:=String:C10($_l_PageNumber)
			...
			: ($_l_Column=3)
				...
				Case of 
					: (FUR_at_CustomFieldTypes{$_l_Row}="D")
						...
						End if 
					: (FUR_at_CustomFieldTypes{$_l_Row}="N")
						$_l_PageNumber:=Num:C11(CUS_at_PageText{$_l_Row})
						CUS_at_PageText{$_l_Row}:=String:C10($_l_PageNumber)
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [CONTACTS].dCont_Sel.oCustomFieldsQuery"; $_t_oldMethodName)
