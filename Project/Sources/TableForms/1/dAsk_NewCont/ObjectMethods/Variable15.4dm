If (False:C215)
	//object Name: [CONTACTS]dAsk_NewCont.Variable15
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CONTACTS].dAsk_NewCont.Variable15"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [CONTACTS].dAsk_NewCont.Variable15"; $_t_oldMethodName)
