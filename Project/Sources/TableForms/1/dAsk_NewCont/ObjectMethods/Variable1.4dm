If (False:C215)
	//object Name: [CONTACTS]dAsk_NewCont.Variable1
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ObjectBottom; $_l_ObjectLeft; $_l_ObjectRight; $_l_ObjectTop; $_l_SalutationRow; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight; $_l_windowTop)
	C_TEXT:C284($_t_oldMethodName; $_t_Surname; SD_t_AttachContactCode; VcompName; vForename; vSurname; Vtitle; VWholeName)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [CONTACTS].dAsk_NewCont.Variable1"; Form event code:C388)
//$1 is the whole name
...
If (Vtitle#"")
	...
	$_l_SalutationRow:=Find in array:C230(AA_at_Salutations; VTitle)
	If ($_l_SalutationRow>0)
		Vtitle:=AA_at_Salutations{$_l_SalutationRow}
	End if 
	If (Vtitle#"")
		VWholeName:=Vtitle
	End if 
...
End if 
ERR_MethodTrackerReturn("OBJ [CONTACTS].dAsk_NewCont.Variable1"; $_t_oldMethodName)
