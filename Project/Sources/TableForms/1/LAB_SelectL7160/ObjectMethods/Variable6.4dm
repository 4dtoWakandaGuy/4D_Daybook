If (False:C215)
	//object Name: [CONTACTS]LAB_SelectL7160.Variable6
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_POINTER:C301($_ptr_LabelButton; $_ptr_Variable)
	C_TEXT:C284($_t_oldMethodName; LAB_t_BUTTON)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("OBJ [CONTACTS].LAB_SelectL7160.Variable6"; Form event code:C388)
$_ptr_LabelButton:=Self:C308
RESOLVE POINTER:C394($_ptr_LabelButton; LAB_t_BUTTON; $_l_TableNumber; $_l_FieldNumber)
For ($_l_Index; 1; 21)
	$_ptr_Variable:=Get pointer:C304("Lab_but_data"+String:C10($_l_Index))
	If ($_l_Index<Num:C11(LAB_t_BUTTON))
		OBJECT SET TITLE:C194($_ptr_Variable->; "X")
	Else 
		OBJECT SET TITLE:C194($_ptr_Variable->; "")
	End if 
End for 
ERR_MethodTrackerReturn("OBJ [CONTACTS].LAB_SelectL7160.Variable6"; $_t_oldMethodName)
