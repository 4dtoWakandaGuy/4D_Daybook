If (False:C215)
	//object Name: [CONTACTS]LAB_SelectL7160.Variable16
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [CONTACTS].LAB_SelectL7160.Variable16"; Form event code:C388)
...
For ($_l_Index; 1; 21)
	...
	End if 
End for 
ERR_MethodTrackerReturn("OBJ [CONTACTS].LAB_SelectL7160.Variable16"; $_t_oldMethodName)
