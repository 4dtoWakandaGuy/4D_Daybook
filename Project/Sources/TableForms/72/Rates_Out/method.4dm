If (False:C215)
	//Table Form Method Name: [CURRENCY_RATES]Rates_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [CURRENCY_RATES].Rates_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		...
		End if 
		INT_Setoutput(Table:C252(->[CURRENCY_RATES:72]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[CURRENCY_RATES:72]); "Rates_Out")
		Cache_Initialise
		FSetting_SetLabel(WIN_t_CurrentOutputform)
		SD2_SetDiaryPopup
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[CURRENCY_RATES:72]; ->[CURRENCY_RATES:72]Currency_From:1; ->[CURRENCY_RATES:72]Currency_To:2; "Rates"; "CurrRates_In"; "CurrRates_Sel"; "Minor_DelSet"; "Master"; "Currency Rates"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[CURRENCY_RATES:72])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
		...
		SD2_SetDiaryPopup
End case 
ERR_MethodTrackerReturn("FM [CURRENCY_RATES].Rates_Out"; $_t_oldMethodName)
