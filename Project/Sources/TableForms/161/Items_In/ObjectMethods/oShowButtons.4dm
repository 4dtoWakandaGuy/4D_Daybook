If (False:C215)
	//object Name: [INVOICES_ITEMS]Items_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 13:26
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES_ITEMS].Items_in.oShowButtons"; Form event code:C388)
...
Case of 
	: ($_l_event=On Mouse Enter:K2:33)
		...
		DB_ShowFloatingButtons(Current process:C322; vButtDisINVITEM; $_l_WindowLeft+$_l_MouseX; $_l_windowTop+$_l_MouseY; "input")
...
End case 
ERR_MethodTrackerReturn("OBJ [INVOICES_ITEMS].Items_in.oShowButtons"; $_t_oldMethodName)
