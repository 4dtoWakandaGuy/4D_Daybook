If (False:C215)
	//object Name: [INVOICES_ITEMS]Items_in.Invisible Button20
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 07/03/2011 15:52
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [INVOICES_ITEMS].Items_in.Invisible Button20"; Form event code:C388)
$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ [INVOICES_ITEMS].Items_in.Invisible Button20"; $_t_oldMethodName)
