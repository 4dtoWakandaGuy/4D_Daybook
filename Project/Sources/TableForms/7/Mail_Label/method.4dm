If (False:C215)
	//Table Form Method Name: [DOCUMENTS]Mail Label
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [DOCUMENTS].Mail Label"; Form event code:C388)
...
Case of 
	: (Form event code:C388=On Printing Detail:K2:18)  // (During)
		...
		// End if
End case 
ERR_MethodTrackerReturn("FM [DOCUMENTS].Mail Label"; $_t_oldMethodName)
