If (False:C215)
	//object Name: [DOCUMENTS]eMail_in.oShowButtons
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 01/08/2012 12:46
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DOCUMENTS].eMail_in.oShowButtons"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DOCUMENTS].eMail_in.oShowButtons"; $_t_oldMethodName)
