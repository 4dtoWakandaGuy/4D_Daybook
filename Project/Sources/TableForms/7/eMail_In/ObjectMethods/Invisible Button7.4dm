If (False:C215)
	//object Name: [DOCUMENTS]eMail_in.Invisible Button7
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DOCUMENTS].eMail_in.Invisible Button7"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DOCUMENTS].eMail_in.Invisible Button7"; $_t_oldMethodName)
