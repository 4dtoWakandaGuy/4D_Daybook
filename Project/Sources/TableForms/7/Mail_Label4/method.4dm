If (False:C215)
	//Table Form Method Name: [DOCUMENTS]Mail Label4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [DOCUMENTS].Mail Label4"; Form event code:C388)
...
Case of 
	: (Form event code:C388=On Printing Detail:K2:18)  // (During)
		...
		// End if
End case 
ERR_MethodTrackerReturn("FM [DOCUMENTS].Mail Label4"; $_t_oldMethodName)
