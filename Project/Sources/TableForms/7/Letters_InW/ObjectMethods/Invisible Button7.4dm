If (False:C215)
	//object Name: [DOCUMENTS]Letters_inW.Invisible Button7
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DOCUMENTS].Letters_inW.Invisible Button7"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DOCUMENTS].Letters_inW.Invisible Button7"; $_t_oldMethodName)
