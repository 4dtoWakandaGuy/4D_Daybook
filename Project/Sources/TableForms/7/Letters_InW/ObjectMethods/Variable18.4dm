If (False:C215)
	//object Name: [DOCUMENTS]Letters_inW.Variable18
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DOCUMENTS].Letters_inW.Variable18"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DOCUMENTS].Letters_inW.Variable18"; $_t_oldMethodName)
