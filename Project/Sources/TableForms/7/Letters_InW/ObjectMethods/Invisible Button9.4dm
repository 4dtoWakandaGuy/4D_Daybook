If (False:C215)
	//object Name: [DOCUMENTS]Letters_inW.Invisible Button9
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DOCUMENTS].Letters_inW.Invisible Button9"; Form event code:C388)
...
Case of 
	: ($_l_event=On Long Click:K2:37)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [DOCUMENTS].Letters_inW.Invisible Button9"; $_t_oldMethodName)
