If (False:C215)
	//object Name: [ORDERS]dQuickAdd.Variable18
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dQuickAdd.Variable18"; Form event code:C388)
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("OBJ [ORDERS].dQuickAdd.Variable18"; $_t_oldMethodName)
