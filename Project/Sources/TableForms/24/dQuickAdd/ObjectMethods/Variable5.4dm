If (False:C215)
	//object Name: [ORDERS]dQuickAdd.Variable5
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dQuickAdd.Variable5"; Form event code:C388)
...
Else 
	QuickAdd_Update
	vAct1:=vAct1+1
	INSERT IN ARRAY:C227(ORD_AT_QuickAddProdCode; vAct1; 1)
	INSERT IN ARRAY:C227(ORD_AT_QuickAddProdName; vAct1; 1)
	INSERT IN ARRAY:C227(ORD_ar_QuickAddQuantity; vAct1; 1)
	INSERT IN ARRAY:C227(ORD_AT_QuickAddSerialNo; vAct1; 1)
...
ERR_MethodTrackerReturn("OBJ [ORDERS].dQuickAdd.Variable5"; $_t_oldMethodName)