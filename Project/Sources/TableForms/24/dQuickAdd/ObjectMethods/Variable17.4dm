If (False:C215)
	//object Name: [ORDERS]dQuickAdd.Variable17
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dQuickAdd.Variable17"; Form event code:C388)
...
End if 
ERR_MethodTrackerReturn("OBJ [ORDERS].dQuickAdd.Variable17"; $_t_oldMethodName)
