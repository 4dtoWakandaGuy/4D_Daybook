If (False:C215)
	//object Name: [ORDERS]dQuickAdd.Variable8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dQuickAdd.Variable8"; Form event code:C388)
QuickAdd_Update
...
ERR_MethodTrackerReturn("OBJ [ORDERS].dQuickAdd.Variable8"; $_t_oldMethodName)