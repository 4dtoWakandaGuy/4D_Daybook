If (False:C215)
	//object Name: [ORDERS]dQuickAdd.Variable10
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dQuickAdd.Variable10"; Form event code:C388)
QuickAdd_Update
...
ERR_MethodTrackerReturn("OBJ [ORDERS].dQuickAdd.Variable10"; $_t_oldMethodName)