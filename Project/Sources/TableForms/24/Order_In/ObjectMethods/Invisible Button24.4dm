If (False:C215)
	//object Name: [ORDERS]Orders_In.Invisible Button24
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 04/10/2010 11:23
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].Orders_In.Invisible Button24"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [ORDERS].Orders_In.Invisible Button24"; $_t_oldMethodName)
