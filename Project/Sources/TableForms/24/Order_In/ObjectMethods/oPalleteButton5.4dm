If (False:C215)
	//object Name: [ORDERS]Orders_In.Invisible Button2
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 13/04/2011 18:47
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_CallBackProcess; $_l_event; $_l_FieldNumber; $_l_Index; $_l_MouseButton; $_l_MouseX; $_l_MouseY; $_l_PopUpProcess; $_l_TableNumber; PAL_BUTTON103)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].Orders_In.Invisible Button2"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		If (Size of array:C274(PAL_at_PopUpMenu5)>=2)
			...
			If (Ok=0)
				PAL_BUTTON:="PAL_BUTTON"+String:C10(103)
			Else 
...
End case 
ERR_MethodTrackerReturn("OBJ [ORDERS].Orders_In.Invisible Button2"; $_t_oldMethodName)
