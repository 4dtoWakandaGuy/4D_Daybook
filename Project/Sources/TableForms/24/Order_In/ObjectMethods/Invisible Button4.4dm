If (False:C215)
	//object Name: [ORDERS]Orders_In.Invisible Button4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].Orders_In.Invisible Button4"; Form event code:C388)

$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
//TRACE
ERR_MethodTrackerReturn("OBJ [ORDERS].Orders_In.Invisible Button4"; $_t_oldMethodName)