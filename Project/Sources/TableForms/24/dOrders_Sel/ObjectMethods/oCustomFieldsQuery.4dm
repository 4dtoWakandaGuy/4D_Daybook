If (False:C215)
	//object Name: [ORDERS]dOrders_Sel.oCustomFieldsQuery
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 23/07/2012 15:25
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dOrders_Sel.oCustomFieldsQuery"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Data Change:K2:15)
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ [ORDERS].dOrders_Sel.oCustomFieldsQuery"; $_t_oldMethodName)
