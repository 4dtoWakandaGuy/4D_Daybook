If (False:C215)
	//object Name: [ORDERS]dOrders_Sel.oOrderDateTUpDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dOrders_Sel.oOrderDateTUpDown"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [ORDERS].dOrders_Sel.oOrderDateTUpDown"; $_t_oldMethodName)
