If (False:C215)
	//object Name: [ORDERS]dOrders_Sel.oOrderDateFUpDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 23/07/2012 19:09
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ORDERS].dOrders_Sel.oOrderDateFUpDown"; Form event code:C388)
	...
	: ($_l_event=On Clicked:K2:4)
		If (ACC_d_EntryDateFrom=!00-00-00!)
			...
			Repeat 
				...
				QUERY:C277([ORDERS:24]; [ORDERS:24]Enquiry_Date:25<ACC_d_EntryDateFrom; *)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [ORDERS].dOrders_Sel.oOrderDateFUpDown"; $_t_oldMethodName)
