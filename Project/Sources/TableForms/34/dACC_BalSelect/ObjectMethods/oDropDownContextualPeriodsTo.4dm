If (False:C215)
	//object Name: [ACCOUNT_BALANCES]dACC_BalSelect.ovPeriodTDropDown
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/08/2012 11:23
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ACCOUNT_BALANCES].dACC_BalSelect.ovPeriodTDropDown"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [ACCOUNT_BALANCES].dACC_BalSelect.ovPeriodTDropDown"; $_t_oldMethodName)
