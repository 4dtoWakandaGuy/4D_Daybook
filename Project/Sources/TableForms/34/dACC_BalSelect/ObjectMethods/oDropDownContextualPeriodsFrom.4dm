If (False:C215)
	//object Name: [ACCOUNT_BALANCES]dACC_BalSelect.oDropDownContextualPeriods
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/08/2012 11:03
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [ACCOUNT_BALANCES].dACC_BalSelect.oDropDownContextualPeriods"; Form event code:C388)
...
Case of 
	: ($_l_event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [ACCOUNT_BALANCES].dACC_BalSelect.oDropDownContextualPeriods"; $_t_oldMethodName)
