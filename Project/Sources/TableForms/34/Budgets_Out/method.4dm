If (False:C215)
	//Table Form Method Name: [ACCOUNT_BALANCES]Budgets_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [ACCOUNT_BALANCES].Budgets_Out"; Form event code:C388)
...
Case of 
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[ACCOUNT_BALANCES:34]); "Budgets_Out")
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[ACCOUNT_BALANCES:34]; ->[ACCOUNT_BALANCES:34]Account_Code:2; ->[ACCOUNT_BALANCES:34]Analysis_Code:1; "Account Balances"; "ACC_BalInBudget"; "ACC_BalSelectBudget"; "Acc_BalOutBudDelete"; "Master"; "Account Balances"; "AccBal_OutCount"; 0; 0)
...
End case 
ERR_MethodTrackerReturn("FM [ACCOUNT_BALANCES].Budgets_Out"; $_t_oldMethodName)
