If (False:C215)
	//Table Form Method Name: [PROBLEMS]Problems_Out
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FM [PROBLEMS].Problems_Out"; Form event code:C388)
...
Case of 
	: ($_l_event=On Header:K2:17)
		If (DEF_l_SettingsCalled=0)
			...
			End if 
			INT_Setoutput(Table:C252(->[PROBLEMS:22]); WIN_t_CurrentOutputform)
	...
	: ($_l_event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		OpenHelp(Table:C252(->[PROBLEMS:22]); "Problems_Out")
		Cache_Initialise
	...
	: ($_l_event=On Outside Call:K2:11)
		Out_ButtCall(->[PROBLEMS:22]; ->[PROBLEMS:22]Problem_Code:1; ->[PROBLEMS:22]Problem_Name:2; "Problems"; "DB_MenuNewRecord"; "Minor_Sel"; "Minor_Del"; ""; "Problems"; ""; 0; 0)
	...
	: ($_l_event=On Close Detail:K2:24)
		$_t_FormReference:=Table name:C256(->[PROBLEMS:22])+"_"+WIN_t_CurrentInputForm  //added NG may 2004
...
End case 
ERR_MethodTrackerReturn("FM:Problems Out"; $_t_oldMethodName)
