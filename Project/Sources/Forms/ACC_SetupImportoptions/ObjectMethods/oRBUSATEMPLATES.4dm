If (False:C215)
	//object Name: Object Name:      ACC_SetupImportoptions.oRBUSATEMPLATES
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 02/07/2013 12:16
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ ACC_SetupImportoptions.oRBUSATEMPLATES"; Form event code:C388)
...
For ($_l_Index; 1; Size of array:C274(ACC_at_TemplateNames))
	...
	End if 
	If (ACC_at_CountryFilter{$_l_Index}="USA")
...
ERR_MethodTrackerReturn("OBJ ACC_SetupImportoptions.oRBUSATEMPLATES"; $_t_oldMethodName)
