If (False:C215)
	//object Method Name: Object Name:      ACC_SetupImportoptions.oCBImportTabDelimted
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ ACC_SetupImportoptions.oCBImportTabDelimted"; Form event code:C388)
...
Case of 
	: ($_l_Event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ ACC_SetupImportoptions.oCBImportTabDelimted"; $_t_oldMethodName)
