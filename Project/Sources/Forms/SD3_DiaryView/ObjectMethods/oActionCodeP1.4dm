If (False:C215)
	//object Name: Object Name:      SD3_DiaryView.oActionCodeP1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.oActionCodeP1"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.oActionCodeP1"; $_t_oldMethodName)
