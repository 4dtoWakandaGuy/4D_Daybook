If (False:C215)
	//object Name: Object Name:      SD3_DiaryView.oTimeFromPopUp
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.oTimeFromPopUpP1"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.oTimeFromPopUpP1"; $_t_oldMethodName)