If (False:C215)
	//object Name: Object Name:      SD3_DiaryView.oButtonExtendDates
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ [DIARY].SD2_Input.oButtonExtendDates"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ [DIARY].SD2_Input.oButtonExtendDates"; $_t_oldMethodName)