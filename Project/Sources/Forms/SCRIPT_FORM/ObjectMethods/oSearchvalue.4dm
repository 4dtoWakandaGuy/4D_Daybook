If (False:C215)
	//object Name: Object Name:      SCRIPT_FORM.oSearchvalue
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 18/08/2012 19:55
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [projectForm]/SCRIPT_FORM/oSearchvalue"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ:SD2_diaryViewer,SD2_T_SearchValue"; $_t_oldMethodName)
