If (False:C215)
	//object Name: Object Name:      LR_LicenceRequest.Variable6
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ LR_LicenceRequest.Variable6")

$_t_oldMethodName:=ERR_MethodTracker("OBJ LR_LicenceRequest.Variable6"; Form event code:C388)
...
Else 
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ LR_LicenceRequest.Variable6"; $_t_oldMethodName)
