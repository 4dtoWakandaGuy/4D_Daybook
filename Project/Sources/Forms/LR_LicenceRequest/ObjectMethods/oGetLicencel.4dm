If (False:C215)
	//object Name: Object Name:      LR_LicenceRequest.oGetLicencel
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/10/2012 09:54
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ LR_LicenceRequest.oGetLicencel")

$_t_oldMethodName:=ERR_MethodTracker("OBJ LR_LicenceRequest.oGetLicencel"; Form event code:C388)
...
Else 
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("OBJ LR_LicenceRequest.oGetLicencel"; $_t_oldMethodName)
