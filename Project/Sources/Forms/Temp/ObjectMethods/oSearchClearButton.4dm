If (False:C215)
	//object Name: Object Name:      Temp.oSearchClearButton
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 10/02/2012 17:28
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oSearchClearButton")

$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oSearchClearButton"; Form event code:C388)
...
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oSearchClearButton"; $_t_oldMethodName)