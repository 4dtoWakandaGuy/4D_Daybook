If (False:C215)
	//object Method Name: Temp.oSearchCriteriaButton
	//------------------ Method Notes ------------------
	//------------------ Revision Control ----------------
	//Date Created: 
	//Created BY: 
...
If (True:C214)
	...
	C_TEXT:C284($_t_CarriageReturn; $_t_OldMethodName; $_t_PopupMenu; $_t_SearchButtonName; $_t_SearchCloseObject; $_t_SearchCriteriaObject; $FocusRing; SD2_t_SearchCriteria; SD2_T_SearchValue)
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [projectForm]/Temp/oSearchCriteriaButton"; Form event code:C388)
If (False:C215)  // ----------------------------------------------------
End if 
