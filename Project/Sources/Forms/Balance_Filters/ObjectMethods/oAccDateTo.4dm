If (False:C215)
	//object Method Name: Object Name:      Balance_Filters.oAccDateTo
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oAccDateTo"; Form event code:C388)
...
Case of 
	: ($_l_Event=On After Keystroke:K2:26)
		...
		If (Character code:C91($_t_Keystroke)#Backspace:K15:36)
			...
			If ($_l_ArrayRow>0)
				...
				//o_ENABLE BUTTON(DB_but_ClearFiltersButton)
			Else 
	...
	: ($_l_Event=On Clicked:K2:4)
		...
		Lay_bo_UpdateFilters:=True:C214
End case 
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oAccDateTo"; $_t_oldMethodName)
