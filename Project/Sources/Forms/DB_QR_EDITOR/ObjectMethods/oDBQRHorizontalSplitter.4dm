If (False:C215)
	//object Name: Object Name:      DB_QR_EDITOR.oDBQRHorizontalSplitter
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 04/12/2011 02:27
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_QR_EDITOR.oDBQRHorizontalSplitter"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ DB_QR_EDITOR.oDBQRHorizontalSplitter"; $_t_oldMethodName)
