If (False:C215)
	//object Name: Object Name:      SD2_WFManager.oPeriodBack
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ SD2_WFManager.oPeriodBack"; Form event code:C388)
...
Case of 
	...
	: (SD2_l_CurrentScheduleView=3)  // Month view
		SD2_D_CurrentDateStart:=SD2_D_CurrentDateStart-1  //The last day of the previous month
...
End case 
ERR_MethodTrackerReturn("OBJ SD2_WFManager.oPeriodBack"; $_t_oldMethodName)
