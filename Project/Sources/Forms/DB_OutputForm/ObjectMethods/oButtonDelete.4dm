If (False:C215)
	//object Name: Object Name:      DB_OutputForm.oButtonDelete
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oButtonDelete")

$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oButtonDelete"; Form event code:C388)
...
Else 
	...
	RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
End if 
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oButtonDelete"; $_t_oldMethodName)
