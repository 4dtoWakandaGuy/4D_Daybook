...
If (False:C215)
	//Object Name:      DB_OutputForm.Invisible Button6
	//------------------ Script Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.Invisible Button6"; Form event code:C388)

$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ:WS_Buttons,PAL_BUTTON_2877"; $_t_oldMethodName)