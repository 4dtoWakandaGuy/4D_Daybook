If (False:C215)
	//object Name: Object Name:      DB_OutputForm.oButtonAccept
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oButtonAccept"; Form event code:C388)

$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oButtonAccept"; $_t_oldMethodName)
