If (False:C215)
	//object Name: Object Name:      DB_OutputForm.oStatsListbox
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/04/2011 21:46
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.oStatsListbox"; Form event code:C388)
...
Case of 
	: ($_l_event=On Double Clicked:K2:5)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ DB_OutputForm.oStatsListbox"; $_t_oldMethodName)
