...
If (False:C215)
	//Object Name:      DB_OutputForm.obuttonConfig
	//------------------ Script Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.obuttonConfig"; Form event code:C388)

$_t_oldMethodName:=ERR_MethodTracker("OBJ DB_OutputForm.obuttonConfig"; Form event code:C388)
$_ptr_PalletButton:=Self:C308
RESOLVE POINTER:C394($_ptr_PalletButton; PAL_BUTTON; $_l_TableNumber; $_l_FieldNumber)
ERR_MethodTrackerReturn("OBJ DB_OutputForm.obuttonConfig"; $_t_oldMethodName)