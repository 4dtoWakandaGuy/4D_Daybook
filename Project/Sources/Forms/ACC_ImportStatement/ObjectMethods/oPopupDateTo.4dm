If (False:C215)
	//object Name: Object Name:      ACC_ImportStatement.oPopupDate1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 20/05/2012 08:32
...
If (True:C214)
	...
	C_DATE:C307(ACC_D_TransactsFrom; Vdate)
	C_TEXT:C284($_t_FormName; $_t_ObjectName; $_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ ACC_ImportStatement.oPopupDate1"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ ACC_ImportStatement.oPopupDate1"; $_t_oldMethodName)
