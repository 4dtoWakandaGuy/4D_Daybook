If (False:C215)
	//object Name: Object Name:      LAYOUT_CONFIG.oFontStyleBold
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/08/2012 16:42
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [projectForm]/LAYOUT_CONFIG/oFontStyleBold"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ LAYOUT_CONFIG.oFontStyleBold"; $_t_oldMethodName)
