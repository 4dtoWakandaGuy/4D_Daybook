If (False:C215)
	//object Name: Object Name:      LAYOUT_CONFIG.oFontStyleitalic
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/08/2012 16:54
...
If (True:C214)
	...
	C_BOOLEAN:C305(DB_bo_RecordModified; LAB_cb_BoldFont; LAB_cb_ItalicFont; LAB_cb_UnerlineFont; LAY_bo_RecordEdited; LAY_bo_ShowLastColumn)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ LAYOUT_CONFIG.oFontStyleitalic"; Form event code:C388)
...
End case 
ERR_MethodTrackerReturn("OBJ LAYOUT_CONFIG.oFontStyleitalic"; $_t_oldMethodName)
