If (False:C215)
	//object Method Name: Object Name:      TEST_SVG.oXAxisField
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 29/07/2011 19:32
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ TEST_SVG.oXAxisField"; Form event code:C388)
$_l_Event:=Form event code:C388
Case of 
	: ($_l_Event=On Clicked:K2:4)
		
		If (DB_at_GraphBreaks>0)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ TEST_SVG.oXAxisField"; $_t_oldMethodName)
