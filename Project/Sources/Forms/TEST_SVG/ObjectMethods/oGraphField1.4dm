If (False:C215)
	//object Method Name: Object Name:      TEST_SVG.oGraphField1
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 02/08/2011 10:41
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ TEST_SVG.oGraphField1"; Form event code:C388)
$_l_Event:=Form event code:C388
Case of 
	: ($_l_Event=On Clicked:K2:4)
		Case of 
			: (DB_al_GraphType{DB_at_GraphType}=2)
				OBJECT SET VISIBLE:C603(*; "oXAxis"; True:C214)
				//SET VISIBLE(
				
				If (DB_at_GraphType>0)
		...
		End case 
End case 
ERR_MethodTrackerReturn("OBJ TEST_SVG.oGraphField1"; $_t_oldMethodName)
