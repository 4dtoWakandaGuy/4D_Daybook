If (False:C215)
	//object Method Name: Object Name:      TEST_SVG.oGraphField2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ TEST_SVG.oGraphField2"; Form event code:C388)
...
Case of 
	: ($_l_Event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ TEST_SVG.oGraphField2"; $_t_oldMethodName)
