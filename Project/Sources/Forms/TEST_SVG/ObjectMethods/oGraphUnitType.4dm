If (False:C215)
	//object Method Name: Object Name:      TEST_SVG.oGraphUnitType
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 29/07/2011 19:39
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ TEST_SVG.oGraphUnitType"; Form event code:C388)
...
Case of 
	: ($_l_Event=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ TEST_SVG.oGraphUnitType"; $_t_oldMethodName)
