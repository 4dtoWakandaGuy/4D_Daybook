If (False:C215)
	//object Method Name: Object Name:      CON_ContSel.Variable56
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>PER_l_CurrentUserID; $_l_Event; $_l_SearchID; $_l_TableNumber; ch1; cNAA; cNAL; cSetAdd; cSetMod; cSIS; SM_l_QueryMode)
	C_LONGINT:C283(SM_l_ReturnQueryID; vAct1; vAct2; vAct3; vAct4; vAct5; vNo1; vNo2; vNo3; vNo4; vNo5)
	...
	C_TEXT:C284(Vomit; Vperson; VPostCode; vProdCode; Vrole; VSales; Vsource; Vstatus; vSubGroup1; vSubGroup2; vSubGroup3)
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ CON_ContSel.Variable56"; Form event code:C388)
...
Case of 
	: ($_l_Event=On Clicked:K2:4)
			...
			Case of 
				: (SM_al_SearchIDs{SM_at_SearchNames}>0)
					...
					If (SM_l_QueryMode#0)
						...
						End if 
						Gen_Set_enterable($_bo_Enterable; ->vCompCode; ->Vtitle; ->VForeName; ->Vsurname; ->VJobTitle; ->Vstatus; ->Vtype_; ->Vsource; ->ACC_d_EntryDateFrom; ->SRCH_d_EntryDateTo; ->VsDateF; ->VsDateT; ->VCompName; ->Vtown)
				...
				: (SM_al_SearchIDs{SM_at_SearchNames}<0)  //Resave
					...
					SM_SearchVarsToBlob(->SM_blb_SearchBlob; ->vCompCode; ->Vtitle; ->VForeName; ->Vsurname; ->VJobTitle; ->Vstatus; ->Vtype_; ->Vsource; ->ACC_d_EntryDateFrom; ->SRCH_d_EntryDateTo; ->VsDateF; ->VsDateT; ->VCompName; ->Vtown)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ CON_ContSel.Variable56"; $_t_oldMethodName)
