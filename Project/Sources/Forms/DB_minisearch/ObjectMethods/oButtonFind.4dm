...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [projectForm]/DB_minisearch/oButtonFind"; Form event code:C388)
Case of 
	: (Form event code:C388=On Clicked:K2:4)
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [projectForm]/DB_minisearch/oButtonFind"; $_t_oldMethodName)
