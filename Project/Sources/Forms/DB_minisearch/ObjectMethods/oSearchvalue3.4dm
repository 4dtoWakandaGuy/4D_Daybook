...
If (True:C214)
	...
	C_TIME:C306($_ti_CurrentText)
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [projectForm]/DB_minisearch/oSearchvalue3"; Form event code:C388)
...
Case of 
	...
	: ($_l_FormEvent=On Losing Focus:K2:8)
		...
		$_ti_CurrentText:=SD2_to_SearchValue  //Get edited text
		If ($_ti_CurrentText#?00:00:00?)
	...
	: ($_l_FormEvent=On After Edit:K2:43)
		...
		SRCH_t_SearchValue:=$_t_CurrentText
End case 
ERR_MethodTrackerReturn("OBJ [projectForm]/DB_minisearch/oSearchvalue3"; $_t_oldMethodName)
