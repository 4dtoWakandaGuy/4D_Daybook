...
If (False:C215)
	//Object Name:      DB_minisearch.Datepicker
	//------------------ Script Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("OBJ [projectForm]/DB_minisearch/Datepicker"; Form event code:C388)
...
Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		If ($_bo_Customise)
			DatePicker SET MIN DATE($_t_FormName; Add to date:C393(Current date:C33; 0; 0; -15))  //min date is current date minus 15 days
		...
		End if 
End case 
ERR_MethodTrackerReturn("OBJ [projectForm]/DB_minisearch/Datepicker"; $_t_oldMethodName)
