If (False:C215)
	//object Name: Object Name:      Cal4D_Cal_CalenderwithMinis_d.oCal_ab_ListboxCalender
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ Cal4D_Cal_CalenderwithMinis_d.oCal_ab_ListboxCalender"; Form event code:C388)

If (True:C214)
	If (False:C215)
		//*****************************************************************************
		////
		////  Object Method: Cal4D_Cal_CalendarWithMinis_d.◊Cal_lb_ListboxCalender
		////
		////  Written by Charles Vass - 04/28/2009, 09:58
		////
		////  Purpose:
		////
		////  $1 - type - purpose
...
//EOM
ERR_MethodTrackerReturn("OBJ Cal4D_Cal_CalenderwithMinis_d.oCal_ab_ListboxCalender"; $_t_oldMethodName)
