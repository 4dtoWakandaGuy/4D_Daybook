If (False:C215)
	//object Name: Object Name:      Cal4D_Cal_CalenderwithMinis_d.3DBTN_Next_Mini
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OBJ Cal4D_Cal_CalenderwithMinis_d.3DBTN_Next_Mini"; Form event code:C388)

If (True:C214)
	If (False:C215)
		//*****************************************************************************
		////
		////  Object Method: Cal4D_Cal_CalendarWithMinis_d.3DBTN_Previous
		////
		////  Written by Charles Vass - 03/04/2009, 12:04
		////
		////  Purpose:
		////
		////  $1 - type - purpose
...
Case of 
	: ($_l_FormEvent=On Clicked:K2:4)
		Cal4D_OM_CalWithMinis_BTN("Mini_Next")
		//
		//--------------------------------------------------------------------------------
...
//EOM
ERR_MethodTrackerReturn("OBJ Cal4D_Cal_CalenderwithMinis_d.3DBTN_Next_Mini"; $_t_oldMethodName)
