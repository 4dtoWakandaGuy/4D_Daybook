If (False:C215)
	//object Name: Object Name:      ACC_ReconcileSelectTransactions.oButtonNext
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_BOOLEAN:C305(ABR_bo_NextRecord)
	C_REAL:C285(ACC_R_SelectedReconcilles)
	C_TEXT:C284($_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("OBJ ACC_ReconcileSelectTransactions.oButtonNext"; Form event code:C388)
...
Else 
	ABR_bo_NextRecord:=True:C214
	ACCEPT:C269
End if 
ERR_MethodTrackerReturn("OBJ ACC_ReconcileSelectTransactions.oButtonNext"; $_t_oldMethodName)
