...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_4DWriteInstalled; CON_bo_Chargable; CON_bo_LoansBilling; CON_bo_PartsBilling; CON_bo_TimeOption; CONT_bo_FurtherFieldsLoaded; SVS_bo_Chargable; SVS_bo_LoansBilling; SVS_bo_PartsBilling; SVS_bo_Sheduled; SVS_bo_TimeOption)
	C_DATE:C307(<>DB_d_CurrentDate; vPDateF)
	...
	C_LONGINT:C283(CON2_iRB_ChargePartPeriod; CON2_iRB_ChargePartPeriodnil; CON2_iRB_ChargeProRata; CONT_4DWriteText; CONT_l_BUT1; CONT_l_BUT2; CONT_l_BUT3; CONT_l_BUT4; CONT_l_BUT5; CONT_l_BUT6; CONT_l_BUT7)
	C_LONGINT:C283(CONT_l_BUT8; CONT_l_BUT9; CONT_l_FurtherFieldsMod; CONT_l_OpenEndedStatus; CONT_l_ViewTabsSelectedOLD; SVS_l_ChargeLoanOption; SVS_l_ChargePeriodType; SVS_l_LoansPricePeriod; SVS_l_TimeBilling; SVS_l_TimeMinimum; SVS_l_TimePerUnit)
	C_LONGINT:C283(vOR)
	...
	C_TEXT:C284(CON_t_PartsPriceGroup; Cont_T_BillingProductName; CONT_t_LoansPriceGroup; CONT_t_LoansPriceGroupOLD; CONT_t_PartsPriceGroup; CONT_t_PartsPriceGroupOLD; DB_t_CallOnCloseorSave; oContracttp_COL1; oContracttp_COL2; oContracttp_COL3; oContracttp_COL4)
	C_TEXT:C284(oContracttp_COL5; oContracttp_COL6; oContracttp_COL7; oContracttp_COL8; oContracttp_COL9; oContracttp_HED1; oContracttp_HED2; oContracttp_HED3; oContracttp_HED4; oContracttp_HED5; oContracttp_HED6)
	C_TEXT:C284(oContracttp_HED7; oContracttp_HED8; oContracttp_HED9; SD_t_CallingCompanyCode; SD_t_CallingContactCode; SVS_t_CurrencyCode; SVS_t_LoansPriceGroup; SVS_t_PartsPriceGroup; vButtDisCNTR; vCompName; vStage)
	C_TEXT:C284(vTel)
End if 
//Code Starts Here
...
If (DB_UserHas4DWriteAccess)
	//$_t_DocumentWriteType:=LettersWrit(True)
