//%attributes = {}
If (False:C215)
	//Project Method Name:      Invoices_PPrint
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 24/11/2009 15:32`Method: Invoices_PPrint
...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Accept; $_bo_isPosted; $1; $2; INV_bo_Addingitem; INV_bo_newInvoice; PRT_bo_AskPerIteration; PRT_bo_AutoIteration; PRT_bo_ToPdf; PRT_bo_ToScreenPreview; SR_bo_Validated)
	C_BOOLEAN:C305($_bo_Accept; $_bo_Continue; $_bo_isPosted; $1; INV_bo_Addingitem; INV_bo_newInvoice; PRT_bo_AskPerIteration; PRT_bo_AutoIteration; PRT_bo_ToPdf; PRT_bo_ToScreenPreview; SR_bo_Validated)
	C_DATE:C307(vInvDate)
	C_LONGINT:C283(PRT_Count; vRe; VADD)
	C_REAL:C285(vTotal)
	...
	C_TEXT:C284(vNumber; $_t_CurrentFormUsage; $_t_CurrentWindowTitle; $_t_DocumentName; $_t_InvoiceTitle; $_t_oldMethodName; $_t_PrintText; $_t_WindowTitle; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage3; PRT_t_pdfOutputFilePath)
	C_TEXT:C284(vComments; vText)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Invoices_PPrint")
//TRACE
Invoices_FormL2
SR_bo_Validated:=False:C215
//Project Method Invoices_PPrint/3/2(ID-1792-8380)
...
//Invoices_PPrint
Menu_Record("Invoices_PPrint"; "Print")
							...
							If (OK=1)
								...
								If (OK=1)
									...
									If (([INVOICES:39]Delivery_Company:30#"") | ([INVOICES:39]Deliver_To:32#"") | ([INVOICES:39]x_DeliveryAddressID:48>0))
										...
										If (Count parameters:C259>=2)
											If ($2)
												$_bo_Continue:=Gen_PPSingle_2(->[INVOICES:39]; ->[INVOICES_ITEMS:161]; "Form_DT2"; "INVFormSub2"; "Invoices_Out"; DB_t_CurrentFormUsage; "Invoice_DT"; "Invoices_FormL2"; 0; ->[INVOICES:39]State:10; "Invoice_DT"; [INVOICES:39]Analysis_Code:17)  // 08/04/04 pb
									...
									Else 
										If (Count parameters:C259>=2)
											If ($2)
												...
												$_bo_Continue:=Gen_PPSingle_2(->[INVOICES:39]; ->[INVOICES_ITEMS:161]; "Form2"; "INVFormSub2"; "Invoices_Out"; DB_t_CurrentFormUsage; "Invoice"; "Invoices_FormL2"; 0; ->[INVOICES:39]State:10; "Invoice"; [INVOICES:39]Analysis_Code:17)  // 08/04/04 pb
...
ERR_MethodTrackerReturn("Invoices_PPrint"; $_t_oldMethodName)
