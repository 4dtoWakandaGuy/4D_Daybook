//%attributes = {}
If (False:C215)
	//Project Method Name:      Contracts_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Contracts_File")
//Contracts_File

FORM SET INPUT:C55([CONTRACTS:17]; "Contract_in")  //NG April 2004 removed reference to ◊screen
WIN_t_CurrentInputForm:="Contract_in"
FORM SET OUTPUT:C54([CONTRACTS:17]; "Contracts_Out")
WIN_t_CurrentOutputform:="Contracts_Out"
vContr:=1
...
End if 
ERR_MethodTrackerReturn("Contracts_File"; $_t_oldMethodName)