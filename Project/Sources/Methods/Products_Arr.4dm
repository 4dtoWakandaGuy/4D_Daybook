//%attributes = {}
If (False:C215)
	//Project Method Name:      Products_Arr
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 21/11/2009`Method: Products_Arr`Description
...
$_t_oldMethodName:=ERR_MethodTracker("Products_Arr")
//Products_Arr
...
GEN_ar_Value:=1
ERR_MethodTrackerReturn("Products_Arr"; $_t_oldMethodName)