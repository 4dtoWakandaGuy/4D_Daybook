//%attributes = {}
If (False:C215)
	//Project Method Name:      Purch_InPLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purch_InPLP")
//Project Method Purch_InPLP 26/3/2(ID 695-4022)
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		Purch_InPLPB
		OpenHelp(Table:C252(->[PURCHASE_INVOICES:37]); "Purchases_inP")
		...
		DB_SetInputFormMenu(Table:C252(->[PURCHASE_INVOICES:37]); "Purchases_inP")
	...
	: ($_l_Event=On Deactivate:K2:10)
		// PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("Purch_InPLP"; $_t_oldMethodName)
