//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_Status
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_Status")
Case of 
...
End case 
//Case of   `NB Duplicated into Orders_Out LP & OutV LP
//  : ([ORDERS]State=-4)
//  vStatus:="Lost Order"
...
// vDate:=!00/00/00!
//End case
ERR_MethodTrackerReturn("Orders_Status"; $_t_oldMethodName)