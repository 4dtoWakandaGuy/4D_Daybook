...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Resolved; DB_bo_NoLoad; DB_bo_RecordModified; PAL_bo_ButtonSubFunction; $_bo_Expanded; $_bo_Resolved; DB_bo_NoLoad; DB_bo_RecordModified; PAL_bo_ButtonSubFunction)
	C_DATE:C307(<>DB_d_CurrentDate)
	C_LONGINT:C283($_l_FieldNumber; $_l_Index; $_l_ItemReference; $_l_offset; $_l_ProblemTypePosition; $_l_SelectedItemParent; $_l_SelectedListItem; $_l_SublistID; $_l_TableNumber; DB_l_ButtonClickedFunction; iOK)
	C_LONGINT:C283(PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord; SC_l_problemtypes; SVS_l_ChargableCall; SVS_l_MaxResponseTime; $_l_Event; $_l_FieldNumber; $_l_Index; $_l_ItemReference)
	C_LONGINT:C283($_l_offset; $_l_ProblemTypePosition; $_l_SelectedItemParent; $_l_SelectedListItem; $_l_SublistID; $_l_TableNumber; DB_l_ButtonClickedFunction; iCancel; SC_l_problemtypes; SVS_l_ChargableCall; SVS_l_MaxResponseTime)
	C_PICTURE:C286(SC_pic_LBMode; SC_Pi_PartsMode; SC_pic_LBMode)
	C_POINTER:C301($_ptr_FocusObject)
	C_REAL:C285(vTot; $1)
	C_TEXT:C284($_t_ItemText; $_t_oldMethodName; $_t_PalletButtonName; $_t_VariableName; COM_t_TelephoneNumberFormat; DB_t_CUrrentInputMenuRef; DB_T_CurrentInputWindowMenu; PAL_BUTTON; SVS_t_CallPriority; SVS_t_CompDetails; SVS_t_Mobile)
	C_TEXT:C284(vButtDisSC; vCompName; vStage; vTel; WIN_t_CurrentInputForm; <>SYS_t_DefaultTelFormat; $_t_ItemText; $_t_oldMethodName; $_t_PalletButtonName; $_t_VariableName; COM_t_TelephoneNumberFormat)
	C_TEXT:C284(DB_t_CUrrentInputMenuRef; DB_T_CurrentInputWindowMenu; SVS_t_CallPriority; SVS_t_CompDetails; SVS_t_emailAddress; SVS_t_Mobile; WIN_t_CurrentInputForm)
...
Case of 
	...
	: ($_l_Event=On Activate:K2:9)
		DB_SetInputFormMenu(Table:C252(->[SERVICE_CALLS:20]); "Calls_in")
		OpenHelp(Table:C252(->[SERVICE_CALLS:20]); "Calls_In")
			...
			: (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Plus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Minus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Open"))
				...
				Case of 
					: (FORM Get current page:C276=1)
						...
						inButtSubHandle(FORM Get current page:C276; ->[SERVICE_CALLS:20]; "Calls_in")
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		WS_AutoscreenSize(1; 450; 1200; Table name:C256(->[SERVICE_CALLS:20])+"_"+"Calls_in")
