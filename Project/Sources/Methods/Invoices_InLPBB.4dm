...
If (True:C214)
	//C_UNKNOWN(baddressModify)
	//C_UNKNOWN(vTot)
	//ARRAY TEXT(INV_at_ViewTabsLabels;0)
	//ARRAY TEXT(INV_at_ViewTabsLabelsOLD;0)
	C_BOOLEAN:C305(INV_bo_FurtherFieldsLoaded; INV_bo_newInvoice; <>SalesHdrDP; INV_bo_FurtherFieldsLoaded; INV_bo_newInvoice)
	C_LONGINT:C283(baddressModify; INV_at_ViewTabsLabelsOLD; INV_l_AdhocMod; $_l_FurtherFieldsExist; INV_l_AdhocMod; INV_l_FurtherFieldsMod)
	C_REAL:C285(vTot)
	C_TEXT:C284(<>DB_t_Address2Label; <>DB_t_CountryLabel; <>DB_t_CountyLabel; <>DB_t_PostcodeLabel; <>DB_t_TownLabel; $_t_oldMethodName; COM_t_titleVAT; DB_t_CallOnCloseorSave; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; INV_t_AddressLine1)
	C_TEXT:C284(INV_t_AddressLine1_OLD; INV_t_AddressLine2; INV_t_AddressLine2_OLD; INV_t_Country; INV_t_Country_OLD; INV_t_County; INV_t_County_OLD; INV_t_PostalCode; INV_t_PostalCode_OLD; INV_t_Town_OLD; <>DB_t_Address1Label)
	C_TEXT:C284(<>DB_t_Address2Label; <>DB_t_CountryLabel; <>DB_t_CountyLabel; <>DB_t_PostcodeLabel; <>DB_t_TownLabel; $_t_oldMethodName; COM_t_titleVAT; DB_t_CallOnCloseorSave; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; INV_t_AddressLine1)
	C_TEXT:C284(INV_t_AddressLine1_OLD; INV_t_AddressLine2; INV_t_AddressLine2_OLD; INV_t_Country; INV_t_Country_OLD; INV_t_County; INV_t_County_OLD; INV_t_PostalCode; INV_t_PostalCode_OLD; INV_t_Town; INV_t_Town_OLD)
End if 
//Code Starts Here
...
vTot:=0
Invoices_InLPTi
COM_t_titleVAT:=Term_VATWT("Reg No")
INV_t_AddressLine1:=""
INV_t_AddressLine2:=""
INV_t_Town:=""
INV_t_County:=""
