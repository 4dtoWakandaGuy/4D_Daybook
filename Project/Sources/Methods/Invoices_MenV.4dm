//%attributes = {}
If (False:C215)
	//Project Method Name:      Invoices_MenV
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Invoices_MenV")
If (Count parameters:C259>=1)
	$_l_MenuOption:=$1
Else 
	$_l_MenuOption:=Sel_LPmi("Invoices_MenV")
End if 
...
End if 
ERR_MethodTrackerReturn("Invoices_MenV"; $_t_oldMethodName)