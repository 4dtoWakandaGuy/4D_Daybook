//%attributes = {}
If (False:C215)
	//Project Method Name:      Letters_SWMerSp
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letters_SWMerSp")
//Letters_SWMerSp - merge special
...
End if 
ERR_MethodTrackerReturn("Letters_SWMerSp"; $_t_oldMethodName)