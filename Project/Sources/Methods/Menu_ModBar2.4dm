//%attributes = {}
If (False:C215)
	//Project Method Name:      Menu_ModBar2
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>BAR; <>MENU_l_BarModule; <>MenuProc; <>Mod_l_MaxModules; <>PER_l_CurrentUserID; <>SYS_l_WindowTop; <>WIN_MINTOP; $_l_CurrentWinRefOLD; $_l_DefaultSpaceRequired; $_l_MaxBarWidth; $_l_MenuBarScreen)
	C_LONGINT:C283($_l_VisibleModules; $_l_Windowbottom; $_l_Windowleft; $_l_Windowright; $_l_WindowTop; vSNo; WIN_l_CurrentWinRef; WIN_l_CurrentWinRefOLD)
	C_OBJECT:C1216($_Obj_Form; $_Obj_GetUser; $_Obj_ToolbarForm)
	C_TEXT:C284($_t_FormPath; $_t_oldMethodName; $_t_oldMethodName2; $_t_VolumesMenuName; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3)
	C_TIME:C306(vTime)
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Menu_ModBar2")


//ALERT("Starting MenuModBar2, 1")
//Menu_ModBar2 - the new Modules palette
...
If ($_bo_BarState) | (True:C214)
	If (True:C214)
		...
		//$_Obj_Form:=
		//}}}} ) //-> Function result 
		$_Obj_ToolbarForm:=New object:C1471
		//$_ToolbarForm:=FORM Convert to dynamic([COMPANIES]; "WS_TOOLBAR")
		//TRACE
		//$_t_FormPath:="/Project/Sources/TableForms/2/WS_TOOLBAR"
	...
	Else 
		...
		$_Obj_ToolbarForm:=New object:C1471
		$_ToolbarForm:=FORM Convert to dynamic:C1570([COMPANIES:2]; "WS_TOOLBAR")
		//DIALOG($_Obj_ToolbarForm; *)
		//$_obj_Form:=
		DIALOG:C40([COMPANIES:2]; "WS_TOOLBAR")
		WIN_l_CurrentWinRef:=$_l_CurrentWinRefOLD
	End if 
...
ERR_MethodTrackerReturn("Menu_ModBar2"; $_t_oldMethodName)
