//%attributes = {}
If (False:C215)
	//Project Method Name:      TransB_Audit
	//------------------ Method Notes ------------------
...
If (True:C214)
	//C_UNKNOWN(vNo)
	//C_UNKNOWN(vTr)
	C_LONGINT:C283(MOD_l_CurrentModuleAccess; vNo; vTr; $_l_OK; MOD_l_CurrentModuleAccess)
...
$_t_oldMethodName:=ERR_MethodTracker("TransB_Audit")
//TransB_Audit
...
ERR_MethodTrackerReturn("TransB_Audit"; $_t_oldMethodName)
