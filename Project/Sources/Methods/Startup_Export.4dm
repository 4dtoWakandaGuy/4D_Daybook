//%attributes = {}
If (False:C215)
	//Project Method Name:      Startup_Export
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Startup_Export")
//Startup_Export
...
DIALOG:C40([COMPANIES:2]; "dStartup_Export")
CLOSE WINDOW:C154
If (OK=1)
	$_l_PictureDoc:=0
	...
	If ($_l_Accessible>0)
		...
		If (OK=1)
			...
			End if 
			If (r0=1)
				SEND PACKET:C103(vDoc; "Field:"+STR_LeadZeros(String:C10(vNo1); 3)+" Record:"+STR_LeadZeros(String:C10(vNo2); 3)+"/"+STR_LeadZeros(String:C10(vNo3); 3)+vRec+vText)
...
Process_End
ERR_MethodTrackerReturn("Startup_Export"; $_t_oldMethodName)
