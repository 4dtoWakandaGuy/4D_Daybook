//%attributes = {}
If (False:C215)
	//Project Method Name:      Letter_Text
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letter_Text")
//Letter_Text as Now in Daybook
...
If (WIN_t_CurrentInputForm="Letters_inW")
	[DOCUMENTS:7]Write_:5:=WR Area to picture:P12000:139(WRITE; 1; 1)
	
End if 
ERR_MethodTrackerReturn("Letter_Text"; $_t_oldMethodName)