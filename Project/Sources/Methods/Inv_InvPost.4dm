//%attributes = {}
If (False:C215)
	//Project Method Name:      Inv_InvPost
	//------------------ Method Notes ------------------
	//TRACE
...
$_t_oldMethodName:=ERR_MethodTracker("Inv_InvPost")
//Project Method Inv_InvPost 26/3/2(ID 8913-3372)
//Invoices_InvPost
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Inv_InvPost"; $_t_oldMethodName)