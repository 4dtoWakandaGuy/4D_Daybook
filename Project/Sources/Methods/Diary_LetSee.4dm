//%attributes = {}
If (False:C215)
	//Project Method Name:      Diary_LetSee
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_BOOLEAN:C305($_bo_Update; $_bo_WPAccess; DB_bo_RecordModified; DOC_bo_FromDiary; Mail_bo_inOK)
...
$_t_oldMethodName:=ERR_MethodTracker("Diary_LetSee")
//Diary_LetSee

DOC_bo_FromDiary:=True:C214
Menu_Record("Diary_LetSee"; "View Document")
	...
	If (Records in selection:C76([DOCUMENTS:7])>0)
		...
		If (OK=1)
			...
			If (Records in selection:C76([DOCUMENTS:7])>0)
				...
				Open_Pro_Window("Open Document"; 0; 2; ->[DOCUMENTS:7]; WIN_t_CurrentInputForm)
...
ERR_MethodTrackerReturn("Diary_LetSee"; $_t_oldMethodName)