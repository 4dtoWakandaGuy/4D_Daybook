...
If (True:C214)
	...
	//C_UNKNOWN(vCompNameA)
	//C_UNKNOWN(vCompNameC)
	//C_UNKNOWN(vContNameA)
	//C_UNKNOWN(vDetails)
	//C_UNKNOWN(vExtnA)
	//C_UNKNOWN(vExtnC)
	//C_UNKNOWN(vTelA)
	...
	//ARRAY TEXT(STK_at_DeliveryLocationNAME;0)
	...
	C_BOOLEAN:C305(<>SalesItemDP; $_bo_LocationFound; $_bo_ReadOnly; $_bo_Set; DB_bo_NoLoad; DB_bo_RecordModified; PAL_bo_ButtonSubFunction; PO_bo_AddItem; <>DB_bo_NewStockActive; $_bo_LocationFound; $_bo_ReadOnly)
	C_BOOLEAN:C305($_bo_Set; DB_bo_NoLoad; DB_bo_RecordModified; PAL_bo_ButtonSubFunction; PO_bo_AddItem)
	C_LONGINT:C283($_l_ButtonNumber; $_l_CalledFromProcess; $_l_CharacterPosition; $_l_Column; $_l_CommentObjectRight; $_l_CopyLinesIndex; $_l_CurrentWinRefOLD; $_l_Event; $_l_FieldNumber; $_l_Index; $_l_ObjectBottom)
	C_LONGINT:C283($_l_ObjectBottom2; $_l_ObjectBottom3; $_l_ObjectLeft; $_l_ObjectLeft2; $_l_ObjectLeft3; $_l_ObjectRight; $_l_ObjectRight2; $_l_ObjectRight3; $_l_ObjectTop; $_l_ObjectTop3; $_l_ObjectWidth)
	C_LONGINT:C283($_l_Row; $_l_SizeofArray; $_l_TableNumber; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight; $_l_windowTop; $1; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; iCancel)
	C_LONGINT:C283(iOK; ModuleNumber; PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord; SD2_l_CallingProcess; WIN_l_CurrentWinRef; WIN_l_CurrentWinRefOLD; $_l_AddedLineNumber; $_l_ButtonNumber)
	C_LONGINT:C283($_l_CalledFromProcess; $_l_CharacterPosition; $_l_Column; $_l_CommentObjectRight; $_l_CopyLinesIndex; $_l_CurrentWinRefOLD; $_l_Event; $_l_FieldNumber; $_l_Index; $_l_ModuleRow; $_l_ObjectBottom)
	C_LONGINT:C283($_l_ObjectBottom2; $_l_ObjectBottom3; $_l_ObjectLeft; $_l_ObjectLeft2; $_l_ObjectLeft3; $_l_ObjectRight; $_l_ObjectRight2; $_l_ObjectRight3; $_l_ObjectTop; $_l_ObjectTop2; $_l_ObjectTop3)
	C_LONGINT:C283($_l_ObjectWidth; $_l_Row; $_l_SizeofArray; $_l_TableNumber; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowRight; $_l_windowTop; $1; baddressModify; DB_l_ButtonClickedFunction)
	C_LONGINT:C283(DB_l_WindowCurrentModule; PO_l_ItemId; SD2_l_CallingProcess; SD2_l_TableNum; WIN_l_CurrentWinRef)
	C_PICTURE:C286(PO_pic_EditMode)
	C_POINTER:C301($_ptr_ArrayOfArrayNames; $_ptr_ArrayofArrayPointers; $_ptr_ArrayOfColumFormats; $_Ptr_ArrayofColumnFormulas; $_ptr_ArrayReferences; $_ptr_EnterabilityArray; $_ptr_FocusObject; $_ptr_LBTable; $_Ptr_ThisColumnArray; $_ptr_ArrayFieldPointers; $_ptr_ArrayofArrayPointers)
	C_POINTER:C301($_ptr_ArrayReferences; $_ptr_EnterabilityArray; $_ptr_FocusObject; $_ptr_LBTable; $_Ptr_ThisColumnArray)
	C_REAL:C285(vTot)
	C_TEXT:C284(<>SYS_t_DefaultTelFormat; $_t_CompNameC; $_t_DummyTab; $_t_oldMethodName; $_t_PalletButtonName; $_t_PurchaseCompanyCode; $_t_SubItemName; $_t_VariableName; $_t_WindowTitle; BAR_t_Button; DB_t_CUrrentInputMenuRef)
	C_TEXT:C284(DB_T_CurrentInputWindowMenu; PAL_BUTTON; PO_t_AddressLine1; PO_t_AddressLine2; PO_t_Country; PO_t_County; PO_t_DeliveryAddress; PO_t_FalseTab; PO_t_PostalCode; PO_t_RelatedRecordOLD; PO_t_TabFunction)
	C_TEXT:C284(PO_t_Town; SD2_t_TabFunction; STK_at_DeliveryLocationNAME; STK_t_DeliveryLocationNAME; vButtDisInv; vCompNameA; vCompNameC; vContNameA; vDetails; vExtnA; vExtnC)
	C_TEXT:C284(vTelA; vTelC; WIN_t_CurrentInputForm; <>SYS_t_BaseCurrency; <>SYS_t_DefaultTelFormat; $_t_CompNameC; $_t_DummyTab; $_t_oldMethodName; $_t_PalletButtonName; $_t_PurchaseCompanyCode; $_t_SubItemName)
	C_TEXT:C284($_t_VariableName; $_t_WindowTitle; BAR_t_Button; COM_t_TelephoneNumberFormat; DB_t_CUrrentInputMenuRef; DB_T_CurrentInputWindowMenu; PO_t_AddressLine1; PO_t_AddressLine2; PO_t_Country; PO_t_County; PO_t_DeliveryAddress)
	C_TEXT:C284(PO_t_FalseTab; PO_t_PostalCode; PO_t_RelatedRecord; PO_t_RelatedRecordOLD; PO_t_TabFunction; PO_t_Town; SD2_t_TabFunction; STK_t_DeliveryLocationNAME; vContNameC; WIN_t_CurrentInputForm)
End if 
//Code Starts Here
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		PurchOrd_InLPB
		PurchOrd_InLPß("B")
		OpenHelp(Table:C252(->[PURCHASE_ORDERS:57]); "PurchaseOrder_In")
		WS_AutoscreenSize(1; 560; 800; Table name:C256(->[PURCHASE_ORDERS:57])+"_"+"PurchaseOrder_In")
		...
		DB_SetInputFormMenu(Table:C252(->[PURCHASE_ORDERS:57]); "PurchaseOrder_In")
