//%attributes = {}
If (False:C215)
	//Project Method Name:      OrderI_SubSubs
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OrderI_SubSubs")
//OrderI_SubSubs - criptions
...
If ([ORDER_ITEMS:25]Product_Code:2#"")
	...
	End if 
End if 
ERR_MethodTrackerReturn("OrderI_SubSubs"; $_t_oldMethodName)