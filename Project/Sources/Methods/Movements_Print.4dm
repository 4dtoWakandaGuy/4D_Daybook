//%attributes = {}
If (False:C215)
	//Project Method Name:      Movements_Print
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Movements_Print")
//Movements_Print
Menu_Record("Movements_Print"; "Print Movement")
...
If (In_ButtChkMan(->[STOCK_MOVEMENTS:40]; "1 5 6"))
	...
	If (OK=1)
		...
		If (OK=1)
			Movements_Prin2
			//  OUTPUT LAYOUT([STOCK MOVEMENTS];"Movt_Form")
			// PRINT RECORD([STOCK MOVEMENTS])
			//   OUTPUT LAYOUT([STOCK MOVEMENTS];"Movements_out")
			If (OK=1)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Movements_Print"; $_t_oldMethodName)
