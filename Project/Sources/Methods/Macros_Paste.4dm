//%attributes = {}
If (False:C215)
	//Project Method Name:      Macros_Paste
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Macros_Paste")
Menu_Record("Macros_Paste"; "Paste Current Macro")
...
ERR_MethodTrackerReturn("Macros_Paste"; $_t_oldMethodName)