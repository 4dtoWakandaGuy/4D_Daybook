//%attributes = {}
If (False:C215)
	//Project Method Name:      Letter_Replace
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letter_Replace")
//Project Method Letter_Replace 2/3/2(ID 19066-2744)
...
If (Count parameters:C259=0)
	Diary_InLLPQtnR
End if 
ERR_MethodTrackerReturn("Letter_Replace"; $_t_oldMethodName)