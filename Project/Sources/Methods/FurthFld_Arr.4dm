//%attributes = {}
If (False:C215)
	//Project Method Name:      FurthFld_Arr
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FurthFld_Arr")
//FurthFld_Arr
...
If (True:C214)
	If (Count parameters:C259>=1)
		...
		If (Records in selection:C76([CUSTOM_FIELD_DEFINITiONS:99])>0)
			$_t_AccessCode:=STR_LeadZeros(String:C10($_l_TableNumber); 3)+Str_TrailSpaces(<>PER_t_CurrentUserInitials; 5)+"@"
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("FurthFld_Arr"; $_t_oldMethodName)