//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_POTrans
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 07/12/2009 19:27`Method: Orders_POTrans
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_POTrans")
//Orders_POTrans
StartTransaction
...
ERR_MethodTrackerReturn("Orders_POTrans"; $_t_oldMethodName)