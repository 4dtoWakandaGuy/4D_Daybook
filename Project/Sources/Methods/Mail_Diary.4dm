//%attributes = {}
If (False:C215)
	//Project Method Name:      Mail_Diary
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Mail_Diary")
//Mail_Diary
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Start_Process
Start_ProcMail
If (Diary_FileL)
	FORM SET OUTPUT:C54([DIARY:12]; "Diary_Out")
	WIN_t_CurrentOutputform:="Diary_Out"
		...
		If (vD=1)
			If (Records in selection:C76([DIARY:12])>0)
				...
				If (DB_t_CurrentFormUsage#"Button")
					...
					Open_Pro_Window("Mail_Diary"; 0; 1; ->[DIARY:12]; WIN_t_CurrentOutputform)
...
ERR_MethodTrackerReturn("Mail_Diary"; $_t_oldMethodName)
