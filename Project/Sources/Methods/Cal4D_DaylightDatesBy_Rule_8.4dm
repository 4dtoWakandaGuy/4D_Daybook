...
If (False:C215)
	//Project Method Name:      Cal4D_DaylightDatesBy_Rule_8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Cal4D_DaylightDatesBy_Rule_8")
...
Case of 
	...
	: ($_t_Request="StartRule")
		////  begins on the second Sunday in March
		$_t_DtTiStr:="BYMONTH="+String:C10(March:K10:3)+";BYDAY=2SU"
		
	: ($_t_Request="EndDate")
		$_t_Mon:=String:C10(October:K10:10; "00")
		$_l_1stDayNo:=Day number:C114(Date:C102($_t_Mon+"/01/"+String:C10(Year of:C25($_d_Date))))
		////    ends on the first first Sunday in October.
		$_t_DtTiStr:=$_t_DtTiStr+$_t_Mon
		Case of 
			: ($_l_1stDayNo=Monday:K10:13)
...
$0:=$_t_DtTiStr
ERR_MethodTrackerReturn("Cal4D_DaylightDatesBy_Rule_8"; $_t_oldMethodName)