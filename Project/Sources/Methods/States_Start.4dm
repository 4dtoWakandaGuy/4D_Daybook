//%attributes = {}
If (False:C215)
	//Project Method Name:      States_Start
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 23/11/2009`Method: States_Start
...
$_t_oldMethodName:=ERR_MethodTracker("States_Start")
...
If ($_l_SizeOfArray>0)
	...
	// States_CUArr ($1)
End if 
ERR_MethodTrackerReturn("States_Start"; $_t_oldMethodName)
