...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_isModal; $_bo_Query; $_bo_SearchSelection; $_bo_TypeSet; $8; LB_bo_MinorFromLB; vInModalWindow)
	...
	C_LONGINT:C283($_l_Top; $_l_TypeSet; $_l_WindowBottom; $_l_WindowKind; $_l_WindowLeft; $_l_WindowReference; $_l_WindowRight; $_l_windowTop; $10; $9; AL_l_Bottom)
	C_LONGINT:C283(AL_l_Left; AL_l_Right; AL_l_Top; WIN_l_CurrentWinRef; WIN_l_CurrentWinRefOLD)
...
$_l_WindowKind:=Window kind:C445
$_bo_isModal:=($_l_WindowKind=1) | ($_l_WindowKind=9)
...
Else 
	...
	If (LB_bo_MinorFromLB) & (AL_l_Left>0) | (AL_l_Top>0)
		$_l_Left:=AL_l_Left
		$_l_Top:=AL_l_Top
		$_l_Right:=AL_l_Right
...
End if 
If (GenValidatePointer($1)=False:C215)
...
Else 
	...
	If ($_t_SearchText#"")
		...
		If (Records in selection:C76($3->)>1)
			...
			If (vInModalWindow) | ($_bo_isModal)  //added kmw 30/01/07
