...
If (True:C214)
	...
	C_LONGINT:C283(<>AutoProc; <>IACTIVPROC; <>IACTIVSAVE; <>ProcessSeen; <>ProcProc; <>SCPT_l_PlayerActive; <>ScrnSavMin; <>SD3_l_DiaryMessageProcess; $_l_BarProcess; $_l_Process; Mod_l_MenuBarPaletteProcess)
...
$_t_oldMethodName:=ERR_MethodTracker("Quit_2")
...
End if 
QUIT 4D:C291
ERR_MethodTrackerReturn("Quit_2"; $_t_oldMethodName)
