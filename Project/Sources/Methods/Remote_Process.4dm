//%attributes = {}
If (False:C215)
	//Project Method Name:      Remote_Process
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Remote_Process")
//Remote_Process
Start_Process
Open_PrD_Window("Remote_Process (Command-. to Cancel)")
...
<>Process:=0
Process_End
ERR_MethodTrackerReturn("Remote_Process"; $_t_oldMethodName)
