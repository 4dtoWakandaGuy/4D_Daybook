//%attributes = {}
If (False:C215)
	//Project Method Name:      DB_SetFormLayoutNEW
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 20/01/2015 14:36
...
If (True:C214)
	ARRAY BOOLEAN:C223($_abo_SelectedFromInvDate; 0)
	...
	//ARRAY POINTER(DB_aptr_PIAllocations;0)
	...
	//ARRAY POINTER(DB_aptr_QualGroups;0)
	//ARRAY POINTER(DB_aptr_Quotations;0)
	//ARRAY POINTER(DB_aptr_RecDates;0)
	...
	//ARRAY POINTER(DB_aptr_SCProducts;0)
	//ARRAY POINTER(DB_aptr_SDSettings;0)
	//ARRAY POINTER(DB_aptr_ServiceCalls;0)
	//ARRAY POINTER(DB_aptr_Solutions;0)
	//ARRAY POINTER(DB_aptr_Sources;0)
	//ARRAY POINTER(DB_aptr_SPLinks;0)
	//ARRAY POINTER(DB_aptr_SProjections;0)
	...
	//ARRAY POINTER(DB_aptr_Subsciptions;0)
	//ARRAY POINTER(DB_aptr_TaxCodes;0)
	//ARRAY POINTER(DB_aptr_Terminology;0)
	//ARRAY POINTER(DB_aptr_TimeBudgets;0)
	//ARRAY POINTER(DB_aptr_TransactionBatchItems;0)
	//ARRAY POINTER(DB_aptr_TransactionMulti;0)
	...
	//ARRAY POINTER(DB_aptr_UserSets;0)
	//ARRAY POINTER(DB_aptr_Webaccess;0)
	...
	C_BOOLEAN:C305($_bo_FillArray; $_bo_GraphsAvailable; $_bo_LoadSetup; $_bo_newLevel; $_bo_OnScreenEdit; $_bo_ReadWriteEdit; $_bo_StatsAvailable; $_bo_UseContext; DB_bo_DisplayFilters; DB_bo_DisplayStats; DB_bo_FiltersActivated)
	C_BOOLEAN:C305(DB_bo_FiltersAvailable; DB_bo_GraphsAvailable; DB_bo_OnScreenEdit; DB_bo_PopupSelectorInited; DB_bo_ReturnSelection; DB_bo_RootTabDefined; DB_bo_SelectionManagerAvailable; DB_bo_ShowArrayBased; DB_bo_ShowCurrentSelection; DB_bo_StatsAvailabe; DB_bo_StatsAvailable)
	C_BOOLEAN:C305(INV_bo_DisplayPostedSet; LAY_bo_AreasSetup; LAY_bo_ContractTypesSetup; LAY_bo_ConTypeSetup; LAY_bo_CoTypesSetup; LAY_bo_CountiesSetup; LAY_bo_CountriesSetup; LAY_bo_CreditStatesSetup; LAY_bo_HeadingsSetup; LAY_bo_MoveTypesSetup; LAY_bo_OrdStatesSetup)
	C_BOOLEAN:C305(LAY_bo_OrdTypeSetup; LAY_bo_pBrandsSetup; LAY_bo_pCollectionsSetup; LAY_bo_PeriodsSetup; LAY_bo_pGroupsSetup; LAY_bo_POStatesSetup; LAY_bo_RolesSetup; LAY_bo_SalesPersonSetup; LAY_bo_StatusSetup; LAY_bo_StockLocationsSetup; LAY_bo_StockTypesSetup)
	C_BOOLEAN:C305(PRD_bo_ScreenFilterLoaded; STK_bo_StockItemsIncluded)
	C_DATE:C307(<>DB_d_CurrentDate; $_d_InvoiceDateTo; PER_d_Period3From; PUR_D_Date; PUR_D_PeriodToDate; vDate)
	C_LONGINT:C283($_l_ContextRow; $_l_CurrentLevel; $_l_DefaultFilterID; $_l_index; $_l_Index2; $_l_InvoicableIndex; $_l_NewTableNumber; $_l_OldTableNumber; $_l_PeriodID; $_l_RecordsCount2; $_l_RecordsInSelection)
	C_LONGINT:C283($_l_ReuseLevel; $_l_StateRow; $_l_TabIncludes; $_l_Table; $_l_TableNumber; $_l_TableViewRow; $1; $3; ACC_l_BUT1; ACC_l_BUT10; ACC_l_BUT11)
	...
	C_TEXT:C284($_t_Context; $_t_CurrentStockLabel; $_t_InvoiceLabel; $_t_InvoiceNumberLabel; $_t_oldMethodName; $_t_OrderState; $_t_OrderStateCode; $_t_OrderType; $_t_PeriodTo; $_t_PurchaseLabel; $_t_PurchasesLabel)
	C_TEXT:C284($_t_StateCode1; $_t_StateCode2; $_t_StockLabel; $_t_StocksLabel; $_t_TableContext; $_t_TableName; $2; ACC_t_PeriodFrom; DB_t_Column; DB_t_CurrentContext; DB_t_FilterMessage)
...
If (Count parameters:C259>=2)
					...
					Case of 
						...
						Else 
							...
							If (Size of array:C274(DB_at_TabNames)>0)
								$_l_Table:=Find in array:C230(DB_at_TabNames; DB_at_TabNavigation{DB_at_TabNavigation})
								If ($_l_Table>0)
									If (Size of array:C274(DB_al_TabIncludes{$_l_Table})>0)
										ARRAY LONGINT:C221($_al_ActionIDs; 0)
										For ($_l_index; 1; Size of array:C274(DB_al_TabIncludes{$_l_Table}))
											If (DB_al_TabIncludes{$_l_Table}{$_l_index}>0)
												APPEND TO ARRAY:C911($_al_ActionIDs; DB_al_TabIncludes{$_l_Table}{$_l_index})
											Else 
												$_l_TabIncludes:=DB_al_TabIncludes{$_l_Table}{$_l_index}
												$_l_TableViewRow:=Find in array:C230(SD2_al_ActionGroupIDs; Abs:C99($_l_TabIncludes))
												If ($_l_TableViewRow>0)
													For ($_l_Index2; 1; Size of array:C274(SD_al_ActionGroupIncludes{$_l_TableViewRow}))
														APPEND TO ARRAY:C911($_al_ActionIDs; SD_al_ActionGroupIncludes{$_l_TableViewRow}{$_l_Index2})
													End for 
												End if 
											End if 
										End for 
										...
										If (DB_al_DocIncludes{$_l_Table}=0)  //don't include diary items with documents.
						...
						: ($_t_Context="Send Statements")
							...
							For ($_l_index; 1; Size of array:C274(STG_al_Selected))
								If (STG_al_Selected{$_l_index}>0)
									...
									APPEND TO ARRAY:C911($_abo_SelectedFromInvDate; STG_abo_StageFromiDate{STG_al_Selected{$_l_index}})
									APPEND TO ARRAY:C911($_al_LetterDays; STG_al_LEtterDays{STG_al_Selected{$_l_index}})
								End if 
							End for 
							CREATE EMPTY SET:C140([INVOICES:39]; "$Selected")
							For ($_l_index; 1; Size of array:C274($_abo_SelectedFromInvDate))
								...
								If ($_abo_SelectedFromInvDate{$_l_index})
				...
				: ($_l_TableNumber=Table:C252(->[ORDERS:24]))
					...
					Case of 
						...
						: ($_t_Context#"")
							...
							If ($_l_StateRow>0)
								//TRACE
								$_t_StateCode1:=<>SYS_at_RecStateCodes{24}{$_l_StateRow}
								$_t_StateCode1:="024"+$_t_StateCode1
									...
									: ($_t_Context="Batch Invoice Orders")
										If (Size of array:C274(<>SYS_at_RecStateCodes{24})>=3)
											...
											For ($_l_InvoicableIndex; 1; Size of array:C274($_at_OrderStates))
												...
												$_t_OrderStateCode:="090"+$_t_OrderState
												QUERY:C277([CODE_USES:91]; [CODE_USES:91]Code:1=$_t_OrderStateCode; *)
												QUERY:C277([CODE_USES:91];  & ; [CODE_USES:91]Use:2=2)
												If (Records in selection:C76([CODE_USES:91])>0)
													APPEND TO ARRAY:C911($_at_ValidOrderStates; $_at_OrderStates{$_l_InvoicableIndex})
	...
	If (Count parameters:C259>=2)
		If ($_t_Context#"USER@")
			...
			End if 
		Else 
			//$_l_ContextRow:=Find in array(DB_al_ContextTableNumber;$_l_TableNumber)
			//There is a name for the context
	...
	$_l_ReuseLevel:=0
	$_bo_FillArray:=False:C215
	$_bo_newLevel:=False:C215
	$_l_TableViewRow:=0
	DB_SetupFillParameters
	Case of 
		: ($_l_TableNumber=Table:C252(->[COMPANIES:2]))
			Case of 
				: ($_t_Context="Creditors Report")
					If ($_l_ContextRow<0)
						...
						$_l_ContextRow:=DB_appendPointers(->DB_aptr_Companies; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel)
		...
		: ($_l_TableNumber=Table:C252(->[CONTACTS:1]))
			...
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Contacts; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel)
			...
			If ($_bo_newLevel)
				Case of 
					...
					Else 
						LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[CONTACTS:1]Contact_Code:2; ->[CONTACTS:1]Contact_Code:2; "411111000"; "Contacts_In"; 5; "Contacts"; "Contact"; ""; $_bo_newLevel; $_l_ReuseLevel)
				End case 
			End if 
			$_bo_OnScreenEdit:=False:C215
			$_bo_ReadWriteEdit:=True:C214
		...
		: ($_l_TableNumber=Table:C252(->[PRODUCTS:9]))
			...
			If ($_l_ContextRow<0)
				...
				Else 
					APPEND TO ARRAY:C911(DB_at_ContextNames; $_t_TableContext+"_"+String:C10($_l_TableNumber))
					APPEND TO ARRAY:C911(DB_at_ContextUsage; DB_t_FormUsage)
				End if 
				//APPEND TO ARRAY(DB_al_ContextAccess;DB_l_UserFormAccess)
				
				$_l_ContextRow:=Size of array:C274(DB_at_ContextNames)
		...
		: ($_l_TableNumber=Table:C252(->[ACCOUNTS_ANALYSES:157]))
			If ($_t_Context="USER@")
				//not displayed as a table-except in User_Mode
				...
				If ($_bo_newLevel)
					...
					LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[ACCOUNTS_LAYERS:156]Layer_Code:1; ->[ACCOUNTS_LAYERS:156]Layer_Code:1; "411111000"; "ACCOUNTS_LAYERS_IN"; -1; "Accounts Layers"; "Accounts Layer"; ""; $_bo_newLevel; $_l_ReuseLevel)
				End if 
				$_bo_OnScreenEdit:=False:C215
				$_bo_ReadWriteEdit:=True:C214
				$_bo_StatsAvailable:=True:C214
		...
		: ($_l_TableNumber=Table:C252(->[ACCOUNTS_LAYERS:156]))
			//not displayed as a table-except un User_Mode
			If ($_t_Context="USER@")
				//not displayed as a table-except in User_Mode
				...
				If ($_bo_newLevel)
					...
					LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[ACCOUNTS_ANALYSES:157]Analysis_Code:1; ->[ACCOUNTS_ANALYSES:157]Analysis_Code:1; "411111000"; "ACCOUNTS_ANALYSIS_IN"; -1; "Accounts Analysis"; "Accounts Analysis"; ""; $_bo_newLevel; $_l_ReuseLevel)
				End if 
		...
		: ($_l_TableNumber=Table:C252(->[INVOICES:39]))
			...
			Case of 
				: ($_t_Context="ViewReceipts") | ($_t_Context="View Receipts") | ($_t_Context="Undo Receipt")
					...
					End if 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
					$_t_InvoiceNumberLabel:="Receipts"
					$_t_InvoiceNumberLabel:=Term_SLPLWT($_t_InvoiceNumberLabel)
					$_t_InvoiceLabel:="Receipt"
					$_t_InvoiceLabel:=Term_SLPLWT($_t_InvoiceLabel)
					$_bo_LoadSetup:=True:C214
					If ($_bo_newLevel)
						LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[INVOICES:39]Invoice_Number:1; ->[INVOICES:39]Invoice_Number:1; "411111000"; "Invoice_In"; 11; $_t_InvoiceNumberLabel; $_t_InvoiceLabel; ""; $_bo_newLevel; $_l_ReuseLevel)
					End if 
					$_bo_OnScreenEdit:=False:C215
					$_bo_ReadWriteEdit:=True:C214
					$_bo_StatsAvailable:=True:C214
				...
				: ($_t_Context="ViewDeposits") | ($_t_Context="View Deposits") | ($_t_Context="Refund Deposit")
					...
					End if 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
					$_t_InvoiceNumberLabel:="Deposits"
					$_t_InvoiceNumberLabel:=Term_SLPLWT($_t_InvoiceNumberLabel)
					$_t_InvoiceLabel:="Deposit"
					$_t_InvoiceLabel:=Term_SLPLWT($_t_InvoiceLabel)
					$_bo_LoadSetup:=True:C214
					LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[INVOICES:39]Invoice_Number:1; ->[INVOICES:39]Invoice_Number:1; "411111000"; "Invoice_In"; 10; $_t_InvoiceNumberLabel; $_t_InvoiceLabel; ""; $_bo_newLevel; $_l_ReuseLevel)
					$_bo_OnScreenEdit:=False:C215
					$_bo_ReadWriteEdit:=True:C214
					$_bo_StatsAvailable:=True:C214
					$_bo_GraphsAvailable:=False:C215
				: ($_t_Context="ViewCreditnotes") | ($_t_Context="View Credit notes")
					...
					End if 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
					$_t_InvoiceNumberLabel:="Credit Notes"
					$_t_InvoiceNumberLabel:=Term_SLPLWT($_t_InvoiceNumberLabel)
					$_t_InvoiceLabel:="Credits"
					$_t_InvoiceLabel:=Term_SLPLWT($_t_InvoiceLabel)
					$_bo_LoadSetup:=True:C214
					LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[INVOICES:39]Invoice_Number:1; ->[INVOICES:39]Invoice_Number:1; "411111000"; "Invoice_In"; 9; $_t_InvoiceNumberLabel; $_t_InvoiceLabel; ""; $_bo_newLevel; $_l_ReuseLevel)
					$_bo_OnScreenEdit:=False:C215
					$_bo_ReadWriteEdit:=True:C214
					$_bo_StatsAvailable:=True:C214
					$_bo_GraphsAvailable:=False:C215
				: ($_t_Context="ViewProformas") | ($_t_Context="View Proformas")  //View invoices
					...
					End if 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
					$_t_InvoiceNumberLabel:="Invoices"
					$_t_InvoiceNumberLabel:=Term_SLPLWT($_t_InvoiceNumberLabel)
					$_t_InvoiceLabel:="Invoice"
					$_t_InvoiceLabel:=Term_SLPLWT($_t_InvoiceLabel)
					$_bo_LoadSetup:=True:C214
					LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[INVOICES:39]Invoice_Number:1; ->[INVOICES:39]Invoice_Number:1; "411111000"; "Invoice_In"; 12; $_t_InvoiceNumberLabel; $_t_InvoiceLabel; ""; $_bo_newLevel; $_l_ReuseLevel)
					$_bo_OnScreenEdit:=False:C215
					$_bo_ReadWriteEdit:=True:C214
					$_bo_StatsAvailable:=True:C214
					$_bo_GraphsAvailable:=False:C215
				Else 
					...
					$_bo_LoadSetup:=True:C214
					If ($_bo_newLevel)
						LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[INVOICES:39]Invoice_Number:1; ->[INVOICES:39]Invoice_Number:1; "411111000"; "Invoice_In"; 8; $_t_InvoiceNumberLabel; $_t_InvoiceLabel; ""; $_bo_newLevel; $_l_ReuseLevel)
					End if 
					$_bo_OnScreenEdit:=False:C215
					$_bo_ReadWriteEdit:=True:C214
					$_bo_StatsAvailable:=True:C214
		...
		: ($_l_TableNumber=Table:C252(->[INVOICES_ITEMS:161]))
			...
			End if 
			$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
			$_t_InvoiceNumberLabel:="Invoice Items"
			$_t_InvoiceNumberLabel:=Term_SLPLWT($_t_InvoiceNumberLabel)
			$_t_InvoiceLabel:="Invoice Item"
			$_t_InvoiceLabel:=Term_SLPLWT($_t_InvoiceLabel)
			$_bo_LoadSetup:=True:C214
			If ($_bo_newLevel)
				LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; ->[INVOICES_ITEMS:161]ID:17; ->[INVOICES_ITEMS:161]ID:17; "411111000"; "Items_in"; 4; $_t_InvoiceNumberLabel; $_t_InvoiceLabel; ""; $_bo_newLevel; $_l_ReuseLevel)
			End if 
			$_bo_OnScreenEdit:=False:C215
			$_bo_ReadWriteEdit:=False:C215
			$_bo_StatsAvailable:=False:C215
		...
		: ($_l_TableNumber=Table:C252(->[PURCHASE_INVOICES:37]))
			...
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_PurchaseItems; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(8))
				End case 
				$_bo_FillArray:=True:C214
			Else 
				$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
				$_bo_newLevel:=False:C215
			End if 
			...
			If ($_l_TableViewRow>0)
				DB_at_PLuralName{$_l_TableViewRow}:=$_t_PurchasesLabel
				DB_at_SingleName{$_l_TableViewRow}:=$_t_PurchaseLabel
			End if 
			$_bo_LoadSetup:=True:C214
		...
		: ($_l_TableNumber=Table:C252(->[PURCHASE_INVOICE_ALLOCATIONS:159]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_PIAllocations; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
			...
			If ($_l_ContextRow<0)
				...
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(4))
				End case 
				$_bo_FillArray:=True:C214
			Else 
				$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[QUALITY_GROUPS:56]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_QualGroups; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[RECURRING_JOURNALS:38]))
			...
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_RecordJournals; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[REC_JOURNALS_DATES:160]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_RecDates; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[RESULTS:14]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Results; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[ROLES:87]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Roles; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[SALES_PROJECTION:113]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_SProjections; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[SALES_ProjectionLinks:114]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_SPLinks; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[SD_Settings:107]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_SDSettings; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[SERVICE_CALLS:20]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_ServiceCalls; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(3))
				End case 
				$_bo_FillArray:=True:C214
				$_bo_newLevel:=True:C214
			Else 
		...
		: ($_l_TableNumber=Table:C252(->[SERVICE_CALLS_PRODUCTS:152]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_SCProducts; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[SOLUTIONS:23]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Solutions; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[SOURCES:6]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Sources; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[STAGES:45]))
			...
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Stages; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[STATUS:4]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Status; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[STOCK_MOVEMENT_ITEMS:27]))
			If ($_t_Context#"Stock_History")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_StockItems; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					Case of 
						: ($_t_Context="USER@")
							$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
						Else 
							$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(14))
					End case 
					$_bo_FillArray:=True:C214
					$_bo_newLevel:=True:C214
				Else 
				...
				If ($_l_TableViewRow>0)
					DB_at_PLuralName{$_l_TableViewRow}:=$_t_StocksLabel
					DB_at_SingleName{$_l_TableViewRow}:=$_t_StockLabel
				End if 
				$_bo_LoadSetup:=True:C214
			...
			Else 
				...
				//GET PICTURE FROM LIBRARY(403; $_pic_Picture)  //410 for expanded
				
				$_pic_Picture:=Get_Picture(403)
				For ($_l_index; 1; Size of array:C274(PRD_aPic_Expanded))
					PRD_aPic_Expanded{$_l_index}:=$_pic_Picture
				End for 
		...
		: ($_l_TableNumber=Table:C252(->[STOCK_LEVELS:58]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_StockLevels; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[STOCK_MOVEMENTS:40]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_StockMovement; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[STOCK_TYPES:59]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_StockType; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[SUBSCRIPTIONS:93]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_Subsciptions; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
					$_bo_newLevel:=True:C214
				Else 
		...
		: ($_l_TableNumber=Table:C252(->[TAX_CODES:35]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_TaxCodes; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
			...
			End if 
			$_bo_LoadSetup:=True:C214
			$_bo_OnScreenEdit:=True:C214  //this one can be edited on screen
			$_bo_ReadWriteEdit:=True:C214
			
		: ($_l_TableNumber=Table:C252(->[TERMINOLOGY:75]))
			If ($_l_ContextRow<0)
				ARRAY POINTER:C280(DB_aptr_Terminology; 0)
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Terminology; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
		...
		: ($_l_TableNumber=Table:C252(->[TIME_BUDGETS:49]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_TimeBudgets; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
					$_bo_newLevel:=True:C214
				Else 
		...
		: ($_l_TableNumber=Table:C252(->[TRANSACTION_BATCHES:30]))
			...
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_TransIn; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[TRANSACTION_BATCH_ITEMS:155]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_TransactionBatchItems; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
					$_bo_newLevel:=True:C214
				Else 
		...
		: ($_l_TableNumber=Table:C252(->[TRANSACTION_TYPES:31]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_TransTypes; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					Else 
		...
		: ($_l_TableNumber=Table:C252(->[TRANS_MULTI:128]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_TransactionMulti; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
			...
			Case of 
				: ($_t_Context="")
					...
					If ($_l_ContextRow<0)
						...
						$_l_ContextRow:=DB_appendPointers(->DB_aptr_Transactions; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(1))
						$_bo_FillArray:=True:C214
					Else 
						$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
					...
					Case of 
						...
						: ($_t_Context="Reconcile Transactions")
							If ($_l_ContextRow<0)
								ARRAY POINTER:C280(DB_aptr_RecTransactions; 0)
								$_l_ContextRow:=DB_appendPointers(->DB_aptr_Transactions; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
								$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(2))
								$_bo_FillArray:=True:C214
								$_bo_newLevel:=True:C214
							Else 
								$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[TYPES:5]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Types; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
		...
		: ($_l_TableNumber=Table:C252(->[USER_SETS:105]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_UserSets; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[WEB_ACCESS:130]))
			If ($_t_Context="USER@")
				If ($_l_ContextRow<0)
					...
					$_l_ContextRow:=DB_appendPointers(->DB_aptr_Webaccess; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
					$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
					$_bo_FillArray:=True:C214
				Else 
					$_ptr_ListBoxSetup:=DB_aptr_ContextPointers{$_l_ContextRow}
		...
		: ($_l_TableNumber=Table:C252(->[WORKFLOW_CONTROL:51]))
			If ($_l_ContextRow<0)
				...
				$_l_ContextRow:=DB_appendPointers(->DB_aptr_Workflow; $_l_TableNumber; $_t_Context; ->$_l_ReuseLevel; ->$_bo_newLevel; ->$_ptr_ListBoxSetup)
				Case of 
					: ($_t_Context="USER@")
						$_bo_StatsAvailable:=False:C215
						$_l_TableViewRow:=Find in array:C230(DB_at_TableViewID; String:C10($_l_TableNumber)+"_"+String:C10(-1))
	...
	If ($_bo_FillArray)
		If ($_l_TableViewRow>0)
			LBi_ArrDefFill($_ptr_ListBoxSetup; ->DB_l_LBOutputForm; DB_aptr_KeyField{$_l_TableViewRow}; DB_aptr_KeyField{$_l_TableViewRow}; DB_at_Settings{$_l_TableViewRow}; DB_at_InputForm{$_l_TableViewRow}; DB_al_viewNumber{$_l_TableViewRow}; DB_at_PLuralName{$_l_TableViewRow}; DB_at_SingleName{$_l_TableViewRow}; ""; $_bo_newLevel; $_l_ReuseLevel)
		End if 
	End if 
	...
	Else 
		$_bo_StatsAvailable:=False:C215
		DB_TableAreStatsAvailable($_l_TableNumber)
		If (Not:C34($_bo_StatsAvailable))
			DB_bo_DisplayStats:=False:C215
		End if 
	...
	Else 
		...
		If ($_bo_LoadSetup)
			...
			If (DB_l_MaxRecords=-1)
				$_l_RecordsCount2:=Records in table:C83($_ptr_Table->)
			Else 
				$_l_RecordsCount2:=DB_l_MaxRecords
			End if 
			SET WINDOW TITLE:C213($_t_TableName+" "+String:C10($_l_RecordsInSelection)+" of "+String:C10($_l_RecordsCount2))
		...
		If ($3#DB_l_CurrentDisplayedForm)
			...
			If (DB_bo_FiltersAvailable)
				...
				Else 
					...
					//_O_DISABLE BUTTON(DB_but_ClearFiltersButton)
					DB_t_FilterMessage:=""
					//DB_LoadFilterParameters (1;DB_l_CurrentDisplayedForm)
				End if 
			End if 
		End if 
	End if 
