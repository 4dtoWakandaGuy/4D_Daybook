//%attributes = {}
If (False:C215)
	//Project Method Name:      Letters_SWDets
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letters_SWDets")
//Letters_SWDets - the proc to call for a SW Print Merge
If (Letters_LayCode)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Letters_SWDets"; $_t_oldMethodName)