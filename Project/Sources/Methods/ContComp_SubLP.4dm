//%attributes = {}
If (False:C215)
	//Project Method Name:      ContComp_SubLP
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 10/12/2009 14:55`Method: ContComp_SubLP
...
$_t_oldMethodName:=ERR_MethodTracker("ContComp_SubLP")
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		vFax:=""
End case 
ERR_MethodTrackerReturn("ContComp_SubLP"; $_t_oldMethodName)