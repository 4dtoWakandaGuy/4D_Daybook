//%attributes = {}
If (False:C215)
	//Project Method Name:      JobPers_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("JobPers_File")

FORM SET INPUT:C55([JOB PERSONNEL:48]; "JobPers_in")  //NG April 2004 removed reference to ◊screen)
WIN_t_CurrentInputForm:="JobPers_in"
FORM SET OUTPUT:C54([JOB PERSONNEL:48]; "JobPers_Out")
WIN_t_CurrentOutputform:="JobPers_Out"
vJ:=1
...
End if 
ERR_MethodTrackerReturn("JobPers_File"; $_t_oldMethodName)