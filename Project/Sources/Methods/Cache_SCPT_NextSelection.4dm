//%attributes = {}
If (False:C215)
	//Project Method Name:      Cache_SCPT_NextSelection
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Cache_SCPT_NextSelection")
...
Case of 
	: ($_l_Event=On Clicked:K2:4)
		...
		End if 
		If (WS_l_CachedSelectionName<Size of array:C274(WS_al_CachedSelection))
...
End case 
ERR_MethodTrackerReturn("Cache_SCPT_NextSelection"; $_t_oldMethodName)
