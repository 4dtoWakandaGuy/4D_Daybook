//%attributes = {}
If (False:C215)
	//Project Method Name:      DD_SoundlikeBuilder
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("DD_SoundlikeBuilder")
...
ERR_MethodTrackerReturn("DD_SoundlikeBuilder"; $_t_oldMethodName)