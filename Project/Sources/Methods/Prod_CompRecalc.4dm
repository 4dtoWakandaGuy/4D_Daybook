//%attributes = {}
If (False:C215)
	//Project Method Name:      Prod_CompRecalc
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 21/11/2009`Method: Prod_CompRecalc`Description
...
$_t_oldMethodName:=ERR_MethodTracker("Prod_CompRecalc")
Menu_Record("Prod_CompRecalc"; "Calc Prices from Components")
...
End if 
ERR_MethodTrackerReturn("Prod_CompRecalc"; $_t_oldMethodName)
