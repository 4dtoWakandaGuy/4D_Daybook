//%attributes = {}
If (False:C215)
	//Project Method Name:      StockI_InLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockI_InLP"; Form event code:C388)
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetnewToolBar
		StockI_InLPB("B")
		OpenHelp(Table:C252(->[STOCK_MOVEMENT_ITEMS:27]); "Stock_in")
		...
		DB_SetInputFormMenu(Table:C252(->[STOCK_MOVEMENT_ITEMS:27]); "Stock_in")
	...
	: ($_l_Event=On Deactivate:K2:10)
		...
		//PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("StockI_InLP"; $_t_oldMethodName)