//%attributes = {}
If (False:C215)
	//Project Method Name:      Modules_ArrDCl
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Modules_ArrDCl")
//Modules_ArrDCl - Array clear
MOD_at_ModuleName:=0
...
ERR_MethodTrackerReturn("Modules_ArrDCl"; $_t_oldMethodName)