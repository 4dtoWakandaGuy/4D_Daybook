//%attributes = {}
If (False:C215)
	//Project Method Name:      Gen_RequestText
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Gen_RequestText")
...
DIALOG:C40([COMPANIES:2]; "dRequest_Text")
CLOSE WINDOW:C154
TXT_t_CHeckBoxMessage:=""
WIN_l_CurrentWinRef:=$_l_CurrentWinRefOLD
$0:=vT
<>SYS_bo_CurrentWindowModal:=False:C215
ERR_MethodTrackerReturn("Gen_RequestText"; $_t_oldMethodName)