//%attributes = {}
If (False:C215)
	//Project Method Name:      Move_InPost
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 07/12/2009 20:41`Method: Move_InPost
...
//TRACE
$_t_oldMethodName:=ERR_MethodTracker("Move_InPost")
...
Else 
	...
	OK:=0
End if 
ERR_MethodTrackerReturn("Move_InPost"; $_t_oldMethodName)
