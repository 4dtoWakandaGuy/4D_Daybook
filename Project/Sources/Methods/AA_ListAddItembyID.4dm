...
If (True:C214)
	...
	C_BOOLEAN:C305(AA_bo_ListInitiation; AA_bo_ListsInited; WS_bo_ListItemComplete)
	C_LONGINT:C283($_l_Index; $_l_ListID; $_l_ListPosition; $_l_Process; $_l_Retries; $0; $1; WS_l_ListItemaddedID)
	C_TEXT:C284($_t_ListName; $_t_oldMethodName; $2; $3; $4; $5; $6; $7; $8; $9)
End if 
//Code Starts Here


$_t_oldMethodName:=ERR_MethodTracker("AA_ListAddItembyID")
...
If (Count parameters:C259>=1)
	...
	If ($_l_ListID>0)
		...
		If ($_l_ListPosition<0)
			QUERY:C277([X_LISTS:111]; [X_LISTS:111]x_ID:1=$_l_ListPosition)
		...
		If ($_t_ListName#"")
			...
			If (Count parameters:C259>=2)
				...
				Else 
					...
					For ($_l_Index; 2; Count parameters:C259)
						$_l_Process:=New process:C317("AA_ListCreateIteminprocess"; 128000; "Create List item"; $_l_ListID; ${$_l_Index})
					End for 
...
ERR_MethodTrackerReturn("AA_ListAddItembyID"; $_t_oldMethodName)
