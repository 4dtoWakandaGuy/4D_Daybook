//%attributes = {}
If (False:C215)
	//Project Method Name:      Gen_SetModCol
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Gen_SetModCol")
//Gen_SetModCol - sets the colour of Modules Palette acc Modules
...
ERR_MethodTrackerReturn("Gen_SetModCol"; $_t_oldMethodName)
