//%attributes = {}
If (False:C215)
	//Project Method Name:      QR_AdvanceArray
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 14/09/2012 11:01
...
$_t_oldMethodName:=ERR_MethodTracker("QR_AdvanceArray")
...
If (LB_l_CurrentRow>Size of array:C274($_ptr_Variable->))
	...
	LB_l_CurrentRow:=1
End if 
ERR_MethodTrackerReturn("QR_AdvanceArray"; $_t_oldMethodName)
