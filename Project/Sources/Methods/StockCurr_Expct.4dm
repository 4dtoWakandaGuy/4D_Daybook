//%attributes = {}
If (False:C215)
	//Project Method Name:      StockCurr_Expct
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockCurr_Expct")
//StockCurr_Expct - what you expect in
...
Else 
	$0:="None"
End if 
ERR_MethodTrackerReturn("StockCurr_Expct"; $_t_oldMethodName)
