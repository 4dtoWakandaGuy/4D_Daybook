...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Itemised; $_bo_Messaging; $4; CB_bo_ConvertAtOlderRate; CB_bo_ConvertAtOldRate; DM_bo_CustomSort; $_bo_Continue; $_bo_Itemised; $_bo_Messaging; CB_bo_ConvertAtOlderRate; CB_bo_ConvertAtOldRate)
	C_BOOLEAN:C305(DM_bo_CustomSort)
	C_LONGINT:C283($_l_CompaniesIndex; $_l_OK; $_l_SortedOrder; $5; vIn; $_l_CharacterPosition; $_l_CompaniesIndex; $_l_OK; $_l_SortedOrder; $5)
	C_POINTER:C301($10; $11; $2; $7; $8; $9; $_Ptr_Table)
	C_REAL:C285(v31; v61; v91; VGtotal; vTot; vTot0; vtot1; vTot31; vTot61; vTot91; v0)
	C_REAL:C285(Vtotal)
	C_TEXT:C284($_t_ReportName; $1; CUR_t_ouputCurrency; vanalcodes; vInvTitle; vTitle1; vTitle2; vTitle3; vTitle4; vTitle5; $_t_oldMethodName)
	C_TEXT:C284($_t_ReportName; CUR_t_ouputCurrency)
	C_TIME:C306($6)
End if 
//Code Starts Here
...
If (OK=1)
	...
	Else 
		...
		If (Count parameters:C259<6)
			FORM SET OUTPUT:C54([COMPANIES:2]; "Aged_Debtors")
			BREAK LEVEL:C302(0)
			ACCUMULATE:C303(v0; v31; v61; v91)
		End if 
		SET AUTOMATIC RELATIONS:C310(True:C214; False:C215)
