//%attributes = {}
If (False:C215)
	//Project Method Name:      Layers_InLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Layers_InLP")
...
Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		OpenHelp(Table:C252(->[LAYERS:76]); "Layer_In")
		WS_AutoscreenSize(2; 210; 570)
		INT_SetInput(Table:C252(->[LAYERS:76]); WIN_t_CurrentInputForm)
		DB_SetInputFormMenu(Table:C252(->[LAYERS:76]); "Layer_In")
...
End case 
ERR_MethodTrackerReturn("Layers_InLP"; $_t_oldMethodName)