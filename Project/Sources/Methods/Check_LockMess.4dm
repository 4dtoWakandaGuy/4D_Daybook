//%attributes = {}
If (False:C215)
	//Project Method Name:      Check_LockMess
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Check_LockMess")
...
Else   //added 26/02/08
	...
	End if   //added 26/02/08
End if 
ERR_MethodTrackerReturn("Check_LockMess"; $_t_oldMethodName)