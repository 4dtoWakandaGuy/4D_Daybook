//%attributes = {}
If (False:C215)
	//Project Method Name:      Reports_PrefsOpt2ObjHandler
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/11/2009`Method: Reports_PrefsOpt2ObjHandler
...
$_t_oldMethodName:=ERR_MethodTracker("Reports_PrefsOpt2ObjHandler")
...
Case of 
	: ((Form event code:C388=On Data Change:K2:15) | (Form event code:C388=On Clicked:K2:4))
		...
		SR_at_EmailPrintOption2Val:=SR_at_EmailPrintOption2
		
		Reports_PrefArraysToFormVars(SR_at_EmailPrintOption2)
...
End case 
ERR_MethodTrackerReturn("Reports_PrefsOpt2ObjHandler"; $_t_oldMethodName)
