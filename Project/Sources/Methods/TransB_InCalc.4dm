//%attributes = {}
If (False:C215)
	//Project Method Name:      TransB_InCalc
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("TransB_InCalc")
//TransB_InCalc
//Modified NG July 2004 to work with area list area

If (Count parameters:C259=0)
	If (DB_t_CurrentFormUsage2#"NBat")
		Menu_Record("TransB_InCalc"; "Update Single-Sided Total")
...
Else 
	...
	End case 
End if 
ERR_MethodTrackerReturn("TransB_InCalc"; $_t_oldMethodName)