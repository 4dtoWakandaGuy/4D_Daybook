...
If (True:C214)
	...
	C_LONGINT:C283(<>SCPT_l_RecordEdit; $_l_ButtonNumber; $_l_Event; $_l_ModulePosition; $_l_ScriptLength; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; iCancel; iOK; ModuleNumber; PAL_but_FirstRecord)
	C_LONGINT:C283(PAL_but_LastRecord; PAL_but_NextRecord; PAL_but_PreviousRecord)
...
//AA_DBNormaliseFieldNames//not sure why i put this here-it expects 2 parameter(table and field) and returns a value-so here it does nothing
...
Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		If (WIN_t_CurrentInputForm#"Macro_RestrictedEntry")
			DB_SetInputFormMenu(Table:C252(->[SCRIPTS:80]); "Scripts_In")
		End if 
