//%attributes = {}
If (False:C215)
	//Project Method Name:      Minor_DelCU
	//------------------ Method Notes ------------------
...
If (True:C214)
	C_POINTER:C301($1; $2)
	C_TEXT:C284($_t_oldMethodName; $_t_RecordIdent; $_t_UniqueCode)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Minor_DelCU")
If (Records in set:C195("Userset")>0)
	...
	If (OK=1)
		...
		While (Not:C34(End selection:C36($1->)))
			...
			$_t_RecordIdent:=$2->
			$_t_UniqueCode:=("0"*(3-Length:C16($_t_UniqueCode)))+$_t_UniqueCode+$_t_RecordIdent
	...
	End if 
End if 
ERR_MethodTrackerReturn("Minor_DelCU"; $_t_oldMethodName)