//%attributes = {}
If (False:C215)
	//Project Method Name:      Calls_ContrSrch
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Calls_ContrSrch")
//Calls Contract Search
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Menu_Record("Calls_ContrSrch"; "Items by Contract")
...
ERR_MethodTrackerReturn("Calls_ContrSrch"; $_t_oldMethodName)