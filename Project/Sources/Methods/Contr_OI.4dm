...
$_t_oldMethodName:=ERR_MethodTracker("Contr_OI")
//Contracts
$_t_CurrentOutputForm:=WIN_t_CurrentOutputform
Menu_Record("Contr_OI"; "Find Items by Company")
Contr_PP1
...
ERR_MethodTrackerReturn("Contr_OI"; $_t_oldMethodName)