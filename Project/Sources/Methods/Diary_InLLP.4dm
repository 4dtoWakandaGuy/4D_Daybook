...
If (True:C214)
	...
	C_LONGINT:C283(iOK; PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord; REICIPIENT_COUNT; vCreate; vEdit; write; WS_l_ContactElement; WS_l_SelectedEmailName)
		...
		Case of 
			: (Modified:C32([DIARY:12]Company_Code:1)) | ($_bo_CompanyMod)
				...
				Else 
					...
					If (WIN_t_CurrentInputForm="Diary_inLW")
