...
$_t_oldMethodName:=ERR_MethodTracker("Import_YP")
//Import_YP
$_l_Count:=0
Open_PrD_Window("Import_YP: Command-. to Cancel")
$_t_StopCharacter:=">"
...
End if 
Companies_ImpEn
ERR_MethodTrackerReturn("Import_YP"; $_t_oldMethodName)