//%attributes = {}
If (False:C215)
	//Project Method Name:      MAsk_Print
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/12/2009 12:26`Method: MAsk_Print
...
$_t_oldMethodName:=ERR_MethodTracker("MAsk_Print")
//MAsk_Print
cPreview:=0
vP:=1
vPS:=1
...
While (vPS=1)
	...
	DIALOG:C40([DOCUMENTS:7]; "dAsk_Print")
	CLOSE WINDOW:C154
	$_l_OK:=OK
	OK:=1
...
End while 
vNo:=vNo2
ERR_MethodTrackerReturn("MAsk_Print"; $_t_oldMethodName)
