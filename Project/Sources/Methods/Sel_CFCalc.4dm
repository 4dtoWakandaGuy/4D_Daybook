//%attributes = {}
If (False:C215)
	//Project Method Name:      Sel_CFCalc
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Sel_CFCalc")
Menu_Record("Sel_CFCalc"; "Calculations ...")
If ((DB_GetModuleSettingByNUM(1))#5)
	If (DB_bo_RecordModified)
		...
		DIALOG:C40([COMPANIES:2]; "dAsk_CFCalc")
		CLOSE WINDOW:C154
...
End if 
ERR_MethodTrackerReturn("Sel_CFCalc"; $_t_oldMethodName)