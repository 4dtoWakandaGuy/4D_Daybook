//%attributes = {}
If (False:C215)
	//Project Method Name:      Letters_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letters_File")
Start_ProcMail
...
If ($_t_DocumentWriteType#"")
	FORM SET OUTPUT:C54([DOCUMENTS:7]; "Letters_Out")
	WIN_t_CurrentOutputform:="Letters_Out"
	...
	End if 
End if 
ERR_MethodTrackerReturn("Letters_File"; $_t_oldMethodName)