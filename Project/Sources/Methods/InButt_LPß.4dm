//%attributes = {}
If (False:C215)
	//Project Method Name:      InButt_LPß
	//------------------ Method Notes ------------------
	//InButt_LPß
...
If (True:C214)
	//C_UNKNOWN($1)
	//C_UNKNOWN($2)
	C_LONGINT:C283($3; $_l_ButtonPressed; $3)
	C_TEXT:C284($_t_MethodName; $_t_oldMethodName; $1; $2; $_t_CallMethodName; $_t_oldMethodName)
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("InButt_LPß")
...
Case of 
	...
	Else 
		...
		//End if 
End case 
ERR_MethodTrackerReturn("InButt_LPß"; $_t_oldMethodName)
