//%attributes = {}
If (False:C215)
	//Project Method Name:      StockI_Dup
	//------------------ Method Notes ------------------
...
If (STOCK_l_Context>=0)  // added NG may 2004 to
	...
	End if 
End if 
ERR_MethodTrackerReturn("StockI_Dup"; $_t_oldMethodName)