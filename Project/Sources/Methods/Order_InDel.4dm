//%attributes = {}
If (False:C215)
	//Project Method Name:      Order_InDel
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Order_InDel")
...
If (Gen_DeleteCheckStateSingle(->[ORDERS:24]State:15))
	...
	Else 
		...
		If ($_bo_Continue)
			...
			$_l_OK:=DB_DeletionControl(->[ORDERS:24]; "Order_InDel")
	...
	<>ContCode:=""
End if 
ERR_MethodTrackerReturn("Order_InDel"; $_t_oldMethodName)
