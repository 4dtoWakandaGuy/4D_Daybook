//%attributes = {}
If (False:C215)
	//Project Method Name:      Inv_Accept
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305($1; INV_bo_Addingitem; INV_bo_FurtherFieldsLoaded; $_bo_ExitWIndow; $1; INV_bo_Addingitem; INV_bo_FurtherFieldsLoaded)
	C_DATE:C307(vInvDate)
	C_LONGINT:C283($_l_TableNumber; INV_l_FurtherFieldsMod)
	C_POINTER:C301($_ptr_Field)
	C_REAL:C285(vSubtotal; vTotal)
	C_TEXT:C284($_t_SemaphoreName; $_t_TableNumAsString; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; vText; $_t_oldMethodName; $_t_SemaphoreName; $_t_TableNumAsString; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Inv_Accept")
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Inv_Accept"; $_t_oldMethodName)
