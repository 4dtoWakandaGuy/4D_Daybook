...
$_t_oldMethodName:=ERR_MethodTracker("Jobs_PPPO")
//Jobs_PPPO
$_t_CurrentFormUsage:=DB_t_CurrentFormUsage
Menu_Record("Jobs_PPPO"; "Purchase Order")
...
ERR_MethodTrackerReturn("Jobs_PPPO"; $_t_oldMethodName)