//%attributes = {}
If (False:C215)
	//Project Method Name:      PurchOrd_MenV
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("PurchOrd_MenV")
$_l_Menu:=Sel_LPmi("PurchOrd_MenV")
...
Case of 
	...
	: ($_l_Menu=2)
		...
		//ZContacts_Mod
End case 
ERR_MethodTrackerReturn("PurchOrd_MenV"; $_t_oldMethodName)
