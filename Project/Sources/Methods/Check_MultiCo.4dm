//%attributes = {}
If (False:C215)
	//Project Method Name:      Check_MultiCo
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Check_MultiCo")
//Check_MultiCo
//$2->:=""  ``````WT-06/26
...
If (Records in selection:C76([CONTACTS_COMPANIES:145])>1)
	...
	DIALOG:C40([COMPANIES:2]; "dAsk_Company")
	CLOSE WINDOW:C154
...
Else   //`````WT-06/26
	...
	xNew:=0  //`````WT-06/26
End if   //`````WT-06/26
ERR_MethodTrackerReturn("Check_MultiCo"; $_t_oldMethodName)
