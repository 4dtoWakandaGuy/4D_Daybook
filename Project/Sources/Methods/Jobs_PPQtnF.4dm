...
Jobs_PPBef
//Gen_PPSingle (->[JOBS];"Form";"Jobs_Out";"Qtn";"JOB QTN";"Jobs_PPFormL2")
$_t_Nul:=""  // 05/04/04 pb
$_t_DocumentName:="Job "+[JOBS:26]Job_Code:1
$_t_CurrentWindowTitle:=Get window title:C450
SET WINDOW TITLE:C213($_t_DocumentName)
$_l_Printed:=Gen_PPSingle(->[JOBS:26]; "Form"; "Jobs_Out"; "Qtn"; "JOB QTN"; "Jobs_PPFormL2"; 0; ->$_t_Nul; ""; ""; False:C215; $_t_DocumentName)  // 05/04/04 pb
