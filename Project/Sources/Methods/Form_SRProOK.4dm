//%attributes = {}
If (False:C215)
	//Project Method Name:      Form_SRProOK
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>FormMethod; $_l_Field; $_l_TableNumber; $_l_TableNumber)
	C_POINTER:C301($_ptr_Table)
	C_TEXT:C284(<>PER_t_UserGroup; <>SYS_t_PlatformSetting; $_t_AnalysisCode; $_t_Field; $_t_oldMethodName; $_t_ReportCode; $_t_ReportName; $_t_ReportsPath; $_t_Version; $1; $2)
	C_TEXT:C284(<>PER_t_UserGroup; <>SYS_t_PlatformSetting; $_t_AnalysisCode; $_t_Field; $_t_oldMethodName; $_t_ReportCode; $_t_ReportName; $_t_ReportsPath; $_t_Version; $1; $2)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Form_SRProOK")
...
End if 
$0:=$_bo_Return
ERR_MethodTrackerReturn("Form_SRProOK"; $_t_oldMethodName)
