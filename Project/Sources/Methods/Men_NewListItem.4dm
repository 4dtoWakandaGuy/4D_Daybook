//%attributes = {}
If (False:C215)
	//Project Method Name:      Men_NewListItem
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Men_NewListItem"; Form event code:C388)
AA_LMA_NewListItem
...
End if 
ERR_MethodTrackerReturn("Men_NewListItem"; $_t_oldMethodName)