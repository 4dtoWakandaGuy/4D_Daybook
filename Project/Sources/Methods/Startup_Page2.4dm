//%attributes = {}
If (False:C215)
	//Project Method Name:      Startup_Page2
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>BUTTPROC; <>PER_l_CurrentUserID; <>SYS_l_DateFormatPreference; $_l_Functionality; $_l_Index; $_l_PeriodID; $_l_WindowReferenceRow; ch1; ch2; ch3; r1)
...
$_t_oldMethodName:=ERR_MethodTracker("Startup_Page2")
//Startup_Page2
...
DIALOG:C40([COMPANIES:2]; "dAsk_Startup2")
CLOSE WINDOW:C154
...
If (WIN_bo_TrackerInited)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Startup_Page2"; $_t_oldMethodName)
