//%attributes = {}
If (False:C215)
	//Project Method Name:      SR_Print_Res2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("SR_Print_Res2")
//SR_Print_Res2 - see also SR Print
...
If (Count parameters:C259>=1)
	...
	End if 
End if 
ERR_MethodTrackerReturn("SR_Print_Res2"; $_t_oldMethodName)
