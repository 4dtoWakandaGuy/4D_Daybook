//%attributes = {}
If (False:C215)
	//Project Method Name:      DB_DisableTableTrigger
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("DB_DisableTableTrigger")
...
If (Count parameters:C259>0)
	...
	If (Not:C34(Is nil pointer:C315($p_Array2populate)))
		...
		If (Size of array:C274(<>DB_al_TriggerTable)>=$i_tablenum)
			<>DB_al_TriggerTable{$i_tablenum}:=-1
		End if 
	End if 
End if 
ERR_MethodTrackerReturn("DB_DisableTableTrigger"; $_t_oldMethodName)