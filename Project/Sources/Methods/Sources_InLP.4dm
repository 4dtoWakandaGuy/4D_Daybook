...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_Event; $_l_Index; $_l_ModuleRow; $1; DB_l_WindowCurrentModule; ModuleNumber; PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord)
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetInputFormMenu(Table:C252(->[SOURCES:6]); "Sources_In")
