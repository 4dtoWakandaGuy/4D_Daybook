//%attributes = {}
If (False:C215)
	//Project Method Name:      Term_MenuEnq
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Term_MenuEnq")
...
End if 
// SET MENU ITEM(6;1;"Enter Inquiries";◊MenuProc)
...
End if 
ERR_MethodTrackerReturn("Term_MenuEnq"; $_t_oldMethodName)
