...
$_t_oldMethodName:=ERR_MethodTracker("Fax_SPEnd")
//Fax_SPEnd see alsp Fax_SPEndM1 & 2
...
End if 
ERR_MethodTrackerReturn("Fax_SPEnd"; $_t_oldMethodName)