//%attributes = {}
If (False:C215)
	//Project Method Name:      Record_PlMacro
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/12/2009 09:32`Method: Record_PlMacro
...
$_t_oldMethodName:=ERR_MethodTracker("Record_PlMacro")
//Record_PlMacro
...
End if 
ERR_MethodTrackerReturn("Record_PlMacro"; $_t_oldMethodName)
