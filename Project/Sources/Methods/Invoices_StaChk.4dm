//%attributes = {}
If (False:C215)
	//Project Method Name:      Invoices_StaChk
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Invoices_StaChk")
//Project Method Invoices_StaChk /3/2(ID 22051-1858)
...
If (vIn=1)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Invoices_StaChk"; $_t_oldMethodName)