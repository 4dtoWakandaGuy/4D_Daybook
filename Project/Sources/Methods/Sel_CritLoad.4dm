//%attributes = {}
If (False:C215)
	//Project Method Name:      Sel_CritLoad
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Sel_CritLoad")
//Sel_CritLoad
Menu_Record("Sel_CritLoad"; "Load Criteria ...")
If (vTitle13#"")
...
End if 
ERR_MethodTrackerReturn("Sel_CritLoad"; $_t_oldMethodName)