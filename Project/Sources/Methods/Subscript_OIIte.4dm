//%attributes = {}
If (False:C215)
	//Project Method Name:      Subscript_OIIte
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Subscript_OIIte")
//Subscript_OIIte - used in Del Not Items' LP to change the Product name
// & in Order FormSR
...
If ([SUBSCRIPTIONS:93]Product_Name:2#"")
	...
	End if 
End if 
ERR_MethodTrackerReturn("Subscript_OIIte"; $_t_oldMethodName)