//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPProf
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPProf")
//Orders_PPPO
If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPProf"; "Proforma Invoice")
	$_l_AddMode2:=vAdd
	...
	vAdd:=$_l_AddMode2
End if 
ERR_MethodTrackerReturn("Orders_PPProf"; $_t_oldMethodName)
