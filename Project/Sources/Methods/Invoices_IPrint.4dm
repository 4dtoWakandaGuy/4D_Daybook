//%attributes = {}
If (False:C215)
	//Project Method Name:      Invoices_IPrint
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_BOOLEAN:C305($_bo_Continue; $_bo_InvoiceSuperReportFoundOK; $_bo_SuperReportFoundOK; $_bo_UserCancel; PRT_bo_AskPerIteration; PRT_bo_AutoIteration; PRT_bo_ToPdf; PRT_bo_ToScreenPreview; RPT_bo_OverrideEmailScreen; SR_bo_Validated; $_bo_Continue)
	C_BOOLEAN:C305($_bo_InvoiceDTSuperReportFoundOK; $_bo_InvoiceSuperReportFoundOK; $_bo_SuperReportFoundOK; $_bo_UserCancel; PRT_bo_AskPerIteration; PRT_bo_AutoIteration; PRT_bo_ToPdf; PRT_bo_ToScreenPreview; RPT_bo_OverrideEmailScreen; SR_bo_Validated)
	...
	C_LONGINT:C283(RPT_l_btnGenTypeSelContinue; RPT_l_btnGenTypeSelToggleAll; xCancel; xNext; xOK; $_l_Index; $_l_Index2; $_l_NewSizeOfArray; $_l_NumAsk; $_l_NumEmailOnly; $_l_NumPrintAndEmail)
	C_LONGINT:C283($_l_NumPrintOnly; $_l_RecordsInSelection; $_l_WhereFound; RPT_l_btnGenTypeSelCancel; RPT_l_btnGenTypeSelContinue; RPT_l_btnGenTypeSelToggleAll)
	C_TEXT:C284($_T_EmailAddress; $_T_GenerationType; $_t_InvoiceDTSRCode; $_t_InvoiceSRCode; $_t_InvoiceTitle; $_T_Message; $_t_oldMethodName; $_t_PreviousInvoiceCompanyCode; $_t_PreviousSuperReportCode; $_t_WindowTitle; DB_t_CurrentFormUsage2)
	C_TEXT:C284(DB_t_CurrentFormUsage3; PRT_t_pdfOutputFilePath; RPT_T_GenTypeSelFooter; RPT_t_GenTypeSelGenTypeHead; RPT_T_GenTypeSelHeader; RPT_T_GenTypeSelHeader1; RPT_T_GenTypeSelHeader2; RPT_T_GenTypeSelHeader3; RPT_T_GenTypeSelHeader4; RPT_T_GenTypeSelMainHeading; $_t_CurrentSuperReportCode)
	C_TEXT:C284($_T_EmailAddress; $_T_GenerationType; $_t_InvoiceDTSRCode; $_t_InvoiceSRCode; $_t_InvoiceTitle; $_T_Message; $_t_oldMethodName; $_t_PreviousInvoiceCompanyCode; $_t_PreviousSuperReportCode; $_t_WindowTitle; DB_t_CurrentFormUsage)
	C_TEXT:C284(DB_t_CurrentFormUsage2; PRT_t_pdfOutputFilePath; RPT_T_GenTypeSelFooter; RPT_t_GenTypeSelGenTypeHead; RPT_T_GenTypeSelHeader; RPT_T_GenTypeSelHeader1; RPT_T_GenTypeSelHeader2; RPT_T_GenTypeSelHeader3; RPT_T_GenTypeSelHeader4; RPT_T_GenTypeSelMainHeading)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Invoices_IPrint")
//Project Method Invoices_IPrint /3/2(ID-14117-7452)
//Invoices_IPrint
...
//  If (OK=1)
//   OUTPUT LAYOUT([INVOICES];"Delivery_Note")
...
If (OK=1)
	...
	$_t_InvoiceSRCode:=""
	$_bo_InvoiceSuperReportFoundOK:=(Form_SRProOK("Invoice"+"_Email"; [INVOICES:39]Analysis_Code:17))
	...
	$_t_InvoiceDTSRCode:=""
	$_bo_InvoiceDTSuperReportFoundOK:=(Form_SRProOK("Invoice_DT"+"_Email"; [INVOICES:39]Analysis_Code:17))
	If (Records in selection:C76([DOCUMENTS:7])=0) | ($_bo_InvoiceDTSuperReportFoundOK=False:C215)
		
		$_bo_InvoiceDTSuperReportFoundOK:=(Form_SRProOK("Invoice_DT"; [INVOICES:39]Analysis_Code:17))
	...
	If ($_bo_UserCancel=False:C215)  //added v631b120p 13/03/09 -kmw
		...
		For ($_l_Index2; 1; 2)  //Added 21/11/08 v631b120i -kmw
			...
			If (OK=1)
				If (Records in selection:C76([INVOICES:39])>0)
					If (False:C215)
						Gen_PPMulti(->[INVOICES:39]; "Form"; "Invoices_Out"; DB_t_CurrentFormUsage; "Invoice"; "Invoices_FormL2"; 0; ->[INVOICES:39]State:10; "Invoice"; [INVOICES:39]Analysis_Code:17)
					Else 
						...
						For ($_l_Index; 1; Records in selection:C76([INVOICES:39]))
							...
							If (([INVOICES:39]Delivery_Company:30#"") | ([INVOICES:39]Deliver_To:32#"") | ([INVOICES:39]x_DeliveryAddressID:48>0))
								...
								$_l_WhereFound:=Find in array:C230($_at_RemInvoice; [INVOICES:39]Invoice_Number:1)
								If ($_l_WhereFound>0)
									$_bo_Continue:=Gen_PPSingle_2(->[INVOICES:39]; ->[INVOICES_ITEMS:161]; "Form_DT2"; "INVFormSub2"; "Invoices_Out"; DB_t_CurrentFormUsage; "Invoice_DT"; "Invoices_FormL2"; 0; ->[INVOICES:39]State:10; "Invoice_DT"; [INVOICES:39]Analysis_Code:17; False:C215; $_l_Index; $_T_GenerationType; $_at_RemEmailAddress{$_l_WhereFound})
								Else 
									$_bo_Continue:=Gen_PPSingle_2(->[INVOICES:39]; ->[INVOICES_ITEMS:161]; "Form_DT2"; "INVFormSub2"; "Invoices_Out"; DB_t_CurrentFormUsage; "Invoice_DT"; "Invoices_FormL2"; 0; ->[INVOICES:39]State:10; "Invoice_DT"; [INVOICES:39]Analysis_Code:17; False:C215; $_l_Index)
								End if 
								
							Else 
								$_l_WhereFound:=Find in array:C230($_at_RemInvoice; [INVOICES:39]Invoice_Number:1)
								If ($_l_WhereFound>0)
									$_bo_Continue:=Gen_PPSingle_2(->[INVOICES:39]; ->[INVOICES_ITEMS:161]; "Form2"; "INVFormSub2"; "Invoices_Out"; DB_t_CurrentFormUsage; "Invoice"; "Invoices_FormL2"; 0; ->[INVOICES:39]State:10; "Invoice"; [INVOICES:39]Analysis_Code:17; False:C215; $_l_Index; $_T_GenerationType; $_at_RemEmailAddress{$_l_WhereFound})
								Else 
									$_bo_Continue:=Gen_PPSingle_2(->[INVOICES:39]; ->[INVOICES_ITEMS:161]; "Form2"; "INVFormSub2"; "Invoices_Out"; DB_t_CurrentFormUsage; "Invoice"; "Invoices_FormL2"; 0; ->[INVOICES:39]State:10; "Invoice"; [INVOICES:39]Analysis_Code:17; False:C215; $_l_Index)
								End if 
							End if 
							NEXT RECORD:C51([INVOICES:39])
...
Else 
	...
	End if 
End if 
//OUTPUT FORM([INVOICES];"Invoices_Out")
...
ERR_MethodTrackerReturn("Invoices_IPrint"; $_t_oldMethodName)
