...
$_t_oldMethodName:=ERR_MethodTracker("Jobs_TCIn")
//Jobs_TCIn
Start_Process
...
FORM SET INPUT:C55([ORDERS:24]; "Jobs_TCIn")
WIN_t_CurrentInputForm:="Jobs_TCIn"
...
Process_End
ERR_MethodTrackerReturn("Jobs_TCIn"; $_t_oldMethodName)