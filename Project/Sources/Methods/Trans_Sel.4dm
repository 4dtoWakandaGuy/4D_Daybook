...
$_t_oldMethodName:=ERR_MethodTracker("Trans_Sel")
//Trans_Sel
...
Else 
	...
	While ((vTr=1) & ((SRCH_l_And=1) | (SRCH_l_or=1) | (SRCH_l_Not=1))) | ($_l_Element<=$_l_ElementCount)
		...
		If ($_l_QueryID=0)
			...
			End if 
			DIALOG:C40([TRANSACTIONS:29]; "dTrans_Sel")
...
End if 
ERR_MethodTrackerReturn("Trans_Sel"; $_t_oldMethodName)
