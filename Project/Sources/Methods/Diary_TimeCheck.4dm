//%attributes = {}
If (False:C215)
	//Project Method Name:      Diary_TimeCheck
	//------------------ Method Notes ------------------
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Diary_TimeCheck"; $_t_oldMethodName)