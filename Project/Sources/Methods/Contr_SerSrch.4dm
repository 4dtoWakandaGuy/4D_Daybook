//%attributes = {}
If (False:C215)
	//Project Method Name:      Contr_SerSrch
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Contr_SerSrch")
//Contracts Serial Search
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Menu_Record("Contr_SerSrch"; "Find Items by Serial No")
...
If ((OK=1) & ($_t_Search#""))
	...
	If (Records in selection:C76([ORDER_ITEMS:25])>0)
		If (Records in selection:C76([ORDER_ITEMS:25])>1)
			//OUTPUT FORM([ORDER ITEMS];"Items_Out")
...
ERR_MethodTrackerReturn("Contr_SerSrch"; $_t_oldMethodName)