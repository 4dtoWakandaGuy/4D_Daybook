//%attributes = {}
If (False:C215)
	//Project Method Name:      User_TempDocs
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("User_TempDocs")
//Letters_File
vT:=""
vComments:=""
...
Else 
	//`Open_Pro_Window ("View Documents";0;1;->[DOCUMENTS];"Reports_Out")
...
End if 
ERR_MethodTrackerReturn("User_TempDocs"; $_t_oldMethodName)