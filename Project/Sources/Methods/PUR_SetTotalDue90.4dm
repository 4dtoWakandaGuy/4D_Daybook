//%attributes = {}
If (False:C215)
	//Project Method Name:      PUR_SetTotalDue90
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_REAL:C285($0; PUR_R_TotalDue90)
	C_TEXT:C284($_t_oldMethodName; PER_t_Period3)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("PUR_SetTotalDue90")
...
Else 
	...
	End if 
	QUERY:C277([PURCHASE_INVOICES:37];  & ; [PURCHASE_INVOICES:37]Period_Code:3=PER_t_Period3)
End if 
$0:=Gen_Round((Sum:C1([PURCHASE_INVOICES:37]Total_Due:9)); 2; 2)
PUR_R_TotalDue90:=PUR_R_TotalDue90+$0
ERR_MethodTrackerReturn("PUR_SetTotalDue90"; $_t_oldMethodName)
