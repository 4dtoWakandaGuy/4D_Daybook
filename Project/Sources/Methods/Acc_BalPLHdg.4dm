//%attributes = {}
If (False:C215)
	//Project Method Name:      Acc_BalPLHdg
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_POINTER:C301($1)
	C_REAL:C285($0; vAmountF; vAmountT; vPTot; vYTot)
	C_TEXT:C284($_t_oldMethodName; vHeading; vRec; vTerms)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Acc_BalPLHdg")
...
End if 
ERR_MethodTrackerReturn("Acc_BalPLHdg"; $_t_oldMethodName)
