//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPDelA
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPDelA")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPDelA"; "Delivery Note All")
...
End if 
ERR_MethodTrackerReturn("Orders_PPDelA"; $_t_oldMethodName)