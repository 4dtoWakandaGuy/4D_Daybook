//%attributes = {}
If (False:C215)
	//Project Method Name:      OrderI_InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(ModuleNumber; ORDI_l_LBLevel; ORDI_l_Textlength; PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord; SD2_l_CallingProcess; SD2_l_TableNum; WS_OLDSORTORDER)
...
$_t_oldMethodName:=ERR_MethodTracker("OrderI_InLP")
...
End case 
ERR_MethodTrackerReturn("OrderI_InLP"; $_t_oldMethodName)
