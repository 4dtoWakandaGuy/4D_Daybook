//%attributes = {}
If (False:C215)
	//Project Method Name:      DBWS_GetDataGrid
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 18/10/2012 20:02
...
$_t_oldMethodName:=ERR_MethodTracker("DBWS_GetDataGrid")
If (True:C214)
	$_t_String:=""
	If ($1#"")
	...
	End if 
End if 
ERR_MethodTrackerReturn("DBWS_GetDataGrid"; $_t_oldMethodName)