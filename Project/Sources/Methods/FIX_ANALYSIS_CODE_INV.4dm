//%attributes = {}
If (False:C215)
	//Project Method Name:      FIX_ANALYSIS_CODE_INV
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FIX_ANALYSIS_CODE_INV")
//Project Method FIX_ANALYSIS_COD/3/2(ID 18984-1462)

READ WRITE:C146(*)

//ALL RECORDS([INVOICES])`10/07/02 pb
QUERY:C277([INVOICES:39]; [INVOICES:39]Analysis_Code:17=""; *)
QUERY:C277([INVOICES:39];  & ; [INVOICES:39]Period_Code:13#"")
...
If (Records in selection:C76([INVOICES:39])>0)
	...
	End for 
End if 
ERR_MethodTrackerReturn("FIX_ANALYSIS_CODE_INV"; $_t_oldMethodName)