//%attributes = {}
If (False:C215)
	//Project Method Name:      StatsView_Cal4F
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StatsView_Cal4F")
//StatsView_Cal4F - FurthFld
Load_Fields
...
Else 
	BEEP:C151
End if 
ERR_MethodTrackerReturn("StatsView_Cal4F"; $_t_oldMethodName)
