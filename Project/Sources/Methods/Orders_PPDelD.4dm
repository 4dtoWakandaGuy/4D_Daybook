//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPDelD
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPDelD")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPDelD"; "Delivery Note by Date")
...
End if 
ERR_MethodTrackerReturn("Orders_PPDelD"; $_t_oldMethodName)