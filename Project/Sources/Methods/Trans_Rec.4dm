...
$_t_oldMethodName:=ERR_MethodTracker("Trans_Rec")
//Trans_Rec
Start_Process
If (Trans_File)
	While (vTr=1)
		...
		If (vTr=1)
			If (Records in selection:C76([TRANSACTIONS:29])>0)
				...
				FORM SET OUTPUT:C54([TRANSACTIONS:29]; "Trans_BR")
...
Process_End
ERR_MethodTrackerReturn("Trans_Rec"; $_t_oldMethodName)
