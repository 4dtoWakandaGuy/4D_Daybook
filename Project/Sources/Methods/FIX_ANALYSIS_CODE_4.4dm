//%attributes = {}
If (False:C215)
	//Project Method Name:      FIX_ANALYSIS_CODE_4
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FIX_ANALYSIS_CODE_4")
//Project Method FIX_ANALYSIS_COD/3/2(ID 11829-2028)
...
QUERY:C277([TRANSACTION_BATCH_ITEMS:155];  & ; [TRANSACTION_BATCH_ITEMS:155]Period_Code:11#"")
...
End for 
ERR_MethodTrackerReturn("FIX_ANALYSIS_CODE_4"; $_t_oldMethodName)