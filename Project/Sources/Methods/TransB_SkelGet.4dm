//%attributes = {}
If (False:C215)
	//Project Method Name:      TransB_SkelGet
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("TransB_SkelGet")
//TransB_SkelGet
Menu_Record("TransB_SkelGet"; "Copy Previous Batch")
OK:=1
...
End if 
ERR_MethodTrackerReturn("TransB_SkelGet"; $_t_oldMethodName)
