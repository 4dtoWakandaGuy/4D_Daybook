...
$_t_oldMethodName:=ERR_MethodTracker("MailP_Exp")
//MailP_Exp
...
If (bd2=1)
	...
	If (OK=1)
		...
		WIN_t_CurrentOutputform:="Reports_Out"  //added NG may 2004
...
End if 
//End if
ERR_MethodTrackerReturn("MailP_Exp"; $_t_oldMethodName)
