...
If (True:C214)
	...
	C_REAL:C285(STK_r_TotalStock; STK_r_TotalStockValue; vQuantity; vTotal)
	C_TEXT:C284($_t_oldMethodName; oSL_COL1; oSL_COL2; oSL_COL3; oSL_COL4; oSL_COL5; oSL_COL6; oSL_COL7; oSL_COL8; oSL_COL9; oSL_HED1)
	C_TEXT:C284(oSL_HED2; oSL_HED3; oSL_HED4; oSL_HED5; oSL_HED6; oSL_HED7; oSL_HED8; oSL_HED9; STK_t_ProductName; STK_t_StockHeaderLabel; STK_t_StockTypeName)
	C_TEXT:C284(vButtDisSL; vProduct; vTitleL; vType)
End if 
//Code Starts Here
...
STK_t_StockTypeName:=[STOCK_TYPES:59]Type_Name:2
RELATE ONE:C42([STOCK_LEVELS:58]Product_Code:1)
STK_t_ProductName:=[PRODUCTS:9]Product_Name:2
STK_r_TotalStock:=[STOCK_LEVELS:58]Free_Level:3+[STOCK_LEVELS:58]Allocated_Level:4
STK_r_TotalStockValue:=[STOCK_LEVELS:58]Free_Cost:5+[STOCK_LEVELS:58]Allocated_Cost:6
STK_t_StockHeaderLabel:=Uppercase:C13(Term_StoWT("Stock Level"))
