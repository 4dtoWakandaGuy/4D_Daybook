...
If (True:C214)
	...
	C_LONGINT:C283($_l_Event; $_l_NewNumbersProcess; $_l_ProcessState; $_l_TypeNumber; $_l_TypeNumberMN; $_l_TypeNumberNew; ch1; DB_l_ButtonClickedFunction; PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord)
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		MoveTypes_InLPB
		DB_SetInputFormMenu(Table:C252(->[MOVEMENT_TYPES:60]); "MoveType_in")
