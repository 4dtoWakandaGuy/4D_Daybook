//%attributes = {}
If (False:C215)
	//Project Method Name:      Qualities_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Qualities_File")
//DEFAULT TABLE([INFORMATION])
FORM SET INPUT:C55([INFORMATION:55]; "Information_in")  //NG April 2004 Removed ◊Screen
WIN_t_CurrentInputForm:="Information_in"
FORM SET OUTPUT:C54([INFORMATION:55]; "Information_Out")
WIN_t_CurrentOutputform:="Information_Out"
vA:=1
...
End if 
ERR_MethodTrackerReturn("Qualities_File"; $_t_oldMethodName)
