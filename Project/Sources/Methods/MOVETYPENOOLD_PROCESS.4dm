//%attributes = {}
If (False:C215)
	//Project Method Name:      MOVETYPENOOLD_PROCESS
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_Clash; $_l_MultiTableNumber; $_l_NewNumberProcess; $_l_OK; $_l_RecordsinSelectionMN; $_l_TypeNumberOK)
	C_TEXT:C284(<>MPNUMBERSTR; $_t_oldMethodName; $_t_TestClashingNumberSTR; $_t_TypeNumberSTR; CreateSem; CREATESEM2; CREATESEM3)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("MOVETYPENOOLD_PROCESS")
...
Repeat 
	...
	If ([MOVEMENT_TYPES:60]MN_Identifier_Number:24>0) | (In transaction:C397)
		Repeat 
			...
			LOAD RECORD:C52([IDENTIFIERS_MULTI_NUMBERS:94])
...
ERR_MethodTrackerReturn("MOVETYPENOOLD_PROCESS"; $_t_oldMethodName)
