//%attributes = {}
If (False:C215)
	//Project Method Name:      LBi_SCPT_DiaryItemView
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_Row; SD_CurrentFormObject; SD_l_EditingDiaryRecord)
...
$_t_oldMethodName:=ERR_MethodTracker("LBi_SCPT_DiaryItemView")
// LB_DiaryItemView
// 26/06/06 pb
...
If ($_bo_Modify)
	...
	End if 
End if 
ERR_MethodTrackerReturn("LBi_SCPT_DiaryItemView"; $_t_oldMethodName)