...
If (True:C214)
	...
	C_BOOLEAN:C305(DB_bo_NoLoad; DB_bo_RecordModified; PAL_bo_ButtonSubFunction; $_bo_StageChanges; DB_bo_NoLoad; DB_bo_RecordModified; PAL_bo_ButtonSubFunction)
	C_LONGINT:C283($_l_CountTables; $_l_Event; $_l_Index; $_l_JobCodeRow; $_l_JobSalesType; $_l_RestrictionRow; $_l_StageCodeRow; $_l_TableNumber; DB_l_ButtonClickedFunction; iCancel; JT_l_ResListID)
	C_LONGINT:C283(JT_l_TableRestrictionID; RBTemp; $_l_CodeusedRow; $_l_CountTables; $_l_Event; $_l_Index; $_l_JobCodeRow; $_l_JobSalesType; $_l_RestrictionRow; $_l_StageCodeRow; $_l_TableNumber)
	C_LONGINT:C283(DB_l_ButtonClickedFunction; iOK; JT_l_ResListID; JT_l_TableRestrictionID)
	C_TEXT:C284($_t_PalletButtonName; PAL_BUTTON; vButtDisJtypes; WIN_t_CurrentInputForm; $_t_oldMethodName; $_t_PalletButtonName; WIN_t_CurrentInputForm)
End if 
//Code Starts Here
