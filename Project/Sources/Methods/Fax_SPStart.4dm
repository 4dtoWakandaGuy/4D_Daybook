//%attributes = {}
If (False:C215)
	//Project Method Name:      Fax_SPStart
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Fax_SPStart")
//Fax_SPStart - see also StartM1 & 2
$0:=0
If (Fax_SPSetup)
	...
	DIALOG:C40([COMPANIES:2]; "dFax_SPCover")
	CLOSE WINDOW:C154
...
Else 
	$0:=1
End if 
ERR_MethodTrackerReturn("Fax_SPStart"; $_t_oldMethodName)