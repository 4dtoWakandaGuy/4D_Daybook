//%attributes = {}
If (False:C215)
	//Project Method Name:      Check_Cont
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_AddMode; $_l_CurrentWinRefOLD; $_l_DockRight; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowReference; $_l_WindowRight; $_l_WindowTop; vAdd; vCM; vCT)
	C_LONGINT:C283(WIN_l_CurrentWinRef; WIN_l_CurrentWinRefOLD; xNew; <>SYS_l_WindowTop; $_l_AddMode; $_l_CurrentWinRefOLD; $_l_DockRight; $_l_WindowBottom; $_l_WindowLeft; $_l_WindowReference; $_l_WindowRight)
	C_LONGINT:C283($_l_WindowTop; vCP; WIN_l_CurrentWinRef)
	C_POINTER:C301($2; $3; $1)
	C_TEXT:C284($_t_CurrentFormUsage; $_t_oldMethodName; COM_t_TelephoneNumberFormat; DB_t_CallOnCloseorSave; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; vCompCode; vCompName; vContact; <>SYS_t_DefaultTelFormat)
	C_TEXT:C284($_t_CurrentFormUsage; $_t_oldMethodName; COM_t_TelephoneNumberFormat; DB_t_CallOnCloseorSave; DB_t_CurrentFormUsage; vTel)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Check_Cont")
//Check_Cont
...
Else 
	...
	If (OK=1)
		...
		DIALOG:C40([CONTACTS:1]; "dAsk_Contact2")
		CLOSE WINDOW:C154
...
ERR_MethodTrackerReturn("Check_Cont"; $_t_oldMethodName)
