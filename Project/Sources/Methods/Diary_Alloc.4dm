//%attributes = {}
If (False:C215)
	//Project Method Name:      Diary_Alloc
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary_Alloc")
//Diary_Alloc
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Menu_Record("Diary_Alloc"; "Allocate to Companies")
...
If (OK=1)
	...
	If (OK=1)
		...
		//OUTPUT FORM([COMPANIES];"Companies_Out")
...
ERR_MethodTrackerReturn("Diary_Alloc"; $_t_oldMethodName)