//%attributes = {}
If (False:C215)
	//Project Method Name:      Fax_FEStartM1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Fax_FEStartM1")
//Fax_FEStartM1 - Multi 1
$0:=0
...
DIALOG:C40([COMPANIES:2]; "dFax_FECover")
CLOSE WINDOW:C154
$_l_OK:=OK
OK:=1
...
End if 
ERR_MethodTrackerReturn("Fax_FEStartM1"; $_t_oldMethodName)