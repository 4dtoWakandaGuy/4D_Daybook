//%attributes = {}
If (False:C215)
	//Project Method Name:      Purchases_Dup
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purchases_Dup")

//Purchases_Dup
Menu_Record("Purchases_Dup"; "Copy Previous")
...
End if 
ERR_MethodTrackerReturn("Purchases_Dup"; $_t_oldMethodName)
