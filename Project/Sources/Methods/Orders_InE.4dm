...
If (True:C214)
	...
	C_LONGINT:C283(vAdd; SD_l_ParentProcess)
	C_TEXT:C284($1; $2; $3; $4; $5; $6; SD_t_CallingCompanyCode; SD_t_CallingContactCode; SD_t_InputFormName; WIN_t_CurrentInputForm; $_t_oldMethodName)
	C_TEXT:C284(SD_t_CallingCompanyCode; SD_t_CallingContactCode; SD_t_InputFormName; WIN_t_CurrentInputForm)
End if 
//Code Starts Here
