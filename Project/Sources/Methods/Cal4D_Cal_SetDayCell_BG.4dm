...
If (False:C215)
	//Project Method Name:      Cal4D_Cal_SetDayCell_BG
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284($_t_CellID; $_t_MethodName; $_t_Msg; $_t_oldMethodName; $_t_Ordinal; $1; $2; SVG_t_Ref_Day)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Cal4D_Cal_SetDayCell_BG")
...
Case of 
	: ($_t_Msg="default")
		If (Cal4D_Cal_SelectedDate#Current date:C33)
			For ($_l_Index; 0; 23)
				$_t_CellID:=SVG_Find_ID(SVG_t_Ref_Day; $_t_Ordinal+"_"+String:C10($_l_Index; "00"))
...
//========================    Clean up and Exit    =================================
ERR_MethodTrackerReturn("Cal4D_Cal_SetDayCell_BG"; $_t_oldMethodName)