//%attributes = {}
If (False:C215)
	//Project Method Name:      StatsView_FFS3
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StatsView_FFS3")
//StatsView_FFS3 - finds the actual records from a FurthFld_Selection
...
End case 
ERR_MethodTrackerReturn("StatsView_FFS3"; $_t_oldMethodName)
