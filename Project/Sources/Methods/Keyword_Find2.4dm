...
If ($_l_TableNumber>0)
	If (<>SYS_al_TableUniqueField{$_l_TableNumber}#0)
		...
		If ($6="")
			$_t_KeywordCode:="K"+STR_LeadZeros(String:C10(<>DB_al_TableNums{$_l_TableNumber}); 3)+"@"
		Else 
			$_t_KeywordCode:="K"+STR_LeadZeros(String:C10(<>DB_al_TableNums{$_l_TableNumber}); 3)+$6
		End if 
