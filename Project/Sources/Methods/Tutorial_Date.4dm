//%attributes = {}
If (False:C215)
	//Project Method Name:      Tutorial_Date
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Tutorial_Date")
//Tutorial_Date - sets the Limit Date such that on next launch will get x days
...
ERR_MethodTrackerReturn("Tutorial_Date"; $_t_oldMethodName)
