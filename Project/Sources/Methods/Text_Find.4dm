...
$_t_oldMethodName:=ERR_MethodTracker("Text_Find")
Menu_Record("Text_Find"; "Find...")
...
If (Type:C295($_ptr_FocusObject->)=2)
	...
	DIALOG:C40([COMPANIES:2]; "dText_Find")
	Close_ProWin
	If ((OK=1) & (<>TextFind#""))
		<>TextReplace:=""
		If ($Req=<>TextFind)
...
End if 
ERR_MethodTrackerReturn("Text_Find"; $_t_oldMethodName)
