//%attributes = {}
If (False:C215)
	//Project Method Name:      Macros_Copy
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Macros_Copy")
Menu_Record("Macros_Copy"; "Copy to Current Macro")
If (<>ButtDis="O@")
...
End if 
ERR_MethodTrackerReturn("Macros_Copy"; $_t_oldMethodName)