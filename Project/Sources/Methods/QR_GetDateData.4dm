//%attributes = {}
If (False:C215)
	//Project Method Name:      QR_GetDateData
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 14/09/2012 08:39
...
$_t_oldMethodName:=ERR_MethodTracker("QR_GetDateData")
...
End if 
ERR_MethodTrackerReturn("QR_GetDateData"; $_t_oldMethodName)
