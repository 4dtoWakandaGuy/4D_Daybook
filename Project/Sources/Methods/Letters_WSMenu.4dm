//%attributes = {}
If (False:C215)
	//Project Method Name:      Letters_WSMenu
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letters_WSMenu")
...
If (Menu selected:C152#0)
			...
			Case of 
				...
				: ($_l_menuItemNumber=3)
					...
					If (vMod2)
						...
						SET MENU ITEM:C348(2050; 3; "Hide Invisibles")
						vMod2:=False:C215
					Else 
						SET MENU ITEM:C348(2050; 3; "Show Invisibles")
						vMod2:=True:C214
					End if 
				: ($_l_menuItemNumber=4)
					...
					If (vMod3)
						SET MENU ITEM:C348(2050; 4; "Hide Pictures")
						vMod3:=False:C215
					Else 
						SET MENU ITEM:C348(2050; 4; "Show Pictures")
						vMod3:=True:C214
					End if 
				: ($_l_menuItemNumber=5)
					...
					If (vBefore2)
						SET MENU ITEM:C348(2050; 5; "Hide Ruler")
						vBefore2:=False:C215
					Else 
						SET MENU ITEM:C348(2050; 5; "Show Ruler")
						vBefore2:=True:C214
					End if 
				: ($_l_menuItemNumber=6)
					WR O DO COMMAND:P12000:25(Write; 606; 0)
					If (vBefore2I)
						SET MENU ITEM:C348(2050; 6; "Hide Margins")
						vBefore2I:=False:C215
					Else 
						SET MENU ITEM:C348(2050; 6; "Show Margins")
						vBefore2I:=True:C214
					End if 
				: ($_l_menuItemNumber=8)
	...
	End case 
End if 
ERR_MethodTrackerReturn("Letters_WSMenu"; $_t_oldMethodName)