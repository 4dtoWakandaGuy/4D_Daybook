...
If (Records in selection:C76([TRANSACTIONS:29])>0)
	...
	$_l_Process:=New process:C317("DBI_DisplayRecords"; 1024000; "VIEW"+$_t_TableName; $_l_DisplayRecordsTable; "◊Preselection"; $_t_Context; $_l_ViewType; $_bo_TabsAvailable; $_bo_HideModuleBar; $_bo_SearchesAvailable; Current process:C322; $_bo_StatsAvailable; $_bo_GraphsAvailable; $_bo_FiltersAvailable; $_bo_SeletionsAvailable; $_l_Module)
