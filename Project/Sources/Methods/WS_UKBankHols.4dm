//%attributes = {}
If (False:C215)
	//Project Method Name:      WS_UKBankHols
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("WS_UKBankHols")
...
If (Count parameters:C259>=1)
	...
	For ($_l_Index; 1; 7)
		$_d_DateTest:=Date:C102(String:C10($_l_Index)+"/05/"+String:C10(Year of:C25($1)))
	...
	If ($1>$_d_DateTest)
		...
		For ($_l_Index; 1; 7)
			$_d_DateSet:=Date:C102(String:C10($_l_Index)+"/05/"+String:C10(Year of:C25($1)+1))
	...
	//when is the LAST monday in may
	For ($_l_Index; 31; (31-7); -1)
		$_d_DateTest:=Date:C102(String:C10($_l_Index)+"/08/"+String:C10(Year of:C25($1)))
	...
	If ($1>$_d_DateTest)
		...
		For ($_l_Index; 31; (31-7); -1)
			$_d_DateSet:=Date:C102(String:C10($_l_Index)+"/08/"+String:C10(Year of:C25($1)+1))
...
End if 
ERR_MethodTrackerReturn("WS_UKBankHols"; $_t_oldMethodName)