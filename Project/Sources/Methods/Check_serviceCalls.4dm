//%attributes = {}
If (False:C215)
	//Project Method Name:      Check_serviceCalls
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 25/03/2010 13:44
...
$_t_oldMethodName:=ERR_MethodTracker("Check_serviceCalls")
...
If (Records in selection:C76([PURCHASE_INVOICES:37])>0)
	...
	End if 
Else 
	Gen_Alert("No Service call found")
	$1->:=""
	
End if 
ERR_MethodTrackerReturn("Check_serviceCalls"; $_t_oldMethodName)