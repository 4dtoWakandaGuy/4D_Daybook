...
$_t_oldMethodName:=ERR_MethodTracker("Orders_CP")
If (Not:C34(ORD_bo_IsRevision))
	$_t_CurrentOutputform:=WIN_t_CurrentOutputform
	$_t_CurrentFormUsage:=DB_t_CurrentFormUsage
	Menu_Record("Orders_CP"; "Copy Previous")
	If (In_ButtChkMan(->[ORDERS:24]; "3"))
		If (Gen_PPChkStSing(->[ORDERS:24]State:15; 18))
			...
			$_l_Process:=New process:C317("DBI_DisplayRecords"; 1024000; "Copy Previous to"+String:C10(Current process:C322); Table:C252(->[ORDERS:24]); ""; "Copy Order"; 1; False:C215; True:C214; True:C214; Current process:C322; False:C215; False:C215; True:C214; True:C214; 0; False:C215; False:C215; False:C215)
...
End if 
ERR_MethodTrackerReturn("Orders_CP"; $_t_oldMethodName)
