//%attributes = {}
If (False:C215)
	//Project Method Name:      Diary_EmailSEND
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary_EmailSEND")
//GET EMAIL DATA
...
If (<>Email_bo_Enabled)
	If ([DIARY:12]Document_Code:15#"")
		...
		If ([DOCUMENTS:7]Document_Class:14=Text Email Template) | ([DOCUMENTS:7]Document_Class:14=Text Email)
			...
			End if 
			EMAIL_t_SendCalledFrom:="Diary_EmailSEND"
	...
	End if 
End if 
ERR_MethodTrackerReturn("Diary_EmailSEND"; $_t_oldMethodName)