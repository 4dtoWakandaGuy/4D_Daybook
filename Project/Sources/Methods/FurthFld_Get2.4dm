			...
			If ($_l_CustomFieldPosition>0)
				If ($srcOrig="")
					...
					If (Type:C295($_l_CustomFieldPositionldPtr->)=9)
						$src:=STR_LeadZeros(String:C10($_l_TableNumber); 3)+String:C10($_l_CustomFieldPositionldPtr->)
					Else 
						$src:=STR_LeadZeros(String:C10($_l_TableNumber); 3)+$_l_CustomFieldPositionldPtr->
					End if 
					
				Else 
					$src:=STR_LeadZeros(String:C10($_l_TableNumber); 3)+$srcOrig
				End if 
