//%attributes = {}
If (False:C215)
	//Project Method Name:      Gen_SetObjectPosition
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 10/03/2010 08:45
...
If (True:C214)
	C_LONGINT:C283($_l_NextObject; $_l_ObjectBottom; $_l_ObjectHeight; $_l_ObjectHeightis; $_l_ObjectLeft; $_l_ObjectRight; $_l_ObjectTop; $_l_ObjectWidth; $0; $2; $3)
	C_LONGINT:C283($4; $5)
	C_POINTER:C301($1; $6)
...
$_t_oldMethodName:=ERR_MethodTracker("Gen_SetObjectPosition")
If (Count parameters:C259>=2)
	OBJECT GET COORDINATES:C663($1->; $_l_ObjectLeft; $_l_ObjectTop; $_l_ObjectRight; $_l_ObjectBottom)
	
	$_l_ObjectHeightis:=$_l_ObjectBottom-$_l_ObjectTop
	...
	If (Count parameters:C259>=4)
		If ($4>0)
			...
			If ($2=0)  //Top was not set so keep height
				$_l_NextObject:=$_l_ObjectBottom-$_l_ObjectHeightis
			Else 
	...
	Else 
		//Keep height same
		$_l_ObjectBottom:=$_l_ObjectTop+$_l_ObjectHeightis
	End if 
...
End if 
ERR_MethodTrackerReturn("Gen_SetObjectPosition"; $_t_oldMethodName)