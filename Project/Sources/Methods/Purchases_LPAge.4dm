//%attributes = {}
If (False:C215)
	//Project Method Name:      Purchases_LPAge
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/11/2009`Method: Purchases_LPAge
...
$_t_oldMethodName:=ERR_MethodTracker("Purchases_LPAge")
//See Also Purchases_Out & Pay
...
End if 
ERR_MethodTrackerReturn("Purchases_LPAge"; $_t_oldMethodName)