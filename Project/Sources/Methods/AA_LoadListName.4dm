//%attributes = {}
If (False:C215)
	//Project Method Name:      AA_LoadListName
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ListID; $_l_ListPosition; $_l_Retries; $0; $1)
	C_TEXT:C284($_t_ListName; $_t_oldMethodName; $2)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("AA_LoadListName")
...
If (Count parameters:C259>=2)
	...
	If ($_l_ListPosition<0)
		...
		Else 
			$0:=AA_al_ListIDS{$_l_ListPosition}
			CLEAR SEMAPHORE:C144("$LoadingListofLists")
...
ERR_MethodTrackerReturn("AA_LoadListName"; $_t_oldMethodName)
