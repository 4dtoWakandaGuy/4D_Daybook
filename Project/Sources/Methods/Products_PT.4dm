//%attributes = {}
If (False:C215)
	//Project Method Name:      Products_PT
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Products_PT")
//Products_PT
Menu_Record("Products_PT"; "Price Table")
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Products_PT"; $_t_oldMethodName)
