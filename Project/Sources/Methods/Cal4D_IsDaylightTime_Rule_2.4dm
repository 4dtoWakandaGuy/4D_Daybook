...
If (False:C215)
	//Project Method Name:      Cal4D_IsDaylightTime_Rule_2
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_1stDayNo; $_l_Day; $_l_DayNo; $_l_Month; $LastDayNo_L)
	C_TEXT:C284($_t_MethodName; $_t_oldMethodName)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Cal4D_IsDaylightTime_Rule_2")
...
Case of 
	: (($_l_Month>October:K10:10) | ($_l_Month<March:K10:3))
	...
	: ($_l_Month=March:K10:3)
		////  and ends on the third Sunday in March.
		Case of 
...
$0:=$_bo_DST
ERR_MethodTrackerReturn("Cal4D_IsDaylightTime_Rule_2"; $_t_oldMethodName)