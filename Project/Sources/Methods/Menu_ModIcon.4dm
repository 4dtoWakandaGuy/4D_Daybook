//%attributes = {}
If (False:C215)
	//Project Method Name:      Menu_ModIcon
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(<>BAR; <>MENU_l_BarModule; $_l_BarProcess)
	C_TEXT:C284($_t_oldMethodName; $_t_oldMethodName2)
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Menu_ModIcon")

//this menu item has been removed now
If ((DB_GetModuleSettingByNUM(1))#5)
	Menu_Record("Menu_ModIcon"; "Module Icons")
	...
	End if 
End if 
ERR_MethodTrackerReturn("Menu_ModIcon"; $_t_oldMethodName)
