//%attributes = {}
If (False:C215)
	//Project Method Name:      NewGenCodePref
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_LeadingZeros; $_l_Number; $_l_OK; $_l_TableNumber; $1; SYS_l_LastNumber)
	C_POINTER:C301($2)
	C_TEXT:C284($_t_Before; $_t_oldMethodName; $_t_TableName; $0; $3; $4; CREATESEM2; CREATESEM3; CREATESEM4)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("NewGenCodePref")
...
Case of 
	...
	: (Count parameters:C259=3)
		//$3 IS ADDED TO THE BEFORE(AFTER THE OFFICE CODE AND BACK SLASH...ERRR FORWARD SLASH!!!!
		If ($_t_OfficeCode)
			If ($_bo_Backslash)
				$_t_Before:=DB_GetOrganisationOfficeCode+"/"
			Else 
...
End case 
ERR_MethodTrackerReturn("NewGenCodePref"; $_t_oldMethodName)
