//%attributes = {}
If (False:C215)
	//Project Method Name:      Calls_List
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Calls_List")
...
Gen_ListSR("Calls_List"; "Calls_File"; "Master"; ->[SERVICE_CALLS:20]; ->vCalls; "Calls_Sel"; "Calls"; "g t"; ""; "CallList"; $_bo_AutoSearch; $_t_SearchCode)
ERR_MethodTrackerReturn("Calls_List"; $_t_oldMethodName)