//%attributes = {}
If (False:C215)
	//Project Method Name:      Letters_Preview
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Letters_Preview")
//XPreview
Menu_Record("Letters_Preview"; "Preview")
...
If ($_l_OK>=0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Letters_Preview"; $_t_oldMethodName)