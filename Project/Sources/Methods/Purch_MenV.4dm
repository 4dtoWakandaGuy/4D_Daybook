//%attributes = {}
If (False:C215)
	//Project Method Name:      Purch_MenV
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purch_MenV")
$_l_Menu:=Sel_LPmi("Purch_MenV")
<>ContCode:=""
...
Case of 
	...
	: ($_l_Menu=5)
		Purchases_Alloc
End case 
ERR_MethodTrackerReturn("Purch_MenV"; $_t_oldMethodName)
