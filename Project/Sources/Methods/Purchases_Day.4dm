//%attributes = {}
If (False:C215)
	//Project Method Name:      Purchases_Day
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purchases_Day")
//Purchases_List
...
While (vPu=1)
	...
	If (vPu=1)
		If (Records in selection:C76([PURCHASE_INVOICES:37])>0)
			...
			//Open_Pro_Window (Term_SLPLWT ("Purchases_Daybook");0;1;->[PURCHASES];WIN_t_CurrentOutputform)
...
ERR_MethodTrackerReturn("Purchases_Day"; $_t_oldMethodName)