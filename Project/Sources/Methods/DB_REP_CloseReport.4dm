//%attributes = {}
If (False:C215)
	//Project Method Name:      DB_REP_CloseReport
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/01/2012 12:03
...
If (True:C214)
	...
	C_LONGINT:C283($_l_Error; $_l_OK; DB_l_CurrentDisplayedForm; DB_l_ReportType; DB_l_SRarea; DBQR_l_EDITORAREA; PAL_BUTTON_2)
	C_TEXT:C284($_t_oldMethodName; $_t_ReportName; DB_T_CurrentReportCode; DB_T_CurrentReportName; PAL_BUTTON; SR_t_ReportDataXML)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("DB_REP_CloseReport")
...
PAL_BUTTON:=""
ACCEPT:C269
ERR_MethodTrackerReturn("DB_REP_CloseReport"; $_t_oldMethodName)