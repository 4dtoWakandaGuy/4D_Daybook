//%attributes = {}
If (False:C215)
	//Project Method Name:      Record_Startup
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/12/2009 09:32`Method: Record_Startup
...
$_t_oldMethodName:=ERR_MethodTracker("Record_Startup")
...
ERR_MethodTrackerReturn("Record_Startup"; $_t_oldMethodName)
