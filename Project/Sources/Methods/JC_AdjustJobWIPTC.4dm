...
If (False:C215)
	//Project Method Name:      JC_AdjustJobWIPTC
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("JC_AdjustJobWIPTC")
...
If ($_bo_PostiveAjustment)
	[JOBS:26]JS_WIP_Cost_Amount:45:=[JOBS:26]JS_WIP_Cost_Amount:45+[JOBS:26]JS_WIP_Cost_Amount_Adj:59
Else 
	[JOBS:26]JS_WIP_Cost_Amount:45:=[JOBS:26]JS_WIP_Cost_Amount:45-[JOBS:26]JS_WIP_Cost_Amount_Adj:59
End if 
ERR_MethodTrackerReturn("JC_AdjustJobWIPTC"; $_t_oldMethodName)