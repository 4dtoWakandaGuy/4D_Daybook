//%attributes = {}
If (False:C215)
	//Project Method Name:      Prod_StockCurr
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Prod_StockCurr")
Menu_Record("Prod_StockCurr"; "Current Stock")
...
ERR_MethodTrackerReturn("Prod_StockCurr"; $_t_oldMethodName)
