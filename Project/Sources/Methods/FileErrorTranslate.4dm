//%attributes = {}
If (False:C215)
	//Project Method Name:      FileErrorTranslate
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FileErrorTranslate")

//FileErrorTranslate

//Added kmw, 30/10/08 v631b120c
//Factors out what looks like some useful code from "EW_OnErr"
...
ERR_MethodTrackerReturn("FileErrorTranslate"; $_t_oldMethodName)