//%attributes = {}
If (False:C215)
	//Project Method Name:      REPORT_UNIQUE_FIELD_RECORDS
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("REPORT_UNIQUE_FIELD_RECORDS")
...
CLOSE DOCUMENT:C267($_ti_ExportDocument)

//ALERT("Done")
Gen_Alert("Done.")
ERR_MethodTrackerReturn("REPORT_UNIQUE_FIELD_RECORDS"; $_t_oldMethodName)