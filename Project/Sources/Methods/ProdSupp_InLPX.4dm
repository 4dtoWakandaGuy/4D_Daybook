//%attributes = {}
If (False:C215)
	//Project Method Name:      ProdSupp_InLPX
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 21/11/2009`Method: ProdSupp_InLPX`Description
...
$_t_oldMethodName:=ERR_MethodTracker("ProdSupp_InLPX")
//ProdSupp_InLPX
Case of 
	...
	: ($1=(->[PRODUCTS_SUPPLIERS:148]Supplier_Product_Code:4))
		...
		Products_InMod
End case 
ERR_MethodTrackerReturn("ProdSupp_InLPX"; $_t_oldMethodName)
