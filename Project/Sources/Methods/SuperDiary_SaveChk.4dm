//%attributes = {}
If (False:C215)
	//Project Method Name:      SuperDiary_SaveChk
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("SuperDiary_SaveChk")
//SuperDiary_SaveChk: asks to save changes before a change of screen
...
End if 
ERR_MethodTrackerReturn("SuperDiary_SaveChk"; $_t_oldMethodName)
