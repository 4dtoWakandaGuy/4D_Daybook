//%attributes = {}
If (False:C215)
	//Project Method Name:      PurchOrd_ItemPr
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/11/2009`Method: PurchOrd_ItemPr
...
$_t_oldMethodName:=ERR_MethodTracker("PurchOrd_ItemPr")
//PurchOrd_ItemPr
...
If ((DB_GetModuleSettingByNUM(Module_Companies)#3) & (<>PER_bo_ProdUpdateAccess) & ([PURCHASE_ORDERS:57]Company_Code:1#<>SYS_t_StockOrderCompany))
	...
	End if 
End if 
ERR_MethodTrackerReturn("PurchOrd_ItemPr"; $_t_oldMethodName)