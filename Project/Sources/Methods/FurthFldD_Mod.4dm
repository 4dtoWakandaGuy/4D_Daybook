//%attributes = {}
If (False:C215)
	//Project Method Name:      FurthFldD_Mod
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FurthFldD_Mod")
//FurthFldD_Mod
<>StartProc:=False:C215
Start_Process
If ((DB_GetModuleSettingByNUM(1))#5)
	
	FORM SET OUTPUT:C54([CUSTOM_FIELD_DEFINITiONS:99]; "FieldDefs_Out")
	FORM SET INPUT:C55([CUSTOM_FIELD_DEFINITiONS:99]; "CustomFieldDef_In")  //NG April 2004 removed reference to ◊screen
	
	FORM SET OUTPUT:C54([CUSTOM_FIELDS:98]; "CustomFIelds_Out")
	FORM SET INPUT:C55([CUSTOM_FIELDS:98]; "CustomFIeld_in")  //NG April 2004 removed reference to ◊screen)
	...
	MESSAGES OFF:C175
	Open_Pro_Window("Further Fields"; 0; 3; ->[CUSTOM_FIELD_DEFINITiONS:99]; "dField_Defs")
	DIALOG:C40([CUSTOM_FIELD_DEFINITiONS:99]; "dField_Defs")
	Close_ProWin
	MESSAGES ON:C181
	If (OK=1)
...
End if 
Process_End
ERR_MethodTrackerReturn("FurthFldD_Mod"; $_t_oldMethodName)