//%attributes = {}
If (False:C215)
	//Project Method Name:      Check_Prod2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Check_Prod2")
//Check_Prod2
...
DIALOG:C40([PRODUCTS:9]; "dAsk_Product")
CHK_l_OnLoad:=0
CLOSE WINDOW:C154
...
WS_KeepFocus
ERR_MethodTrackerReturn("Check_Prod2"; $_t_oldMethodName)