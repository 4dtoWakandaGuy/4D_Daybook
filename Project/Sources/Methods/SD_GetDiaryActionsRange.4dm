//%attributes = {}
If (False:C215)
	//Project Method Name:      SD_GetDiaryActionsRange
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 17/12/2009 20:50`Method: SD_GetDiaryActionsRange
...
$_t_oldMethodName:=ERR_MethodTracker("SD_GetDiaryActionsRange")
...
If (Count parameters:C259>=1)
	For ($_l_ParameterIndex; 1; Count parameters:C259)
		$_l_actionRow:=Find in array:C230(SD2_at_ActionNames; ${$_l_ParameterIndex})
		If ($_l_actionRow>0)
...
ERR_MethodTrackerReturn("SD_GetDiaryActionsRange"; $_t_oldMethodName)
