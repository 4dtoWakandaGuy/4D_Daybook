//%attributes = {}
If (False:C215)
	//Project Method Name:      Minor_DelSinCU
	//------------------ Method Notes ------------------
...
If (OK=1)
	...
	Gen_InNoF($1)
End if 
ERR_MethodTrackerReturn("Minor_DelSinCU"; $_t_oldMethodName)