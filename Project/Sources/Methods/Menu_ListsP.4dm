//%attributes = {}
If (False:C215)
	//Project Method Name:      Menu_ListsP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Menu_ListsP")
If (<>MenuProc=0)
	<>MenuProc:=1
End if 
...
If (<>DB_t_PostcodeLabel#"Postcode")
	...
	//SET MENU ITEM(3;3;"  "+◊ATPostcode+"s";◊MenuProc)
End if 
...
//End if
$_t_TaxName:=Term_VATWT("  Tax Codes")
If ($_t_TaxName#"  Tax Codes")
	DB_MenuAction("Financials"; "  Tax Codes"; 1; $_t_TaxName)
End if 
ERR_MethodTrackerReturn("Menu_ListsP"; $_t_oldMethodName)
