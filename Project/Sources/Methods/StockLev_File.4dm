//%attributes = {}
If (False:C215)
	//Project Method Name:      StockLev_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockLev_File")

FORM SET INPUT:C55([STOCK_LEVELS:58]; "StockLev_in")  //NG April 2004 Removed ◊Screen
WIN_t_CurrentInputForm:="StockLev_in"
FORM SET OUTPUT:C54([STOCK_LEVELS:58]; "StockLev_out")
WIN_t_CurrentOutputform:="StockLev_out"
vPu:=1
...
End if 
ERR_MethodTrackerReturn("StockLev_File"; $_t_oldMethodName)
