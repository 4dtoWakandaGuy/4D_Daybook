//%attributes = {}
If (False:C215)
	//Project Method Name:      Expand_BlobPtr
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Expand_BlobPtr")
...
Case of 
	...
	Else 
		...
		If ($_l_Compressed#Is not compressed:K22:11)
			EXPAND BLOB:C535($_blb_Pointer->)
		End if 
End case 
ERR_MethodTrackerReturn("Expand_BlobPtr"; $_t_oldMethodName)