//%attributes = {}
If (False:C215)
	//Project Method Name:      Purch_PPrint
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purch_PPrint")
Menu_Record("Purch_PPrint"; "Print")
...
ERR_MethodTrackerReturn("Purch_PPrint"; $_t_oldMethodName)