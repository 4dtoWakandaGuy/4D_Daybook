//%attributes = {}
If (False:C215)
	//Project Method Name:      QR_GetStringData
	//------------------ Method Notes ------------------
	//This method is so Array elements from a listbox area can be printed on a QR.
	//it returns the data of the column($1(pointer)) and Row(LB_l_CurrentRow)
	//and advances(LB_l_CurrentRow) by one(make its set to 1 or zero to start!)
	
	//------------------ Revision Control ----------------
	//Date Created: 14/09/2012 07:55
...
$_t_oldMethodName:=ERR_MethodTracker("QR_GetStringData")
...
End if 
ERR_MethodTrackerReturn("QR_GetStringData"; $_t_oldMethodName)
