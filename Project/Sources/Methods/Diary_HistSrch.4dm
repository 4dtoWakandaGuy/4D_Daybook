//%attributes = {}
If (False:C215)
	//Project Method Name:      Diary_HistSrch
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 09/09/2009 21:11:46If (False)// ----------------------------------------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Diary_HistSrch")
If (Count parameters:C259>=1)
	$_t_HistoryType:=$1
Else 
	$_t_HistoryType:=<>SD3_at_HistoryRelation{<>SD3_at_HistoryRelation}
End if 
...
End case 
ERR_MethodTrackerReturn("Diary_HistSrch"; $_t_oldMethodName)