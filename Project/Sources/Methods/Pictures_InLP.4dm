//%attributes = {}
If (False:C215)
	//Project Method Name:      Pictures_InLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Pictures_InLP")
...
Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetInputFormMenu(Table:C252(->[PICTURES:85]); "Picture_In")
	...
	: ($_l_Event=On Deactivate:K2:10)
		//PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("Pictures_InLP"; $_t_oldMethodName)