//%attributes = {}
If (False:C215)
	//Project Method Name:      Calls_ShtPrint
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Calls_ShtPrint")
//Calls_ShtPrint
SR_bo_Validated:=False:C215

Menu_Record("Calls_ShtPrint"; "Print Call Sheet")
...
//Gen_PPSingle (->[SERVICE CALLS];"ServiceReport";"Calls_Out";"Call Sheet";"Call Sheet";"Calls_SerRepLP";0;->vNo;"Call Sheet";◊PersAnal)
...
$_l_PrintDone:=Gen_PPSingle(->[SERVICE_CALLS:20]; "ServiceReport"; "Calls_Out"; "Call Sheet"; "Call Sheet"; "Calls_SerRepLP"; 0; ->vNo; "Call Sheet"; <>Per_t_CurrentDefaultAnalCode; False:C215; $_t_DocumentName)
SET WINDOW TITLE:C213($_t_CurrentWindowTitle)
//OUTPUT LAYOUT("ServiceReport")
//PRINT SELECTION([SERVICE CALLS])
//OUTPUT LAYOUT("Calls_Out")
...
ERR_MethodTrackerReturn("Calls_ShtPrint"; $_t_oldMethodName)