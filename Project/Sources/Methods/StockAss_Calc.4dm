//%attributes = {}
If (False:C215)
	//Project Method Name:      StockAss_Calc
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StockAss_Calc")
Menu_Record("StockAss_Calc"; "Trial Assembly")
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("StockAss_Calc"; $_t_oldMethodName)
