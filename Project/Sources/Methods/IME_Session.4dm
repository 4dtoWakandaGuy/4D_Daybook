//%attributes = {}
If (False:C215)
	//Project Method Name:      IME_Session
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("IME_Session")
//IME_Session
...
If (vWebRef="")
	...
	If ($_l_IPRow<1)
		IME_bo_isaRobot:=False:C215
		IME_AccessCreate($_t_Site; 1)
	Else 
		IME_bo_isaRobot:=True:C214  //NB: Is currently NOT a robot if cookies are handled by the robot
...
ERR_MethodTrackerReturn("IME_Session"; $_t_oldMethodName)