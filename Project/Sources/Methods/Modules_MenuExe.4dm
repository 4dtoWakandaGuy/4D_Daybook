//%attributes = {}
If (False:C215)
	//Project Method Name:      Modules_MenuExe
	//------------------ Method Notes ------------------
...
End if 
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("Modules_MenuExe")
...
Case of 
	: ($1="Menu_Main")
		Menu_Main(Db_t_MenuType; $_l_MenuProc)
	: ($1="Menu_Silver")
...
End case 
ERR_MethodTrackerReturn("Modules_MenuExe"; $_t_oldMethodName)
