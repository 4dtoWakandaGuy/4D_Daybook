//%attributes = {}
If (False:C215)
	//Project Method Name:      Movements_List
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Movements_List")
//Movements_List
...
While (vPu=1)
	...
	If (vPu=1)
		If (Records in selection:C76([STOCK_MOVEMENTS:40])>0)
			...
			//Open_Pro_Window ("Movements_List";0;1;->[STOCK MOVEMENTS];WIN_t_CurrentOutputform)
...
ERR_MethodTrackerReturn("Movements_List"; $_t_oldMethodName)
