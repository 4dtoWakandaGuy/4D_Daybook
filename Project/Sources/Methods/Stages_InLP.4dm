//%attributes = {}
If (False:C215)
	//Project Method Name:      Stages_InLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Stages_InLP")
...
Case of 
	...
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetInputFormMenu(Table:C252(->[STAGES:45]); "Stages_in")
	...
	: ($_l_Event=On Menu Selected:K2:14)
		...
		End if 
End case 
ERR_MethodTrackerReturn("Stages_InLP"; $_t_oldMethodName)