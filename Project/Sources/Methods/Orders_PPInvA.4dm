//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPInvA
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPInvA")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPInvA"; "Invoice All")
...
End if 
ERR_MethodTrackerReturn("Orders_PPInvA"; $_t_oldMethodName)