//%attributes = {}
If (False:C215)
	//Project Method Name:      SD_WorkingHours
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("SD_WorkingHours")
If (Count parameters:C259>=4)
	If ($1#?00:00:00?)
		$_ti_TimeStart:=Time:C179(Time string:C180($1+($2*60*60)))
	...
	End if 
End if 
ERR_MethodTrackerReturn("SD_WorkingHours"; $_t_oldMethodName)
