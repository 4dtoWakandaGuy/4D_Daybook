//%attributes = {}
If (False:C215)
	//Project Method Name:      IME_RelateOne
	//------------------ Method Notes ------------------
	//IME_RelateOne
	//Rollo 18/6/2004
...
$_t_oldMethodName:=ERR_MethodTracker("IME_RelateOne")
...
Else 
	$0:="IME_RelateOne - Error - no parameters"
End if 
ERR_MethodTrackerReturn("IME_RelateOne"; $_t_oldMethodName)