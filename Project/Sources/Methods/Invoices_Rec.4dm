//%attributes = {}
If (False:C215)
	//Project Method Name:      Invoices_Rec
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	//C_UNKNOWN(vNo2)
	//C_UNKNOWN(vTitle)
	C_LONGINT:C283(vNo; vNo2; vIn)
	C_TEXT:C284($_t_oldMethodName; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; vTitle; WIN_t_CurrentOutputform; $_t_CurrentOutputform; $_t_oldMethodName; DB_t_CurrentFormUsage; WIN_t_CurrentOutputform)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Invoices_Rec")
//Invoices_Rec
If (False:C215)
...
End if 
ERR_MethodTrackerReturn("Invoices_Rec"; $_t_oldMethodName)
