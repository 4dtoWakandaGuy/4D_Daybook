//%attributes = {}
If (False:C215)
	//Project Method Name:      CCM_BC_initiate
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 12/12/2009 13:21`Method: CCM_BC_initiate
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; CCM_t_AuthorizationLogin)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("CCM_BC_initiate")
...
End if 
If ($_l_IndexID>0)
	CCM_AN_INSERTDATA($_l_IndexID; "x_login"; CCM_t_AuthorizationLogin; "x_tran_key"; CCM_t_AuthorizationLogin; "X_version"; "3.1"; "x_Delim_data"; "TRUE"; "x_delim_char"; "|"; "x_relay_response"; "FALSE")
End if 
//Note that we never bother deleting rows, normally there will only be one row
ERR_MethodTrackerReturn("CCM_BC_initiate"; $_t_oldMethodName)