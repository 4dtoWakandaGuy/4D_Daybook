//%attributes = {}
If (False:C215)
	//Project Method Name:      Purch_PrePost
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purch_PrePost")
//Project Method Purch_PrePost 26/3/2(ID 12869-2444)
...
If ((DB_GetModuleSettingByNUM(Module_NominalLedger)>0) & (OK=1))
	...
	End if 
End if 
ERR_MethodTrackerReturn("Purch_PrePost"; $_t_oldMethodName)
