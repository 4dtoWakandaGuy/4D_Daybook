//%attributes = {}
If (False:C215)
	//Project Method Name:      FIX_ANALYSIS_CODE_5_D
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FIX_ANALYSIS_CODE_5_D")
...
QUERY:C277([TRANSACTIONS:29];  & ; [TRANSACTIONS:29]Period_Code:12=ACC_t_AnalysisPeriodtoFix)
...
If (Records in set:C195("WT_One")>0)
	...
	End for 
End if 
ERR_MethodTrackerReturn("FIX_ANALYSIS_CODE_5_D"; $_t_oldMethodName)