//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPDelS
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPDelS")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPDelS"; "Delivery Note Selected")
...
End if 
ERR_MethodTrackerReturn("Orders_PPDelS"; $_t_oldMethodName)