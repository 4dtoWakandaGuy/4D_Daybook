//%attributes = {}
If (False:C215)
	//Project Method Name:      FurthFldP_InLPA
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("FurthFldP_InLPA")
//FurthFldP_InLPA

READ WRITE:C146([CUSTOM_FIELDS_PERSONNEL:100])
$_t_AccessCode:=STR_LeadZeros(String:C10(vJB); 3)+Str_TrailSpaces([PERSONNEL:11]Initials:1; 5)
...
ERR_MethodTrackerReturn("FurthFldP_InLPA"; $_t_oldMethodName)