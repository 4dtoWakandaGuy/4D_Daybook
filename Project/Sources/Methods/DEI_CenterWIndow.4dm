//%attributes = {}
If (False:C215)
	//Project Method Name:      DEI_CenterWIndow
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("DEI_CenterWIndow")
If (False:C215)
...
If ($_l_CountParameters>3)
	$_t_WindowTitle:=$4
Else 
	$_t_WindowTitle:="Daybook Tools"
End if 

If ($_l_CountParameters>4)
	$_t_CloseBoxMethod:=$5
Else 
	$_t_CloseBoxMethod:="DEI_CLOSEBOX"
End if 
...
ERR_MethodTrackerReturn("DEI_CenterWIndow"; $_t_oldMethodName)