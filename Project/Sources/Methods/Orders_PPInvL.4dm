//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPInvL
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPInvL")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPInvL"; "Invoice Allocated")
...
End if 
ERR_MethodTrackerReturn("Orders_PPInvL"; $_t_oldMethodName)