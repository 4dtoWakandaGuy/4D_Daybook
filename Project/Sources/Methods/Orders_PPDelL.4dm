//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPDelL
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPDelL")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPDelL"; "Delivery Note Allocated")
...
End if 
ERR_MethodTrackerReturn("Orders_PPDelL"; $_t_oldMethodName)
