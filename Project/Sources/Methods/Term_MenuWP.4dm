//%attributes = {}
If (False:C215)
	//Project Method Name:      Term_MenuWP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Term_MenuWP")
If (<>MenuProc=0)
	<>MenuProc:=1
End if 
...
If ($_t_QuotesMenuItemName#"View Letters & Quotes")
	DB_MenuAction("Documents"; "View Letters & Quotes "; 1; $_t_QuotesMenuItemName; <>MenuProc; False:C215)
	//  SET MENU ITEM(4;5;"View Inquiries, Qtns, Orders";◊MenuProc)
End if 
ERR_MethodTrackerReturn("Term_MenuWP"; $_t_oldMethodName)
