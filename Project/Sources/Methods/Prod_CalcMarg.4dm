//%attributes = {}
If (False:C215)
	//Project Method Name:      Prod_CalcMarg
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 21/11/2009`Method: Prod_CalcMarg`Description
...
$_t_oldMethodName:=ERR_MethodTracker("Prod_CalcMarg")
...
End while 
ERR_MethodTrackerReturn("Prod_CalcMarg"; $_t_oldMethodName)
