...
If (False:C215)
	//Project Method Name:      Cal4D_IsDaylightTime_Rule_8
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Cal4D_IsDaylightTime_Rule_8")
...
$0:=$_bo_DST
ERR_MethodTrackerReturn("Cal4D_IsDaylightTime_Rule_8"; $_t_oldMethodName)