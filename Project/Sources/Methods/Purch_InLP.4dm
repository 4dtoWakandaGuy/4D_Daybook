//%attributes = {}
If (False:C215)
	//Project Method Name:      Purch_InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord; SD2_l_CallingProcess; SD2_l_TableNum)
...
$_t_oldMethodName:=ERR_MethodTracker("Purch_InLP")
//Project Method Purch_InLP 26/3/2(ID-21459-7386)
//Purch_InLP
...
Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		OpenHelp(Table:C252(->[PURCHASE_INVOICES:37]); "Purchases_in")
		WS_AutoscreenSize(1; 640; 800; Table name:C256(->[PURCHASE_INVOICES:37])+"_"+"Purchases_in")
		...
		DB_SetInputFormMenu(Table:C252(->[PURCHASE_INVOICES:37]); "Purchases_in")
...
End case 
ERR_MethodTrackerReturn("Purch_InLP"; $_t_oldMethodName)
