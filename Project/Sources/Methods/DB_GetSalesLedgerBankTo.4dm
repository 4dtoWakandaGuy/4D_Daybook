//%attributes = {}
If (False:C215)
	//Project Method Name:      DB_GetSalesLedgerBankTo
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 05/09/2012 10:28
...
If (True:C214)
	...
	C_TEXT:C284($_t_oldMethodName; $0; DM_T_BankAccto)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("DB_GetSalesLedgerBankTo")
...
Else 
	...
	$0:=[USER:15]Bank To:16
End if 
ERR_MethodTrackerReturn("DB_GetSalesLedgerBankTo"; $_t_oldMethodName)