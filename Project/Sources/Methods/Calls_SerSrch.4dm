//%attributes = {}
If (False:C215)
	//Project Method Name:      Calls_SerSrch
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Calls_SerSrch")
//Calls Serial Search
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Menu_Record("Calls_SerSrch"; "Items by Serial No")
...
ERR_MethodTrackerReturn("Calls_SerSrch"; $_t_oldMethodName)