//%attributes = {}
If (False:C215)
	//Project Method Name:      StatsView_ArF1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StatsView_ArF1"; Form event code:C388)
//StatsView_ArF1 - creates array of fields for col 1
...
ERR_MethodTrackerReturn("StatsView_ArF1"; $_t_oldMethodName)