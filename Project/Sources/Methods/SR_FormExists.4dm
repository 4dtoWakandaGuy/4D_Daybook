//%attributes = {}
If (False:C215)
	//Project Method Name:      SR_FormExists
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 07/08/2012 14:58
...
If (True:C214)
	...
	C_LONGINT:C283(<>FormMethod; $_l_TableNumber; $_l_TableNumber)
	C_POINTER:C301($_ptr_Table)
	C_TEXT:C284(<>PER_t_UserGroup; <>SYS_t_PlatformSetting; $_t_AnalysisCode; $_t_oldMethodName; $_t_ReportCode; $_t_ReportName; $_t_ReportsPath; $_t_Version; $1; $2; <>PER_t_UserGroup)
	C_TEXT:C284(<>SYS_t_PlatformSetting; $_t_AnalysisCode; $_t_oldMethodName; $_t_ReportCode; $_t_ReportName; $_t_ReportsPath; $_t_Version; $1; $2)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("SR_FormExists")
//TRACE
//C_TEXT($_t_ReportName)  //Suffix (after 'SR ')
...
$_bo_Return:=((((<>FormMethod=1) & ($_bo_OptionKey=False:C215)) | (($_bo_OptionKey) & (<>FormMethod=0))) & ($_t_ReportName#"") & (($_t_ReportName="Invoice") | ($_t_ReportName="Invoice_DT") | ($_t_ReportName="Statement") | ($_t_ReportName="Purchase_Order") | ($_t_ReportName="Movement") | ($_t_ReportName="Order_Ack") | ($_t_ReportName="Order_Quote") | ($_t_ReportName="Order_Auth") | ($_t_ReportName="Delivery") | ($_t_ReportName="Contract") | ($_t_ReportName="Remittance") | ($_t_ReportName="Cheque") | ($_t_ReportName="Call_Sheet") | ($_t_ReportName="Diary_@") | ($_t_ReportName="PackingLabels")))  //Sun, Feb 12, 2006 bwalia: bref added
...
End if 
$0:=$_bo_Return
ERR_MethodTrackerReturn("SR_FormExists"; $_t_oldMethodName)
