//%attributes = {}
If (False:C215)
	//Project Method Name:      Purchases_Postd
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purchases_Postd")
Menu_Record("Purchases_Postd"; "Opening Balance")
If (In_ButtChkMan(->[PURCHASE_INVOICES:37]; "2 3 4 5 7"))
	...
	End if 
End if 
ERR_MethodTrackerReturn("Purchases_Postd"; $_t_oldMethodName)