...
$_t_oldMethodName:=ERR_MethodTracker("Diary_Cal")
//Diary_Cal
vButt:=0
Open_Squ_Window
DIALOG:C40([DIARY:12]; "dDiary_Cal")
CLOSE WINDOW:C154
If (vButt>0)
...
If (WIN_bo_TrackerInited)
	...
	End if 
End if 
ERR_MethodTrackerReturn("Diary_Cal"; $_t_oldMethodName)