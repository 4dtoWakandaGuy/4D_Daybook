//%attributes = {}
If (False:C215)
	//Project Method Name:      Calls_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Calls_File")

FORM SET INPUT:C55([SERVICE_CALLS:20]; "Calls_in")  //NG April 2004 removed reference to ◊screen
WIN_t_CurrentInputForm:="Calls_in"
FORM SET OUTPUT:C54([SERVICE_CALLS:20]; "Calls_Out")
WIN_t_CurrentOutputform:="Calls_Out"
vCalls:=1
...
End if 
ERR_MethodTrackerReturn("Calls_File"; $_t_oldMethodName)