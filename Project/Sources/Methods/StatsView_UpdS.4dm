//%attributes = {}
If (False:C215)
	//Project Method Name:      StatsView_UpdS
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("StatsView_UpdS")
//StatsView Update Search
//see also StatsView_UpdSF
...
USE SET:C118("$temp")
MESSAGES ON:C181
ERR_MethodTrackerReturn("StatsView_UpdS"; $_t_oldMethodName)