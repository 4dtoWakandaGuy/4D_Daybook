...
If (True:C214)
	...
	C_BOOLEAN:C305(DM_bo_CustomSort; $_bo_Continue; DM_bo_CustomSort)
	C_LONGINT:C283($_l_SortedOrder; vNo; vPu; $_l_OK; $_l_SortedOrder)
	C_POINTER:C301($2)
	C_REAL:C285(v31; v61; v91; v0)
	C_TEXT:C284($_t_ReportName; $1; CUR_t_ouputCurrency; vCompany; vInvTitle; vTitle1; vTitle2; vTitle3; vTitle4; vTitle5; $_t_oldMethodName)
...
If (OK=1)
	...
	Else 
		...
		If ($_bo_Continue)
			...
			//FORM SET OUTPUT([COMPANIES];"Aged_Creditors")
			BREAK LEVEL:C302(1)
			ACCUMULATE:C303(v0; v31; v61; v91)
			SET AUTOMATIC RELATIONS:C310(True:C214; False:C215)
