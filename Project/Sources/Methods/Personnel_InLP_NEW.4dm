...
If (True:C214)
	...
	C_LONGINT:C283(ModuleNumber; PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord; PER_l_BUT1; PER_l_BUT10; PER_l_BUT11; PER_l_BUT12; PER_l_BUT13; PER_l_BUT14)
...
Case of 
	...
	: ($_l_FormEvent=On Data Change:K2:15) | ($_l_FormEvent=On Clicked:K2:4)
		...
		//: (current form page=5)
		//SET COLOR(Per_Pi_Header;-(190+(256*190)))
		//INT_SetInput (Table(->[JOBS]);"Job_In")
