//%attributes = {}
If (False:C215)
	//Project Method Name:      Startup_SLOB
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Startup_SLOB")
//Startup_SLOB - Sales Ledger Opening Balances
...
Else 
	$0:=False:C215
End if 
ERR_MethodTrackerReturn("Startup_SLOB"; $_t_oldMethodName)
