//%attributes = {}
If (False:C215)
	//Project Method Name:      SD_GetOwnerDiaryIDbyNames
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/12/2009 15:55
...
$_t_oldMethodName:=ERR_MethodTracker("SD_GetOwnerDiaryIDbyNames")
...
If (Count parameters:C259>0)
	For ($_l_ParameterIndex; 1; Count parameters:C259)
		$_l_PersonRow:=Find in array:C230(SD_at_aDiaryOwners; ${$_l_ParameterIndex})
		If ($_l_PersonRow>0)
...
End if 
$0:=->SD2_al_UserIDS
ERR_MethodTrackerReturn("SD_GetOwnerDiaryIDbyNames"; $_t_oldMethodName)
