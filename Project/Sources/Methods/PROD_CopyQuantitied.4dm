//%attributes = {}
If (False:C215)
	//Project Method Name:      PROD_CopyQuantitied
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_CurrentRow; $_l_FieldNumber; $_l_Index; $_l_LineIndex; $_l_offset; $_l_RecordNumber; $_l_TableNumber; DB_l_ButtonClickedFunction; PROD_l_CallBackMProcess)
	C_TEXT:C284($_t_DiaryRecordCode; $_t_FormName; $_t_oldMethodName)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("PROD_CopyQuantitied")
...
End if 
ERR_MethodTrackerReturn("PROD_CopyQuantitied"; $_t_oldMethodName)
