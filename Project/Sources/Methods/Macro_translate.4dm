//%attributes = {}
If (False:C215)
	//Project Method Name:      Macro_translate
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Macro_translate")
...
If (True:C214)
	...
	APPEND TO ARRAY:C911($_at_NewCommands; "SET MENU ITEM MARK")
	...
	APPEND TO ARRAY:C911($_at_NewCommands; "SET MENU ITEM")
	...
	//TRACE
End if 
ERR_MethodTrackerReturn("Macro_translate"; $_t_oldMethodName)
