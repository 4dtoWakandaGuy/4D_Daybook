//%attributes = {}
If (False:C215)
	//Project Method Name:      Invoices_Posted
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Invoices_Posted")
Menu_Record("Invoices_Posted"; "Opening Balance")
If (In_ButtChkMan(->[INVOICES:39]; "2 4 5 13"))
	...
	End if 
End if 
ERR_MethodTrackerReturn("Invoices_Posted"; $_t_oldMethodName)