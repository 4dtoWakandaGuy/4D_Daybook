//%attributes = {}
If (False:C215)
	//Project Method Name:      SCPT_XL_range_set_value
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("SCPT_XL_range_set_value")
...
ERR_MethodTrackerReturn("SCPT_XL_range_set_value"; $_t_oldMethodName)