//%attributes = {}
If (False:C215)
	//Project Method Name:      Order_TitDown
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Order_TitDown")
//Order_TitDown
...
If (Not:C34(((<>SalesOrder=False:C215) | (DB_GetModuleSettingByNUM(Module_SalesOrders)<2) | (DB_GetModuleSettingByNUM(Module_SalesOrders)=3)) & ([ORDERS:24]State:15>=$_t_NewOrderState) & (vProcaMod=13)))
	...
	States_Down(->[ORDERS:24]State:15)
	//Order_TitCheck ($_t_StatePrevious)
	Orders_InLPX(->[ORDERS:24]State:15)
End if 
USE SET:C118("$Before")
ERR_MethodTrackerReturn("Order_TitDown"; $_t_oldMethodName)
