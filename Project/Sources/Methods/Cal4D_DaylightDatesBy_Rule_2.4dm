...
If (False:C215)
	//Project Method Name:      Cal4D_DaylightDatesBy_Rule_2
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Cal4D_DaylightDatesBy_Rule_2")
...
Case of 
	...
	: ($_t_Request="EndRule")
		////  and ends on the third Sunday in March.
		$_t_DtTiStr:="BYMONTH="+String:C10(March:K10:3)+";BYDAY=3SU"
		
End case 


$0:=$_t_DtTiStr
ERR_MethodTrackerReturn("Cal4D_DaylightDatesBy_Rule_2"; $_t_oldMethodName)