//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPInvN
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPInvN")

If (Not:C34(ORD_bo_IsRevision))
	
	Menu_Record("Orders_PPInvN"; "Invoice by No")
...
End if 
ERR_MethodTrackerReturn("Orders_PPInvN"; $_t_oldMethodName)