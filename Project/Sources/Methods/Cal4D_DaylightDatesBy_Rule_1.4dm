...
If (False:C215)
	//Project Method Name:      Cal4D_DaylightDatesBy_Rule_1
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Cal4D_DaylightDatesBy_Rule_1")
...
Case of 
	: ($_t_Request="StartDate")
		$_l_1stDayNo:=Day number:C114(Date:C102(String:C10(March:K10:3; "00")+"/01/"+String:C10(Year of:C25($_d_Date))))
	...
	: ($_t_Request="StartRule")
		////  begins on the last Sunday in March
		$_t_DtTiStr:="BYMONTH=3;BYDAY=-1SU"
		
	: ($_t_Request="EndDate")
		$_l_1stDayNo:=Day number:C114(Date:C102(String:C10(October:K10:10; "00")+"/01/"+String:C10(Year of:C25($_d_Date))))
		
		////  ends on  the last Sunday in October
		$_t_DtTiStr:=$_t_DtTiStr+String:C10(October:K10:10; "00")
		Case of 
			: ($_l_1stDayNo=Monday:K10:13)
	...
	: ($_t_Request="EndRule")
		////  ends on  the last Sunday in October
		$_t_DtTiStr:="BYMONTH=10;BYDAY=-1SU"
		
End case 


$0:=$_t_DtTiStr
ERR_MethodTrackerReturn("Cal4D_DaylightDatesBy_Rule_1"; $_t_oldMethodName)