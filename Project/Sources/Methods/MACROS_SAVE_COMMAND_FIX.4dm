//%attributes = {}
If (False:C215)
	//Project Method Name:      MACROS_SAVE_COMMAND_FIX
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("MACROS_SAVE_COMMAND_FIX")
...
ERR_MethodTrackerReturn("MACROS_SAVE_COMMAND_FIX"; $_t_oldMethodName)
