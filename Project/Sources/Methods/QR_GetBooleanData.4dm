//%attributes = {}
If (False:C215)
	//Project Method Name:      QR_GetBooleanData
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 14/09/2012 08:37
...
$_t_oldMethodName:=ERR_MethodTracker("QR_GetBooleanData")
...
End if 
ERR_MethodTrackerReturn("QR_GetBooleanData"; $_t_oldMethodName)
