//%attributes = {}
If (False:C215)
	//Project Method Name:      ORD_CommentstoDiary
	//------------------ Method Notes ------------------
	//ththis  transfers the contents of orders comments 2(not comments as that is for printing). to a diary record
	
	//------------------ Revision Control ----------------
	//Date Created: 05/11/2012 18:35
...
$_t_oldMethodName:=ERR_MethodTracker("ORD_CommentstoDiary")
...
ERR_MethodTrackerReturn("ORD_CommentstoDiary"; $_t_oldMethodName)
ERR_MethodTrackerReturn("ORD_CommentstoDiary"; $_t_oldMethodName)