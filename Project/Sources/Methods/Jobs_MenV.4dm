...
$_t_oldMethodName:=ERR_MethodTracker("Jobs_MenV")
$_l_MenuSelected:=Sel_LPmi("Jobs_MenV")
...
End case 
ERR_MethodTrackerReturn("Jobs_MenV"; $_t_oldMethodName)