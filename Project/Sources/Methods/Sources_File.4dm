//%attributes = {}
If (False:C215)
	//Project Method Name:      Sources_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Sources_File")
If (<>Mod_l_MaxModules=0)
	GET PROCESS VARIABLE:C371(-1; <>Mod_l_MaxModules; <>Mod_l_MaxModules)
End if 

FORM SET INPUT:C55([SOURCES:6]; "Sources_In")  //NG April 2004 Removed ◊Screen
WIN_t_CurrentInputForm:="Sources_In"
FORM SET OUTPUT:C54([SOURCES:6]; "Sources_Out")
WIN_t_CurrentOutputform:="Sources_Out"
vP:=1
...
Else 
	...
	End if 
End if 
ERR_MethodTrackerReturn("Sources_File"; $_t_oldMethodName)