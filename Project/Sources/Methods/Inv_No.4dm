...
$_t_oldMethodName:=ERR_MethodTracker("Inv_No")
//Project Method Inv_No 26/3/2(ID 7027-2566)
...
If ([INVOICES:39]Invoice_Number:1="0")
	CANCEL:C270
End if 
ERR_MethodTrackerReturn("Inv_No"; $_t_oldMethodName)