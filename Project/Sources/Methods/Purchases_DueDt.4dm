//%attributes = {}
If (False:C215)
	//Project Method Name:      Purchases_DueDt
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 22/11/2009`Method: Purchases_DueDt
...
$_t_oldMethodName:=ERR_MethodTracker("Purchases_DueDt")
If ([PURCHASE_INVOICES:37]Invoice_Date:5#!00-00-00!)
	...
	Purchases_LPAge
End if 
ERR_MethodTrackerReturn("Purchases_DueDt"; $_t_oldMethodName)