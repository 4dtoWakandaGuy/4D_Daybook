//%attributes = {}
If (False:C215)
	//Project Method Name:      PI_SelectDiaryRecords
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("PI_SelectDiaryRecords")
...
If (Count parameters:C259>=1)
	...
	If ($_l_TabRow>0)
		...
		For ($_l_TabColumnIndex; 1; Size of array:C274(PI_al_TabIncludes{$_l_TabRow}))
			If (PI_al_TabIncludes{$_l_TabRow}{$_l_TabColumnIndex}>0)
				QUERY:C277([ACTIONS:13]; [ACTIONS:13]xID:12=PI_al_TabIncludes{$_l_TabRow}{$_l_TabColumnIndex})
			...
			Else 
				...
				$_l_TabIncludes:=PI_al_TabIncludes{$_l_TabRow}{$_l_TabColumnIndex}
...
ERR_MethodTrackerReturn("PI_SelectDiaryRecords"; $_t_oldMethodName)
