//%attributes = {}
If (False:C215)
	//Project Method Name:      Prod_Components
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Prod_Components")
//Prod_Components
Menu_Record("Prod_Components"; "Components")
...
End if 
ERR_MethodTrackerReturn("Prod_Components"; $_t_oldMethodName)