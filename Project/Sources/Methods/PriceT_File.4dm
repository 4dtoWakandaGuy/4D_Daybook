//%attributes = {}
If (False:C215)
	//Project Method Name:      PriceT_File
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("PriceT_File")

FORM SET INPUT:C55([PRICE_TABLE:28]; "PriceTable_In")  //NG April 2004 Removed ◊Screen
WIN_t_CurrentInputForm:="PriceTable_In"
FORM SET OUTPUT:C54([PRICE_TABLE:28]; "PriceTable_Out")
WIN_t_CurrentOutputform:="PriceTable_Out"
vP:=1
...
End if 
ERR_MethodTrackerReturn("PriceT_File"; $_t_oldMethodName)
