//%attributes = {}
If (False:C215)
	//Project Method Name:      IME_Replace
	//------------------ Method Notes ------------------
...
//Code Starts Here
$_t_oldMethodName:=ERR_MethodTracker("IME_Replace")
			...
			If (($_t_FieldValue#"@(@") & ($_t_FieldValue#"@+@") & ($_t_FieldValue#"@-@") & ($_t_FieldValue#("@"+Char:C90(34)+"@")) & ($_t_FieldValue#"@*@") & ($_t_FieldValue#"@&@") & ($_t_FieldValue#"@?@"))  //& ($_t_FieldValue#"@/@")
				...
				If ($_l_CharacterPosition>0)
					...
					If ($_l_CharPositon2<1)
						If ($_l_CharPositon>0)
							$_t_Format:=STR_RemQuote(Substring:C12($_t_FieldValue; $_l_CharPositon+1))
...
End if 
$0:=$1
ERR_MethodTrackerReturn("IME_Replace"; $_t_oldMethodName)