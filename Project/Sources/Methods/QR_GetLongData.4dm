//%attributes = {}
If (False:C215)
	//Project Method Name:      QR_GetLongData
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_FieldNumber; $_l_TableNumber; $0; $2; LB_l_CurrentRow)
	C_POINTER:C301($_Ptr_ListBoxArea; $_ptr_Variable)
	C_TEXT:C284($_t_oldMethodName; $_t_VariableName; $1)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("QR_GetLongData")
...
End if 
ERR_MethodTrackerReturn("QR_GetLongData"; $_t_oldMethodName)
