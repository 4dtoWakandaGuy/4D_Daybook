...
If (True:C214)
	...
	C_LONGINT:C283(<>BAR; <>Mod_l_MaxModules; $_l_AddMode; $_l_Number; $_l_Process; MOD_l_CurrentModuleAccess; SD3_l_CalendarStartDayNumber; Vadd; vCreate; <>Mod_l_MaxModules; $_l_AddMode)
	C_LONGINT:C283($_l_Number; $_l_Process; MOD_l_CurrentModuleAccess; SD3_l_CalendarStartDayNumber)
	C_POINTER:C301(vFilePtr)
	C_TEXT:C284($_t_oldMethodName; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; WIN_t_CurrentInputForm; $_t_oldMethodName; DB_t_CurrentFormUsage; WIN_t_CurrentInputForm)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("User_Mod")
//User_Mod
...
Else 
	...
	End if 
	If (<>Bar=47)
		FORM SET INPUT:C55([USER:15]; "User_In")  //NG April 2004 Removed ◊Screen and "S"
		WIN_t_CurrentInputForm:="User_In"
	Else 
		FORM SET INPUT:C55([USER:15]; "User_In")  //NG April 2004 Removed ◊Screen
		WIN_t_CurrentInputForm:="User_In"
	End if 
	ALL RECORDS:C47([USER:15])
	vCreate:=0
	Open_Pro_Window("Preferences"; 0; 3; ->[USER:15]; "User_In")
...
End if 
Process_End
ERR_MethodTrackerReturn("User_Mod"; $_t_oldMethodName)
