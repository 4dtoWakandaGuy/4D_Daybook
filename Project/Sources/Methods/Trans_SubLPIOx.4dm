...
If (False:C215)
	//Project Method Name:      Trans_SubLPIOx
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Trans_SubLPIOx")

//Based on Trans_SubLPIO this works with variables
$_t_oldMethodName:=ERR_MethodTracker("Trans_SubLPIOx")
//Trans_SubLPIO
//Check_SecTrB ($1)
If (OK=1)
...
End if 
ERR_MethodTrackerReturn("Trans_SubLPIOx"; $_t_oldMethodName)
