//%attributes = {}
If (False:C215)
	//Project Method Name:      SCPT_XL_shape_get_rect
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("SCPT_XL_shape_get_rect")
...
$_t_json:=SCPT_XL("sheet_shape_get_rect")
...
End if 
ERR_MethodTrackerReturn("SCPT_XL_shape_get_rect"; $_t_oldMethodName)
