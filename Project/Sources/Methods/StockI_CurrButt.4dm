//%attributes = {}
If (False:C215)
	//Project Method Name:      StockI_CurrButt
	//------------------ Method Notes ------------------
...
If (STOCK_l_Context>=0)  // added NG may 2004 to
	...
	End if 
End if 
ERR_MethodTrackerReturn("StockI_CurrButt"; $_t_oldMethodName)
