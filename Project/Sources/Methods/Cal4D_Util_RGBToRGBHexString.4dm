...
If (False:C215)
	//Project Method Name:      Cal4D_Util_RGBToRGBHexString
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Cal4D_Util_RGBToRGBHexString")
...
$_t_RGBString:="0x"+String:C10($_l_Red)+","+String:C10($_l_Green)+","+String:C10($_l_Blue)


$0:=$_t_RGBString
ERR_MethodTrackerReturn("Cal4D_Util_RGBToRGBHexString"; $_t_oldMethodName)