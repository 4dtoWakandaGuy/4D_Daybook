//%attributes = {}
If (False:C215)
	//Project Method Name:      Year_Close
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_TransPostStatus; DS_l_BATCHITEMRef; vAdd; $_l_Index; $_l_TransPostStatus; DS_l_BATCHITEMRef)
	C_REAL:C285($_r_Sum)
	C_TEXT:C284(<>YrPerF; <>YrPerT; $_t_oldMethodName; ACC_t_PeriodFrom; ACC_t_PeriodTo; <>SYS_t_BaseCurrency; $_t_oldMethodName; ACC_t_PeriodFrom; ACC_t_PeriodTo)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Year_Close")
//Year_Close
Start_Process
...
Process_End
ERR_MethodTrackerReturn("Year_Close"; $_t_oldMethodName)
