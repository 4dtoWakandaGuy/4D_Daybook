//%attributes = {}
If (False:C215)
	//Project Method Name:      Periods_InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283(PAL_but_FirstRecord; vAdd)
...
$_t_oldMethodName:=ERR_MethodTracker("Periods_InLP")
//lp Periods in
...
Case of 
	...
	: ($_l_Event=On Clicked:K2:4)
		...
		//PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("Periods_InLP"; $_t_oldMethodName)