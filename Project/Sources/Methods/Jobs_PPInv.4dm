...
If (False:C215)
	//Project Method Name:      Jobs_PPInv
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Jobs_PPInv")

//NG January 2007-=---temp change to allow invoicing of jobs--needs looking at
If (False:C215)
	Menu_Record("Jobs_PPInv"; "Invoice or Credit Note")
	...
	Else 
		...
		End if 
	End if 
	ERR_MethodTrackerReturn("Jobs_PPInv"; $_t_oldMethodName)
Else 
	$_t_oldMethodName:=ERR_MethodTracker("Jobs_PPInv")
	Menu_Record("Jobs_PPInv"; "Invoice or Credit Note")
	If ((DB_GetModuleSettingByNUM(Module_SalesLedger)<2) | (DB_GetModuleSettingByNUM(Module_SalesLedger)=3))
