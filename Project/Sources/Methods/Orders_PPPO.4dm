//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPPO
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 07/12/2009 18:21`Method: Orders_PPPO
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPPO")
//Orders_PPPO
Menu_Record("Orders_PPPO"; "Purchase Order")
$_l_AddMode2:=vAdd
...
vAdd:=$_l_AddMode2
//Need to reSET_MENU
ERR_MethodTrackerReturn("Orders_PPPO"; $_t_oldMethodName)
