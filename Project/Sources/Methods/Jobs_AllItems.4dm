//%attributes = {}
If (False:C215)
	//Project Method Name:      Jobs_AllItems
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Jobs_AllItems")
Menu_Record("Jobs_AllItems"; "Show All Cost Items")
...
ERR_MethodTrackerReturn("Jobs_AllItems"; $_t_oldMethodName)