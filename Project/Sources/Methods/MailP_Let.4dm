...
If (True:C214)
	...
	C_BOOLEAN:C305(DOC_bo_Loaded; DOC_bo_Loaded2; EMAIL_bo_DonotChangeSubject; EMAIL_bo_MailListBuilt; Email_bo_TestMailing)
...
$_t_oldMethodName:=ERR_MethodTracker("MailP_Let")
//MailP_Let
...
Case of 
	: (MMLetterClass=0) | (MMLetterClass=4D Write Letter) | (MMLetterClass=4D Write Letter Template)  //this is a letter
		...
		Letter_Date
		vName:=""
		DOC_bo_Loaded:=False:C215
		DOC_bo_Loaded2:=False:C215
...
ERR_MethodTrackerReturn("MailP_Let"; $_t_oldMethodName)
