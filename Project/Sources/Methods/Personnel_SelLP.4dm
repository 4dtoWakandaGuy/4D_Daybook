//%attributes = {}
If (False:C215)
	//Project Method Name:      Personnel_SelLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Personnel_SelLP")

If (Count parameters:C259=0)
	$mi:=Sel_LPmi("Personnel_SelLP")
Else 
...
ERR_MethodTrackerReturn("Personnel_SelLP"; $_t_oldMethodName)