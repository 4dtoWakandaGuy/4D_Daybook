//%attributes = {}
If (False:C215)
	//Project Method Name:      Sel_CritSave
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Sel_CritSave")
//Sel_CritSave
Menu_Record("Sel_CritSave"; "Save Criteria ...")
If (vTitle13#"")
...
End if 
ERR_MethodTrackerReturn("Sel_CritSave"; $_t_oldMethodName)