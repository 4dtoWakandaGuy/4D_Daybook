//%attributes = {}
If (False:C215)
	//Project Method Name:      Mail_State
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Mail_State")
//Mail_Statements
	...
	While (vIn=1)
		...
		If (vIn=1)
			If (Records in selection:C76([INVOICES:39])>0)
				...
				//Open_Pro_Window ("Mail_Statements";0;1;->[INVOICES];WIN_t_CurrentOutputform)
...
ERR_MethodTrackerReturn("Mail_State"; $_t_oldMethodName)
