//%attributes = {}
If (False:C215)
	//Project Method Name:      SETEMAILFORMOBJECTS_NEW
	//------------------ Method Notes ------------------
	
	//------------------ Revision Control ----------------
	//Date Created: 30/11/2010 20:08
...
$_t_oldMethodName:=ERR_MethodTracker("SETEMAILFORMOBJECTS_NEW")
...
End case 
ERR_MethodTrackerReturn("SETEMAILFORMOBJECTS_NEW"; $_t_oldMethodName)