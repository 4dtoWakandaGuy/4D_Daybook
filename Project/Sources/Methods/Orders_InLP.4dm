...
If (True:C214)
	...
	C_BOOLEAN:C305(DB_bo_RecordModified; Gen_bo_StateModified; ORD_bo_InitPointers; ORD_bo_OrderModified; ORD_bo_QuickAddMode; PAL_bo_ButtonSubFunction; PROD_bo_Exit; vFromIn; DB_bo_NoLoad; DB_bo_RecordModified; Gen_bo_StateModified)
	C_BOOLEAN:C305(ORD_bo_InitPointers; ORD_bo_OrderModified; ORD_bo_QuickAddMode; PAL_bo_ButtonSubFunction; PROD_bo_Exit)
	C_LONGINT:C283($_l_ButtonNumber; $_l_CallFromProcess; $_l_Event; $_l_FrontmostWindow; $_l_Index; $_l_ModuleRow; $_l_NextSort; $_l_ProcessIndex; $_l_ProcessRow; $_l_Sizeofarray; $_l_WindowRef)
	C_LONGINT:C283($nul; DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; DF_l_ContactCentric; iCancel; iOK; ModuleNumber; ORD_l_quickaddprocess; PAL_but_LastRecord; PAL_but_NextRecord; PAL_but_FirstRecord)
	C_LONGINT:C283(PROD_l_SelectorPallette; SD_l_DragSource; SD2_l_CallingProcess; SD2_l_TableNum; vAB; vAccessSwNo; vAdd; vALLevels; WS_OLDSORTORDER; <>AutoProc; $_l_ButtonNumber)
	C_LONGINT:C283($_l_CallFromProcess; $_l_Event; $_l_FrontmostWindow; $_l_Index; $_l_ModuleRow; $_l_NextSort; $_l_ProcessIndex; $_l_ProcessRow; $_l_Sizeofarray; $_l_ViewPosition; $_l_WindowRef)
	C_LONGINT:C283(DB_l_ButtonClickedFunction; DB_l_WindowCurrentModule; DF_l_ContactCentric; ORD_l_quickaddprocess; PAL_but_PreviousRecord; PROD_l_SelectorPallette; SD2_l_CallingProcess; SD2_l_TableNum; WIN_l_CurrentWinRef)
	C_POINTER:C301($_ptr_ListBoxSetup; $_ptr_ArrayReferences; $_ptr_ListBoxSetup)
	C_REAL:C285(ORD_r_SubSelection; vTot; $_r_Quantity)
	C_TEXT:C284($_t_oldMethodName; $_t_oldMethodName2; $_t_PalletButtonName; $_t_ProductCode; $_t_SubItemName; BAR_t_Button; DB_t_CUrrentInputMenuRef; DB_T_CurrentInputWindowMenu; IP_t_MessageReplySTR; ORD_t_FalseTab; PAL_BUTTON)
	C_TEXT:C284(SD2_t_TabFunction; vButtDisOrd; vStPrev; VstPrevOLD; WIN_t_CurrentInputForm; $_t_DummyTab; $_t_oldMethodName; $_t_oldMethodName2; $_t_PalletButtonName; $_t_ProductCode; $_t_SubItemName)
	C_TEXT:C284(BAR_t_Button; DB_t_CUrrentInputMenuRef; DB_T_CurrentInputWindowMenu; IP_t_MessageReplySTR; ORD_t_FalseTab; ORD_t_TabFunction; SD2_t_TabFunction; WIN_t_CurrentInputForm)
End if 
//Code Starts Here
...
Case of 
	...
	: (($_l_Event=On Activate:K2:9) | (vFromIn))
		...
		If (vFromIn)
			//TRACE
			//DB_SetInputFormMenu (Table(->[ORDERS]);"Order_In")
		End if 
		vFromIn:=False:C215
		In_ButtChkDis(->vButtDisOrd)
