//%attributes = {}
If (False:C215)
	//Project Method Name:      Products_SuLP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Products_SuLP")
//Products_SuLP
...
Case of 
	...
	: ($_l_Event=On Outside Call:K2:11)
		Case of 
			...
			: (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Plus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Minus")) | (DB_l_ButtonClickedFunction=DB_GetButtonFunction("Open"))
				inButtSubHandle(FORM Get current page:C276; ->[PRODUCTS:9]; "Items_Su")
	...
	: ($_l_Event=On Deactivate:K2:10)
		//  PAUSE PROCESS(vProc)
End case 
ERR_MethodTrackerReturn("Products_SuLP"; $_t_oldMethodName)