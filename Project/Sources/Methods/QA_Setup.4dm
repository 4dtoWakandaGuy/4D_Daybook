...
If (True:C214)
	...
	C_TEXT:C284($_t_ApplicationVersion; $_t_oldMethodName; $ErrStr; $s; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; QA_t_Value4; QA_t_ErrSting; QA_T_Search1)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("QA_Setup")
...
If ($_t_ApplicationVersion[[2]]#"7")
		...
		If ($_l_Error=0)
			...
			If ($_l_Error=0)
				...
				If ($_l_Error=0)
					...
					QA_t_Value4:=$s
					PLUGCALL_QuickAddress("SpecialOps"; 0; ->QA_l_return; ->QA_l_Value1; ->QA_l_Value2; ->QA_l_Value3; ->QA_t_Value4)
					If ($_l_Error=0)
	...
	End if 
End if 
ERR_MethodTrackerReturn("QA_Setup"; $_t_oldMethodName)
