//%attributes = {}
If (False:C215)
	//Project Method Name:      Orders_PPInvS
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Orders_PPInvS")
Menu_Record("Orders_PPInvS"; "Invoice Selected")
...
End if 
ERR_MethodTrackerReturn("Orders_PPInvS"; $_t_oldMethodName)