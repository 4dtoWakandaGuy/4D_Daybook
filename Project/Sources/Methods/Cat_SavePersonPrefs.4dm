//%attributes = {}
If (False:C215)
	//Project Method Name:      Cat_SavePersonPrefs
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Cat_SavePersonPrefs")
If (CAT_bo_ChangePrefs)
	...
	QUERY:C277([Catalogue_Availability:110]; [Catalogue_Availability:110]Person_Or_GroupID:2=([PERSONNEL:11]Personnel_ID:48); *)
	...
	For ($_l_Index; 1; Size of array:C274(CAT_aI_CatalogueINC))
		If (CAT_aI_CatalogueINC{$_l_Index}=1)
			...
			Else 
				...
				[Catalogue_Availability:110]Person_Or_GroupID:2:=[PERSONNEL:11]Personnel_ID:48
...
End if 
ERR_MethodTrackerReturn("Cat_SavePersonPrefs"; $_t_oldMethodName)