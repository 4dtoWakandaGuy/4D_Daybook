//%attributes = {}
If (False:C215)
	//Project Method Name:      PriceG_InLP
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_LONGINT:C283($_l_ButtonNumber; $_l_Event; $_l_ModuleRow; DB_l_WindowCurrentModule; ModuleNumber; PAL_but_LastRecord; PAL_but_PreviousRecord; PAL_but_NextRecord; PAL_but_FirstRecord)
	C_TEXT:C284($_t_oldMethodName; $_t_PalletButtonName; BAR_t_Button; DB_t_CUrrentInputMenuRef; PAL_BUTTON; WIN_t_CurrentInputForm)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("PriceG_InLP")
...
Case of 
	: ($_l_Event=On Load:K2:1) & (Not:C34(DB_bo_NoLoad))
		...
		DB_SetInputFormMenu(Table:C252(->[PRICE_GROUPS:18]); "PriceGroup_In")
	...
	: ($_l_Event=On Clicked:K2:4)
		...
		End case 
End case 
ERR_MethodTrackerReturn("PriceG_InLP"; $_t_oldMethodName)