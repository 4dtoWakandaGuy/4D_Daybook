//%attributes = {}
If (False:C215)
	//Project Method Name:      Stickie_Small
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Stickie_Small")
Start_Process
If (Diary_File)  //NG modified June 2004
	FORM SET INPUT:C55([DIARY:12]; "Stickie_Small")
...
End if 
ERR_MethodTrackerReturn("Stickie_Small"; $_t_oldMethodName)