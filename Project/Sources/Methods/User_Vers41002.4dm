//%attributes = {}
If (False:C215)
	//Project Method Name:      User_Vers41002
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("User_Vers41002")
...
If (Records in selection:C76([LIST_ITEMS:95])=0)
	User_Message(Char:C90(13)+"      Creating Script Groups List"+Char:C90(13))
...
ERR_MethodTrackerReturn("User_Vers41002"; $_t_oldMethodName)
