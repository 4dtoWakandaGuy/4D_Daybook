//%attributes = {}
If (False:C215)
	//Project Method Name:      JobsTC_JobCheck
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("JobsTC_JobCheck")
//JobsTC_JobCheck - check that a job you've allocated is allowed
...
If (($1->#"") & (Substring:C12(BUT_p_ButtonStringPointer->; 2; 1)="J"))
	...
	End if 
End if 
ERR_MethodTrackerReturn("JobsTC_JobCheck"; $_t_oldMethodName)