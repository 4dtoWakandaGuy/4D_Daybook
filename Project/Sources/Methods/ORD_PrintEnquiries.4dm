//%attributes = {}
If (False:C215)
	//Project Method Name:      ORD_PrintEnquiries
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_TEXT:C284(<>UserAdd; $_t_oldMethodName; DB_t_CurrentContext)
End if 

//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("ORD_PrintEnquiries")
...
ERR_MethodTrackerReturn("ORD_PrintEnquiries"; $_t_oldMethodName)