//%attributes = {}
If (False:C215)
	//Project Method Name:      OrdDel_StockP
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("OrdDel_StockP")
//OrdDel_StockP
			...
			If (OK=1)
				...
				If ((DB_t_CurrentFormUsage2#"NC") & (<>StockPostAu=False:C215) & (OK=1))
					...
					If (OK=1)
						...
						Open_Pro_Window("Delivery Stock Movement"; 0; 2; ->[STOCK_MOVEMENTS:40]; "Movements_in")
						MODIFY RECORD:C57([STOCK_MOVEMENTS:40]; *)
						Close_ProWin(Table name:C256(->[STOCK_MOVEMENTS:40])+"_"+"Movements_in")
...
End if 
ERR_MethodTrackerReturn("OrdDel_StockP"; $_t_oldMethodName)