//%attributes = {}
If (False:C215)
	//Project Method Name:      Purchase_SMI
	//------------------ Method Notes ------------------
...
$_t_oldMethodName:=ERR_MethodTracker("Purchase_SMI")
//Project Method Purchase_SMI 26/3/2(ID 20423-4048)
//Purchase Stock Movement items
$_t_CurrentOutputform:=WIN_t_CurrentOutputform
Menu_Record("Purchase_SMI"; "Copy a Stock Movement")
...
If ((OK=1) & ($_t_Search#""))
	...
	If (Records in selection:C76([STOCK_MOVEMENT_ITEMS:27])>0)
		...
		//OUTPUT FORM([STOCK ITEMS];"Stock_out")
...
vTot:=1
vNo:=$No
ERR_MethodTrackerReturn("Purchase_SMI"; $_t_oldMethodName)