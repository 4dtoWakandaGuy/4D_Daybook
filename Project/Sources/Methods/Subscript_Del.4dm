//%attributes = {}
If (False:C215)
	//Project Method Name:      Subscript_Del
	//------------------ Method Notes ------------------
...
If (True:C214)
	...
	C_DATE:C307(vDoDateF; <>DB_d_CurrentDate)
	C_LONGINT:C283($_l_SizeofArray; vNo; vOrdI; $_l_Index; $_l_SizeofArray)
	C_TEXT:C284($_t_oldMethodName; $form; DB_t_CurrentFormUsage; DB_t_CurrentFormUsage2; DB_t_CurrentFormUsage3; WIN_t_CurrentOutputform; $_t_CurrentOutputform; $_t_oldMethodName; DB_t_CurrentFormUsage; WIN_t_CurrentOutputform)
End if 
//Code Starts Here

$_t_oldMethodName:=ERR_MethodTracker("Subscript_Del")
//Subscript_Del iveries
...
ERR_MethodTrackerReturn("Subscript_Del"; $_t_oldMethodName)
